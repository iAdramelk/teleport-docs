...
- [Per-session MFA](/access-controls/guides/per-session-mfa)
- [Dual authorization](/access-controls/guides/dual-authz)
- [Role templates, allow/deny rules, and traits](/access-controls/guides/role-templates)
- [Access Requests](/access-controls/access-requests)

### Background reading

- [Authentication connectors](/reference/authentication)
- [Proxy Service](/architecture/proxy)
- [Auth Service](/architecture/authentication)
