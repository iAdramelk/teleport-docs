...
Back up before upgrading. We have more instructions in [Backing up Teleport](/management/operations/backup-restore).
...
[Upgrade the Teleport Binary](/management/admin/upgrading-the-teleport-binary).
