...
page](/architecture/agent-update-management) describes how agent
updating works.
...
[enroll agents into automatic updates](/management/operations/enroll-agent-into-automatic-updates).
...
You can now [enroll agents into automatic updates](/management/operations/enroll-agent-into-automatic-updates).
