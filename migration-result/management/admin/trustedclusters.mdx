...
As you learned in [Core Concepts](/core-concepts), a Teleport cluster
...
- The `tctl` admin tool and `tsh` client tool version >= 15.0.0-dev.
  ...
  For more information about installing Teleport, see [Installation](/installation).
...
- A Teleport SSH server that is joined to the cluster you plan to use as the **leaf cluster**.
  ...
  [Join Services to your Cluster](/agents/join-services-to-your-cluster).
