...
- [Add local users](/management/admin/users#adding-local-users)
- [Edit existing users](/management/admin/users#editing-users)
- [Delete users](/management/admin/users#deleting-users)
...
<Tabs>
  <Tab title="Teleport Enterprise/Enterprise Cloud">
    ...
    resources. See our [Teleport Resources Reference](/reference/resources).

    For all available `tctl` commands and flags, see our [CLI Reference](/reference/cli/tctl).

    You can also configure Teleport so that users can log in using an SSO provider.
    For more information, see:

    - [Single Sign-On](/access-controls/sso)
  </Tab>
  ...
  <Tab title="Teleport Team/Community Edition">
    ...
    [CLI Reference](/reference/cli/tctl).

    You can also configure Teleport so that users can log in using GitHub. For more
    information, see [GitHub SSO](/access-controls/sso/github-sso).
  </Tab>
</Tabs>
