...
<Accordion title="Using containers?">
  ...
  [How to Run Teleport Using Docker](/installation#docker) for information on
...
[Upgrading a Teleport Cluster](/management/operations/upgrading).

See the full list of supported signals in the
[Teleport Signals Reference](/reference/signals).
