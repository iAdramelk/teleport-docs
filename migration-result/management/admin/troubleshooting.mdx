...
<Tabs>
  ...
  <Tab title="Teleport Community Edition">
    ...
    For more information about custom features, or to try our [Enterprise edition](/choose-an-edition/teleport-enterprise/introduction) of Teleport, please reach out to us at [sales](https://goteleport.com/signup/enterprise/).
  </Tab>
</Tabs>
...
cluster, read our [Teleport Diagnostics](/management/diagnostics/monitoring) guides.
...
If disabling TLS routing, you can find the list of default ports to use for connecting different Teleport services at [ports without TLS routing](/reference/networking#ports-without-tls-routing)
