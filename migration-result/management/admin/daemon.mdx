...
<Tip>
  ...
  - Replace the Teleport binaries, usually
    [`teleport`](/reference/cli/teleport) and
    [`tctl`](/reference/cli/tctl).
...
[Teleport CLI Reference](/reference/cli/teleport).
...
[upgrading a Teleport binary](/management/admin/upgrading-the-teleport-binary).
