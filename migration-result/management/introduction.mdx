...
and Kubernetes Operator. Read [Using Dynamic Resources](/management/dynamic-resources)
for more information.

## Configure your cluster

Get to know the [tools you can use](/management/dynamic-resources) to apply
...
The [Admin Guides](/management/admin) section describes how to perform routine
...
The [Operations](/management/operations) section describes how to perform critical,
...
[Security](/management/security) section.

## Integrations

Teleport integrates with third-party software in order to enable secure access
to your infrastructure. The [Integrations](/management/guides) section describes
...
Learn more in the [Diagnostics](/management/diagnostics) section.
...
[Exporting Audit Events](/management/export-audit-events) guides.
