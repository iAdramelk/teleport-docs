...
Policy](/desktop-access/active-directory-manual#enable-smart-card-authentication).
...
Policy](/desktop-access/active-directory-manual#create-the-GPO-for-the-Teleport-certificate).
...
connections](/desktop-access/active-directory-manual#allow-remote-desktop-connections)
...
connections](/desktop-access/active-directory-manual#step-47-configure-a-certificate-for-rdp-connections).
...
desktop connections](/desktop-access/active-directory-manual#allow-remote-desktop-connections)
in the group policy object you have configured for Teleport connections.
