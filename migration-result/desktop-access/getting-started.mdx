...
6. (Optional) Add labels for the Windows Desktop Service to the configuration file.
   ...
   role permissions](/desktop-access/rbac).
...
2. Create a `windows-desktop-admins.yaml` file to define a new role:
   ...
   to create local Windows logins, see [Logins](/desktop-access/rbac#logins).
...
Getting Started](/access-controls/getting-started#step-13-add-local-users-with-preset-roles).
