...
- The Teleport Desktop Service with at least one remote desktop registered in
  ...
  Started with Desktop Access](/desktop-access/getting-started) before beginning this
  guide.
...
up [session recording for desktop access](/desktop-access/reference/sessions).
