...
Read our guides to how [authorization](/architecture/authorization) and
[authentication](/architecture/authentication) work in Teleport.
...
in our [CLI Reference](/reference/cli/teleport).
...
Service](/application-access/introduction).
...
Service](/database-access/introduction).
...
Service](/desktop-access/introduction).
...
Service](/kubernetes-access/introduction)
...
Read more about the [Teleport SSH Service](/server-access/introduction).
...
Read more in our [Machine ID guide](/machine-id/introduction).
...
edition in [Choose an edition](/choose-an-edition/introduction).
...
guide](/choose-an-edition/teleport-cloud/introduction).
...
guide](/choose-an-edition/teleport-enterprise/introduction).
...
Read more in our [resource reference](/reference/resources).
...
Read our [guide to Teleport roles](/access-controls/guides/role-templates).
...
Read more about [local users](/reference/authentication) and how [SSO
authentication works in Teleport](/access-controls/sso).
...
See our guide to [Authentication Options](/reference/authentication).
...
see [Configure Trusted Clusters](/management/admin/trustedclusters).
