...
<Tabs>
  <Tab title="Self-Hosted">
    - [Teleport Proxy Service](/architecture/proxy). A stateless service
  ...
  <Tab title="Teleport Enterprise Cloud">
    - [Teleport Proxy Service](/architecture/proxy). A stateless service that performs
...
- [Teleport Auth Service](/architecture/authentication). Serves as
...
1. A user logs into the cluster with `tsh login` command and retrieves
   a client certificate. See [Issuing User Certificates](/architecture/authentication)
...
of the secrets. See [GUI Clients](/connect-your-client/gui-clients) for details.
...
See respective [guides](/database-access/guides) for details on configuring client
...
See respective [guides](/database-access/guides) for details on configuring IAM/AD
authentication.
...
See [Core Concepts](/core-concepts) for general Teleport
