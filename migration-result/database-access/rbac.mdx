...
Read the [RBAC](/database-access/rbac/configuring-access) guide to get a general understanding
of how to configure Teleport roles to grant or deny access to your database users.

The [Automatic User Provisioning](/database-access/auto-user-provisioning) guides explain
