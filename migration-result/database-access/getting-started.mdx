...
See the [Automatic User Provisioning](/database-access/rbac/configuring-access) guide for how to configure Teleport to create accounts for your PostgreSQL users on demand.
...
- Check out configuration [guides](/database-access/guides).
- Learn how to configure [GUI clients](/connect-your-client/gui-clients).
- Learn about database access [role-based access control](/database-access/rbac).
- See [frequently asked questions](/database-access/faq).
