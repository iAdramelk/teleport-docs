...
- Teleport cluster with a configured [self-hosted PostgreSQL](/database-access/guides/postgres-self-hosted)
  or [RDS PostgreSQL](/database-access/guides/rds) database.
...
<Tabs>
  ...
  <Tab title="Self-hosted PostgreSQL">
    ...
    Refer to the [self-hosted PostgreSQL guide](/database-access/guides/postgres-self-hosted#step-35-configure-your-postgresql-server)
...
- Connect using your [GUI database
  client](/connect-your-client/gui-clients).
- Learn about [role
  templating](/access-controls/guides/role-templates#interpolation-rules).
