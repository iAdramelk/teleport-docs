...
See the available [guides](/database-access/guides) for all supported configurations.
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [Proxy Configuration](/database-access/reference/configuration#proxy-configuration) for
    more details.
...
[graphical clients](/connect-your-client/gui-clients).
...
[configuration file](/database-access/reference/configuration#database-service-configuration)
...
See [labels reference](/database-access/reference/labels) for a full list of Teleport
