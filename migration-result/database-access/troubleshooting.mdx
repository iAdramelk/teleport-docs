...
- [PostgreSQL](/database-access/guides/postgres-self-hosted#step-25-create-a-certificatekey-pair)
- [MySQL/MariaDB](/database-access/guides/mysql-self-hosted#step-24-create-a-certificatekey-pair)
- [MongoDB](/database-access/guides/mongodb-self-hosted#set-up-mutual-tls)
- [CockroachDB](/database-access/guides/cockroachdb-self-hosted#set-up-mutual-tls)
- [Redis](/database-access/guides/redis#step-45-set-up-mutual-tls)
- [Redis Cluster](/database-access/guides/redis-cluster#step-46-set-up-mutual-tls)
...
Controls Reference](/access-controls/reference).
...
access see the [RBAC](/database-access/rbac) documentation.
...
feature](/management/operations/tls-routing), where the Teleport Proxy
...
command](/connect-your-client/gui-clients#get-connection-information),
