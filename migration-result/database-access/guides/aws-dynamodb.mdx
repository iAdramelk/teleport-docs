...
You can also connect to this database from the AWS NoSQL Workbench, as documented in our [Database Access GUI Clients](/connect-your-client/gui-clients#nosql-workbench) guide.
...
- See [Dynamic Database Registration](/database-access/guides/dynamic-registration) to learn how
