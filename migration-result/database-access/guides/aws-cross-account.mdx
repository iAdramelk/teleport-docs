...
<Note>
  ...
  [how to connect your database](/database-access/guides#how-to-connect-your-database-to-teleport).
</Note>
...
<Tabs>
  ...
  <Tab title="Dynamic Config">
    ...
    resources, see: [Dynamic Registration](/database-access/guides/dynamic-registration).
  </Tab>
</Tabs>
...
- Get started by [connecting](/database-access/guides) your database.
