...
Service instances for [high availability](/database-access/guides/ha) by configuring Database
...
See the full database resource spec [reference](/database-access/reference/configuration#database-resource).
...
- [AWS Discovery](/database-access/guides/aws-discovery)
- [Terraform Provider](/management/dynamic-resources/terraform-provider)
- [Kubernetes Operator](/management/dynamic-resources/teleport-operator)
- [Teleport API](/api/introduction)

See [Using Dynamic Resources](/management/dynamic-resources) to learn
