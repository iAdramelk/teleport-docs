...
bootstrap`](/database-access/reference/cli#teleport-db-configure-bootstrap)
...
manually using a [static configuration](/database-access/reference/configuration) or
[`tctl`](/database-access/guides/dynamic-registration) and manage IAM yourself, example
