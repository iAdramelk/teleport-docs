...
users`](/reference/cli/tctl#tctl-users-add) command. Teleport also supports
...
- `webauthn` implements the [Web Authentication standard](https://webauthn.guide) for utilizing
  ...
  See our [Second Factor - WebAuthn](/access-controls/guides/webauthn) guide for detailed
...
<Tabs>
  <Tab title="Teleport Team">
    ...
    See [GitHub OAuth 2.0](/access-controls/sso/github-sso) for details on how to configure it.
  </Tab>
