...
See our [Upgrading](/management/operations/upgrading) guide for more information.
...
[Using Teleport Connect](/connect-your-client/teleport-connect) for usage and installation*.
...
| ------------------------------------------------------------------------- | ------------- | ------------------------ | -------- | ----------- | ---------------------- | -------------- |
| [Enhanced Session Recording](/server-access/guides/bpf-session-recording) | Kernel  v5.8+ | 11, or 10 with backports | 20.04.2+ | 9+          | 2 (post 11/2021), 2023 | 12 SP5, 15 SP5 |
...
<Tabs>
  ...
  <Tab title="Teleport Enterprise Cloud">
    Check the [Cloud Downloads](/choose-an-edition/teleport-cloud/downloads) page for the most up-to-date
...
See the Teleport [Configuration Reference](/reference/config) for whether a
...
Reference](/reference/networking#ports) for the ports on your Teleport
container to expose.
...
method](/agents/join-services-to-your-cluster/join-token).
...
See the [AWS Single-Instance Deployment](/deploy-a-cluster/deployments/aws-starter-cluster-terraform)
and the [Running Teleport Enterprise in High Availability mode on AWS using Terraform](/deploy-a-cluster/deployments/aws-ha-autoscale-cluster-terraform)
...
| ----------------------------------------- | ---------- | ------------ | ----------------------------------------------------------------------------------- | ---------------- |
| `teleport-oss-15.0.0-dev-$TIMESTAMP`      | OSS        | No           | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: oss`, `TeleportFipsEnabled: false` | 146628656107     |
| `teleport-ent-15.0.0-dev-$TIMESTAMP`      | Enterprise | No           | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: false` | 146628656107     |
| `teleport-oss-15.0.0-dev-fips-$TIMESTAMP` | Enterprise | Yes          | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: true`  | 146628656107     |
...
| --------------------- | -------------------------------------------------------------------------------------------- | ---------------------------------------------------------- |
| `teleport-cluster`    | Auth Service<br />Proxy Service<br />Other Teleport services if using a custom configuration | [Reference](/reference/helm-reference/teleport-cluster)    |
| `teleport-kube-agent` | Kubernetes Service<br />Application Service<br />Database Service                            | [Reference](/reference/helm-reference/teleport-kube-agent) |
...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  <Tab title="Community/Team">
    <Tabs>
      ...
      <Tab title="Homebrew">
        ...
        [compatibility policy](/management/operations/upgrading) for details.
  ...
  <Tab title="Enterprise Cloud">
    ...
    | Link                                                                          | Binaries                                      |
    | ----------------------------------------------------------------------------- | --------------------------------------------- |
    | [`teleport-ent-13.4.3.pkg`](https://cdn.teleport.dev/teleport-ent-13.4.3.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
    | [`tsh-13.4.3.pkg`](https://cdn.teleport.dev/tsh-13.4.3.pkg)                   | `tsh`                                         |
    ...
    # Install on Macintosh HD
    $ sudo installer -pkg teleport-ent-13.4.3.pkg -target / 
    Password:
    installer: Package name is teleport-ent-13.4.3
    installer: Upgrading at base path /
    installer: The upgrade was successful.
    $ which teleport
    /usr/local/bin/teleport
...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  <Tab title="Teleport Community Edition">
    ...
    `teleport-v15.0.0-dev-windows-amd64-bin\teleport\tsh.exe`.

    ```code
    $ Expand-Archive teleport-v{{ .version }}-windows-amd64-bin.zip
    $ cd teleport-v15.0.0-dev-windows-amd64-bin\teleport
    $ .\tsh.exe version
    Teleport v15.0.0-dev git:v{{ .version }} go1.21
    ```
  ...
  <Tab title="Teleport Enterprise Cloud">
    ...
    $ .\tsh.exe version
    Teleport v13.4.3 git:v{{ .version }} go1.21
    ```
...
If you wish to uninstall Teleport at any time, see our documentation on [Uninstalling Teleport](/management/admin/uninstall-teleport).
...
- [Server Access](/server-access/introduction)
- [Kubernetes Access](/kubernetes-access/introduction)
- [Database Access](/database-access/introduction)
- [Application Access](/application-access/introduction)
- [Desktop Access](/desktop-access/introduction)
- [Machine ID](/machine-id/introduction)
