...
[scope](/contributing/documentation/reference#scopes). If the `scopeOnly` property is provided and the
...
`scope` is an optional property that specifies the component's [scope](/contributing/documentation/reference#scopes).
...
`scope` is an optional property that specifies the component's
[scope](/contributing/documentation/reference#scopes). Selecting a scope via the menu at the top of
