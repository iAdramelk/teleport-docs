...
You can find our list of currently-supported versions in the [FAQ](/faq#which-version-of-teleport-is-supported).
...
- Consult the [style guide](/contributing/documentation/style-guide) to ensure your docs page is consistent with the rest of the documentation.
- Use the [documentation UI components](/contributing/documentation/reference) reference guide to find the right UI components for your needs.
