...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [`teleport join openssh`](/server-access/guides/openssh/openssh)), you must specify the `sshd` port
...
For more information about Teleport authentication, see [Authentication options](/reference/authentication).
...
- [CLI Reference](/reference/cli/tsh#tsh-puttyconfig).
