...
<Warning>
  ...
  [Host user creation](/server-access/guides/host-user-creation) guide to learn how to configure
...
authentication](/reference/authentication) (e.g. `tsh login`) is preferred.
