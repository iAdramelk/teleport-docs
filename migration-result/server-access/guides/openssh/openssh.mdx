...
- RBAC and resource filtering based on [dynamically updated labels](/management/admin/labels)
- [Session recording without SSH connection termination](/server-access/guides/recording-proxy-mode)
- [Session sharing](/connect-your-client/tsh)
- [Advanced session recording](/server-access/guides/bpf-session-recording)
- [Restricting outbound network connections in SSH sessions](/server-access/guides/restricted-session)
...
<Tip>
  ...
  an option, you can [register your node manually instead](/server-access/guides/openssh/openssh-manual-install).
</Tip>
