...
- One or more Teleport SSH Service instances. If you have not yet done this,
  read the [Server Access Getting Started Guide](/server-access/getting-started) to
  learn how.
...
<Note>
  ...
  See the [OpenSSH guide](/server-access/guides/openssh) for more information.
...
[dedicated guide](/server-access/guides/openssh) for additional information.
