...
Teleport's default [SSH and Kubernetes session recording](/architecture/nodes#ssh-session-recording)
...
<Tip>
  ...
  [Teleport Nodes](/architecture/nodes#ssh-session-recording) for more
  details.
</Tip>
...
- Read more about
  [session recording](/architecture/nodes#ssh-session-recording).
