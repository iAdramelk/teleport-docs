...
look at [Using OpenSSH Guide](/server-access/guides/openssh).

## Can I connect to nodes behind a firewall?

Yes, Teleport supports reverse SSH tunnels out of the box. To configure
behind-firewall clusters, see [Configure Trusted Clusters](/management/admin/trustedclusters).
...
See the [Installation](/installation) guide for details on installing to specific platforms
...
[Adding Nodes to the
Cluster](/agents/join-services-to-your-cluster/join-token).
...
Yes, Teleport supports [Headless WebAuthn authentication](/access-controls/guides/headless),
...
| -------------------------------------------------------------------- | ----------- | ---------------------------------------------- | ---------------------------------------------- | ---------------- |
| [Access Requests](/access-controls/guides/dual-authz)                | Limited     | ✔                                              | ✔                                              | ✖                |
| [Single Sign-On](/access-controls/sso)                               | GitHub      | GitHub, Google Workspace, OIDC, SAML, Teleport | GitHub, Google Workspace, OIDC, SAML, Teleport | GitHub, Teleport |
| [Role-Based Access Control](/access-controls/guides/role-templates)  | ✔           | ✔                                              | ✔                                              | ✔                |
| [Moderated Sessions](/access-controls/guides/moderated-sessions)     | ✖           | ✔                                              | ✔                                              | ✖                |
| [Device Trust](/access-controls/device-trust/guide)                  | ✖           | ✔                                              | ✔                                              | ✖                |
| [Dual Authorization](/access-controls/guides/dual-authz)             | ✖           | ✔                                              | ✔                                              | ✖                |
| [Hardware Key Support](/access-controls/guides/hardware-key-support) | ✖           | ✔                                              | ✔                                              | ✖                |

### Infrastructure access

|                                                                             | Open Source | Enterprise | Cloud | Team |
| --------------------------------------------------------------------------- | ----------- | ---------- | ----- | ---- |
| [Application Access](/application-access/getting-started)                   | ✔           | ✔          | ✔     | ✔    |
| [Server Access](/server-access/getting-started)                             | ✔           | ✔          | ✔     | ✔    |
| [Database Access](/database-access/getting-started)                         | ✔           | ✔          | ✔     | ✔    |
| [Desktop Access](/desktop-access/introduction)                              | ✔           | ✔          | ✔     | ✔    |
| [Kubernetes Access](/kubernetes-access/getting-started)                     | ✔           | ✔          | ✔     | ✔    |
| [Machine ID](/machine-id/getting-started)                                   | ✔           | ✔          | ✔     | ✔    |
| Agentless Integration with [OpenSSH Servers](/server-access/guides/openssh) | ✔           | ✔          | ✔     | ✔    |

### Audit logging and session recording

|                                                                           | Open Source | Enterprise | Cloud | Team |
| ------------------------------------------------------------------------- | ----------- | ---------- | ----- | ---- |
| [Structured Audit Logs](/reference/audit)                                 | ✔           | ✔          | ✔     | ✔    |
| [Session Recording with Playback](/architecture/session-recording)        | ✔           | ✔          | ✔     | ✔    |
| [Recording Proxy Mode](/server-access/guides/recording-proxy-mode)        | ✔           | ✔          | ✖     | ✖    |
| [Enhanced Session Recording](/server-access/guides/bpf-session-recording) | ✔           | ✔          | ✔     | ✔    |

### Compliance

|                                                                   | Open Source | Enterprise | Cloud | Team    |
| ----------------------------------------------------------------- | ----------- | ---------- | ----- | ------- |
| [FedRAMP Control](/access-controls/compliance-frameworks/fedramp) | ✖           | ✔          | ✖     | ✖       |
...
| [Hardware Security Module support](/choose-an-edition/teleport-enterprise/hsm) for encryption at rest | ✖                                                                                                  | ✔                                                                                                 | ✖                                                                                                             | ✖                                                                                                             |
...
Please refer to our [Networking](/reference/networking) guide.

## Does Teleport support authentication via OIDC, SAML, or Active Directory?

Teleport offers this feature for the [Enterprise Cloud](/choose-an-edition/teleport-cloud/introduction) and [Enterprise](/choose-an-edition/teleport-enterprise/introduction) versions of Teleport.
...
[CLI Reference](/reference/cli/tctl#tctl-alerts-list).
...
If you no longer want to send usage data, see [disabling telemetry](/connect-your-client/teleport-connect#disabling-telemetry).
