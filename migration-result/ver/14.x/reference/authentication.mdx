...
database. This database is managed by the [`tctl users`](/ver/14.x/reference/cli#tctl-users-add)
...
- `webauthn` implements the [Web Authentication standard](https://webauthn.guide) for utilizing
  ...
  See our [Second Factor - WebAuthn](/ver/14.x/access-controls/guides/webauthn) guide for detailed
...
<Tabs>
  <Tab title="Teleport Team">
    ...
    See [GitHub OAuth 2.0](/ver/14.x/access-controls/sso/github-sso) for details on how to configure it.
  </Tab>
