...
<Tip>
  You can use
  [Enhanced Session Recording with BPF](/ver/14.x/server-access/guides/bpf-session-recording)
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [DynamoDB](/ver/14.x/reference/backends#dynamodb) or [Firestore](/ver/14.x/reference/backends#firestore)
    ...
    [Teleport Configuration Reference](/ver/14.x/reference/config).
...
<Tip>
  ...
  read [Exporting Teleport Audit Events](/ver/14.x/management/export-audit-events).
</Tip>
...
<Tabs>
  <Tab title="Self-Hosted">
    Teleport can store the recorded sessions in an [AWS S3 bucket](/ver/14.x/reference/backends#s3)
    ...
    You can replay recorded sessions using the [`tsh play`](/ver/14.x/reference/cli#tsh-play)
  ...
  <Tab title="Cloud-Hosted">
    ...
    You can replay recorded sessions using the [`tsh play`](/ver/14.x/reference/cli#tsh-play) command or the Web
    UI.
