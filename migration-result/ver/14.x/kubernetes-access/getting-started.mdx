...
<Tip>
  ...
  Standalone Teleport Cluster](/ver/14.x/kubernetes-access/register-clusters/static-kubeconfig).
</Tip>
...
- Take a look at a [kube-agent helm chart reference](/ver/14.x/reference/helm-reference/teleport-kube-agent) for a full list of parameters.
