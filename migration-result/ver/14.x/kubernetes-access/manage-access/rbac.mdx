...
the Kubernetes [Access Controls Guide](/ver/14.x/kubernetes-access/controls). You can leave your
...
Requests](/ver/14.x/access-controls/access-requests/resource-requests)
for just-in-time access and [Access Request
plugins](/ver/14.x/access-controls/access-request-plugins/index) so you can manage
