...
guide](/ver/14.x/kubernetes-access/manage-access/rbac).
...
<Tip>
  ...
  methods](/ver/14.x/kubernetes-access/register-clusters) and [automatic methods](/ver/14.x/kubernetes-access/discovery) for
