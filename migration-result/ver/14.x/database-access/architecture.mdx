...
- [Teleport Proxy](/ver/14.x/architecture/proxy). A stateless service
  that performs a function of an authentication gateway, serves the Web UI, and
  accepts database (and other) client connections.

- [Teleport Proxy](/ver/14.x/architecture/proxy). A stateless service that performs
...
- [Teleport Auth Service](/ver/14.x/architecture/authentication). Serves as
...
1. A user logs into the cluster with `tsh login` command and retrieves
   a client certificate. See [Issuing User Certificates](/ver/14.x/architecture/authentication)
...
of the secrets. See [GUI Clients](/ver/14.x/connect-your-client/gui-clients) for details.
...
See respective configuration guides for [PostgreSQL](/ver/14.x/database-access/guides/postgres-self-hosted)
and [MySQL](/ver/14.x/database-access/guides/mysql-self-hosted) for details on configuring client certificate
authentication.
...
See [RDS](/ver/14.x/database-access/guides/rds) configuration guide for details on configuring IAM
authentication.
...
See [Core Concepts](/ver/14.x/core-concepts) for general Teleport
