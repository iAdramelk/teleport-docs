...
![Teleport Database Access Cassandra Self-Hosted](../../../../../assets/cassandra_selfhosted-c026da54a6.png)

![Teleport Database Access Cassandra Cloud](../../../../../assets/cassandra_cloud-5872ccd902.png)
    ...
    <Tabs>
      <Tab title="Self-Hosted">
        ...
        $ helm install teleport-kube-agent teleport/teleport-kube-agent \
          ...
          --set "databases[0].name=cassandra" \
          --set "databases[0].uri=cassandra.example.com:9042" \
          --set "databases[0].protocol=cassandra" \
          --set "labels.env=dev" \
          --version 14.0.0-dev
        ```
      </Tab>
