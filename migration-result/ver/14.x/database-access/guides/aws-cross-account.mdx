...
<Note>
  ...
  [how to connect your database](/ver/14.x/database-access/guides#how-to-connect-your-database-to-teleport).
</Note>
...
- Get started by [connecting](/ver/14.x/database-access/guides) your database.
