...
You can also connect to this database from the AWS NoSQL Workbench, as documented in our [Database Access GUI Clients](/ver/14.x/connect-your-client/gui-clients#nosql-workbench) guide.
...
- See [Dynamic Database Registration](/ver/14.x/database-access/guides/dynamic-registration) to learn how
