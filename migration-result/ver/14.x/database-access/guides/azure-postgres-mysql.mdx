...
![Teleport Database Access Azure PostgreSQL/MySQL Self-Hosted](../../../../../assets/azure_selfhosted-5d9a230019.png)

![Teleport Database Access Azure PostgreSQL/MySQL Cloud](../../../../../assets/azure_cloud-e8c21c6fe1.png)
...
Assign the `azure-database-access` role to your Teleport user by running the following
...
<Tabs>
  ...
  <Tab title="GitHub">
    ...
    Edit `github.yaml`, adding `azure-database-access` to the
  ...
  <Tab title="SAML">
    ...
    Edit `saml.yaml`, adding `azure-database-access` to the
  ...
  <Tab title="OIDC">
    ...
    Edit `oidc.yaml`, adding `azure-database-access` to the
...
![Create JSON role](../../../../../assets/create-role-from-json@2x-f3d5507b97.png)
...
<Tabs>
  <Tab title="MySQL Flexible">
    ...
    ![Set AD admin](../../../../../assets/set-ad-admin-889a3ceaf5.png)
  </Tab>
  ...
  <Tab title="PostgreSQL Flexible">
    ...
    ![Set AD admin](../../../../../assets/set-ad-admin-postgres-601de78bb4.png)
  </Tab>
  ...
  <Tab title="Single server">
    ...
    ![Set AD admin](../../../../../assets/set-ad-admin@2x-9fc54b97cf.png)
  </Tab>
</Tabs>
