...
Access](/ver/14.x/database-access/introduction). This allows for
fine-grain access control through [Teleport's RBAC](/ver/14.x/database-access/rbac).
...
![OpenSearch Self-Hosted](../../../../../assets/opensearch_selfhosted-f64f73df35.png)

![OpenSearch Cloud](../../../../../assets/opensearch_cloud-b2f3fb90b4.png)
...
![Create Role to Identify EC2 Instance](../../../../../assets/create-ec2-role-f29eb95c6c.png)
...
![Create Role Step 1](../../../../../assets/create-role-1-6823d0ab8e.png)
...
![Select Get Started](../../../../../assets/01-opensearch_get_started-cc6436ee42.png)
...
![Mapped User](../../../../../assets/02-opensearch_mapped_users-88d7d370a5.png)

Add mapping between the OpenSearch role and AWS IAM `ExampleTeleportOpenSearchRole`
role created in the previous step.

![IAM Role mapping](../../../../../assets/03-opensearch_iam_role_mapping-bb7d4a160e.png)
...
Assign the `aws-opensearch-access` role to your Teleport user by running the following
...
<Tabs>
  ...
  <Tab title="GitHub">
    ...
    Edit `github.yaml`, adding `aws-opensearch-access` to the
  ...
  <Tab title="SAML">
    ...
    Edit `saml.yaml`, adding `aws-opensearch-access` to the
  ...
  <Tab title="OIDC">
    ...
    Edit `oidc.yaml`, adding `aws-opensearch-access` to the
...
<Accordion title="Alterative methods">
  ...
  - [Joining Nodes via AWS EC2 Identity Document](/ver/14.x/agents/join-services-to-your-cluster/aws-ec2)
</Accordion>
...
<Tabs>
  <Tab title="Generating a new Teleport Config file">
  ...
  <Tab title="Modifying the existing Database Service Config">
  ...
  <Tab title="Dynamic Config">
    ...
    resources, see: [Dynamic Registration](/ver/14.x/database-access/guides/dynamic-registration).
  </Tab>
</Tabs>
