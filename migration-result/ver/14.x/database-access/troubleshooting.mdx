...
- [PostgreSQL](/ver/14.x/database-access/guides/postgres-self-hosted#step-25-create-a-certificatekey-pair)
- [MySQL/MariaDB](/ver/14.x/database-access/guides/mysql-self-hosted#step-24-create-a-certificatekey-pair)
- [MongoDB](/ver/14.x/database-access/guides/mongodb-self-hosted#set-up-mutual-tls)
- [CockroachDB](/ver/14.x/database-access/guides/cockroachdb-self-hosted#set-up-mutual-tls)
- [Redis](/ver/14.x/database-access/guides/redis#step-45-set-up-mutual-tls)
- [Redis Cluster](/ver/14.x/database-access/guides/redis-cluster#step-46-set-up-mutual-tls)
...
access see the [RBAC](/ver/14.x/database-access/rbac) documentation.
...
feature](/ver/14.x/management/operations/tls-routing), where the Teleport Proxy
...
command](/ver/14.x/connect-your-client/gui-clients#get-connection-information),
