...
- [Servers](/ver/14.x/server-access/rbac)
- [Databases](/ver/14.x/database-access/rbac)
- [Kubernetes clusters](/ver/14.x/kubernetes-access/manage-access/rbac)
- [Windows Desktops](/ver/14.x/desktop-access/rbac)
- [Applications](/ver/14.x/application-access/controls)

For general guidance, read our [Access Controls
Reference](/ver/14.x/access-controls/reference).
...
- [AWS](/ver/14.x/application-access/cloud-apis/aws-console)
- [Google Cloud](/ver/14.x/application-access/cloud-apis/google-cloud)
- [Azure](/ver/14.x/application-access/cloud-apis/azure)
...
documentation](/ver/14.x/machine-id/introduction) to learn more.
