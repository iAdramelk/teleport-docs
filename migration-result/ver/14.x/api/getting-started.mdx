...
<Tip>
  Read [API authorization](/ver/14.x/api/architecture#authorization) to learn more about defining custom roles for your API client.
</Tip>
...
- Read about Teleport [API architecture](/ver/14.x/api/architecture) for an in-depth overview of the API and API clients.
- Read [API authorization](/ver/14.x/api/architecture#authorization) to learn more about defining custom roles for your API client.
...
- Familiarize yourself with the [admin manual](/ver/14.x/management/admin) to make the best use of the API.
