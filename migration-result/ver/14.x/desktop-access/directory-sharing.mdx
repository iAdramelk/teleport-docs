...
- The Teleport Desktop Service with at least one remote desktop registered in
  ...
  Started with Desktop Access](/ver/14.x/desktop-access/getting-started) before beginning this
  guide.
...
up [session recording for desktop access](/ver/14.x/desktop-access/reference/sessions).
...
[Clipboard Sharing](/ver/14.x/desktop-access/reference/clipboard).
