...
<Note>
  ...
  for automatic discovery by reading [Desktop Access with Active Directory](/ver/14.x/desktop-access/active-directory).
...
<Accordion title="Version warning">
  ...
  an [Active Directory domain](/ver/14.x/desktop-access/active-directory).
</Accordion>
...
Teleport in your config file, or use Teleport's [API](/ver/14.x/api/introduction)
...
- See the [RBAC page](/ver/14.x/desktop-access/rbac) for more information about setting up
  Windows desktop access permissions.
- See the [Access Controls Getting Started](/ver/14.x/access-controls/getting-started#step-13-add-local-users-with-preset-roles)
