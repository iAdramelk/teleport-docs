...
<Tip>
  You can find our list of currently supported versions in the [FAQ](/ver/14.x/faq#which-version-of-teleport-is-supported).
</Tip>
...
- Consult our [style guide](/ver/14.x/contributing/documentation/style-guide) to ensure your docs page is
  consistent with the rest of our docs.
- Use our [UI reference](/ver/14.x/contributing/documentation/reference) to find the right UI components for your needs.
