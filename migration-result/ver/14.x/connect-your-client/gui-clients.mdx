...
- The Teleport Database Service configured to access a database. See one of our
  [guides](/ver/14.x/database-access/guides) for how to set up the Teleport
...
<Tabs>
  ...
  <Tab title="TLS routing">
    If you're using Teleport in [TLS routing](/ver/14.x/management/operations/tls-routing)
...
[Get connection information](/ver/14.x/connect-your-client/gui-clients#get-connection-information)).
...
[Get connection information](/ver/14.x/connect-your-client/gui-clients#get-connection-information) for
more information.)
...
section on [Get connection information](/ver/14.x/connect-your-client/gui-clients#get-connection-information)
...
instead of `localhost`. (See [Get connection information](/ver/14.x/connect-your-client/gui-clients#get-connection-information) for
more information.)
