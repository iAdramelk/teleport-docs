...
that this cluster trusts. In this case, Teleport activates [trusted cluster mapping logic](/ver/14.x/architecture/trustedclusters#role-mapping).
...
[`tctl users add`](/ver/14.x/reference/cli) or API call.
...
[trusted cluster mapping logic](/ver/14.x/architecture/trustedclusters#role-mapping) to support this use case.
...
<Tip>
  You can use `where` fields in all resource rules. Check out [the full role reference](/ver/14.x/access-controls/reference) contains full role spec for details.
</Tip>
...
- [Access Control Reference](/ver/14.x/access-controls/reference).
- [Teleport Predicate Language](/ver/14.x/reference/predicate-language).
- [Access Requests Guides](/ver/14.x/access-controls/access-requests)
- [Architecture Overview](/ver/14.x/core-concepts)
- [Teleport Auth](/ver/14.x/architecture/authentication)
- [Teleport Nodes](/ver/14.x/architecture/nodes)
- [Teleport Proxy](/ver/14.x/architecture/proxy)
