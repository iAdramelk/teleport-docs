...
- [OpenSSH: `ssh`](/ver/14.x/server-access/guides/openssh)
- [Teleport CLI client: `tsh ssh`](/ver/14.x/reference/cli#tsh-ssh)
- [Teleport Proxy UI](/ver/14.x/architecture/proxy) accessed via a web browser.
...
See the [reference](/ver/14.x/reference/audit#recorded-sessions) to learn how to turn
...
- [Teleport Authentication](/ver/14.x/architecture/authentication)
- [Teleport Authorization](/ver/14.x/architecture/authorization)
