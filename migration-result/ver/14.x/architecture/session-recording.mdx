...
[Trusted Clusters](/ver/14.x/management/admin/trustedclusters) with their own
...
specified by the `audit_sessions_uri` field in the `teleport.yaml` [configuration file](/ver/14.x/reference/config).
...
the [`tsh play`](/ver/14.x/reference/cli#tsh-play) command. Desktop session
...
- [SSH session recording](/ver/14.x/architecture/nodes#ssh-session-recording)
- [SSH recording modes](/ver/14.x/reference/audit#modes)
- [Desktop Access recording](/ver/14.x/desktop-access/reference/sessions)
