...
In TLS routing mode [Teleport proxy](/ver/14.x/architecture/proxy) multiplexes all client
...
See the [OpenSSH client](/ver/14.x/server-access/guides/openssh) guide for details on
how it's configured.
...
See [GUI clients](/ver/14.x/connect-your-client/gui-clients) guide for a usage
example.
...
- See [migration guide](/ver/14.x/management/operations/tls-routing) to learn how to
