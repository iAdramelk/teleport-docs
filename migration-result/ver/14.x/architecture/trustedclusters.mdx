...
- See how Teleport uses [Certificates](/ver/14.x/architecture/authentication) for authentication.
- Reduce your surface of attack using [TLS routing](/ver/14.x/architecture/tls-routing).
- Follow our [guide](/ver/14.x/management/admin/trustedclusters) to set up trusted clusters.
