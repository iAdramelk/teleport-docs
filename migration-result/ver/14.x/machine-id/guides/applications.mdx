...
- If you have not already connected your application to Teleport, follow
  the [Application Access Getting Started Guide](/ver/14.x/application-access/getting-started).
- If you're not already familiar with Machine ID, follow the
  [Getting Started Guide](/ver/14.x/machine-id/getting-started) to familiarize yourself with
...
- Ensure the `tbot` binary is installed on your Machine ID client system.
  ...
  [Installation guide](/ver/14.x/installation) for instructions on installing
...
[JWT authentication](/ver/14.x/application-access/jwt/introduction) for your
app.
...
<Note>
  ...
  refer to the [Configuration Reference](/ver/14.x/machine-id/reference/configuration) for a
...
- Review the [Access Controls Reference](/ver/14.x/access-controls/reference#roles)
  to learn about restricting which Applications and other Teleport resources
  your bot may access.
- Configure [JWTs](/ver/14.x/application-access/jwt/introduction) for your
