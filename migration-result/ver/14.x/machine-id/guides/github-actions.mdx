...
- A node that is a part of the Teleport cluster with [Server Access](/ver/14.x/server-access/introduction).
...
joining on the
[GitHub Actions reference page.](/ver/14.x/machine-id/reference/github-actions#github-join-token)
...
[More information about `anonymous-telemetry`.](/ver/14.x/machine-id/reference/telemetry)
