...
be automatically [locked](/ver/14.x/access-controls/guides/locking).
...
When requesting [Database Access](/ver/14.x/database-access/introduction)
...
Teleport [RBAC permissions](/ver/14.x/access-controls/reference) and are not
allowed to view or list databases by default unless granted permission via one
or more roles.

### Resolution

Per the [Machine ID Database Access Guide](/ver/14.x/machine-id/guides/databases), ensure at
