...
Machine ID can join with a token or the [IAM Method](/ver/14.x/agents/join-services-to-your-cluster/aws-iam) on AWS.
...
- [Machine ID with Ansible](/ver/14.x/machine-id/guides/ansible)
- [Machine ID with Jenkins](/ver/14.x/machine-id/guides/jenkins)
- [Machine ID with Databases](/ver/14.x/machine-id/guides/databases)
