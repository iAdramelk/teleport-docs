...
<Warning>
  ...
  method](/ver/14.x/agents/join-services-to-your-cluster/aws-iam) or [secret tokens](/ver/14.x/agents/join-services-to-your-cluster/join-token).
</Warning>
...
<Accordion title="Other AWS joining methods">
  ...
  tokens](/ver/14.x/agents/join-services-to-your-cluster/join-token), which is useful when you don't want to rely on
  AWS-specific APIs.
</Accordion>
