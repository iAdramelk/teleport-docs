...
see the [OSS Guide](/ver/14.x/access-controls/access-requests/oss-role-requests).
...
[Get started with Resource Access Requests](/ver/14.x/access-controls/access-requests/resource-requests).
...
[Get started with Role Access Requests](/ver/14.x/access-controls/access-requests/role-requests).
