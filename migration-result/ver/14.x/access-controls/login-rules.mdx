...
- When you have multiple [Role Templates](/ver/14.x/access-controls/guides/role-templates) repeating
...
Check out the [Login Rules guide](/ver/14.x/access-controls/login-rules/guide) for a quick walkthrough
...
[Login Rules Reference](/ver/14.x/access-controls/login-rules/reference) for details on the expression
