...
- Teleport must be configured for WebAuthn. See the [Second Factor:
  WebAuthn](/ver/14.x/access-controls/guides/webauthn) guide.
...
- A signed and notarized version of `tsh` is required for Touch ID. This precludes
  versions installed from Homebrew. [Download the macOS tsh installer](/ver/14.x/installation#macos).
...
[installation page](/ver/14.x/installation).
...
standalone version of `tsh`. [Download the macOS tsh installer](/ver/14.x/installation#macos).
