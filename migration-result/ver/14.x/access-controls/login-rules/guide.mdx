...
Check the [Single Sign-On](/ver/14.x/access-controls/sso) docs to learn how to set this up.
...
The [`tctl sso test`](/ver/14.x/reference/cli#tctl-sso-test) command can be used to
...
[Login Rule Reference](/ver/14.x/access-controls/login-rules/reference) page.

Learn about the `tctl login_rule test` command by running the help command or
checking the [reference page](/ver/14.x/reference/cli#tctl-login_rule-test).
