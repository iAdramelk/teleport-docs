...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-mattermost-v12.1.1-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-mattermost-v12.1.1-linux-amd64-bin.tar.gz
