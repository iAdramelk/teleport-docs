...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L https://get.gravitational.com/teleport-access-email-v14.0.0-dev-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-email-v14.0.0-dev-linux-amd64-bin.tar.gz
