...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-msteams-v14.0.0-dev-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-msteams-v14.0.0-dev-linux-amd64-bin.tar.gz
...
teleport-msteams v12.1.1 git:teleport-msteams-v12.1.1-fffffffff go1.20
```
...
<Note>
  ...
  ID](/ver/14.x/machine-id/introduction) to programmatically issue and renew
  certificates for your plugin. See our Machine ID [getting started
  guide](/ver/14.x/machine-id/getting-started) to learn more.
...
```text
teleport-msteams v12.1.1 go1.20
...
- Read our guides to configuring [Resource Access
  Requests](/ver/14.x/access-controls/access-requests/resource-requests) and [Role Access
  Requests](/ver/14.x/access-controls/access-requests/role-requests) so you can get the most out
