...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-discord-v14.0.0-dev-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-discord-v14.0.0-dev-linux-amd64-bin.tar.gz
    ...
    teleport-discord v12.1.1 git:teleport-discord-v12.1.1-fffffffff go1.20
    ```
  </Tab>
