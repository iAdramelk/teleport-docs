...
- A running Teleport Node. See the [Server Access Getting Started Guide](/ver/14.x/server-access/getting-started) for  how to add a Node to your Teleport cluster. On the Node, `teleport` must be running as a systemd service with root permissions.
...
For more details please refer to [PAM](/ver/14.x/server-access/guides/ssh-pam#set-up-pam-on-a-linux-machine-running-teleport) or your operating system
documentation.
