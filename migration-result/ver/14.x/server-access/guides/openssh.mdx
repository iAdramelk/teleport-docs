...
- RBAC and resource filtering based on [dynamically updated labels](/ver/14.x/management/admin/labels)
- [Session recording without SSH connection termination](/ver/14.x/server-access/guides/recording-proxy-mode)
- [Advanced session recording](/ver/14.x/server-access/guides/bpf-session-recording)
- [Restricting outbound network connections in SSH sessions](/ver/14.x/server-access/guides/restricted-session)
...
[Session and Identity Locking Guide](/ver/14.x/access-controls/guides/locking).
