...
- A running Teleport Node. See the [Server Access Getting Started Guide](/ver/14.x/server-access/getting-started) for  how to add a Node to your Teleport cluster.
...
- Configure automatic user provisioning for [Database Access](/ver/14.x/database-access/rbac/configuring-auto-user-provisioning).
- Configure automatic user provisioning for [Desktop Access](/ver/14.x/desktop-access/rbac#automatic-user-creation).
