...
| [Access Requests](/ver/14.x/access-controls/access-requests)                            | Request elevated access to roles or specific resources.                                                                                                                                                                                                                                 |
...
| [Hardware Security Module support](/ver/14.x/choose-an-edition/teleport-enterprise/hsm) | The Teleport Auth Service can use your organization's HSM to generate TLS credentials, ensuring a highly reliable and secure public key infrastructure.                                                                                                                                 |
| [Moderated Sessions](/ver/14.x/access-controls/guides/moderated-sessions)               | Allow or require moderators to be present in SSH or Kubernetes sessions.                                                                                                                                                                                                                |
...
See the [SSO](/ver/14.x/access-controls/sso) chapter for more details.
...
See our [FedRAMP Compliance for Infrastructure Access](/ver/14.x/access-controls/compliance-frameworks/fedramp) guide for more information.
...
information](/ver/14.x/access-controls/access-requests)
...
See [HSM Support](/ver/14.x/choose-an-edition/teleport-enterprise/hsm) for more information.
...
See [Moderated Sessions](/ver/14.x/access-controls/guides/moderated-sessions) for more information.

## License file

Commercial Teleport subscriptions require a valid license. See [Enterprise License File](/ver/14.x/choose-an-edition/teleport-enterprise/license) for how to manage the file in your Teleport Enterprise deployment.

## Next steps

To get started with Teleport Enterprise, read our [deployment
guides](/ver/14.x/deploy-a-cluster/introduction). You will learn how to deploy a
