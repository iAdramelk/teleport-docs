...
See our [Azure
CLI](/ver/14.x/application-access/cloud-apis/azure#step-34-enable-your-user-to-access-azure-clis) guide
for more information on enabling access to Azure managed identities.

## Next steps

- View access controls [Getting Started](/ver/14.x/access-controls/getting-started)
  and other available [guides](/ver/14.x/access-controls/guides).
- Learn about using [JWT tokens](/ver/14.x/application-access/jwt/introduction) to implement access controls
  in your application.
- Integrate with your identity provider:
  - [OIDC](/ver/14.x/access-controls/sso/oidc)
  - [ADFS](/ver/14.x/access-controls/sso/adfs)
  - [Azure AD](/ver/14.x/access-controls/sso/azuread)
  - [Google Workspace](/ver/14.x/access-controls/sso/google-workspace)
  - [Onelogin](/ver/14.x/access-controls/sso/one-login)
  - [Okta](/ver/14.x/access-controls/sso/okta)
