...
- A host running the `teleport` daemon with the Application Service enabled.
  Follow the [Getting Started](/ver/14.x/application-access/getting-started) or [Connecting
  Apps](/ver/14.x/application-access/guides/connecting-apps) guides to get it running.
...
Templates](/ver/14.x/access-controls/guides/role-templates) for details.
...
- Take a closer look at [role-based access controls](/ver/14.x/application-access/controls).
- Explore other application access [guides](/ver/14.x/application-access/guides).
