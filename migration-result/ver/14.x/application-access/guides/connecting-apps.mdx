...
and follow the installation [instructions](/ver/14.x/installation).
...
Rewritten header values support the same templating variables as [role templates](/ver/14.x/access-controls/guides/role-templates).
...
[Integrating with JWTs](/ver/14.x/application-access/jwt/introduction) for more details.
