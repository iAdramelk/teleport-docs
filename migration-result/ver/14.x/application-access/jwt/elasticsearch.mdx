...
- Running [Application Service](/ver/14.x/application-access/guides/connecting-apps).
...
<Tip>
  You can also use [dynamic registration](/ver/14.x/application-access/guides/dynamic-registration).
</Tip>
...
- Get more information about integrating with [Teleport JWT tokens](/ver/14.x/application-access/jwt/introduction).
- Learn more about [accessing APIs](/ver/14.x/application-access/guides/api-access) with the Teleport
  Application Service.
- Take a look at application-related [Access Controls](/ver/14.x/application-access/controls).
