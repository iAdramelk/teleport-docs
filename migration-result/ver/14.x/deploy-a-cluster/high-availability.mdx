...
will enable [TLS Routing](/ver/14.x/management/operations/tls-routing) in your
Teleport cluster.
...
<Tip>
  ...
  Helm chart, read our [Helm Deployments](/ver/14.x/deploy-a-cluster/helm-deployments) documentation.
</Tip>
...
to follow a more specific [deployment guide](/ver/14.x/deploy-a-cluster/introduction) for your
environment.
...
Consult our [Backends Reference](/ver/14.x/reference/backends) for the configuration
...
- [High-availability Teleport Deployments on Kubernetes with
  Helm](/ver/14.x/deploy-a-cluster/helm-deployments)
- [Reference Deployments](/ver/14.x/deploy-a-cluster/deployments) for running Teleport on a cluster of
  virtual machines
...
- [Scaling a Teleport cluster](/ver/14.x/management/operations/scaling)
- [Monitoring a Teleport cluster](/ver/14.x/management/diagnostics)
...
- [Applications](/ver/14.x/application-access/getting-started)
- [Servers](/ver/14.x/server-access/getting-started)
- [Kubernetes clusters](/ver/14.x/kubernetes-access/getting-started)
- [Databases](/ver/14.x/database-access/getting-started)
- [Windows desktops](/ver/14.x/desktop-access/getting-started)
- [Bot users](/ver/14.x/machine-id/getting-started)
