...
guide](/ver/14.x/kubernetes-access/getting-started) to connect your Kubernetes
cluster to Teleport.
...
If you want to use a different version of Teleport, set the [`teleportVersionOverride`](/ver/14.x/reference/helm-reference/teleport-cluster#teleportversionoverride) value.
...
Access](/ver/14.x/access-controls/introduction) section to get started enrolling
users and setting up RBAC.

See the [high availability section of our Helm chart reference](/ver/14.x/reference/helm-reference/teleport-cluster#highavailability) for more details on high availability.
