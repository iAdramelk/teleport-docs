...
look at [Using OpenSSH Guide](/ver/14.x/server-access/guides/openssh).
...
[Trusted Clusters](/ver/14.x/management/admin/trustedclusters) guide.
...
[Adding Nodes to the
Cluster](/ver/14.x/agents/join-services-to-your-cluster/join-token).
...
Yes, Teleport supports [Headless WebAuthn authentication](/ver/14.x/access-controls/guides/headless),
...
| ----------------------------------------------------------------------------- | ----------- | ---------------------------------------------- | ---------------------------------------------- | ---------------- |
| [Access Requests](/ver/14.x/access-controls/guides/dual-authz)                | Limited     | ✔                                              | ✔                                              | ✖                |
| [Single Sign-On](/ver/14.x/access-controls/sso)                               | GitHub      | GitHub, Google Workspace, OIDC, SAML, Teleport | GitHub, Google Workspace, OIDC, SAML, Teleport | GitHub, Teleport |
| [Role-Based Access Control](/ver/14.x/access-controls/guides/role-templates)  | ✔           | ✔                                              | ✔                                              | ✔                |
| [Moderated Sessions](/ver/14.x/access-controls/guides/moderated-sessions)     | ✖           | ✔                                              | ✔                                              | ✖                |
| [Device Trust](/ver/14.x/access-controls/device-trust/guide)                  | ✖           | ✔                                              | ✔                                              | ✖                |
| [Dual Authorization](/ver/14.x/access-controls/guides/dual-authz)             | ✖           | ✔                                              | ✔                                              | ✖                |
| [Hardware Key Support](/ver/14.x/access-controls/guides/hardware-key-support) | ✖           | ✔                                              | ✔                                              | ✖                |

### Infrastructure access

|                                                                                      | Open Source | Enterprise | Cloud | Team |
| ------------------------------------------------------------------------------------ | ----------- | ---------- | ----- | ---- |
| [Application Access](/ver/14.x/application-access/getting-started)                   | ✔           | ✔          | ✔     | ✔    |
| [Server Access](/ver/14.x/server-access/getting-started)                             | ✔           | ✔          | ✔     | ✔    |
| [Database Access](/ver/14.x/database-access/getting-started)                         | ✔           | ✔          | ✔     | ✔    |
| [Desktop Access](/ver/14.x/desktop-access/getting-started)                           | ✔           | ✔          | ✔     | ✔    |
| [Kubernetes Access](/ver/14.x/kubernetes-access/getting-started)                     | ✔           | ✔          | ✔     | ✔    |
| [Machine ID](/ver/14.x/machine-id/getting-started)                                   | ✔           | ✔          | ✔     | ✔    |
| Agentless Integration with [OpenSSH Servers](/ver/14.x/server-access/guides/openssh) | ✔           | ✔          | ✔     | ✔    |

### Audit logging and session recording

|                                                                                    | Open Source | Enterprise | Cloud | Team |
| ---------------------------------------------------------------------------------- | ----------- | ---------- | ----- | ---- |
| [Structured Audit Logs](/ver/14.x/reference/audit)                                 | ✔           | ✔          | ✔     | ✔    |
| [Session Recording with Playback](/ver/14.x/architecture/session-recording)        | ✔           | ✔          | ✔     | ✔    |
| [Recording Proxy Mode](/ver/14.x/server-access/guides/recording-proxy-mode)        | ✔           | ✔          | ✖     | ✔    |
| [Enhanced Session Recording](/ver/14.x/server-access/guides/bpf-session-recording) | ✔           | ✔          | ✔     | ✔    |

### Compliance

|                                                                            | Open Source | Enterprise | Cloud | Team    |
| -------------------------------------------------------------------------- | ----------- | ---------- | ----- | ------- |
| [FedRAMP Control](/ver/14.x/access-controls/compliance-frameworks/fedramp) | ✖           | ✔          | ✖     | ✖       |
...
| [Hardware Security Module support](/ver/14.x/choose-an-edition/teleport-enterprise/hsm) for encryption at rest | ✖                                                                                                  | ✔                                                                                                 | ✖                                                                                                             | ✖                                                                                                             |
...
See our [Upgrading](/ver/14.x/management/operations/upgrading) guide for more
information.
...
Please refer to our [Networking](/ver/14.x/reference/networking) guide.

## Does Teleport support authentication via OAuth, SAML, or Active Directory?

Teleport offers this feature for the [Enterprise versions of Teleport](/ver/14.x/choose-an-edition/teleport-enterprise/introduction).
...
[CLI Reference](/ver/14.x/reference/cli#tctl-alerts-list).
...
If you no longer want to send usage data, see [disabling telemetry](/ver/14.x/connect-your-client/teleport-connect#disabling-telemetry).
