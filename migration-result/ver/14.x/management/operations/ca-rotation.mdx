...
using a [join token](/ver/14.x/agents/join-services-to-your-cluster/join-token), each
...
<Warning>
  ...
  [Read more about exporting the Teleport CA](/ver/14.x/desktop-access/active-directory-manual#export-the-teleport-ca)
</Warning>
...
How the [Teleport Certificate Authority](/ver/14.x/architecture/authentication) works.
