...
- [Per-session MFA](/ver/14.x/access-controls/guides/per-session-mfa)
- [Dual authorization](/ver/14.x/access-controls/guides/dual-authz)
- [Role templates, allow/deny rules, and traits](/ver/14.x/access-controls/guides/role-templates)
- [Access Requests](/ver/14.x/access-controls/access-requests)

### Background reading

- [Authentication connectors](/ver/14.x/reference/authentication)
- [Proxy Service](/ver/14.x/architecture/proxy)
- [Auth Service](/ver/14.x/architecture/authentication)
