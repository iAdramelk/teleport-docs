...
reference](/ver/14.x/reference/cli#tctl) for more information on `tctl`.
...
[Get started with the Terraform provider](/ver/14.x/management/dynamic-resources/terraform-provider).
...
[Get started with the Kubernetes Operator](/ver/14.x/management/dynamic-resources/teleport-operator).
...
- For a comprehensive reference of Teleport's static configuration options, read
  the [Configuration Reference](/ver/14.x/reference/config).
- To see the dynamic configuration resources available to apply, read the
  [Configuration Resource Reference](/ver/14.x/reference/resources). There are also
  dedicated configuration resource references for
  [applications](/ver/14.x/application-access/reference#application-resource) and
  [databases](/ver/14.x/database-access/reference/configuration#database-resource).
...
guides](/ver/14.x/api/introduction).
