...
<Tip>
  ...
  - Replace the Teleport binaries, usually [`teleport`](/ver/14.x/reference/cli#teleport)
    and [`tctl`](/ver/14.x/reference/cli#tctl).
...
[Teleport CLI Reference](/ver/14.x/reference/cli#teleport).
...
[upgrading a Teleport binary](/ver/14.x/management/admin/upgrading-the-teleport-binary).
