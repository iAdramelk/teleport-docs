...
<Tip>
  ...
  databases behind a firewall. For more information, see how to [join a service to your cluster](/ver/14.x/agents/join-services-to-your-cluster).
</Tip>
...
<Tabs>
  <Tab title="Teleport Team">
    ...
    - A second Teleport cluster, which will act as the leaf cluster. For details on
      how to set up this cluster, see our [Getting Started](/ver/14.x/index)
      guide.
    ...
    - The `tctl` and `tsh` client tools version >= 13.2.0.
      ...
      You can download these from [Teleport Cloud Downloads](/ver/14.x/choose-an-edition/teleport-cloud/downloads).
      ```code
      $ tctl version
    ...
    - A Teleport Node that is joined to one of your clusters. We will refer to this
      ...
      See [Join Services to your Cluster](/ver/14.x/agents/join-services-to-your-cluster) for
  ...
  <Tab title="Open Source">
    - Two running Teleport clusters. For details on how to set up your clusters, see
      our [Getting Started](/ver/14.x/index) guide.
    ...
    - A Teleport agent that is joined to one of your clusters. We will refer to this
      ...
      Cluster](/ver/14.x/agents/join-services-to-your-cluster) for how to launch a
  ...
  <Tab title="Enterprise">
    ...
    - A Teleport Node that is joined to one of your clusters. We will refer to this
      ...
      See [Join Services to your Cluster](/ver/14.x/agents/join-services-to-your-cluster) for how to launch a Teleport agent in
      your cluster.
  </Tab>
  ...
  <Tab title="Teleport Enterprise Cloud">
    ...
    - A Teleport Node that is joined to one of your clusters. We will refer to this
      ...
      See [Join Services to your Cluster](/ver/14.x/agents/join-services-to-your-cluster) for how to launch a
      Teleport agent in your cluster.
  </Tab>
</Tabs>
...
- Read more about how Trusted Clusters fit into Teleport's overall architecture:
  [Architecture Introduction](/ver/14.x/architecture/trustedclusters).
