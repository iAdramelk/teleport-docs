...
<Accordion title="Using containers?">
  ...
  [How to Run Teleport Using Docker](/ver/14.x/installation#docker) for information on
...
[Upgrading a Teleport Cluster](/ver/14.x/management/operations/upgrading).

See the full list of supported signals in the
[Teleport Signals Reference](/ver/14.x/reference/signals).
