...
<Tabs>
  <Tab title="Open Source">
    - A running Teleport cluster. For details on how to set this up, see our
      [Getting Started](/ver/14.x/index) guide (skip TLS certificate setup).
...
<Tabs>
  ...
  <Tab title="Helm chart">
    ...
    [extraArgs](/ver/14.x/reference/helm-reference/teleport-cluster#extraargs)
    ...
    ](/ver/14.x/reference/helm-reference/teleport-kube-agent#insecureskipproxytlsverify)
    flag to `true`:
...
flag](/ver/14.x/connect-your-client/teleport-connect#skipping-tls-certificate-verification).

## Further reading

- [Configuring Teleport TLS Certs](/ver/14.x/index#configure-teleport)
- [Run Teleport as a systemd Daemon](/ver/14.x/management/admin/daemon)
- [Teleport Proxy Service](/ver/14.x/architecture/proxy)
