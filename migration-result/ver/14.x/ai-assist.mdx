...
- A running Teleport Community Edition cluster. For details on how to set this
  up, see our [Getting Started](/ver/14.x/index) guide.
...
- [Access controls](/ver/14.x/access-controls/getting-started)
- [Resource filtering](/ver/14.x/reference/predicate-language)
- [Access request plugins](/ver/14.x/access-controls/access-request-plugins/index)
