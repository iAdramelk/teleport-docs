...
- [Audit Events and Records](/ver/13.x/reference/audit)
- [Forwarding events with Fluentd](/ver/13.x/management/export-audit-events/fluentd)
- [Monitor Teleport Audit Events with the Elastic Stack](/ver/13.x/management/export-audit-events/elastic-stack)
