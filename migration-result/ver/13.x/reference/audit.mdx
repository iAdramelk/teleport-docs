...
<Tip>
  You can use
  [Enhanced Session Recording with BPF](/ver/13.x/server-access/guides/bpf-session-recording)
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [DynamoDB](/ver/13.x/reference/backends#dynamodb) or [Firestore](/ver/13.x/reference/backends#firestore)
    ...
    [Teleport Configuration Reference](/ver/13.x/reference/config).
...
<Tip>
  ...
  read [Exporting Teleport Audit Events](/ver/13.x/management/export-audit-events).
</Tip>
...
<Tabs>
  <Tab title="Self-Hosted">
    Teleport can store the recorded sessions in an [AWS S3 bucket](/ver/13.x/reference/backends#s3)
    ...
    You can replay recorded sessions using the [`tsh play`](/ver/13.x/reference/cli#tsh-play)
  ...
  <Tab title="Teleport Cloud">
    ...
    You can replay recorded sessions using the [`tsh play`](/ver/13.x/reference/cli#tsh-play) command or the Web
    UI.
