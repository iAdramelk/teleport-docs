...
Read our guides to how [authorization](/ver/13.x/architecture/authorization) and
[authentication](/ver/13.x/architecture/authentication) work in Teleport.
...
works](/ver/13.x/architecture/proxy).
...
in our [CLI Reference](/ver/13.x/reference/cli#teleport).
...
Service](/ver/13.x/application-access/introduction).
...
Service](/ver/13.x/database-access/introduction).
...
Service](/ver/13.x/desktop-access/introduction).
...
Service](/ver/13.x/kubernetes-access/introduction)
...
Read more about the [Teleport SSH Service](/ver/13.x/server-access/introduction).
...
Read more in our [Machine ID guide](/ver/13.x/machine-id/introduction).
...
edition in [Choose an edition](/ver/13.x/choose-an-edition/introduction).
...
guide](/ver/13.x/choose-an-edition/teleport-cloud/introduction).
...
guide](/ver/13.x/choose-an-edition/teleport-enterprise/introduction).
...
Read more in our [resource reference](/ver/13.x/reference/resources).
...
Read our [guide to Teleport roles](/ver/13.x/access-controls/guides/role-templates).
...
Read more about [local users](/ver/13.x/reference/authentication) and how [SSO
authentication works in Teleport](/ver/13.x/access-controls/sso).
...
See our guide to [Authentication Options](/ver/13.x/reference/authentication).
...
guide](/ver/13.x/architecture/trustedclusters) for how Trusted Clusters work and our
[how-to guide](/ver/13.x/management/admin/trustedclusters) for how to configure
Trusted Clusters.
