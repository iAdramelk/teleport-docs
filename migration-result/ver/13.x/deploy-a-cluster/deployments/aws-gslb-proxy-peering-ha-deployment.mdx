...
2. Teleport's [Proxy Peering](/ver/13.x/architecture/proxy-peering) is used to reduce the total number of tunnel connections in the Teleport cluster.
...
- [GSLB](https://www.cloudflare.com/learning/cdn/glossary/global-server-load-balancing-gslb/)
- [Teleport TLS Routing](/ver/13.x/architecture/tls-routing) to reduce the number of ports needed to use Teleport
- [Teleport Proxy Peering](/ver/13.x/architecture/proxy-peering) for reducing the number of resource connections
...
Review the [configuration reference](/ver/13.x/reference/config) page for
additional settings.

## Configure Proxy Peering

In this deployment architecture, [Proxy Peering](/ver/13.x/architecture/proxy-peering) is used to restrict the number of connections made from
...
Reference the [Auth Server configuration](/ver/13.x/reference/config#auth-service) reference page
...
Reference the [Proxy Service configuration](/ver/13.x/reference/config#proxy-service) reference page
for additional settings.
