...
will enable [TLS Routing](/ver/13.x/management/operations/tls-routing) in your
Teleport cluster.
...
<Tip>
  ...
  Helm chart, read our [Helm Deployments](/ver/13.x/deploy-a-cluster/helm-deployments) documentation.
</Tip>
...
to follow a more specific [deployment guide](/ver/13.x/deploy-a-cluster/introduction) for your
environment.
...
Consult our [Backends Reference](/ver/13.x/reference/backends) for the configuration
...
- [High-availability Teleport Deployments on Kubernetes with
  Helm](/ver/13.x/deploy-a-cluster/helm-deployments)
- [Reference Deployments](/ver/13.x/deploy-a-cluster/deployments) for running Teleport on a cluster of
  virtual machines
...
- [Scaling a Teleport cluster](/ver/13.x/management/operations/scaling)
- [Monitoring a Teleport cluster](/ver/13.x/management/diagnostics)
...
- [Applications](/ver/13.x/application-access/getting-started)
- [Servers](/ver/13.x/server-access/getting-started)
- [Kubernetes clusters](/ver/13.x/kubernetes-access/getting-started)
- [Databases](/ver/13.x/database-access/getting-started)
- [Windows desktops](/ver/13.x/desktop-access/getting-started)
- [Bot users](/ver/13.x/machine-id/getting-started)
