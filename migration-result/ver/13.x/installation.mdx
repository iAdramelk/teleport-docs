...
See our [Upgrading](/ver/13.x/management/operations/upgrading) guide for more information.
...
[Using Teleport Connect](/ver/13.x/connect-your-client/teleport-connect) for usage and installation*.
...
| ---------------------------------------------------------------------------------- | ------------- | ------------------------ | -------- | ----------- | ---------------------- |
| [Enhanced Session Recording](/ver/13.x/server-access/guides/bpf-session-recording) | Kernel  v5.8+ | 11, or 10 with backports | 20.04.2+ | 9+          | 2 (post 11/2021), 2023 |
...
Check the [Cloud Downloads](/ver/13.x/choose-an-edition/teleport-cloud/downloads) page for the most up-to-date
...
See the Teleport [Configuration Reference](/ver/13.x/reference/config) for whether a
...
Reference](/ver/13.x/reference/networking#ports) for the ports on your Teleport
container to expose.
...
method](/ver/13.x/agents/join-services-to-your-cluster/join-token).
...
| --------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `teleport-cluster`    | Auth Service<br />Proxy Service<br />Other Teleport services if using a custom configuration | [Reference](/ver/13.x/reference/helm-reference/teleport-cluster)    |
| `teleport-kube-agent` | Kubernetes Service<br />Application Service<br />Database Service                            | [Reference](/ver/13.x/reference/helm-reference/teleport-kube-agent) |
  ...
  <Tab title="Open Source">
    <Tabs>
      ...
      <Tab title="Homebrew">
        ...
        [compatibility policy](/ver/13.x/management/operations/upgrading) for details.
...
If you wish to uninstall Teleport at any time, see our documentation on [Uninstalling Teleport](/ver/13.x/management/admin/uninstall-teleport).
...
- [Server Access](/ver/13.x/server-access/introduction)
- [Kubernetes Access](/ver/13.x/kubernetes-access/introduction)
- [Database Access](/ver/13.x/database-access/introduction)
- [Application Access](/ver/13.x/application-access/introduction)
- [Desktop Access](/ver/13.x/desktop-access/introduction)
- [Machine ID](/ver/13.x/machine-id/introduction)
