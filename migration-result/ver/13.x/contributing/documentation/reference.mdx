...
[scope](/ver/13.x/contributing/documentation/reference#scopes). If the `scopeOnly` property is provided and the
...
`scope` is an optional property that specifies the component's [scope](/ver/13.x/contributing/documentation/reference#scopes).
...
[explanation](/ver/13.x/contributing/documentation/reference#scopes) of how to use the `scope` property.
...
`scope` is an optional property that specifies the component's
[scope](/ver/13.x/contributing/documentation/reference#scopes). Selecting a scope via the menu at the top of
