...
- **[How-to guides](/ver/13.x/contributing/documentation/style-guide#how-to-guides)**: Tutorials for intermediate readers who want to set up Teleport for a specific scenario.
- **[Getting started articles](/ver/13.x/contributing/documentation/style-guide#getting-started-articles)**: Designed to get the user up and running in the quickest way possible.
- **[Architecture guides](/ver/13.x/contributing/documentation/style-guide#architecture-guides)**: Guides that explain how Teleport works to advanced readers, e.g., architects, DevSecOps engineers, and SREs.
- **[Conceptual guides](/ver/13.x/contributing/documentation/style-guide#conceptual-guides)**: Explain concepts related to Teleport for users who want a deeper understanding of its functionality.
- **[Reference manuals](/ver/13.x/contributing/documentation/style-guide#reference-manuals)**: Provide a comprehensive list of configuration options, API methods, metrics, and other ways of interacting with Teleport.
