...
<Tabs>
  <Tab title="SAML">
    Follow our [SAML Okta Guide](/ver/13.x/access-controls/sso/okta) to
  ...
  <Tab title="OIDC">
    Follow our [OIDC guides](/ver/13.x/access-controls/sso/oidc#identity-providers) to
...
- [Mapping SSO and local users traits with role templates](/ver/13.x/access-controls/guides/role-templates)
- [Create certs for CI/CD using impersonation](/ver/13.x/access-controls/guides/impersonation)
