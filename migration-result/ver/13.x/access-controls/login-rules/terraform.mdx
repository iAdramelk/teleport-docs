...
<Note>
  The [Terraform provider guide](/ver/13.x/management/dynamic-resources/terraform-provider)
...
- Read the [Terraform Guide](/ver/13.x/management/dynamic-resources/terraform-provider) to
  learn more about configuring the Terraform provider.
- Read the [Login Rules reference](/ver/13.x/access-controls/login-rules/reference) to learn mode about the
