...
[Resource Access Requests Guide](/ver/13.x/access-controls/access-requests/resource-requests).
...
| --------------- | ------------- | ----------------------------------------------------------------------------------------------- |
| Slack           | Messaging     | [Set up Slack](/ver/13.x/access-controls/access-request-plugins/ssh-approval-slack)             |
| Mattermost      | Messaging     | [Set up Mattermost](/ver/13.x/access-controls/access-request-plugins/ssh-approval-mattermost)   |
| Microsoft Teams | Messaging     | [Set up Microsoft Teams](/ver/13.x/access-controls/access-request-plugins/ssh-approval-msteams) |
| Jira            | Project Board | [Set up Jira](/ver/13.x/access-controls/access-request-plugins/ssh-approval-jira)               |
| PagerDuty       | Schedule      | [Set up PagerDuty](/ver/13.x/access-controls/access-request-plugins/ssh-approval-pagerduty)     |
| Email           | Messaging     | [Set up email](/ver/13.x/access-controls/access-request-plugins/ssh-approval-email)             |
| Discord         | Messaging     | [Set up Discord](/ver/13.x/access-controls/access-request-plugins/ssh-approval-discord)         |
...
Reference](/ver/13.x/reference/cli#tsh-request-create) for more
details.
