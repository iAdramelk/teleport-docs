...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-slack-v13.2.0-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-slack-v13.2.0-linux-amd64-bin.tar.gz
    ...
    teleport-slack v13.2.0 git:teleport-slack-v13.2.0-fffffffff go1.20
    ```
  </Tab>
