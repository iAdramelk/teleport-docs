...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-pagerduty-v13.2.0-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-pagerduty-v13.2.0-linux-amd64-bin.tar.gz
  ...
  <Tab title="Docker">
    ```code
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-pagerduty:13.2.0
    ```
  </Tab>
