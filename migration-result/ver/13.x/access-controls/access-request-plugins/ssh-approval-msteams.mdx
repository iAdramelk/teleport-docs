...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-msteams-v13.2.0-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-msteams-v13.2.0-linux-amd64-bin.tar.gz
...
teleport-msteams v13.2.0 git:teleport-msteams-v13.2.0-fffffffff go1.20
```
...
<Note>
  ...
  ID](/ver/13.x/machine-id/introduction) to programmatically issue and renew
  certificates for your plugin. See our Machine ID [getting started
  guide](/ver/13.x/machine-id/getting-started) to learn more.
...
```text
teleport-msteams v13.2.0 go1.20
...
INFO   Starting Teleport MS Teams Plugin 13.2.0: msteams/app.go:74
...
- Read our guides to configuring [Resource Access
  Requests](/ver/13.x/access-controls/access-requests/resource-requests) and [Role Access
  Requests](/ver/13.x/access-controls/access-requests/role-requests) so you can get the most out
