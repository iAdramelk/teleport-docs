...
- a Teleport [RBAC](/ver/13.x/access-controls/reference) role by the role's name
- a Teleport [trusted device](/ver/13.x/access-controls/device-trust/guide#optional-locking-a-device) by the device ID
...
- an [Access Request](/ver/13.x/access-controls/access-requests) by UUID
...
<Accordion title="Under the hood: Lock resource and expiration">
  ...
  as per usual. See the [Admin Guide](/ver/13.x/reference/resources) for more
  details.
</Accordion>
