...
edition of Teleport only supports [GitHub](/ver/13.x/access-controls/sso/github-sso) as
an SSO provider.

<Tip>
  The steps below describe how to use Teleport with Mattermost. You can also [integrate with many other providers](/ver/13.x/access-controls/access-requests).
</Tip>
...
![Enable bots](../../../../../assets/mattermost-0-enable-390f27a7ac.png)

Go back to your team settings, navigate to "Integrations -> Bot Accounts". Press "Add Bot Account".

![Enable bots](../../../../../assets/mattermost-1-bot-938870d05a.png)

Add the "Post All" permission on the new account.

![Enable bots](../../../../../assets/mattermost-2-all-permissions@2x-ec6f658606.png)
...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L https://get.gravitational.com/teleport-access-mattermost-v13.2.0-linux-amd64-bin.tar.gz
  ...
  <Tab title="From Source">
    To install from source you need `git` and `go >= 1.20` installed.
...
<Tabs>
  <Tab title="Web UI">
    ![Mattermost-Request](../../../../../assets/teleport-4-bob-request-62329758c7.png)
  </Tab>
...
![Mattermost-Request](../../../../../assets/mattermost-5-request-36237d0c25.png)

Alice and Ivan can review and approve request using Web UI or CLI:

<Tabs>
  <Tab title="Web UI">
    ![Teleport-Approve](../../../../../assets/teleport-6-ivan-approve-2256c804e3.png)
  </Tab>
...
![Teleport Assume](../../../../../assets/teleport-7-bob-assume-147c22598b.png)
