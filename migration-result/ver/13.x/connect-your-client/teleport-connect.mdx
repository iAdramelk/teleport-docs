...
When using [Trusted Clusters](/ver/13.x/management/admin/trustedclusters), the cluster selector allows
...
variable](/ver/13.x/reference/cli#tsh-environment-variables). For example, logging in to a new cluster
...
certificates](/ver/13.x/management/admin/self-signed-certs) or for demo purposes. We do not recommend
