...
- [AWS](/ver/13.x/kubernetes-access/discovery/aws): Kubernetes Auto-Discovery for AWS EKS clusters.
- [Azure](/ver/13.x/kubernetes-access/discovery/azure): Kubernetes Auto-Discovery for Azure AKS clusters.
- [Google Cloud](/ver/13.x/kubernetes-access/discovery/google-cloud): Kubernetes Auto-Discovery for
