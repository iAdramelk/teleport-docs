...
<Tip>
  ...
  Standalone Teleport Cluster](/ver/13.x/kubernetes-access/register-clusters/static-kubeconfig).
</Tip>
...
<Tip>
  ...
  or up to one major version back. You can set the version override with the override variable, ex: `--set teleportVersionOverride=13.2.0`.
</Tip>
...
- Take a look at a [kube-agent helm chart reference](/ver/13.x/reference/helm-reference/teleport-kube-agent) for a full list of parameters.
