...
- [Per-session MFA](/ver/13.x/access-controls/guides/per-session-mfa)
- [Dual authorization](/ver/13.x/access-controls/guides/dual-authz)
- [Role templates, allow/deny rules, and traits](/ver/13.x/access-controls/guides/role-templates)
- [Access Requests](/ver/13.x/access-controls/access-requests)

### Background reading

- [Authentication connectors](/ver/13.x/reference/authentication)
- [Proxy Service](/ver/13.x/architecture/proxy)
- [Auth Service](/ver/13.x/architecture/authentication)
