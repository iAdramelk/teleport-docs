...
<Tabs>
  <Tab title="Linux">
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-event-handler-v13.2.0-linux-amd64-bin.tar.gz
    $ tar -zxvf teleport-event-handler-v13.2.0-linux-amd64-bin.tar.gz
    ```
  ...
  <Tab title="macOS">
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-event-handler-v13.2.0-darwin-amd64-bin.tar.gz
    $ tar -zxvf teleport-event-handler-v13.2.0-darwin-amd64-bin.tar.gz
    ```
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-event-handler:13.2.0
    ```
  </Tab>
...
<Tabs>
  ...
  <Tab title="Helm Chart">
    ...
    $ docker run -v `pwd`:/opt/teleport-plugin -w /opt/teleport-plugin public.ecr.aws/gravitational/teleport-plugin-event-handler:13.2.0 configure . ${TELEPORT_CLUSTER_ADDRESS?}
    ```
...
[audit event reference](/ver/13.x/reference/audit#event-types) so you can plan
...
more reliable renewals. Read [our guide](/ver/13.x/machine-id/getting-started)
