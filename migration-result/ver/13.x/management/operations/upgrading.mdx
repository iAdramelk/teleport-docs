...
Back up before upgrading. We have more instructions in [Backing up Teleport](/ver/13.x/management/operations/backup-restore).
...
[Upgrade the Teleport Binary](/ver/13.x/management/admin/upgrading-the-teleport-binary).
