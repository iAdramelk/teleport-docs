...
An existing Teleport Enterprise cluster. See [introduction to Teleport Enterprise](/ver/13.x/choose-an-edition/teleport-enterprise/introduction) to get started.

All components in the cluster should be running Teleport `10.0` or later. See our
[upgrade procedure](/ver/13.x/management/operations/upgrading) for help upgrading a Teleport cluster.
