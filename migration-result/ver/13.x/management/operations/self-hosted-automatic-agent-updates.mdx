...
[enroll agents into automatic updates](/ver/13.x/management/operations/enroll-agent-into-automatic-updates).
...
You can now [enroll agents into automatic updates](/ver/13.x/management/operations/enroll-agent-into-automatic-updates).
