...
and Kubernetes Operator. Read [Using Dynamic Resources](/ver/13.x/management/dynamic-resources)
for more information.

## Configure your cluster

Get to know the [tools you can use](/ver/13.x/management/dynamic-resources) to apply
...
The [Admin Guides](/ver/13.x/management/admin) section describes how to perform routine
...
The [Operations](/ver/13.x/management/operations) section describes how to perform critical,
...
[Security](/ver/13.x/management/security) section.

## Integrations

Teleport integrates with third-party software in order to enable secure access
to your infrastructure. The [Integrations](/ver/13.x/management/guides) section describes
...
Learn more in the [Diagnostics](/ver/13.x/management/diagnostics) section.
...
[Exporting Audit Events](/ver/13.x/management/export-audit-events) guides.
