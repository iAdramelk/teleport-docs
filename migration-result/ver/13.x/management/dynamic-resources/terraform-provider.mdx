...
<Tip>
  ...
  [Machine ID](/ver/13.x/machine-id/introduction) is often a better option for
...
- Find the full list of [supported Terraform provider resources](/ver/13.x/reference/terraform-provider).
- Read more about [impersonation](/ver/13.x/access-controls/guides/impersonation).
