...
<Tip>
  ...
  databases behind a firewall. For more information, see how to [join a service to your cluster](/ver/13.x/agents/join-services-to-your-cluster).
</Tip>
...
<Tabs>
  <Tab title="Open Source">
    - Two running Teleport clusters. For details on how to set up your clusters, see
      our [Getting Started](/ver/13.x/index) guide.
    ...
    - A Teleport agent that is joined to one of your clusters. We will refer to this
      ...
      Cluster](/ver/13.x/agents/join-services-to-your-cluster) for how to launch a
  ...
  <Tab title="Enterprise">
    ...
    - A Teleport Node that is joined to one of your clusters. We will refer to this
      ...
      See [Join Services to your Cluster](/ver/13.x/agents/join-services-to-your-cluster) for how to launch a Teleport agent in
      your cluster.
  </Tab>
  ...
  <Tab title="Teleport Cloud">
    ...
    - The `tctl` and `tsh` client tools version >= 13.2.0.
      ...
      You can download these from [Teleport Cloud Downloads](/ver/13.x/choose-an-edition/teleport-cloud/downloads).
      ```code
      $ tctl version
      # Teleport Enterprise v13.2.0 go1.20
    ...
    - A Teleport Node that is joined to one of your clusters. We will refer to this
      ...
      See [Join Services to your Cluster](/ver/13.x/agents/join-services-to-your-cluster) for how to launch a
      Teleport agent in your cluster.
  </Tab>
</Tabs>
...
- Read more about how Trusted Clusters fit into Teleport's overall architecture:
  [Architecture Introduction](/ver/13.x/architecture/trustedclusters).
