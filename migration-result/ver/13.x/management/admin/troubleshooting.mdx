...
<Tabs>
  ...
  <Tab title="Open Source">
    ...
    For more information about custom features, or to try our [Enterprise edition](/ver/13.x/choose-an-edition/teleport-enterprise/introduction) of Teleport, please reach out to us at [sales](https://goteleport.com/signup/enterprise/).
  </Tab>
</Tabs>
...
cluster, read our [Teleport Diagnostics](/ver/13.x/management/diagnostics/monitoring) guides.
...
If disabling TLS routing, you can find the list of default ports to use for connecting different Teleport services at [ports without TLS routing](/ver/13.x/reference/networking#ports-without-tls-routing)
