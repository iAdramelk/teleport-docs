...
<Accordion title="Using containers?">
  ...
  [How to Run Teleport Using Docker](/ver/13.x/installation#docker) for information on
...
[Upgrading a Teleport Cluster](/ver/13.x/management/operations/upgrading).

See the full list of supported signals in the
[Teleport Signals Reference](/ver/13.x/reference/signals).
