...
<Tip>
  ...
  | [Databases](/ver/13.x/database-access/getting-started)             | Teleport can discover some AWS-hosted databases automatically. In this case, labels will also be automatically applied.                                          |
  | [Kubernetes clusters](/ver/13.x/kubernetes-access/getting-started) |                                                                                                                                                                  |
  | [Servers](/ver/13.x/server-access/getting-started)                 |                                                                                                                                                                  |
  | [Windows desktops](/ver/13.x/desktop-access/getting-started)       | Dynamic labels are not supported for Windows desktops. See our [Desktop Access documentation](/ver/13.x/desktop-access/rbac#labeling) for how to label desktops. |
</Tip>
...
[Resource filtering](/ver/13.x/reference/predicate-language).
...
[Teleport Role Templates](/ver/13.x/access-controls/guides/role-templates).
