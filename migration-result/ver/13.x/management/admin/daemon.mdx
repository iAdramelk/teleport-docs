...
<Tip>
  ...
  - Replace the Teleport binaries, usually [`teleport`](/ver/13.x/reference/cli#teleport)
    and [`tctl`](/ver/13.x/reference/cli#tctl).
...
[Teleport CLI Reference](/ver/13.x/reference/cli#teleport).
...
[upgrading a Teleport binary](/ver/13.x/management/admin/upgrading-the-teleport-binary).
