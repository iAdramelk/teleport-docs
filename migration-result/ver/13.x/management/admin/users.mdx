...
- [Add local users](/ver/13.x/management/admin/users#adding-local-users)
- [Edit existing users](/ver/13.x/management/admin/users#editing-users)
- [Delete users](/ver/13.x/management/admin/users#deleting-users)
...
<Tabs>
  <Tab title="Commercial">
    ...
    resources. See our [Teleport Resources Reference](/ver/13.x/reference/resources).

    For all available `tctl` commands and flags, see our [CLI Reference](/ver/13.x/reference/cli#tctl).

    You can also configure Teleport so that users can log in using an SSO provider.
    For more information, see:

    - [Single Sign-On](/ver/13.x/access-controls/sso)
  </Tab>
  ...
  <Tab title="Open Source">
    ...
    [CLI Reference](/ver/13.x/reference/cli#tctl).

    You can also configure Teleport so that users can log in using GitHub. For more
    information, see [GitHub SSO](/ver/13.x/access-controls/sso/github-sso).
  </Tab>
</Tabs>
