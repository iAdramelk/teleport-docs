...
<Tabs>
  <Tab title="Open Source">
    - A running Teleport cluster. For details on how to set this up, see our
      [Getting Started](/ver/13.x/index) guide (skip TLS certificate setup).
...
<Tabs>
  ...
  <Tab title="Helm chart">
    ...
    [extraArgs](/ver/13.x/reference/helm-reference/teleport-cluster#extraargs)
    ...
    ](/ver/13.x/reference/helm-reference/teleport-kube-agent#insecureskipproxytlsverify)
    flag to `true`:
...
flag](/ver/13.x/connect-your-client/teleport-connect#skipping-tls-certificate-verification).

## Further reading

- [Configuring Teleport TLS Certs](/ver/13.x/index#configure-teleport)
- [Run Teleport as a systemd Daemon](/ver/13.x/management/admin/daemon)
- [Teleport Proxy Service](/ver/13.x/architecture/proxy)
