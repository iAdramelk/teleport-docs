...
Enterprise Cloud customers can use the [IAM join method](/ver/13.x/agents/join-services-to-your-cluster/aws-iam) or
[secret tokens](/ver/13.x/agents/join-services-to-your-cluster/join-token).
...
<Accordion title="Other AWS joining methods">
  ...
  tokens](/ver/13.x/agents/join-services-to-your-cluster/join-token), which is useful when you don't want to rely on
  AWS-specific APIs.
</Accordion>
