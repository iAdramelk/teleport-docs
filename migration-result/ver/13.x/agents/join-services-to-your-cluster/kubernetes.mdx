...
- A running Teleport cluster in Kubernetes. For details on how to set this up,
  see [Guides for running Teleport using Helm](/ver/13.x/deploy-a-cluster/helm-deployments).
...
- The Auth Service ServiceAccount must be granted the `system:auth-delegator`
  ...
  chart](/ver/13.x/reference/helm-reference/teleport-cluster) version 12 or
...
- The possible values for `teleport-kube-agent` chart are documented
  [in its reference](/ver/13.x/reference/helm-reference/teleport-kube-agent).
- See [Application Access Guides](/ver/13.x/application-access/guides)
- See [Database Access Guides](/ver/13.x/database-access/guides)
