...
clusters](/ver/13.x/kubernetes-access/discovery) in AWS, Azure, and Google Cloud,
as well as [servers](/ver/13.x/server-access/guides/ec2-discovery) on Amazon EC2.
