...
<Tip>
  ...
  follow one of our [getting started guides](/ver/13.x/index) or try our
...
<Tabs>
  <Tab title="Docker">
    ...
    Install Teleport on the host where you will run the Teleport Application Service. See our [Installation](/ver/13.x/installation) page for options besides Linux servers.
...
- Learn in more detail about [connecting applications](/ver/13.x/application-access/guides/connecting-apps).
- Learn about integrating with [JWT tokens](/ver/13.x/application-access/jwt/introduction) for auth.
- Learn how to use application access with [RESTful APIs](/ver/13.x/application-access/guides/api-access).
- See full configuration and CLI [reference](/ver/13.x/application-access/reference).
