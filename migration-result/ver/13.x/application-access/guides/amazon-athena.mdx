...
[AWS CLI and Console](/ver/13.x/application-access/cloud-apis/aws-console).
...
<Tip>
  If you have not yet deployed the Auth Service and Proxy Service, you should follow one of our [getting started guides](/ver/13.x/application-access/getting-started) or try our Teleport application access [interactive learning track](https://play.instruqt.com/teleport/invite/rgvuva4gzkon).
</Tip>
...
<Accordion title="Templating &#x22;aws_role_arns&#x22; in role definitions">
  ...
  See [Role Templates](/ver/13.x/access-controls/guides/role-templates) for
  details.
</Accordion>
...
Service. See our [Installation](/ver/13.x/installation) page for options
...
- More information on [AWS Management and API with Teleport Application Access](/ver/13.x/application-access/cloud-apis/aws-console).
