...
and follow the installation [instructions](/ver/13.x/installation).
...
Rewritten header values support the same templating variables as [role templates](/ver/13.x/access-controls/guides/role-templates).
...
[Integrating with JWTs](/ver/13.x/application-access/jwt/introduction) for more details.
