...
You can inject a JWT token into any header using [headers passthrough](/ver/13.x/application-access/guides/connecting-apps#headers-passthrough)
...
- [ElasticSearch](/ver/13.x/application-access/jwt/elasticsearch)
