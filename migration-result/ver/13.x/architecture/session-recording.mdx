...
[Trusted Clusters](/ver/13.x/management/admin/trustedclusters) with their own
...
specified by the `audit_sessions_uri` field in the `teleport.yaml` [configuration file](/ver/13.x/reference/config).
...
the [`tsh play`](/ver/13.x/reference/cli#tsh-play) command. Desktop session
...
- [SSH session recording](/ver/13.x/architecture/nodes#ssh-session-recording)
- [SSH recording modes](/ver/13.x/reference/audit#modes)
- [Desktop Access recording](/ver/13.x/desktop-access/reference/sessions)
