...
- [OpenSSH: `ssh`](/ver/13.x/server-access/guides/openssh)
- [Teleport CLI client: `tsh ssh`](/ver/13.x/reference/cli#tsh-ssh)
- [Teleport Proxy UI](/ver/13.x/architecture/proxy) accessed via a web browser.
...
See the [reference](/ver/13.x/reference/audit#recorded-sessions) to learn how to turn
...
- [Teleport Authentication](/ver/13.x/architecture/authentication)
- [Teleport Authorization](/ver/13.x/architecture/authorization)
