...
<Tip>
  ...
  Directory](/ver/13.x/desktop-access/active-directory) for more information.

  Teleport Enterprise users can configure Windows Access for local users by
  following [Getting Started with Windows Access](/ver/13.x/desktop-access/getting-started).
...
<Warning>
  ...
  Started with Desktop Access](/ver/13.x/desktop-access/getting-started).
</Warning>
...
Started](/ver/13.x/index) guide to set up a demo cluster.
...
<Note>
  ...
  you must first perform a [CA rotation](/ver/13.x/management/operations/ca-rotation) in
...
[configuration reference](/ver/13.x/desktop-access/reference/configuration) page.
...
[Troubleshooting documentation](/ver/13.x/desktop-access/troubleshooting) for common problems and
solutions.
