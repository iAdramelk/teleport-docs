...
- [Using Machine ID with GitHub Actions](/ver/13.x/machine-id/guides/github-actions): How to
  use Machine ID to SSH into Teleport nodes from GitHub Actions.
- [Using Machine ID with GitHub Actions and Kubernetes](/ver/13.x/machine-id/guides/github-actions-kubernetes):
