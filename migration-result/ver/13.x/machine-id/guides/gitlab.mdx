...
- A running instance of the Teleport SSH Service registered with your Teleport
  ...
  Guide](/ver/13.x/server-access/introduction). The SSH node must include a user
...
on the
[GitLab CI reference page.](/ver/13.x/machine-id/reference/gitlab#gitlab-join-token)
