...
Access](/ver/13.x/database-access/introduction). This allows for
fine-grain access control through [Teleport's RBAC](/ver/13.x/database-access/rbac).
...
![DynamoDB Self-Hosted](../../../../../assets/aws-dynamodb_selfhosted-9824097a9d.png)

![DynamoDB Cloud](../../../../../assets/aws-dynamodb_cloud-e472d58592.png)
...
![Create Role to Identify EC2 Instance](../../../../../assets/dynamodb-create-ec2-role-f29eb95c6c.png)
...
![Create Role Step 2](../../../../../assets/dynamodb-create-role-2-adacae39dc.png)
...
Assign the `aws-dynamodb-access` role to your Teleport user by running the following
...
<Tabs>
  ...
  <Tab title="GitHub">
    ...
    Edit `github.yaml`, adding `aws-dynamodb-access` to the
  ...
  <Tab title="SAML">
    ...
    Edit `saml.yaml`, adding `aws-dynamodb-access` to the
  ...
  <Tab title="OIDC">
    ...
    Edit `oidc.yaml`, adding `aws-dynamodb-access` to the
...
<Accordion title="Alternative methods">
  ...
  - [Configure Teleport to Automatically Enroll EC2 instances (Preview)](/ver/13.x/server-access/guides/ec2-discovery)
  - [Joining Teleport Services via AWS IAM
    Role](/ver/13.x/agents/join-services-to-your-cluster/aws-iam)
  - [Joining Teleport Services via AWS EC2 Identity Document](/ver/13.x/agents/join-services-to-your-cluster/aws-ec2)
</Accordion>
...
You can also connect to this database from the AWS NoSQL Workbench, as documented in our [Database Access GUI Clients](/ver/13.x/connect-your-client/gui-clients#nosql-workbench) guide.
...
- See [Dynamic Database Registration](/ver/13.x/database-access/guides/dynamic-registration) to learn how
