...
See the available [guides](/ver/13.x/database-access/guides) for all supported configurations.
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [Proxy Configuration](/ver/13.x/database-access/reference/configuration#proxy-configuration) for
    more details.
...
[graphical clients](/ver/13.x/connect-your-client/gui-clients).
...
[configuration file](/ver/13.x/database-access/reference/configuration#database-service-configuration)
