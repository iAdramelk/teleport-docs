...
For a more general description of Teleport roles and examples see [RBAC](/ver/13.x/access-controls/introduction), as
...
The `{{external.xyz}}` variables are replaced with values from external [SSO](/ver/13.x/access-controls/sso)
