...
- Teleport cluster v13.1 or above with a configured [self-hosted
  PostgreSQL](/ver/16.x/database-access/guides/postgres-self-hosted) or [RDS
  PostgreSQL](/ver/16.x/database-access/guides/rds) database.
...
<Tabs>
  ...
  <Tab title="Self-hosted PostgreSQL">
    ...
    Refer to the [self-hosted PostgreSQL guide](/ver/16.x/database-access/guides/postgres-self-hosted#step-35-configure-your-postgresql-server)
...
- Connect using your [GUI database
  client](/ver/16.x/connect-your-client/gui-clients).
- Learn about [role
  templating](/ver/16.x/access-controls/guides/role-templates#interpolation-rules).
