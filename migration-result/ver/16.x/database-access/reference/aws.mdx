...
bootstrap`](/ver/16.x/database-access/reference/cli#teleport-db-configure-bootstrap)
...
manually using a [static configuration](/ver/16.x/database-access/reference/configuration) or
[`tctl`](/ver/16.x/database-access/guides/dynamic-registration) and manage IAM yourself, example
