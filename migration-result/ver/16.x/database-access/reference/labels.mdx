...
| `dynamic`   | database resources created through [dynamic registration](/ver/16.x/database-access/guides/dynamic-registration) like `tcl create` command. |
...
[Configuration](/ver/16.x/database-access/reference/configuration) for reference.
...
Tags](/ver/16.x/management/guides/ec2-tags) for more details.
