...
<Note>
  ...
  [impersonation guide](/ver/16.x/access-controls/guides/impersonation)
...
Displays only the databases a user has access to (see [RBAC](/ver/16.x/database-access/rbac)).
