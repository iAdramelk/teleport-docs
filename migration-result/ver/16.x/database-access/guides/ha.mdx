...
Registration](/ver/16.x/database-access/guides/dynamic-registration).
...
- Review the [architecture](/ver/16.x/database-access/architecture) of the Teleport Database
  Service.
