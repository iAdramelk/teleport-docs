...
Service instances for [high availability](/ver/16.x/database-access/guides/ha) by configuring Database
...
See the full database resource spec [reference](/ver/16.x/database-access/reference/configuration#database-resource).
...
- [AWS Discovery](/ver/16.x/database-access/guides/aws-discovery)
- [Terraform Provider](/ver/16.x/management/dynamic-resources/terraform-provider)
- [Kubernetes Operator](/ver/16.x/management/dynamic-resources/teleport-operator)
- [Teleport API](/ver/16.x/api/introduction)

See [Using Dynamic Resources](/ver/16.x/management/dynamic-resources) to learn
