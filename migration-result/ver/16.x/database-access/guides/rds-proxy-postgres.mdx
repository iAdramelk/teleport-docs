...
Teleport can provide secure access to AWS RDS proxy for PostgreSQL via the  [Teleport Database
...
1. Configure an AWS RDS proxy for PostgreSQL with IAM authentication.
2. Join the AWS RDS proxy for PostgreSQL database to your Teleport cluster.
3. Connect to the AWS RDS proxy for PostgreSQL database via the Teleport Database Service.
