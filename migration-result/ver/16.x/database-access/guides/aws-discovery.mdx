...
- Learn about [Dynamic Registration](/ver/16.x/database-access/guides/dynamic-registration) by the
  Teleport Database Service.
- Get started by [connecting](/ver/16.x/database-access/guides) your database.
- Connect AWS databases in [external AWS accounts](/ver/16.x/database-access/guides/aws-cross-account).
