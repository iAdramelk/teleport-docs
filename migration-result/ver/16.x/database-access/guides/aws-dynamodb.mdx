...
You can also connect to this database from the AWS NoSQL Workbench, as documented in our [Database Access GUI Clients](/ver/16.x/connect-your-client/gui-clients#nosql-workbench) guide.
...
- See [Dynamic Database Registration](/ver/16.x/database-access/guides/dynamic-registration) to learn how
