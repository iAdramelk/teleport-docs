...
<Note>
  ...
  [PostgreSQL](/ver/16.x/database-access/guides/rds-proxy-postgres),
  [MariaDB/MySQL](/ver/16.x/database-access/guides/rds-proxy-postgres) or
  [Microsoft SQL Server](/ver/16.x/database-access/guides/rds-proxy-sqlserver).
</Note>
...
- A running Teleport Discovery Service if you plan to use [Database
  Auto-Discovery](/ver/16.x/database-access/guides/aws-discovery).
...
<Accordion title="Alternative methods">
  ...
  - [Configure Teleport to Automatically Enroll EC2 instances](/ver/16.x/server-access/guides/ec2-discovery)
  - [Joining Teleport Services via AWS IAM
    Role](/ver/16.x/agents/join-services-to-your-cluster/aws-iam)
  - [Joining Teleport Services via AWS EC2 Identity Document](/ver/16.x/agents/join-services-to-your-cluster/aws-ec2)
</Accordion>
...
<Accordion title="Method 1: Organize IAM roles with &#x22;assume_role_arn&#x22;">
  ...
  <Tabs>
    <Tab title="Auto-Discovery by Discovery Service">
      ...
      <Tip>
        ...
        labels](/ver/16.x/database-access/reference/labels#auto-discovery)
  ...
  Access](/ver/16.x/database-access/guides/aws-cross-account).
</Accordion>
...
<Accordion title="Method 3: Separate Database Services">
  ...
  configuration](/ver/16.x/database-access/guides/ha) where databases can be
