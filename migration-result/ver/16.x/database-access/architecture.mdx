...
<Tabs>
  <Tab title="Self-Hosted">
    - [Teleport Proxy Service](/ver/16.x/architecture/proxy). A stateless service
  ...
  <Tab title="Teleport Enterprise Cloud">
    - [Teleport Proxy Service](/ver/16.x/architecture/proxy). A stateless service that performs
...
- [Teleport Auth Service](/ver/16.x/architecture/authentication). Serves as
...
1. A user logs into the cluster with `tsh login` command and retrieves
   a client certificate. See [Issuing User Certificates](/ver/16.x/architecture/authentication)
...
of the secrets. See [GUI Clients](/ver/16.x/connect-your-client/gui-clients) for details.
...
See respective [guides](/ver/16.x/database-access/guides) for details on configuring client
...
See respective [guides](/ver/16.x/database-access/guides) for details on configuring IAM/AD
authentication.
...
See [Core Concepts](/ver/16.x/core-concepts) for general Teleport
