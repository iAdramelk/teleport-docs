...
- [PostgreSQL](/ver/16.x/database-access/guides/postgres-self-hosted#step-25-create-a-certificatekey-pair)
- [MySQL/MariaDB](/ver/16.x/database-access/guides/mysql-self-hosted#step-24-create-a-certificatekey-pair)
- [MongoDB](/ver/16.x/database-access/guides/mongodb-self-hosted#set-up-mutual-tls)
- [CockroachDB](/ver/16.x/database-access/guides/cockroachdb-self-hosted#set-up-mutual-tls)
- [Redis](/ver/16.x/database-access/guides/redis#step-45-set-up-mutual-tls)
- [Redis Cluster](/ver/16.x/database-access/guides/redis-cluster#step-46-set-up-mutual-tls)
...
Controls Reference](/ver/16.x/access-controls/reference).
...
access see the [RBAC](/ver/16.x/database-access/rbac) documentation.
...
feature](/ver/16.x/management/operations/tls-routing), where the Teleport Proxy
...
command](/ver/16.x/connect-your-client/gui-clients#get-connection-information),
