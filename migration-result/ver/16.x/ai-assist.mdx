...
- A running Teleport Community Edition cluster, v12.4 or higher. For details on
  how to set this up, see our [Getting Started](/ver/16.x/index) guide.
...
- [Access controls](/ver/16.x/access-controls/getting-started)
- [Resource filtering](/ver/16.x/reference/predicate-language)
- [Access request plugins](/ver/16.x/access-controls/access-request-plugins/index)
