...
<Tip>
  ...
  [Choose an Edition](/ver/16.x/choose-an-edition/introduction).
</Tip>
...
- The `tsh` client tool.
  ...
  For installation instructions, see [Installation Guide](/ver/16.x/installation).
...
with Terraform](/ver/16.x/agents/deploy-agents-terraform).
