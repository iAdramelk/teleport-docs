...
See our documentation on [data retention](/ver/16.x/choose-an-edition/teleport-cloud/architecture#data-retention).
...
We believe mTLS with strong user and [device identity](/ver/16.x/access-controls/device-trust/guide) provides the best available
...
Access Controls Reference](/ver/16.x/access-controls/reference).
...
tunnels](/ver/16.x/agents/join-services-to-your-cluster).
...
[dynamic tokens](/ver/16.x/agents/join-services-to-your-cluster/join-token):
...
Find the appropriate download at [Teleport Enterprise Cloud Downloads](/ver/16.x/choose-an-edition/teleport-cloud/downloads). Use the Enterprise version of `tctl`.
...
Yes. We recommend Teleport's [event handler plugin](/ver/16.x/management/export-audit-events/fluentd) to export Teleport Enterprise Cloud audit events.

### Is it possible to store audit logs and session recordings in my own S3 bucket?

Yes, you can configure [External Audit Storage](/ver/16.x/choose-an-edition/teleport-cloud/external-audit-storage).
...
described in [Teleport Upcoming Releases](/ver/16.x/upcoming-releases).
...
the [Upgrading Overview](/ver/16.x/upgrading/overview) for more information.
...
Read more in our [TLS Routing](/ver/16.x/architecture/tls-routing) guide.
...
Configuring [External Audit Storage](/ver/16.x/choose-an-edition/teleport-cloud/external-audit-storage) will allow
