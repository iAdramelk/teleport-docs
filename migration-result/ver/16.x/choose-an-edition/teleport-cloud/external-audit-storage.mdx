...
[Athena](/ver/16.x/reference/backends#athena) backend for audit events and the
[S3](/ver/16.x/reference/backends#s3) backend for session recordings. It is only
...
[Event Handler](/ver/16.x/management/export-audit-events) plugin to export
