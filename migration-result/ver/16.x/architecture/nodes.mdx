...
- [OpenSSH: `ssh`](/ver/16.x/server-access/guides/openssh)
- [Teleport CLI client: `tsh ssh`](/ver/16.x/reference/cli/tsh#tsh-ssh)
- [Teleport Proxy UI](/ver/16.x/architecture/proxy) accessed via a web browser.
...
See the [reference](/ver/16.x/reference/audit#recorded-sessions) to learn how to turn
...
- [Teleport Authentication](/ver/16.x/architecture/authentication)
- [Teleport Authorization](/ver/16.x/architecture/authorization)
