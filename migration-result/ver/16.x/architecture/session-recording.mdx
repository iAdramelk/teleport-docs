...
[trusted clusters](/ver/16.x/management/admin/trustedclusters) with their own
...
specified by the `audit_sessions_uri` field in the `teleport.yaml` [configuration file](/ver/16.x/reference/config).
...
the [`tsh play`](/ver/16.x/reference/cli/tsh#tsh-play) command. Desktop session
...
- [SSH session recording](/ver/16.x/architecture/nodes#ssh-session-recording)
- [SSH recording modes](/ver/16.x/reference/audit#modes)
- [Desktop Access recording](/ver/16.x/desktop-access/reference/sessions)
