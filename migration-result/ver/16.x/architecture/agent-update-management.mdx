...
mode](/ver/16.x/faq#can-teleport-be-deployed-in-agentless-mode), agent deployments
...
](/ver/16.x/upgrading/self-hosted-automatic-agent-updates).

After that, you can set enroll agents in automatic upgrades as part of the
[upgrading procedure](/ver/16.x/upgrading).
