...
that this cluster trusts. In this case, Teleport activates [trusted cluster mapping logic](/ver/16.x/architecture/trustedclusters#role-mapping).
...
[`tctl users add`](/ver/16.x/reference/cli) or API call.
...
[trusted cluster mapping logic](/ver/16.x/architecture/trustedclusters#role-mapping) to support this use case.
...
<Tip>
  You can use `where` fields in all resource rules. Check out [the full role reference](/ver/16.x/access-controls/reference) contains full role spec for details.
</Tip>
...
- [Access Control Reference](/ver/16.x/access-controls/reference).
- [Teleport Predicate Language](/ver/16.x/reference/predicate-language).
- [Access Requests Guides](/ver/16.x/access-controls/access-requests)
- [Architecture Overview](/ver/16.x/core-concepts)
- [Teleport Auth](/ver/16.x/architecture/authentication)
- [Teleport Nodes](/ver/16.x/architecture/nodes)
- [Teleport Proxy](/ver/16.x/architecture/proxy)
