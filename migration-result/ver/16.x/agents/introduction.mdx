...
Reference](/ver/16.x/reference/config#enabling-teleport-services) for which
...
![Diagram showing the architecture of an agent pool](../../../../assets/agent-pool-diagram-516d201f48.png)

Read our guide for how to use Terraform to [deploy a pool of
agents](/ver/16.x/agents/deploy-agents-terraform).
...
Cluster](/ver/16.x/agents/join-services-to-your-cluster) guides.
...
e.g., [using a Terraform module](/ver/16.x/agents/deploy-agents-terraform). To modify the
...
- **Dynamic**: Apply a [configuration
  resource](/ver/16.x/management/dynamic-resources) that configures a resource to
  proxy.
...
[Read our guide](/ver/16.x/agents/deploy-agents-terraform) to deploying a pool of agents
...
- [SSH Service](/ver/16.x/server-access/introduction)
- [Database Service](/ver/16.x/database-access/introduction)
- [Kubernetes Service](/ver/16.x/kubernetes-access/introduction)
- [Windows Desktop Service](/ver/16.x/desktop-access/introduction)
- [Application Service](/ver/16.x/application-access/introduction)
