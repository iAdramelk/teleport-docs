...
<Accordion title="Connecting directly to the Auth Service">
  ...
  <Warning>
    ...
    by executing [`tctl auth rotate`](/ver/16.x/reference/cli/tctl#tctl-auth-rotate).
  </Warning>
...
- If you have workloads split across different networks or clouds, we recommend
  setting up trusted clusters. Read how to get started in [Configure Trusted Clusters](/ver/16.x/management/admin/trustedclusters).
