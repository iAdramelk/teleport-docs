...
<Accordion title="Using another join method">
  ...
  - Google Kubernetes Engine: Where
    ...
    See the [GCP Platform Guide](/ver/16.x/machine-id/deployment/gcp) for further information.
  - AWS Elastic Kubernetes Service: Where
    ...
    See the [AWS Platform Guide](/ver/16.x/machine-id/deployment/aws) for further information.
</Accordion>
...
spec:
  ...
  template:
    ...
    spec:
      containers:
        - name: tbot
          image: public.ecr.aws/gravitational/teleport:15.0.0-dev
          command:
            - tbot
          args:
            - start
