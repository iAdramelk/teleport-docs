...
Reference](/ver/16.x/access-controls/reference#rbac-for-dynamic-teleport-resources)
...
- Now that you know how to manage Teleport configuration resources with
  ...
  reference](/ver/16.x/reference/terraform-provider) so you can flesh out your
  configuration.
...
- Learn how you can help achieve secure access for service accounts by sending
  [anonymous Machine ID telemetry](/ver/16.x/machine-id/reference/telemetry).
