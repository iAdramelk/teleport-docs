...
- If you have not already connected your Kubernetes cluster to Teleport, follow
  the [Kubernetes Access Getting Started Guide](/ver/16.x/kubernetes-access/getting-started).
...
- Read the [Kubernetes Access RBAC guide](/ver/16.x/kubernetes-access/controls)
