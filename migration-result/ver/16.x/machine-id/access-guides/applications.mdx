...
- If you have not already connected your application to Teleport, follow
  the [Application Access Getting Started Guide](/ver/16.x/application-access/getting-started).
...
- Review the [Access Controls Reference](/ver/16.x/access-controls/reference)
  to learn about restricting which Applications and other Teleport resources
  your bot may access.
- Configure [JWTs](/ver/16.x/application-access/jwt/introduction) for your
