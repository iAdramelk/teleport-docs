...
be automatically [locked](/ver/16.x/access-controls/guides/locking).
...
When requesting [Database Access](/ver/16.x/database-access/introduction)
...
Teleport [RBAC permissions](/ver/16.x/access-controls/reference) and are not
allowed to view or list databases by default unless granted permission via one
or more roles.

### Resolution

Per the [Machine ID Database Access Guide](/ver/16.x/machine-id/access-guides/databases), ensure at
