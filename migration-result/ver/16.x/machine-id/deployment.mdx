...
guide](/ver/16.x/machine-id/deployment/linux) is compatible with most platforms. For
custom approaches, you can also read the [Machine ID Reference](/ver/16.x/machine-id/reference)
and [Architecture](/ver/16.x/machine-id/architecture) to plan your deployment.
...
| -------------------------------------------------------- | ----------------------------------------------- | --------------------------------------------------- |
| [Linux](/ver/16.x/machine-id/deployment/linux)           | Package manager or TAR archive                  | Static join token                                   |
| [GCP](/ver/16.x/machine-id/deployment/gcp)               | Package manager, TAR archive, or Kubernetes pod | Identity document signed by GCP                     |
| [AWS](/ver/16.x/machine-id/deployment/aws)               | Package manager, TAR archive, or Kubernetes pod | Identity document signed by AWS                     |
| [Azure](/ver/16.x/machine-id/deployment/azure)           | Package manager or TAR archive                  | Identity document signed by Azure                   |
| [Kubernetes](/ver/16.x/machine-id/deployment/kubernetes) | Kubernetes pod                                  | Identity document signed by your Kubernetes cluster |
...
| Platform                                                         | Installation method                                           | Join method                        |
| ---------------------------------------------------------------- | ------------------------------------------------------------- | ---------------------------------- |
| [CircleCI](/ver/16.x/machine-id/deployment/circleci)             | TAR archive                                                   | CircleCI-signed identity document  |
| [GitLab](/ver/16.x/machine-id/deployment/gitlab)                 | TAR archive                                                   | GitLab-signed identity document    |
| [GitHub Actions](/ver/16.x/machine-id/deployment/github-actions) | Teleport job available through the GitHub Actions marketplace | GitHub-signed identity document.   |
| [Jenkins](/ver/16.x/machine-id/deployment/jenkins)               | Package manager or TAR archive                                | Static join token                  |
| [Spacelift](/ver/16.x/machine-id/deployment/spacelift)           | Docker Image                                                  | Spacelift-signed identity document |
