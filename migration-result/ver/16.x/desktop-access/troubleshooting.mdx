...
Policy](/ver/16.x/desktop-access/active-directory-manual#enable-smart-card-authentication).
...
Policy](/ver/16.x/desktop-access/active-directory-manual#create-the-GPO-for-the-Teleport-certificate).
...
connections](/ver/16.x/desktop-access/active-directory-manual#allow-remote-desktop-connections)
...
connections](/ver/16.x/desktop-access/active-directory-manual#step-47-configure-a-certificate-for-rdp-connections).
...
desktop connections](/ver/16.x/desktop-access/active-directory-manual#allow-remote-desktop-connections)
in the group policy object you have configured for Teleport connections.
