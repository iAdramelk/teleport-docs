...
![Manage access to Windows through Teleport](../../../../assets/windows-desktop-service-overview-8b46dedeba.png)
...
- [Configure access for local Windows users](/ver/16.x/desktop-access/getting-started)
- [Configure access for Active Directory with scripts](/ver/16.x/desktop-access/active-directory)
- [Configure access for Active Directory manually](/ver/16.x/desktop-access/active-directory-manual)
...
- [Role-Based Access Control for Desktops](/ver/16.x/desktop-access/rbac)
- [Clipboard Sharing](/ver/16.x/desktop-access/reference/clipboard)
- [Directory Sharing](/ver/16.x/desktop-access/directory-sharing)
- [Session Recording and Playback](/ver/16.x/desktop-access/reference/sessions)
- [Troubleshooting Desktop Access](/ver/16.x/desktop-access/troubleshooting)
- [Desktop Access Audit Events Reference](/ver/16.x/desktop-access/reference/audit)
- [Desktop Access Configuration Reference](/ver/16.x/desktop-access/reference/configuration)
- [Desktop Access CLI Reference](/ver/16.x/desktop-access/reference/cli)
