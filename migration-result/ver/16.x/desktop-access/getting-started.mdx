...
6. (Optional) Add labels for the Windows Desktop Service to the configuration file.
   ...
   role permissions](/ver/16.x/desktop-access/rbac).
...
2. Create a `windows-desktop-admins.yaml` file to define a new role:
   ...
   to create local Windows logins, see [Logins](/ver/16.x/desktop-access/rbac#logins).
...
Getting Started](/ver/16.x/access-controls/getting-started#step-13-add-local-users-with-preset-roles).
