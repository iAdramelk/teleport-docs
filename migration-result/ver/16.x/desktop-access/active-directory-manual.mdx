...
Active Directory with scripts](/ver/16.x/desktop-access/active-directory). However, if automation
...
- Access to a running Teleport cluster, `tctl` admin tool, and `tsh` client tool
  ...
  instructions](/ver/16.x/installation#installation-instructions) for the Teleport
  edition you use.
...
- An Active Directory domain that is configured for LDAPS. Because Teleport requires an
  ...
  Active Directory with scripts](/ver/16.x/desktop-access/active-directory) for how to
...
4. Now left-click **Remote Session Environment**
   ...
   ![Enable RemoteFX](../../../../assets/enable-remotefx-004370adf5.png)
...
5. Add the configuration for the Windows Desktop Service to the `/etc/teleport.yaml`
   ...
   [Desktop Configuration Reference](/ver/16.x/desktop-access/reference/configuration).
...
If you encounter any issues, see [Troubleshooting](/ver/16.x/desktop-access/troubleshooting) for common problems and
solutions.
