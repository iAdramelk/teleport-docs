...
Access](/ver/16.x/kubernetes-access/introduction) documentation.
...
- [Deploy Teleport on Kubernetes](/ver/16.x/deploy-a-cluster/helm-deployments/kubernetes-cluster): Run a Teleport cluster in a Kubernetes cluster using
  the default configuration. This deployment is a great starting point to try a self-hosted
  Teleport with minimal resources.
- [HA AWS Teleport Cluster](/ver/16.x/deploy-a-cluster/helm-deployments/aws): Running an HA Teleport cluster in Kubernetes using an AWS EKS Cluster
- [HA Azure Teleport Cluster](/ver/16.x/deploy-a-cluster/helm-deployments/azure): Running an HA Teleport cluster in Kubernetes using an Azure AKS Cluster
- [HA GCP Teleport Cluster](/ver/16.x/deploy-a-cluster/helm-deployments/gcp): Running an HA Teleport cluster in Kubernetes using a Google Cloud GKE Cluster
- [DigitalOcean Kubernetes Cluster](/ver/16.x/deploy-a-cluster/helm-deployments/digitalocean):
  Running Teleport on DigitalOcean Kubernetes.
- [Custom Teleport config](/ver/16.x/deploy-a-cluster/helm-deployments/custom): Running a Teleport cluster in Kubernetes with a custom Teleport config

## Migration Guides

- [Migrating from v11 to v12](/ver/16.x/deploy-a-cluster/helm-deployments/migration-v12)
- [Kubernetes 1.25 and PSP removal](/ver/16.x/deploy-a-cluster/helm-deployments/migration-kubernetes-1-25-psp)
