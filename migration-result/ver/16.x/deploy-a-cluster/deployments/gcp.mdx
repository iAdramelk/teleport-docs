...
see  [Admin Guide: Troubleshooting](/ver/16.x/management/admin/troubleshooting) for more information.
...
Follow install instructions from our [installation page](/ver/16.x/installation#linux).
...
<Tabs>
  <Tab title="Open Source">
    **1. Configure Teleport Auth Server** using the below example `teleport.yaml`,and start it
    using [systemd](/ver/16.x/management/admin/daemon). The DEB/RPM installations will
...
Follow our [Local Users](/ver/16.x/management/admin/users) guide or integrate
with [Google Workspace](/ver/16.x/access-controls/sso/google-workspace) to
provide SSO access.
