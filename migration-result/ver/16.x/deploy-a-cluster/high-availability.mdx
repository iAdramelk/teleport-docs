...
will enable [TLS Routing](/ver/16.x/management/operations/tls-routing) in your
Teleport cluster.
...
<Tip>
  ...
  Helm chart, read our [Helm Deployments](/ver/16.x/deploy-a-cluster/helm-deployments) documentation.
</Tip>
...
to follow a more specific [deployment guide](/ver/16.x/deploy-a-cluster/introduction) for your
environment.
...
Consult our [Backends Reference](/ver/16.x/reference/backends) for the configuration
...
- [High-availability Teleport Deployments on Kubernetes with
  Helm](/ver/16.x/deploy-a-cluster/helm-deployments)
- [Reference Deployments](/ver/16.x/deploy-a-cluster/deployments) for running Teleport on a cluster of
  virtual machines
...
- [Scaling a Teleport cluster](/ver/16.x/management/operations/scaling)
- [Monitoring a Teleport cluster](/ver/16.x/management/diagnostics)
...
- [Applications](/ver/16.x/application-access/getting-started)
- [Servers](/ver/16.x/server-access/getting-started)
- [Kubernetes clusters](/ver/16.x/kubernetes-access/getting-started)
- [Databases](/ver/16.x/database-access/getting-started)
- [Windows desktops](/ver/16.x/desktop-access/introduction)
- [Bot users](/ver/16.x/machine-id/getting-started)
