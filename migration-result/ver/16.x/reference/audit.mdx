...
<Tip>
  You can use
  [Enhanced Session Recording with BPF](/ver/16.x/server-access/guides/bpf-session-recording)
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [Athena](/ver/16.x/reference/backends#athena), [DynamoDB](/ver/16.x/reference/backends#dynamodb) or
    [Firestore](/ver/16.x/reference/backends#firestore) chapters for information on how to
    ...
    [Teleport Configuration Reference](/ver/16.x/reference/config).
...
<Tip>
  ...
  read [Exporting Teleport Audit Events](/ver/16.x/management/export-audit-events).
</Tip>
...
<Tabs>
  <Tab title="Self-Hosted">
    Teleport can store the recorded sessions in an [AWS S3 bucket](/ver/16.x/reference/backends#s3)
    ...
    You can replay recorded sessions using the [`tsh play`](/ver/16.x/reference/cli/tsh#tsh-play)
