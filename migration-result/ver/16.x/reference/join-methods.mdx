...
<Note>
  You must be familiar with the [Teleport Core concepts](/ver/16.x/core-concepts)
...
<Note>
  - How to [Join Services with a Secure Token](/ver/16.x/agents/join-services-to-your-cluster/join-token).
  - [Deploying Machine ID on Linux](/ver/16.x/machine-id/deployment/linux)
</Note>
...
<Note>
  - [Joining Services via AWS IAM Role](/ver/16.x/agents/join-services-to-your-cluster/aws-iam).
  - [Deploying Machine ID on AWS](/ver/16.x/machine-id/deployment/aws)
</Note>
...
<Note>
  [Joining Services via AWS EC2 Identity Document](/ver/16.x/agents/join-services-to-your-cluster/aws-ec2).
</Note>
...
<Note>
  - [Joining Services via Azure Managed Identity](/ver/16.x/agents/join-services-to-your-cluster/azure).
  - [Deploying Machine ID on Azure](/ver/16.x/machine-id/deployment/azure)
</Note>
...
<Note>
  - How to [Join Services with GCP](/ver/16.x/agents/join-services-to-your-cluster/gcp).
  - [Deploying Machine ID on GCP](/ver/16.x/machine-id/deployment/gcp)
</Note>
...
typically used with [Machine ID](/ver/16.x/machine-id/introduction) to access
...
<Note>
  - [Deploying Machine ID on GitHub Actions](/ver/16.x/machine-id/deployment/github-actions)
</Note>

### CircleCI: `circleci`

This join method is typically used with [Machine ID](/ver/16.x/machine-id/introduction)
...
<Note>
  - [Deploying Machine ID on Circle CI](/ver/16.x/machine-id/deployment/circleci)
</Note>
...
This join method is typically used with [MachineID](/ver/16.x/machine-id/introduction)
...
<Note>
  - [Deploying Machine ID on GitLab CI](/ver/16.x/machine-id/deployment/gitlab)
</Note>
...
<Note>
  - [Joining Services via Kubernetes ServiceAccount Token](/ver/16.x/agents/join-services-to-your-cluster/kubernetes)
</Note>
...
<Note>
  - [Deploying Machine ID on Kubernetes](/ver/16.x/machine-id/deployment/kubernetes)
</Note>
