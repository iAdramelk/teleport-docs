...
- [Auth](/ver/16.x/architecture/authentication)
- [Node/SSH](/ver/16.x/architecture/nodes)
- [Proxy](/ver/16.x/architecture/proxy)
- [App](/ver/16.x/application-access/introduction)
- [Database](/ver/16.x/database-access/introduction)
- [Windows Desktop](/ver/16.x/desktop-access/introduction)
- [Kubernetes](/ver/16.x/kubernetes-access/introduction)
...
| `teleport configure`                   | Generates and writes a [configuration YAML file](/ver/16.x/reference/config) for the Teleport service. This file should be customized in production to suit the needs of your environment, and the default output should only be used when testing. |
...
| `teleport start`                       | Starts the `teleport` process in the foreground using the current shell session, including any services configured by the [configuration YAML file](/ver/16.x/reference/config).                                                                    |
...
we recommend using a [configuration file](/ver/16.x/reference/config) in production.
...
| `-r, --roles`          | `proxy`, `node`, `auth`                                 | **string** comma-separated list of `proxy`, `node`, `auth`, `db`, or `app` | start listed services/roles. These roles are explained in the [Core Concepts](/ver/16.x/core-concepts) document.                                                                                                                                              |
...
| `--labels`             | none                                                    | **string** comma-separated list                                            | assigns a set of labels to a node, for example env=dev,app=web. See the explanation of labeling mechanism in the [Labeling Nodes](/ver/16.x/management/admin/labels) section.                                                                                 |
...
| ------------------------------------------------ | --------- | -------------------------------------------------------------------------------------------------------------------------- |
| [Node](/ver/16.x/architecture/nodes)             | `node`    | Allows SSH connections from authenticated clients.                                                                         |
| [Auth](/ver/16.x/architecture/authentication)    | `auth`    | Authenticates and authorizes hosts and users who want access to Teleport-managed resources or information about a cluster. |
| [Proxy](/ver/16.x/architecture/proxy)            | `proxy`   | The gateway that clients use to connect to the Auth Service or resources managed by Teleport.                              |
| [App](/ver/16.x/application-access/introduction) | `app`     | Provides access to applications.                                                                                           |
| [Database](/ver/16.x/database-access/reference)  | `db`      | Provides access to databases.                                                                                              |
