...
<Tip>
  Before continuing, please make sure to take a look at the [Cluster State section](/ver/16.x/architecture/nodes#cluster-state)
...
address of the load balancer in the [`auth_server`](/ver/16.x/reference/config) field when
...
If using the [default configuration](/ver/16.x/reference/networking), configure your load
...
`/readyz` [diagnostics endpoint](/ver/16.x/management/diagnostics/monitoring) on
