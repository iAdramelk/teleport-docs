...
- [Dynamic Impersonation](/ver/16.x/access-controls/guides/impersonation#filter-fields)
- [RBAC for sessions](/ver/16.x/access-controls/reference#rbac-for-sessions)
...
Both the [`tsh`](/ver/16.x/reference/cli/tsh) and [`tctl`](/ver/16.x/reference/cli/tctl) CLI tools allow you to filter nodes,
...
See some [examples](/ver/16.x/reference/cli#filter-examples) of the different ways you can filter resources.
...
[reference page](/ver/16.x/access-controls/reference#label-expressions)
