...
- [Audit Events and Records](/ver/16.x/reference/audit)
- [Forwarding events with Fluentd](/ver/16.x/management/export-audit-events/fluentd)
- [Monitor Teleport Audit Events with the Elastic Stack](/ver/16.x/management/export-audit-events/elastic-stack)
