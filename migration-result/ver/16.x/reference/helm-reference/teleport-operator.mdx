...
See the [Kubernetes Operator for remote Teleport clusters guide](/ver/16.x/management/dynamic-resources/teleport-operator-standalone)
for more details.
...
[Kubernetes JWKS](/ver/16.x/reference/join-methods#kubernetes-jwks) join method.
