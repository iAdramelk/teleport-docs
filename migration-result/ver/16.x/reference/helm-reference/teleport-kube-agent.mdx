...
| ---------------------------------------------------------------- | -------------------------------------- | -------------------------------------------------------------------------------------------- |
| [`kubernetes_service`](/ver/16.x/kubernetes-access/introduction) | `kube`                                 | Uses Teleport to handle authentication<br /> with and proxy access to a Kubernetes cluster   |
| [`application_service`](/ver/16.x/application-access/guides)     | `app`                                  | Uses Teleport to handle authentication<br /> with and proxy access to web-based applications |
| [`database_service`](/ver/16.x/database-access/guides)           | `db`                                   | Uses Teleport to handle authentication<br /> with and proxy access to databases              |
| [`discovery_service`](/ver/16.x/kubernetes-access/discovery)     | `discovery`                            | Uses Teleport to discover new resources<br /> and dynamically add them to the cluster        |
...
See [the join method reference](/ver/16.x/reference/join-methods) for the list of possible
...
When `joinParams.method` is [a delegated join method](/ver/16.x/reference/join-methods#delegated-join-methods),
...
the agent. See [the Teleport Application access documentation](/ver/16.x/application-access/introduction)
for more details.
...
<Tip>
  ...
  Reference](/ver/16.x/application-access/reference#configuration).
</Tip>
...
Application access documentation](/ver/16.x/application-access/introduction)
for more details.
...
<Tip>
  ...
  `tsh` by following [the Dynamic App Registration guide](/ver/16.x/application-access/guides/dynamic-registration).
</Tip>
...
<Note>
  For AWS database auto-discovery to work, your Database Service pods will need to use a role which has appropriate IAM permissions as per the [database documentation](/ver/16.x/database-access/guides/rds#step-36-create-iam-policies-for-teleport).
...
<Note>
  For Azure database auto-discovery to work, your Database Service pods will need to have appropriate IAM permissions as per the [database documentation](/ver/16.x/database-access/guides/azure-postgres-mysql#step-46-configure-iam-permissions-for-teleport).
...
the agent. See [the Teleport Database access documentation](/ver/16.x/database-access/introduction)
for more details.
...
<Tip>
  You can see a list of all the supported [values which can be used in a Teleport database service configuration here](/ver/16.x/database-access/reference/configuration).
</Tip>
...
Database access documentation](/ver/16.x/database-access/introduction)
for more details.
...
<Tip>
  ...
  `tsh` by following [this guide](/ver/16.x/database-access/guides/dynamic-registration).
</Tip>
...
documentation](/ver/16.x/application-access/enroll-kubernetes-applications/architecture)
for more details.
...
<Warning>
  ...
  One option might be to use Teleport's built-in [ACME support](/ver/16.x/reference/helm-reference/teleport-cluster#acme) or enable [cert-manager support](/ver/16.x/reference/helm-reference/teleport-cluster#highavailabilitycertmanager).
</Warning>
...
<Note>
  ...
  For more information on how to set static/dynamic labels for Teleport services, see [labelling nodes and applications](/ver/16.x/management/admin/labels).
</Note>
...
See the [Teleport config file reference](/ver/16.x/reference/config) for
