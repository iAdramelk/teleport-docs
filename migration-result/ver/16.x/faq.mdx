...
look at [Using OpenSSH Guide](/ver/16.x/server-access/guides/openssh).

## Can I connect to nodes behind a firewall?

Yes, Teleport supports reverse SSH tunnels out of the box. To configure
behind-firewall clusters, see [Configure Trusted Clusters](/ver/16.x/management/admin/trustedclusters).
...
See the [Installation](/ver/16.x/installation) guide for details on installing to specific platforms
...
[Adding Nodes to the
Cluster](/ver/16.x/agents/join-services-to-your-cluster/join-token).
...
Yes, Teleport supports [Headless WebAuthn authentication](/ver/16.x/access-controls/guides/headless),
...
| ----------------------------------------------------------------------------- | ----------- | ---------------------------------------------- | ---------------------------------------------- | ---------------- |
| [Access Requests](/ver/16.x/access-controls/guides/dual-authz)                | Limited     | ✔                                              | ✔                                              | ✖                |
| [Single Sign-On](/ver/16.x/access-controls/sso)                               | GitHub      | GitHub, Google Workspace, OIDC, SAML, Teleport | GitHub, Google Workspace, OIDC, SAML, Teleport | GitHub, Teleport |
| [Role-Based Access Control](/ver/16.x/access-controls/guides/role-templates)  | ✔           | ✔                                              | ✔                                              | ✔                |
| [Moderated Sessions](/ver/16.x/access-controls/guides/moderated-sessions)     | ✖           | ✔                                              | ✔                                              | ✖                |
| [Device Trust](/ver/16.x/access-controls/device-trust/guide)                  | ✖           | ✔                                              | ✔                                              | ✖                |
| [Dual Authorization](/ver/16.x/access-controls/guides/dual-authz)             | ✖           | ✔                                              | ✔                                              | ✖                |
| [Hardware Key Support](/ver/16.x/access-controls/guides/hardware-key-support) | ✖           | ✔                                              | ✔                                              | ✖                |

### Infrastructure access

|                                                                                      | Open Source | Enterprise | Cloud | Team |
| ------------------------------------------------------------------------------------ | ----------- | ---------- | ----- | ---- |
| [Application Access](/ver/16.x/application-access/getting-started)                   | ✔           | ✔          | ✔     | ✔    |
| [Server Access](/ver/16.x/server-access/getting-started)                             | ✔           | ✔          | ✔     | ✔    |
| [Database Access](/ver/16.x/database-access/getting-started)                         | ✔           | ✔          | ✔     | ✔    |
| [Desktop Access](/ver/16.x/desktop-access/introduction)                              | ✔           | ✔          | ✔     | ✔    |
| [Kubernetes Access](/ver/16.x/kubernetes-access/getting-started)                     | ✔           | ✔          | ✔     | ✔    |
| [Machine ID](/ver/16.x/machine-id/getting-started)                                   | ✔           | ✔          | ✔     | ✔    |
| Agentless Integration with [OpenSSH Servers](/ver/16.x/server-access/guides/openssh) | ✔           | ✔          | ✔     | ✔    |

### Audit logging and session recording

|                                                                                    | Open Source | Enterprise | Cloud | Team |
| ---------------------------------------------------------------------------------- | ----------- | ---------- | ----- | ---- |
| [Structured Audit Logs](/ver/16.x/reference/audit)                                 | ✔           | ✔          | ✔     | ✔    |
| [Session Recording with Playback](/ver/16.x/architecture/session-recording)        | ✔           | ✔          | ✔     | ✔    |
| [Recording Proxy Mode](/ver/16.x/server-access/guides/recording-proxy-mode)        | ✔           | ✔          | ✖     | ✖    |
| [Enhanced Session Recording](/ver/16.x/server-access/guides/bpf-session-recording) | ✔           | ✔          | ✔     | ✔    |

### Compliance

|                                                                            | Open Source | Enterprise | Cloud | Team    |
| -------------------------------------------------------------------------- | ----------- | ---------- | ----- | ------- |
| [FedRAMP Control](/ver/16.x/access-controls/compliance-frameworks/fedramp) | ✖           | ✔          | ✖     | ✖       |
...
| [Hardware Security Module support](/ver/16.x/choose-an-edition/teleport-enterprise/hsm) for encryption at rest | ✖                                                                                                  | ✔                                                                                                 | ✖                                                                                                             | ✖                                                                                                             |
...
Please refer to our [Networking](/ver/16.x/reference/networking) guide.

## Does Teleport support authentication via OIDC, SAML, or Active Directory?

Teleport offers this feature for the [Enterprise Cloud](/ver/16.x/choose-an-edition/teleport-cloud/introduction) and [Enterprise](/ver/16.x/choose-an-edition/teleport-enterprise/introduction) versions of Teleport.
...
[CLI Reference](/ver/16.x/reference/cli/tctl#tctl-alerts-list).
...
For more details, see the [Usage Reporting and Billing](/ver/16.x/usage-billing)
guide.
...
If you no longer want to send usage data, see [disabling telemetry](/ver/16.x/connect-your-client/teleport-connect#disabling-telemetry).
