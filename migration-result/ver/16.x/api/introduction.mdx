...
programatically interact with the API. [tsh and tctl](/ver/16.x/reference/cli) use
the same API.

Here is what you can do with the Go Client:

- Integrate with external tools, e.g., to write an [Access Request
  plugin](/ver/16.x/access-controls/access-request-plugins/index). Teleport
...
Guide](/ver/16.x/api/getting-started).
...
- [Automatically Register Teleport Agents](/ver/16.x/api/automatically-register-agents):
  Write a Teleport API client to reconcile the resources in your Teleport
  cluster with an external service discovery API.
- [Automatically generate Teleport roles](/ver/16.x/api/rbac) from an external RBAC
  system, making it easier to get started with Teleport-based RBAC and keep your
  Teleport roles up to date.
- [Write an Access Request Plugin](/ver/16.x/api/access-plugin): Follow this guide for a
