...
clusters](/ver/16.x/kubernetes-access/discovery) in AWS, Azure, and Google Cloud,
as well as [servers](/ver/16.x/server-access/guides/ec2-discovery) on Amazon EC2.
