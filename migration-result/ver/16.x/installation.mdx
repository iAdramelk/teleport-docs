...
See our [Upgrading](/ver/16.x/upgrading) guide for more information.
...
[Using Teleport Connect](/ver/16.x/connect-your-client/teleport-connect) for usage and installation*.
...
| ---------------------------------------------------------------------------------- | ------------- | ------------------------ | -------- | ----------- | ---------------------- | -------------- |
| [Enhanced Session Recording](/ver/16.x/server-access/guides/bpf-session-recording) | Kernel  v5.8+ | 11, or 10 with backports | 20.04.2+ | 9+          | 2 (post 11/2021), 2023 | 12 SP5, 15 SP5 |
...
<Tabs>
  ...
  <Tab title="Teleport Enterprise Cloud">
    Check the [Cloud Downloads](/ver/16.x/choose-an-edition/teleport-cloud/downloads) page for the most up-to-date
...
See the Teleport [Configuration Reference](/ver/16.x/reference/config) for whether a
...
Reference](/ver/16.x/reference/networking#ports) for the ports on your Teleport
container to expose.
...
method](/ver/16.x/agents/join-services-to-your-cluster/join-token).
...
See the [AWS Single-Instance Deployment](/ver/16.x/deploy-a-cluster/deployments/aws-starter-cluster-terraform)
and the [Running Teleport Enterprise in High Availability mode on AWS using Terraform](/ver/16.x/deploy-a-cluster/deployments/aws-ha-autoscale-cluster-terraform)
...
| --------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `teleport-cluster`    | Auth Service<br />Proxy Service<br />Other Teleport services if using a custom configuration | [Reference](/ver/16.x/reference/helm-reference/teleport-cluster)    |
| `teleport-kube-agent` | Kubernetes Service<br />Application Service<br />Database Service                            | [Reference](/ver/16.x/reference/helm-reference/teleport-kube-agent) |
  ...
  <Tab title="Community/Team">
    <Tabs>
      ...
      <Tab title="Homebrew">
        ...
        [compatibility policy](/ver/16.x/upgrading) for details.
...
If you wish to uninstall Teleport at any time, see our documentation on [Uninstalling Teleport](/ver/16.x/management/admin/uninstall-teleport).
...
- [Server Access](/ver/16.x/server-access/introduction)
- [Kubernetes Access](/ver/16.x/kubernetes-access/introduction)
- [Database Access](/ver/16.x/database-access/introduction)
- [Application Access](/ver/16.x/application-access/introduction)
- [Desktop Access](/ver/16.x/desktop-access/introduction)
