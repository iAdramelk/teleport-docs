...
- [AWS](/ver/16.x/kubernetes-access/discovery/aws): Discovery for AWS EKS clusters.
- [Azure](/ver/16.x/kubernetes-access/discovery/azure): Discovery for Azure AKS clusters.
- [Google Cloud](/ver/16.x/kubernetes-access/discovery/google-cloud): Discovery for
