...
Guides](/ver/16.x/deploy-a-cluster/helm-deployments).
...
Guide](/ver/16.x/kubernetes-access/getting-started).
...
[Read our overview](/ver/16.x/kubernetes-access/discovery) of how Teleport automatically discovers
Kubernetes clusters.

Read our guides to automatically registering Kubernetes clusters with Teleport
on your cloud:

- [AWS](/ver/16.x/kubernetes-access/discovery/aws)
- [Google Cloud](/ver/16.x/kubernetes-access/discovery/google-cloud)
- [Azure](/ver/16.x/kubernetes-access/discovery/azure)
...
- [Deploy the Teleport Kubernetes
  Service with IAM Joining](/ver/16.x/kubernetes-access/register-clusters/iam-joining) on your cluster of
  choice.
- Deploy the Teleport Kubernetes Service outside your Kubernetes cluster (e.g.,
  ...
  kubeconfig](/ver/16.x/kubernetes-access/register-clusters/static-kubeconfig).
- Deploy the Teleport Kubernetes Service outside of Kubernetes  and [use dynamic
  configuration resources](/ver/16.x/kubernetes-access/register-clusters/dynamic-registration) to
...
Read our [Kubernetes RBAC guide](/ver/16.x/kubernetes-access/manage-access/rbac) for step-by-step
...
Reference](/ver/16.x/kubernetes-access/controls).

See how to federate your Kubernetes access controls using [Teleport Trusted
Clusters](/ver/16.x/kubernetes-access/manage-access/federation).
