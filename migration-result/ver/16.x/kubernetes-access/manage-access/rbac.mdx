...
the Kubernetes [Access Controls Guide](/ver/16.x/kubernetes-access/controls). You can leave your
...
Requests](/ver/16.x/access-controls/access-requests/resource-requests)
for just-in-time access and [Access Request
plugins](/ver/16.x/access-controls/access-request-plugins/index) so you can manage
