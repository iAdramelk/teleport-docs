...
Read our guides to how [authorization](/ver/16.x/architecture/authorization) and
[authentication](/ver/16.x/architecture/authentication) work in Teleport.
...
works](/ver/16.x/architecture/proxy).
...
in our [CLI Reference](/ver/16.x/reference/cli/teleport).
...
Service](/ver/16.x/application-access/introduction).
...
Service](/ver/16.x/database-access/introduction).
...
Service](/ver/16.x/desktop-access/introduction).
...
Service](/ver/16.x/kubernetes-access/introduction)
...
Read more about the [Teleport SSH Service](/ver/16.x/server-access/introduction).
...
Read more in our [Machine ID guide](/ver/16.x/machine-id/introduction).
...
edition in [Choose an edition](/ver/16.x/choose-an-edition/introduction).
...
guide](/ver/16.x/choose-an-edition/teleport-cloud/introduction).
...
guide](/ver/16.x/choose-an-edition/teleport-enterprise/introduction).
...
Read more in our [resource reference](/ver/16.x/reference/resources).
...
Read our [guide to Teleport roles](/ver/16.x/access-controls/guides/role-templates).
...
Read more about [local users](/ver/16.x/reference/authentication) and how [SSO
authentication works in Teleport](/ver/16.x/access-controls/sso).
...
See our guide to [Authentication Options](/ver/16.x/reference/authentication).
...
see [Configure Trusted Clusters](/ver/16.x/management/admin/trustedclusters).
For an overview of the architecture used in a trusted cluster relationship, see
[Trusted Cluster Architecture](/ver/16.x/architecture/trustedclusters).
