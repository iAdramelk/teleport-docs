...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [`teleport join openssh`](/ver/16.x/server-access/guides/openssh/openssh)), you must specify the `sshd` port
...
For more information about Teleport authentication, see [Authentication options](/ver/16.x/reference/authentication).
...
- [CLI Reference](/ver/16.x/reference/cli/tsh#tsh-puttyconfig).
