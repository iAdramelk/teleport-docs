...
follow [the guide for Helm-deployed clusters](/ver/16.x/management/dynamic-resources/teleport-operator-helm).

If you are hosting Teleport out of Kubernetes (Teleport Cloud, Terraform, ...),
follow [the standalone operator guide](/ver/16.x/management/dynamic-resources/teleport-operator-standalone).
...
Check out [access controls documentation](/ver/16.x/access-controls/introduction)
