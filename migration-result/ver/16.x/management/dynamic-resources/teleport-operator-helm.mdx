...
<Warning>
  ...
  [the standalone operator guide](/ver/16.x/management/dynamic-resources/teleport-operator-standalone) instead.
</Warning>
...
Helm Chart parameters are documented in the [`teleport-cluster` Helm chart reference](/ver/16.x/reference/helm-reference/teleport-cluster).

See the [Helm Deployment guides](/ver/16.x/deploy-a-cluster/helm-deployments) detailing specific setups like running Teleport on AWS or GCP.
