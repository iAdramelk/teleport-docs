...
and Machine ID](/ver/16.x/machine-id/deployment/spacelift).
...
[(Machine ID)](/ver/16.x/machine-id/introduction) to generate credentials.
...
using Machine ID, see the [Machine ID Getting Started Guide](/ver/16.x/machine-id/getting-started).
...
- Explore the full list of supported [Terraform provider resources](/ver/16.x/reference/terraform-provider).
- Read more about [impersonation](/ver/16.x/access-controls/guides/impersonation).
