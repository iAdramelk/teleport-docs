...
using a [join token](/ver/16.x/agents/join-services-to-your-cluster/join-token), each
...
How the [Teleport Certificate Authority](/ver/16.x/architecture/authentication) works.
