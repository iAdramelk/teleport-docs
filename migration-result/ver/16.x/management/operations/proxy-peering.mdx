...
An existing Teleport Enterprise cluster. See [introduction to Teleport Enterprise](/ver/16.x/choose-an-edition/teleport-enterprise/introduction) to get started.
