...
As you learned in [Add Labels to Resources](/ver/16.x/management/admin/labels), labels enable you to group, filter, and control access to
...
[Storage backends](/ver/16.x/reference/backends)
