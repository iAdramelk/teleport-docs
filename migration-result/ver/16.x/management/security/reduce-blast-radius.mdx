...
- [Per-session MFA](/ver/16.x/access-controls/guides/per-session-mfa)
- [Dual authorization](/ver/16.x/access-controls/guides/dual-authz)
- [Role templates, allow/deny rules, and traits](/ver/16.x/access-controls/guides/role-templates)
- [Access Requests](/ver/16.x/access-controls/access-requests)

### Background reading

- [Authentication connectors](/ver/16.x/reference/authentication)
- [Proxy Service](/ver/16.x/architecture/proxy)
- [Auth Service](/ver/16.x/architecture/authentication)
