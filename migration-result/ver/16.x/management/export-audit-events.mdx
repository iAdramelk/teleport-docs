...
with Fluentd](/ver/16.x/management/export-audit-events/fluentd) to learn the basics of how our
...
- [Export Teleport Audit Events with
  Datadog](/ver/16.x/management/export-audit-events/datadog): Learn how to configure the Event
...
- [Monitor Teleport Audit Events with the Elastic
  Stack](/ver/16.x/management/export-audit-events/elastic-stack): How to configure the Event
...
- [Monitor Teleport Audit Events with Splunk](/ver/16.x/management/export-audit-events/splunk):
