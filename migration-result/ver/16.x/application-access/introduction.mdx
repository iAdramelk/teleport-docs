...
guide](/ver/16.x/application-access/getting-started).
...
- [AWS Console and CLI Applications](/ver/16.x/application-access/cloud-apis/aws-console): How to access
  AWS Management Console, AWS CLI, and AWS SDKs with Teleport.
- [Google Cloud CLI Applications](/ver/16.x/application-access/cloud-apis/google-cloud): How to access
  Google Cloud CLI applications and SDKs with Teleport.
- [Azure CLI Applications](/ver/16.x/application-access/cloud-apis/azure): How to access Azure CLI
...
- [Web App Access](/ver/16.x/application-access/guides/connecting-apps): How to access web apps with Teleport.
- [TCP App Access](/ver/16.x/application-access/guides/tcp): How to access plain TCP apps with Teleport.
- [API Access](/ver/16.x/application-access/guides/api-access): How to access REST APIs with Teleport.
- [Dynamic Registration](/ver/16.x/application-access/guides/dynamic-registration): Register/unregister apps without restarting Teleport.
...
Teleport cluster automatically](/ver/16.x/application-access/enroll-kubernetes-applications).
...
- [Introduction](/ver/16.x/application-access/jwt/introduction): Introduction to JWT tokens with application access.
- [Elasticsearch](/ver/16.x/application-access/jwt/elasticsearch): How to use JWT authentication with Elasticsearch.
...
Learn more about the [Teleport Okta integration](/ver/16.x/application-access/okta).
