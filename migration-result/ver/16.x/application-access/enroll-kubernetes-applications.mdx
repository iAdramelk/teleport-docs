...
- [Get started](/ver/16.x/application-access/enroll-kubernetes-applications/get-started): Set up automatic
  application discovery with the `teleport-kube-agent` Helm chart.
- [Architecture](/ver/16.x/application-access/enroll-kubernetes-applications/architecture): Learn how
  automatic application discovery works.
- [Reference](/ver/16.x/application-access/enroll-kubernetes-applications/reference): Consult this guide
