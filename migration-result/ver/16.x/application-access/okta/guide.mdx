...
to the application [Access Controls](/ver/16.x/application-access/controls) and update your roles to match the
...
- Learn more about [accessing APIs](/ver/16.x/application-access/guides/api-access) with the Teleport
  Application Service.
- Take a look at application-related [Access Controls](/ver/16.x/application-access/controls).
