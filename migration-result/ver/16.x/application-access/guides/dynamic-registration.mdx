...
instances](/ver/16.x/agents/deploy-agents-terraform). And behind the scenes, the
Teleport Discovery Service uses dynamic registration to [register Kubernetes
applications](/ver/16.x/application-access/enroll-kubernetes-applications).
...
See the full app resource spec [reference](/ver/16.x/application-access/reference#application-resource).
