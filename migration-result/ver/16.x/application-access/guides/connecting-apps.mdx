...
and follow the installation [instructions](/ver/16.x/installation).
...
[role templates](/ver/16.x/access-controls/guides/role-templates). In the
...
[Integrating with JWTs](/ver/16.x/application-access/jwt/introduction) for more details.
