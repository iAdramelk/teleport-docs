...
<Warning>
  ...
  [integration](/ver/16.x/application-access/cloud-apis/aws-console) with the AWS management console and
  ...
  DynamoDB](/ver/16.x/database-access/guides/aws-dynamodb) guide.
