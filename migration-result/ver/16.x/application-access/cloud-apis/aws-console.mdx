...
<Accordion title="Configuring aws_role_arns">
  ...
  Reference](/ver/16.x/access-controls/reference#template-expressions-for-access-to-infrastructure-resources)
...
- Take a closer look at [role-based access controls](/ver/16.x/application-access/controls).
- Explore other application access [guides](/ver/16.x/application-access/guides).
