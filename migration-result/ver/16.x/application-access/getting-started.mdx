...
<Tabs>
  <Tab title="Docker">
    Select a Teleport edition, then follow the [Installation](/ver/16.x/installation) instructions
...
- [Connecting applications](/ver/16.x/application-access/guides/connecting-apps).
- Integrating with [JWT tokens](/ver/16.x/application-access/jwt/introduction).
- Accessing applications with [RESTful APIs](/ver/16.x/application-access/guides/api-access).
- Setting configuration options AND running CLI commands in the [Application Access reference](/ver/16.x/application-access/reference).
