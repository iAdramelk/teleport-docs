...
- Running [Application Service](/ver/16.x/application-access/guides/connecting-apps).
...
<Tip>
  You can also use [dynamic registration](/ver/16.x/application-access/guides/dynamic-registration).
</Tip>
...
- Get more information about integrating with [Teleport JWT tokens](/ver/16.x/application-access/jwt/introduction).
