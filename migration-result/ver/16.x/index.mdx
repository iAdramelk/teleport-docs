...
Team](/ver/16.x/choose-an-edition/teleport-team).
...
<Tip>
  ...
  use [host user creation](/ver/16.x/server-access/guides/host-user-creation).
...
Terraform](/ver/16.x/agents/deploy-agents-terraform) to get started.
