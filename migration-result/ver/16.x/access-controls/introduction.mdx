...
After [deploying a Teleport cluster](/ver/16.x/deploy-a-cluster/introduction), the
...
- SREs can access a production server only when using a [trusted hardware
  device](/ver/16.x/access-controls/device-trust/guide).
...
Started](/ver/16.x/access-controls/getting-started) guide.
...
See the [Cluster Access and RBAC](/ver/16.x/access-controls/guides) section for instructions on
...
Read our [Single Sign-On guide](/ver/16.x/access-controls/sso) to get started.
...
[Get started with Access Requests](/ver/16.x/access-controls/access-requests).
...
[Get started with Access Request plugins](/ver/16.x/access-controls/access-request-plugins/index).
...
- [FedRAMP](/ver/16.x/access-controls/compliance-frameworks/fedramp)
- [SOC 2](/ver/16.x/access-controls/compliance-frameworks/soc2)
