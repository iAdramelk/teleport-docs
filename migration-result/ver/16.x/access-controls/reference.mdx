...
- [Custom API clients](/ver/16.x/api/rbac)

To read more about managing dynamic resources, see the [Dynamic
Resources](/ver/16.x/management/dynamic-resources) guide.
...
| `record_session`             | Defines the [Session recording mode](/ver/16.x/reference/audit#modes).                                                                                                                                                                                                                                                                            | The strictest value takes precedence.                                                                                                                                                                                                      |
...
explicitly set. Additionally, roles `v5` or `v6` are required to use [Moderated Sessions](/ver/16.x/access-controls/guides/moderated-sessions).
...
fine-grained control over Kubernetes resources. See [Kubernetes RBAC](/ver/16.x/kubernetes-access/manage-access/rbac) for more details.
...
This works by [labeling resources](/ver/16.x/management/admin/labels) and
...
Check out our
[predicate language](/ver/16.x/reference/predicate-language#label-expressions)
...
[shared sessions](/ver/16.x/connect-your-client/tsh#sharing-sessions) and
[session recordings](/ver/16.x/architecture/nodes#ssh-session-recording).
...
Read the [predicate
language](/ver/16.x/reference/predicate-language#scoping-allowdeny-rules-in-role-resources)
guide for a more in depth explanation of the language.

## Second Factor - U2F

Refer to the [Second Factor - WebAuthn](/ver/16.x/access-controls/guides/webauthn#u2f) guide if you
