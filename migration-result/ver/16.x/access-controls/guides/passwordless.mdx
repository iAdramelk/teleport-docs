...
- Teleport must be configured for WebAuthn. See the [Second Factor:
  WebAuthn](/ver/16.x/access-controls/guides/webauthn) guide.
...
- A signed and notarized version of `tsh` is required for Touch ID. This precludes
  versions installed from Homebrew. [Download the macOS tsh installer](/ver/16.x/installation#macos).
...
[installation page](/ver/16.x/installation).
...
standalone version of `tsh`. [Download the macOS tsh installer](/ver/16.x/installation#macos).
