...
[integrate with many other providers](/ver/16.x/access-controls/access-requests).

<Warning>
  This guide requires a commercial edition of Teleport. The open source edition of
  Teleport only supports [GitHub](/ver/16.x/access-controls/sso/github-sso) as an
  SSO provider.
</Warning>
...
<Tabs>
  <Tab title="Download">
    ```code
    $ curl -L https://get.gravitational.com/teleport-access-mattermost-v15.0.0-dev-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-mattermost-v15.0.0-dev-linux-amd64-bin.tar.gz
