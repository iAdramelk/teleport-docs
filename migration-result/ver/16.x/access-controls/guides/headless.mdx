...
- A v12.2+ Teleport cluster with WebAuthn configured.
  See the [Second Factor: WebAuthn](/ver/16.x/access-controls/guides/webauthn) guide.
- WebAuthn hardware device, such as YubiKey.
- Machines for Headless WebAuthn activities have [Linux](/ver/16.x/installation#linux), [macOS](/ver/16.x/installation#macos) or [Windows](/ver/16.x/installation#windows-tsh-client-only) `tsh` binary v12.2+ installed.
