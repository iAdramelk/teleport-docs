...
- Follow the [Teleport operator guides](/ver/16.x/management/dynamic-resources/teleport-operator)
...
- Read the [Teleport Operator Guide](/ver/16.x/management/dynamic-resources/teleport-operator) to
