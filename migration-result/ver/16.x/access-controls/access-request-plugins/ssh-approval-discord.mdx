...
![The Discord Access Request plugin](../../../../../assets/discord-3c16613a07.png)
...
<Tabs>
  <Tab title="Download">
    ...
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-discord-v13.3.7-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-discord-v13.3.7-linux-amd64-bin.tar.gz
    ...
    teleport-discord v13.3.7 git:teleport-discord-v13.3.7-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    teleport-discord v13.3.7 git:teleport-discord-v13.3.7-api/14.0.0-gd1e081e 1.21
    ```
...
<Tabs>
  <Tab title="Executable">
    ...
    ```code
    $ teleport-discord start
    INFO   Starting Teleport Access Discord Plugin 15.0.0-dev: discord/app.go:80
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker run -v <path-to-config>:/etc/teleport-discord.toml public.ecr.aws/gravitational/teleport-plugin-discord:15.0.0-dev start
    ```
  </Tab>
