...
![The Microsoft Teams Access Request plugin](../../../../../assets/msteams-c50df8bb2f.png)
...
[deployment guide](/ver/16.x/machine-id/deployment) to run the `tbot` binary on
your infrastructure.
...
<Tabs>
  <Tab title="Download">
    ...
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-msteams-v13.3.7-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-msteams-v13.3.7-linux-amd64-bin.tar.gz
    ...
    teleport-msteams v13.3.7 git:teleport-msteams-v13.3.7-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    teleport-msteams v13.3.7 git:teleport-msteams-v13.3.7-api/14.0.0-gd1e081e 1.21
    ```
...
<Tabs>
  ...
  <Tab title="Long-lived identity files">
    ...
    <Accordion title="Certificate Lifetime">
      ...
      ID](/ver/16.x/machine-id/introduction) to programmatically issue and renew
      certificates for your plugin. See our Machine ID [getting started
      guide](/ver/16.x/machine-id/getting-started) to learn more.
...
![Create Azure Bot](../../../../../assets/create-azure-bot-cdf8b721c5.png)
...
![Add Bot Channel](../../../../../assets/add-bot-channel-2b432bf182.png)
...
![Manage Bot App](../../../../../assets/manage-bot-app-7cd51d56e7.png)
...
![Specify App Permissions](../../../../../assets/specify-app-permissions-6bdfb670ce.png)

Once permissions have been approved, refresh the page and check the approval status.
The result should be as follows:

![Granted App Permissions](../../../../../assets/granted-app-permissions-839a0def31.png)
...
![Copy Teams Channel](../../../../../assets/copy-teams-channel-9c0f76c322.png)
...
![Upload Teams App](../../../../../assets/upload-teams-app-23d60bd430.png)
...
![Upload Teams App](../../../../../assets/allowed-teams-app-92414f5f7e.png)
...
![Add Teams App](../../../../../assets/add-teams-app-92607f7ce7.png)
...
```text
teleport-msteams v13.3.7 go1.21
...
![Validate Bot Message](../../../../../assets/validate-bot-message-a3b391c86b.png)
...
<Tabs>
  <Tab title="Executable">
    ...
    INFO   Starting Teleport MS Teams Plugin 13.3.7: msteams/app.go:74
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker run -v <path-to-config>:/etc/teleport-msteams.toml public.ecr.aws/gravitational/teleport-plugin-msteams:15.0.0-dev start
    ```
  </Tab>
...
- Read our guides to configuring [Resource Access
  Requests](/ver/16.x/access-controls/access-requests/resource-requests) and [Role Access
  Requests](/ver/16.x/access-controls/access-requests/role-requests) so you can get the most out
