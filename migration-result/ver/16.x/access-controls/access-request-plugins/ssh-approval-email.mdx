...
![The email Access Request plugin](../../../../../assets/email-a1dfa0ad44.png)
...
<Tabs>
  <Tab title="Download">
    ...
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-email-v13.3.7-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-email-v13.3.7-linux-amd64-bin.tar.gz
    ...
    teleport-email v13.3.7 git:teleport-email-v13.3.7-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    teleport-email v13.3.7 git:teleport-email-v13.3.7-api/14.0.0-gd1e081e 1.21
    ```
...
<Tabs>
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker run -v <path-to-config>:/etc/teleport-email.toml public.ecr.aws/gravitational/teleport-plugin-email:15.0.0-dev start
    ```
  </Tab>
