...
![The Mattermost Access Request plugin](../../../../../assets/diagram-b0b077f65b.png)
...
<Tabs>
  <Tab title="Download">
    ...
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-mattermost-v13.3.7-linux-amd64-bin.tar.gz
    ...
    teleport-mattermost v13.3.7 git:teleport-mattermost-v13.3.7-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    teleport-mattermost v13.3.7 git:teleport-mattermost-v13.3.7-api/14.0.0-gd1e081e 1.21
    ```
...
<Tabs>
  ...
  <Tab title="Docker">
    ...
    ```bash
    $ docker run -v <path-to-config>:/etc/teleport-mattermost.toml public.ecr.aws/gravitational/teleport-plugin-mattermost:15.0.0-dev start
    ```
  </Tab>
