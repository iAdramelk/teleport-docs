...
![PagerDuty plugin architecture](../../../../../assets/diagram-03bb7cc003.png)
...
<Tabs>
  <Tab title="Download">
    ...
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-pagerduty-v13.3.7-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-pagerduty-v13.3.7-linux-amd64-bin.tar.gz
    ...
    teleport-pagerduty v13.3.7 git:teleport-pagerduty-v13.3.7-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    teleport-pagerduty v13.3.7 git:teleport-pagerduty-v13.3.7-api/14.0.0-gd1e081e 1.21
    ```
...
![Create an API
key](../../../../../assets/pagerduty-integrations-9ae3d64cf4.png)
...
<Tabs>
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker run -v <path-to-config>:/etc/teleport-pagerduty.toml public.ecr.aws/gravitational/teleport-plugin-pagerduty:15.0.0-dev start
    ```
  </Tab>
...
Request](../../../../../assets/new-access-req-incident-150a94087d.png)
