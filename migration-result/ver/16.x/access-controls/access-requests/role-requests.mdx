...
[Resource Access Requests Guide](/ver/16.x/access-controls/access-requests/resource-requests).
...
See the [Access Request Configuration](/ver/16.x/access-controls/access-requests/access-request-configuration) guide
...
[documentation](/ver/16.x/access-controls/access-lists).
