...
- [Role requests in commercial Teleport editions](/ver/16.x/access-controls/access-requests/role-requests)
- [Resource requests in commercial Teleport editions](/ver/16.x/access-controls/access-requests/resource-requests)
- [Role requests in Teleport Community Edition](/ver/16.x/access-controls/access-requests/oss-role-requests)
...
Templates](/ver/16.x/access-controls/guides/role-templates#templating-in-access-requests) for more
...
1. Calculate the maximum duration of elevated privileges if the Access Request
   ...
   - The `--max-duration` flag of the [`tsh request
     create`](/ver/16.x/reference/cli/tsh#tsh-request-create) command (if the
...
2. Calculate the session TTL of the certificate the user would receive if
   ...
   - The requested session expiration time, which is the value of the
     ...
     create`](/ver/16.x/reference/cli/tsh#tsh-request-create).
...
[`tsh request create`](/ver/16.x/reference/cli/tsh#tsh-request-create) and [`tsh request
review`](/ver/16.x/reference/cli/tsh#tsh-request-review) commands. The format accepted
...
1. Begin with with the base expiration of the Access Request, which a user can
   ...
   create`](/ver/16.x/reference/cli/tsh#tsh-request-create) command. If this is
...
language](/ver/16.x/reference/predicate-language).
...
If you [write your own Access Request plugin](/ver/16.x/api/access-plugin), the
