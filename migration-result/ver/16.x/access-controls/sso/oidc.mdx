...
<Tip>
  For Google Workspace, see [Teleport Authentication with Google Workspace](/ver/16.x/access-controls/sso/google-workspace)
</Tip>
...
commands](/ver/16.x/reference/resources) or the Teleport Web UI.
...
oidc](/ver/16.x/reference/cli/tctl#tctl-sso-configure-oidc) section of the Teleport CLI
Reference page.
