...
<Tabs>
  ...
  <Tab title="Teleport Enterprise Cloud">
    ...
    - The Enterprise `tctl` admin tool and `tsh` client tool version >= 14.3.3.
      To download these tools, visit the [Downloads](/ver/16.x/choose-an-edition/teleport-cloud/downloads) page.
...
<Tip>
  Teleport supports device synchronization with [Jamf Pro](/ver/16.x/access-controls/device-trust/jamf-integration). Once configured, devices
...
- A device must be registered. Registration may be
  ...
  integration, like the [Jamf Pro integration](/ver/16.x/access-controls/device-trust/jamf-integration).
...
- [Device Trust Enforcement](/ver/16.x/access-controls/device-trust/enforcing-device-trust)
