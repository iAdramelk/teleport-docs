...
<Tip>
  ...
  [device management guide](/ver/16.x/access-controls/device-trust/device-management#register-a-trusted-device)
</Tip>
...
- [Enforcing Device Trust](/ver/16.x/access-controls/device-trust/enforcing-device-trust)
