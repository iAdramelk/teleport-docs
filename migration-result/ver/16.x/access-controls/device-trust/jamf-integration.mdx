...
See the [Device Trust guide](/ver/16.x/access-controls/device-trust) for fundamental Device Trust concepts
and behavior.
...
- To enroll a macOS device, you need:
  - A signed and notarized `tsh` binary, v12.0.0 or newer.
    [Download the macOS tsh installer](/ver/16.x/installation#macos).
- To enroll a Windows device, you need:
  ...
  - `tsh` v13.1.2 or newer. [Download the Windows tsh installer](/ver/16.x/installation#windows-tsh-client-only).
- To enroll a Linux device, you need:
  ...
  - `tsh` v15.0.0 or newer. [Install tsh for Linux](/ver/16.x/installation#linux).
...
2. Create a new Standard Account with the following settings:
   ...
   User account setup: ![Jamf user setup](../../../../../assets/jamf-setup-1-1befa868d6.png)

   Privileges setup: ![Jamf privileges setup](../../../../../assets/jamf-setup-2-4212d9e613.png)
...
<Tip>
  ...
  <Accordion title="Configure Jamf hosted plugin">
    ...
    ![Select Jamf plugin](../../../../../assets/select-jamf-739a18480c.png)
    Fill in the required information and click "Connect Jamf" button:
    ![Configure Jamf plugin](../../../../../assets/hosted-jamf-8796805fa4.png)
  </Accordion>
</Tip>
...
[auto-enrollment](/ver/16.x/access-controls/device-trust/device-management#auto-enrollment).
