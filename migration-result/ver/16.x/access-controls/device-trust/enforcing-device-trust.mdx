...
works similarly to [`require_session_mfa`](/ver/16.x/access-controls/guides/per-session-mfa).
...
<Tip>
  ...
  clusters](/ver/16.x/management/admin/trustedclusters) to limit the impact of
...
be accessed using tsh commands such as [tsh proxy app](/ver/16.x/reference/cli/tsh#tsh-proxy-app) or using the certificates issued by
...
Similar to [session and identity locking](/ver/16.x/access-controls/guides/locking), a device can
...
device. [Download the macOS tsh installer](/ver/16.x/installation#macos) to fix
the problem.
...
Teleport as such. Follow the [registration](/ver/16.x/access-controls/device-trust/device-management#register-a-trusted-device) and
[enrollment](/ver/16.x/access-controls/device-trust/device-management#enroll-a-trusted-device) steps
...
[App Access support](/ver/16.x/access-controls/device-trust/enforcing-device-trust#app-access-support).
...
- [Device Management](/ver/16.x/access-controls/device-trust/device-management)
- [Jamf Pro Integration](/ver/16.x/access-controls/device-trust/jamf-integration)
