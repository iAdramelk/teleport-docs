...
- RBAC and resource filtering based on [dynamically updated labels](/ver/16.x/management/admin/labels)
- [Session recording without SSH connection termination](/ver/16.x/server-access/guides/recording-proxy-mode)
- [Session sharing](/ver/16.x/connect-your-client/tsh)
- [Advanced session recording](/ver/16.x/server-access/guides/bpf-session-recording)
- [Restricting outbound network connections in SSH sessions](/ver/16.x/server-access/guides/restricted-session)
...
<Tip>
  ...
  an option, you can [register your node manually instead](/ver/16.x/server-access/guides/openssh/openssh-manual-install).
</Tip>
