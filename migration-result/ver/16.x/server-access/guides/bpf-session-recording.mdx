...
Teleport's default [SSH and Kubernetes session recording](/ver/16.x/architecture/nodes#ssh-session-recording)
...
<Tip>
  ...
  [Teleport Nodes](/ver/16.x/architecture/nodes#ssh-session-recording) for more
  details.
</Tip>
...
- Read more about
  [session recording](/ver/16.x/architecture/nodes#ssh-session-recording).
- See all configuration options for Enhanced Session Recording in our
  [Configuration Reference](/ver/16.x/reference/config).
