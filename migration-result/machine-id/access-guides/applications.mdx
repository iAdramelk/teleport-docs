...
- If you have not already connected your application to Teleport, follow
  the [Application Access Getting Started Guide](/application-access/getting-started).
...
- Review the [Access Controls Reference](/access-controls/reference)
  to learn about restricting which Applications and other Teleport resources
  your bot may access.
- Configure [JWTs](/application-access/jwt/introduction) for your
