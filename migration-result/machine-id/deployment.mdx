...
guide](/machine-id/deployment/linux) is compatible with most platforms. For
custom approaches, you can also read the [Machine ID Reference](/machine-id/reference)
and [Architecture](/machine-id/architecture) to plan your deployment.
...
| ----------------------------------------------- | ----------------------------------------------- | --------------------------------------------------- |
| [Linux](/machine-id/deployment/linux)           | Package manager or TAR archive                  | Static join token                                   |
| [GCP](/machine-id/deployment/gcp)               | Package manager, TAR archive, or Kubernetes pod | Identity document signed by GCP                     |
| [AWS](/machine-id/deployment/aws)               | Package manager, TAR archive, or Kubernetes pod | Identity document signed by AWS                     |
| [Azure](/machine-id/deployment/azure)           | Package manager or TAR archive                  | Identity document signed by Azure                   |
| [Kubernetes](/machine-id/deployment/kubernetes) | Kubernetes pod                                  | Identity document signed by your Kubernetes cluster |
...
| Platform                                                | Installation method                                           | Join method                       |
| ------------------------------------------------------- | ------------------------------------------------------------- | --------------------------------- |
| [CircleCI](/machine-id/deployment/circleci)             | TAR archive                                                   | CircleCI-signed identity document |
| [GitLab](/machine-id/deployment/gitlab)                 | TAR archive                                                   | GitLab-signed identity document   |
| [GitHub Actions](/machine-id/deployment/github-actions) | Teleport job available through the GitHub Actions marketplace | GitHub-signed identity document.  |
| [Jenkins](/machine-id/deployment/jenkins)               | Package manager or TAR archive                                | Static join token                 |
