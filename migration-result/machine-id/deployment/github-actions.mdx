...
[GitHub Actions reference page.](/machine-id/reference/github-actions#github-join-token)
...
- For more information about the `github` join method, read the [GitHub Actions
  reference page](/machine-id/reference/github-actions#github-join-token)
- Find out more about GitHub Actions itself, read
  [their documentation](https://docs.github.com/en/actions).
- [More information about `anonymous-telemetry`.](/machine-id/reference/telemetry)
