...
<Accordion title="Using another join method">
  ...
  - Google Kubernetes Engine: Where
    ...
    See the [GCP Platform Guide](/machine-id/deployment/gcp) for further information.
  - AWS Elastic Kubernetes Service: Where
    ...
    See the [AWS Platform Guide](/machine-id/deployment/aws) for further information.
</Accordion>
...
Follow one of the [access guides](/machine-id/access-guides) to configure an output
...
- Follow the [access guides](/machine-id/access-guides) to finish configuring `tbot` for
  your environment.
- Read the [configuration reference](/machine-id/reference/configuration) to explore
