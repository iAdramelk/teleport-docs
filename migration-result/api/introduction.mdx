...
programatically interact with the API. [tsh and tctl](/reference/cli) use
the same API.

Here is what you can do with the Go Client:

- Integrate with external tools, e.g., to write an [Access Request
  plugin](/access-controls/access-request-plugins/index). Teleport
