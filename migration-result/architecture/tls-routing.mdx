...
In TLS routing mode [Teleport proxy](/architecture/proxy) multiplexes all client
...
See the [OpenSSH client](/server-access/guides/openssh) guide for details on
how it's configured.
...
See [GUI clients](/connect-your-client/gui-clients) guide for a usage
example.
...
- See [migration guide](/management/operations/tls-routing) to learn how to
