...
<Tip>
  ...
  For those cases, Teleport Proxy can terminate live connections using [session and identity locking](/access-controls/guides/locking).
</Tip>
...
[short-lived tokens or cloud identity services](/agents/join-services-to-your-cluster/join-token).
...
Take a look at the [Certificate Rotation Guide](/management/operations/ca-rotation) to
...
<Tip>
  ...
  cluster certificates, use node [session and identity locking](/access-controls/guides/locking).
</Tip>
