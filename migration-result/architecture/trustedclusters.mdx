...
- See how Teleport uses [Certificates](/architecture/authentication) for authentication.
- Reduce your surface of attack using [TLS routing](/architecture/tls-routing).
- Follow our [guide](/management/admin/trustedclusters) to set up trusted clusters.
