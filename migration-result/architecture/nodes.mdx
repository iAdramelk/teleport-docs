...
- [OpenSSH: `ssh`](/server-access/guides/openssh)
- [Teleport CLI client: `tsh ssh`](/reference/cli/tsh#tsh-ssh)
- [Teleport Proxy UI](/architecture/proxy) accessed via a web browser.
...
See the [reference](/reference/audit#recorded-sessions) to learn how to turn
...
- [Teleport Authentication](/architecture/authentication)
- [Teleport Authorization](/architecture/authorization)
- [Teleport Proxy](/architecture/proxy)
