...
- The Teleport Database Service configured to access a database. See one of our
  [guides](/docs/database-access/guides) for how to set up the Teleport
  ...
  <Tab title="Self-Hosted">
    <Tabs>
      ...
      <Tab title="TLS routing">
        If you're using Teleport in [TLS routing](/docs/management/operations/tls-routing)
...
[Get connection information](/docs/connect-your-client/gui-clients#get-connection-information)).
...
[Get connection information](/docs/connect-your-client/gui-clients#get-connection-information) for
more information.)
...
section on [Get connection information](/docs/connect-your-client/gui-clients#get-connection-information)
...
instead of `localhost`. (See [Get connection information](/docs/connect-your-client/gui-clients#get-connection-information) for
more information.)
