...
<Tabs>
  <Tab title="Mac">
    ...
    ```bash
    $ curl -O https://cdn.teleport.dev/tsh-15.0.2.pkg
    ```
  </Tab>
  ...
  <Tab title="Mac - Homebrew">
    ...
    <Note>
      ...
      versions. See our [compatibility policy](/docs/upgrading/overview) for details.
    </Note>
  </Tab>

  <Tab title="Windows - Powershell">
    ```bash
    $ curl.exe -O https://cdn.teleport.dev/teleport-v15.0.2-windows-amd64-bin.zip
  ...
  <Tab title="Linux">
    ...
    $ tar -xzf teleport-v15.0.2-linux-amd64-bin.tar.gz
    $ cd teleport
    $ sudo ./install
