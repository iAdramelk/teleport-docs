...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [`teleport join openssh`](/docs/server-access/openssh/openssh)), you must specify the `sshd` port
...
For more information about Teleport authentication, see [Authentication options](/docs/reference/authentication).
...
- [CLI Reference](/docs/reference/cli/tsh#tsh-puttyconfig).
