...
look at [Using OpenSSH Guide](/docs/ver/16.x/server-access/openssh/openssh).

## Can I connect to nodes behind a firewall?

Yes, Teleport supports reverse SSH tunnels out of the box. To configure
behind-firewall clusters, see [Configure Trusted Clusters](/docs/ver/16.x/management/admin/trustedclusters).
...
See the [Installation](/docs/ver/16.x/installation) guide for details on installing to specific platforms
...
[Adding Nodes to the
Cluster](/docs/ver/16.x/agents/join-services-to-your-cluster/join-token).
...
Yes, Teleport supports [Headless WebAuthn authentication](/docs/ver/16.x/access-controls/guides/headless),
...
Please refer to our [Networking](/docs/ver/16.x/reference/networking) guide.

## Does Teleport support authentication via OIDC, SAML, or Active Directory?

Teleport offers this feature for the [Enterprise Cloud](/docs/ver/16.x/choose-an-edition/teleport-cloud/introduction) and [Enterprise](/docs/ver/16.x/choose-an-edition/teleport-enterprise/introduction) versions of Teleport.

## Does Teleport support provisioning users via SCIM?

Teleport supports [SCIM](https://scim.cloud/) provisioning for Okta via the
hosted Okta integration, available in the [Enterprise Cloud](/docs/ver/16.x/choose-an-edition/teleport-cloud/introduction)
and [Enterprise](/docs/ver/16.x/choose-an-edition/teleport-enterprise/introduction) versions
of Teleport.

Refer to the [hosted Okta integration guide](/docs/ver/16.x/application-access/okta/hosted-guide)
...
[CLI Reference](/docs/ver/16.x/reference/cli/tctl#tctl-alerts-list).
...
For more details, see the [Usage Reporting and Billing](/docs/ver/16.x/usage-billing)
guide.
...
The full list of events and collected data is defined as [protocol buffer messages in the Teleport source](https://github.com/gravitational/teleport/tree/branch/v16/proto/prehog/v1alpha/connect.proto).
...
If you no longer want to send usage data, see [disabling telemetry](/docs/ver/16.x/connect-your-client/teleport-connect#disabling-telemetry).
