...
See the [Automatic User Provisioning](/docs/ver/16.x/database-access/rbac/configuring-access) guide for how to configure Teleport to create accounts for your PostgreSQL users on demand.
...
- Check out configuration [guides](/docs/ver/16.x/database-access/guides).
- Learn how to configure [GUI clients](/docs/ver/16.x/connect-your-client/gui-clients).
- Learn about database access [role-based access control](/docs/ver/16.x/database-access/rbac).
- See [frequently asked questions](/docs/ver/16.x/database-access/faq).
