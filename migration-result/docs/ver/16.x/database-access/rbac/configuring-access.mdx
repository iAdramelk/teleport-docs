...
For a more general description of Teleport roles and examples see [RBAC](/docs/ver/16.x/access-controls/introduction), as
...
sign-on](/docs/ver/16.x/access-controls/sso) providers. For OIDC, they will be
