...
<Tabs>
  <Tab title="Self-Hosted">
    - [Teleport Proxy Service](/docs/ver/16.x/architecture/proxy). A stateless service
  ...
  <Tab title="Teleport Enterprise Cloud">
    - [Teleport Proxy Service](/docs/ver/16.x/architecture/proxy). A stateless service that performs
...
- [Teleport Auth Service](/docs/ver/16.x/architecture/authentication). Serves as
...
1. A user logs into the cluster with `tsh login` command and retrieves
   a client certificate. See [Issuing User Certificates](/docs/ver/16.x/architecture/authentication)
...
of the secrets. See [GUI Clients](/docs/ver/16.x/connect-your-client/gui-clients) for details.
...
See respective [guides](/docs/ver/16.x/database-access/guides) for details on configuring client
...
See respective [guides](/docs/ver/16.x/database-access/guides) for details on configuring IAM/AD
authentication.
...
See [Core Concepts](/docs/ver/16.x/core-concepts) for general Teleport
