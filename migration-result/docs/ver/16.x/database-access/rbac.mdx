...
Read the [RBAC](/docs/ver/16.x/database-access/rbac/configuring-access) guide to get a general understanding
of how to configure Teleport roles to grant or deny access to your database users.

The [Automatic User Provisioning](/docs/ver/16.x/database-access/auto-user-provisioning) guides explain
