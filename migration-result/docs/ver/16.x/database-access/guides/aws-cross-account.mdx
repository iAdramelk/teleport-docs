...
<Note>
  ...
  [how to connect your database](/docs/ver/16.x/database-access/guides#how-to-connect-your-database-to-teleport).
</Note>
...
<Tabs>
  ...
  <Tab title="Dynamic Config">
    ...
    resources, see: [Dynamic Registration](/docs/ver/16.x/database-access/guides/dynamic-registration).
  </Tab>
</Tabs>
