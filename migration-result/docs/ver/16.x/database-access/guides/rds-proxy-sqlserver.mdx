...
<Note>
  ...
  [PostgreSQL](/docs/ver/16.x/database-access/guides/rds-proxy-postgres),
  [MariaDB/MySQL](/docs/ver/16.x/database-access/guides/rds-proxy-postgres) or
  [Microsoft SQL Server](/docs/ver/16.x/database-access/guides/rds-proxy-sqlserver).
</Note>
