...
Service instances for [high availability](/docs/ver/16.x/database-access/guides/ha) by configuring Database
...
See the full database resource spec [reference](/docs/ver/16.x/database-access/reference/configuration#database-resource).
...
- [AWS Discovery](/docs/ver/16.x/database-access/guides/aws-discovery)
- [Terraform Provider](/docs/ver/16.x/management/dynamic-resources/terraform-provider)
- [Kubernetes Operator](/docs/ver/16.x/management/dynamic-resources/teleport-operator)
- [Teleport API](/docs/ver/16.x/api/introduction)

See [Using Dynamic Resources](/docs/ver/16.x/management/dynamic-resources) to learn
