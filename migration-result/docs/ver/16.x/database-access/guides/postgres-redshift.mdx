...
- A running Teleport Discovery Service if you plan to use [Database
  Auto-Discovery](/docs/ver/16.x/database-access/guides/aws-discovery).
...
<Accordion title="Method 1: Organize IAM roles with &#x22;assume_role_arn&#x22;">
  ...
  <Tabs>
    <Tab title="Auto-Discovery by Discovery Service">
      ...
      <Tip>
        ...
        labels](/docs/ver/16.x/database-access/reference/labels#auto-discovery)
  ...
  Access](/docs/ver/16.x/database-access/guides/aws-cross-account).
</Accordion>
...
<Accordion title="Method 3: Separate Database Services">
  ...
  configuration](/docs/ver/16.x/database-access/guides/ha) where databases can be
