...
<Tabs>
  <Tab title="Self-Hosted">
        <img src="/assets/cloudsql_selfhosted-a8827f6109.png" alt="Teleport Database Access CloudSQL Self-Hosted" width="1354" height="600" />
  </Tab>

  <Tab title="Teleport Enterprise Cloud">
        <img src="/assets/cloudsql_cloud-8fde563c0b.png" alt="Teleport Database Access CloudSQL Cloud" width="1354" height="600" />
  </Tab>
</Tabs>
...
<img src="/assets/iam-new-instance@2x-4cb09a7e14.png" alt="Enable IAM Authentication" width="517" height="290" />
...
<img src="/assets/iam-existing-instance@2x-3885af8ec4.png" alt="Check IAM Authentication" width="276" height="80" />
...
<img src="/assets/service-account-db@2x-cafb725c49.png" alt="Create Service Account" width="531" height="536" />
...
<img src="/assets/service-account-db-grant@2x-74e98d4aed.png" alt="Grant Cloud SQL Instance User to Service Account" width="532" height="557" />
...
<img src="/assets/add-user-account@2x-95a26569e6.png" alt="Add Cloud SQL User Account" width="531" height="382" />

Press "Add" and your Users table should look similar to this:

<img src="/assets/user-accounts@2x-efa6079ce3.png" alt="Cloud SQL User Accounts Table" width="514" height="447" />
...
<img src="/assets/service-account-db-service@2x-e1b164a4cb.png" alt="Create Service Account" width="532" height="536" />
...
<img src="/assets/service-account-db-service-grant@2x-37a61f6313.png" alt="Grant Service Account Token Creator to Service Account" width="527" height="520" />
...
<img src="/assets/service-account-keys@2x-e1ddc54e71.png" alt="Service Account Keys" width="539" height="313" />

Make sure to choose JSON format:

<img src="/assets/service-account-new-key@2x-2990843e34.png" alt="Service Account New Key" width="538" height="335" />
...
<img src="/assets/instance-id@2x-8605898b78.png" alt="Instance ID" width="154" height="94" />
...
<img src="/assets/instance-public-ip@2x-e518dac4bf.png" alt="Instance Public IP" width="794" height="236" />
...
<img src="/assets/instance-root-ca@2x-2466edcc40.png" alt="Instance Root Certificate" width="518" height="369" />
