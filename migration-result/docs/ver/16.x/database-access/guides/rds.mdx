...
Access](/docs/ver/16.x/database-access/introduction). This allows for
fine-grain access control through [Teleport's RBAC](/docs/ver/16.x/database-access/rbac).
...
- Set up [automatic database user provisioning](/docs/ver/16.x/database-access/auto-user-provisioning).
