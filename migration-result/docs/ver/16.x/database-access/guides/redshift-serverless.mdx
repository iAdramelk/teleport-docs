...
<Tabs>
  <Tab title="Self-Hosted">
        <img src="/assets/redshift_selfhosted_serverless-2c3901f693.png" alt="Teleport Database Access Redshift Self-Hosted" width="1412" height="571" />
  </Tab>

  <Tab title="Teleport Enterprise Cloud">
        <img src="/assets/redshift_cloud_serverless-3ab477fe91.png" alt="Teleport Database Access Redshift Cloud" width="1412" height="571" />
  </Tab>
</Tabs>
  ...
  <Tab title="Local User">
    ...
    2. Edit your local user to add the new role:
       ...
       $ tctl users update $(tsh status -f json | jq -r '.active.username') \
         --set-roles "${ROLES?},redshift-serverless-access"
       ```
