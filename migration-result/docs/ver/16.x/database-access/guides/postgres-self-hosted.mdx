...
<Tabs>
  <Tab title="Self-Hosted">
        <img src="/assets/postgresqlselfhosted_selfhosted-3b552817c9.png" alt="Teleport Database Access PostgreSQL Self-Hosted" width="1178" height="483" />
  </Tab>

  <Tab title="Teleport Enterprise Cloud">
        <img src="/assets/postgresqlselfhosted_cloud-b94b08bd79.png" alt="Teleport Database Access PostgreSQL Cloud" width="1178" height="483" />
  </Tab>
</Tabs>
...
[RBAC](/docs/ver/16.x/database-access/rbac) section for more details.
...
- Set up [automatic database user provisioning](/docs/ver/16.x/database-access/auto-user-provisioning/postgres).
