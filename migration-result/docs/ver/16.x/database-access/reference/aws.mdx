...
bootstrap`](/docs/ver/16.x/database-access/reference/cli#teleport-db-configure-bootstrap)
...
manually using a [static configuration](/docs/ver/16.x/database-access/reference/configuration) or
[`tctl`](/docs/ver/16.x/database-access/guides/dynamic-registration) and manage IAM yourself, example
...
<Accordion title="Example IAM policy document">
  ```json
  {
     "Version": "2012-10-17",
     "Statement": [
