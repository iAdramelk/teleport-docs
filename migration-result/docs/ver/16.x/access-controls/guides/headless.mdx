...
- A v12.2+ Teleport cluster with WebAuthn configured.
  See the [Second Factor: WebAuthn](/docs/ver/16.x/access-controls/guides/webauthn) guide.
- WebAuthn hardware device, such as YubiKey.
- Machines for Headless WebAuthn activities have [Linux](/docs/ver/16.x/installation#linux), [macOS](/docs/ver/16.x/installation#macos) or [Windows](/docs/ver/16.x/installation#windows-tsh-client-only) `tsh` binary v12.2+ installed.
- Machines used to approve Headless WebAuthn requests have a Web browser with [WebAuthn support](https://developers.yubico.com/WebAuthn/WebAuthn_Browser_Support/) or `tsh` binary v12.2+ installed.
...
<Accordion title="Optional: make Headless WebAuthn the default auth connector">
...
<Accordion title="Alternative: disable Headless WebAuthn">
...
<img src="/assets/confirmation-efe4a36a06.png" alt="Headless Confirmation" width="1170" height="663" />

You will be prompted to tap your MFA key to complete the approval process.

<img src="/assets/approval-dea571a1c5.png" alt="Headless WebAuthn Approval" width="1170" height="663" />
