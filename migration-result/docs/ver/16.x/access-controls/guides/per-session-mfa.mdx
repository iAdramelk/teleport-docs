...
<Note>
  ...
  users](/docs/ver/16.x/reference/authentication#local-no-authentication-connector)
  to improve security.
</Note>
...
- [WebAuthn configured](/docs/ver/16.x/access-controls/guides/webauthn) on this cluster
