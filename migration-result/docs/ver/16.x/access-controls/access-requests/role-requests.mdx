...
[Resource Access Requests Guide](/docs/ver/16.x/access-controls/access-requests/resource-requests).
...
See the [Access Request Configuration](/docs/ver/16.x/access-controls/access-requests/access-request-configuration) guide
...
[documentation](/docs/ver/16.x/access-controls/access-lists).
