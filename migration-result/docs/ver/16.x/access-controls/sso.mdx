...
- [Azure Active Directory (AD)](/docs/ver/16.x/access-controls/sso/azuread): Configure Azure Active Directory SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Active Directory (ADFS)](/docs/ver/16.x/access-controls/sso/adfs): Configure Windows Active Directory SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Google Workspace](/docs/ver/16.x/access-controls/sso/google-workspace): Configure Google Workspace SSO for SSH, Kubernetes, databases, desktops and web apps.
- [GitHub](/docs/ver/16.x/access-controls/sso/github-sso): Configure GitHub SSO for SSH,
  Kubernetes, databases, desktops, and web apps.
- [GitLab](/docs/ver/16.x/access-controls/sso/gitlab): Configure GitLab SSO for SSH, Kubernetes, databases, desktops and web apps.
- [OneLogin](/docs/ver/16.x/access-controls/sso/one-login): Configure OneLogin SSO for SSH, Kubernetes, databases, desktops and web apps.
- [OIDC](/docs/ver/16.x/access-controls/sso/oidc): Configure OIDC SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Okta](/docs/ver/16.x/access-controls/sso/okta): Configure Okta SSO for SSH, Kubernetes, databases, desktops and web apps.
...
- `adfs` (SAML): Required for compatibility with Active Directory (ADFS); refer
  to the full [ADFS guide](/docs/ver/16.x/access-controls/sso/adfs#step-23-create-teleport-roles) for details.
- `netiq` (OIDC): Used to enable NetIQ-specific ACR value processing; refer to
  the [OIDC guide](/docs/ver/16.x/access-controls/sso/oidc#optional-acr-values) for details.
...
as described in the [Resources Reference](/docs/ver/16.x/reference/resources).
...
- [SSH Authentication with Okta](/docs/ver/16.x/access-controls/sso/okta)
- [SSH Authentication with OneLogin](/docs/ver/16.x/access-controls/sso/one-login)
- [SSH Authentication with ADFS](/docs/ver/16.x/access-controls/sso/adfs)
- [SSH Authentication with OAuth2 / OpenID Connect](/docs/ver/16.x/access-controls/sso/oidc)
