...
<Note>
  The [Terraform provider guide](/docs/ver/16.x/management/dynamic-resources/terraform-provider)
...
- Read the [Terraform Guide](/docs/ver/16.x/management/dynamic-resources/terraform-provider) to
