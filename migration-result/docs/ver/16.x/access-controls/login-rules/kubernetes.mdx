...
- Follow the [Teleport operator guides](/docs/ver/16.x/management/dynamic-resources/teleport-operator)
...
- Read the [Teleport Operator Guide](/docs/ver/16.x/management/dynamic-resources/teleport-operator) to
  learn more about the Teleport Operator.
- Read the [Login Rules reference](/docs/ver/16.x/access-controls/login-rules/reference) to learn mode about the
