...
- When you have multiple [Role Templates](/docs/ver/16.x/access-controls/guides/role-templates) repeating
...
Check out the [Login Rules guide](/docs/ver/16.x/access-controls/login-rules/guide) for a quick walkthrough
that will show you how to write, test, and add the first Login Rule to your
cluster. See [example Login Rules](/docs/ver/16.x/access-controls/login-rules/guide#example-login-rules) to
learn how to address common use cases.

When you're ready to take full advantage of Login Rules in your cluster, see the
[Login Rules Reference](/docs/ver/16.x/access-controls/login-rules/reference) for details on the expression
