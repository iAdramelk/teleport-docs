...
- [Custom API clients](/docs/ver/16.x/api/rbac)

To read more about managing dynamic resources, see the [Dynamic
Resources](/docs/ver/16.x/management/dynamic-resources) guide.
...
| `record_session`             | Defines the [Session recording mode](/docs/ver/16.x/reference/audit#modes).                                                                                                                                                                                                                                                                            | The strictest value takes precedence.                                                                                                                                                                                                      |
...
explicitly set. Additionally, roles `v5` or `v6` are required to use [Moderated Sessions](/docs/ver/16.x/access-controls/guides/moderated-sessions).
...
fine-grained control over Kubernetes resources. See [Kubernetes RBAC](/docs/ver/16.x/kubernetes-access/manage-access/rbac) for more details.
...
This works by [labeling resources](/docs/ver/16.x/management/admin/labels) and
...
Check out our
[predicate language](/docs/ver/16.x/reference/predicate-language#label-expressions)
...
[shared sessions](/docs/ver/16.x/connect-your-client/tsh#sharing-sessions) and
[session recordings](/docs/ver/16.x/architecture/nodes#ssh-session-recording).
...
Read the [predicate
language](/docs/ver/16.x/reference/predicate-language#scoping-allowdeny-rules-in-role-resources)
guide for a more in depth explanation of the language.

## Second Factor - U2F

Refer to the [Second Factor - WebAuthn](/docs/ver/16.x/access-controls/guides/webauthn#u2f) guide if you
