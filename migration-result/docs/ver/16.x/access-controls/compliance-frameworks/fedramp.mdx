...
```code
$ curl https://cdn.teleport.dev/teleport-ent-16.0.0-dev-linux-$SYSTEM_ARCH-fips-bin.tar.gz.sha256
<checksum> <filename>
$ curl -O https://cdn.teleport.dev/teleport-ent-16.0.0-dev-linux-$SYSTEM_ARCH-fips-bin.tar.gz

# Verify that the checksums match
$ shasum -a 256 teleport-ent-16.0.0-dev-linux-$SYSTEM_ARCH-fips-bin.tar.gz

$ tar -xvf teleport-ent-16.0.0-dev-linux-$SYSTEM_ARCH-fips-bin.tar.gz
$ cd teleport-ent
$ sudo ./install
```
...
```code
$ teleport version
Teleport Enterprise 16.0.0-dev api/14.0.0-gd1e081e 1.22 X:boringcrypto
```
...
Download the `systemd` service unit file from the [examples directory](https://github.com/gravitational/teleport/tree/branch/v16/examples/systemd/fips)
