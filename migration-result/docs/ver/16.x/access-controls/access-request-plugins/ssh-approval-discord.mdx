...
<Tabs>
  <Tab title="Executable">
    ...
    ```code
    $ teleport-discord start
    INFO   Starting Teleport Access Discord Plugin 16.0.0-dev: discord/app.go:80
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker run -v <path-to-config>:/etc/teleport-discord.toml public.ecr.aws/gravitational/teleport-plugin-discord:16.0.0-dev start
    ```
  </Tab>
