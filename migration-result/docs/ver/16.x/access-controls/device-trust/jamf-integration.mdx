...
See the [Device Trust guide](/docs/ver/16.x/access-controls/device-trust) for fundamental Device Trust concepts
and behavior.
...
[auto-enrollment](/docs/ver/16.x/access-controls/device-trust/device-management#auto-enrollment).
