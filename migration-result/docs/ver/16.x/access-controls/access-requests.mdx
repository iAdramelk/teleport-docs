...
consider [Access Lists](/docs/ver/16.x/access-controls/access-lists).
...
[Get started with Role Access Requests](/docs/ver/16.x/access-controls/access-requests/role-requests).
...
[Get started with Resource Access Requests](/docs/ver/16.x/access-controls/access-requests/resource-requests).
...
Configuration](/docs/ver/16.x/access-controls/access-requests/access-request-configuration) guide for an
...
Edition, see [Teleport Community Access Requests](/docs/ver/16.x/access-controls/access-requests/oss-role-requests).
