...
See [the Standalone Operator guide](/docs/ver/16.x/management/dynamic-resources/teleport-operator-standalone)
...
[setup guide](/docs/ver/16.x/desktop-access/active-directory-manual#enable-remotefx).
...
[instructions](/docs/ver/16.x/installation).
...
- [https://gallery.ecr.aws/gravitational/teleport-distroless](https://gallery.ecr.aws/gravitational/teleport-distroless)
- [https://gallery.ecr.aws/gravitational/teleport-ent-distroless](https://gallery.ecr.aws/gravitational/teleport-ent-distroless)
...
- [https://gallery.ecr.aws/gravitational/teleport-distroless-debug](https://gallery.ecr.aws/gravitational/teleport-distroless-debug)
- [https://gallery.ecr.aws/gravitational/teleport-ent-distroless-debug](https://gallery.ecr.aws/gravitational/teleport-ent-distroless-debug)
...
Teleport-provided Amazon Linux 2023 previously only supported x86\_64/amd64.
...
See the documentation [here](/docs/ver/16.x/reference/backends#athena).
...
You can find existing access lists documentation [here](/docs/ver/16.x/access-controls/access-lists/guide).
...
See documentation [here](/docs/ver/16.x/application-access/enroll-kubernetes-applications).
...
resources](/docs/ver/16.x/kubernetes-access/controls#kubernetes_resources).
...
See how to connect ClickHouse to Teleport [here](/docs/ver/16.x/database-access/guides/clickhouse-self-hosted).
...
See documentation on how to configure it in the [Oracle guide](/docs/ver/16.x/database-access/guides/oracle-self-hosted).
...
For more information on using Teleport with local Windows users, see [docs](/docs/ver/16.x/desktop-access/getting-started).
...
For more information, see [docs](/docs/ver/16.x/connect-your-client/putty-winscp).
...
For more information, see [docs](/docs/ver/16.x/machine-id/reference/configuration#kubernetes_secret).
...
the cluster. Follow the updated agentless OpenSSH integration [guide](/docs/ver/16.x/server-access/openssh/openssh)
...
See more details in our [documentation](/docs/ver/16.x/management/security/proxy-protocol).
...
using [header rewriting](/docs/ver/16.x/application-access/jwt/introduction#inject-jwt).
...
You can review role versions in the [documentation](/docs/ver/16.x/access-controls/reference#role-versions).
...
For more details and guidance on how to upgrade to v2, see [docs](/docs/ver/16.x/machine-id/reference/v14-upgrade-guide).
...
guide](/docs/ver/16.x/server-access/openssh/openssh).
...
guide](/docs/ver/16.x/deploy-a-cluster/helm-deployments/migration-v12).
...
follow
the [migration guide](/docs/ver/16.x/deploy-a-cluster/helm-deployments/migration-v12).
...
[documentation](/docs/ver/16.x/machine-id/deployment/github-actions) for using
...
[documentation](/docs/ver/16.x/access-controls/guides/hardware-key-support):
...
- [VS Code](/docs/ver/16.x/server-access/guides/vscode)
- [JetBrains](/docs/ver/16.x/server-access/guides/jetbrains-sftp)
...
guide](/docs/ver/16.x/database-access/guides/azure-postgres-mysql) for more
details.
...
images](/docs/ver/16.x/installation#docker).
...
[install Teleport](/docs/ver/16.x/installation#linux).
...
See the [documentation](/docs/ver/16.x/access-controls/guides/passwordless).
...
[documentation](/docs/ver/16.x/server-access/guides/host-user-creation).
...
Refer to [the guide](/docs/ver/16.x/database-access/guides/sql-server-ad) to set
...
[documentation](/docs/ver/16.x/database-access/guides/snowflake).
...
Learn more about it in the [documentation](/docs/ver/16.x/database-access/guides/redis-aws).
...
[documentation](/docs/ver/16.x/machine-id/access-guides/databases).
...
[documentation](/docs/ver/16.x/upgrading).
...
Refer to the
[documentation](/docs/ver/16.x/reference/networking#http-connect-proxies)
for more details.
...
instructions](/docs/ver/16.x/server-access/getting-started#step-14-install-teleport-on-your-linux-host).
...
guide](/docs/ver/16.x/access-controls/guides/moderated-sessions) for more
details.
...
documentation](/docs/ver/16.x/reference/backends) for more information.
...
configuration](/docs/ver/16.x/desktop-access/getting-started) to force Windows
...
See the [documentation](/docs/ver/16.x/reference/backends) for more information.
...
[Machine ID getting started guide](/docs/ver/16.x/machine-id/getting-started)
...
[Self-hosted Redis guide](/docs/ver/16.x/database-access/guides/redis)
...
[SQL Server guide](/docs/ver/16.x/database-access/guides/sql-server-ad)
...
[Updated RDS guide](/docs/ver/16.x/database-access/guides/rds)
...
- [`teleport db configure
  create`](/docs/ver/16.x/database-access/reference/cli#teleport-db-configure-create)
- [`teleport db configure bootstrap`](/docs/ver/16.x/database-access/reference/cli#teleport-db-configure-bootstrap)
...
[Moderated Sessions guide](/docs/ver/16.x/access-controls/guides/moderated-sessions)
...
[Getting Started Guide](/docs/ver/16.x/desktop-access/getting-started).
...
[documentation](/docs/ver/16.x/application-access/cloud-apis/aws-console).
...
[apps](/docs/ver/16.x/application-access/guides/dynamic-registration)
and
[databases](/docs/ver/16.x/database-access/guides/dynamic-registration).
...
See updated
[RDS guide](/docs/ver/16.x/database-access/guides/rds) for
more information.
...
View the [database access with MongoDB](/docs/ver/16.x/database-access/guides/mongodb-self-hosted) for more details.
...
View the Cloud SQL MySQL [guide](/docs/ver/16.x/database-access/guides/mysql-cloudsql) for more details.
...
Teleport application access can now automatically sign users into the AWS Management Console using [Identity federation](https://aws.amazon.com/identity/federation). View AWS Management Console [guide](/docs/ver/16.x/application-access/cloud-apis/aws-console) for more details.
...
View the [database access with Redshift on AWS guide](/docs/ver/16.x/database-access/guides/postgres-redshift) for more details.
...
MFA](/docs/ver/16.x/access-controls/guides/per-session-mfa) documentation or
[RFD
...
We have implemented [database access](/docs/ver/16.x/database-access/introduction),
...
Configure database access following the [Getting Started](/docs/ver/16.x/database-access/introduction#getting-started) guide.

##### Guides

- [AWS RDS/Aurora PostgreSQL](/docs/ver/16.x/database-access/guides/rds)
- [AWS RDS/Aurora MySQL](/docs/ver/16.x/database-access/guides/rds)
- [Self-hosted PostgreSQL](/docs/ver/16.x/database-access/guides/postgres-self-hosted)
- [Self-hosted MySQL](/docs/ver/16.x/database-access/guides/mysql-self-hosted)
- [GUI clients](/docs/ver/16.x/connect-your-client/gui-clients)

##### Resources

To learn more about configuring role-based access control for database access, check out the [RBAC](/docs/ver/16.x/database-access/introduction) section.

[Architecture](/docs/ver/16.x/database-access/introduction) provides a more in-depth look at database access internals such as networking and security.

See [Reference](/docs/ver/16.x/database-access/reference) for an overview of database access related configuration and CLI commands.

Finally, check out [Frequently Asked Questions](/docs/ver/16.x/database-access/faq).
...
Please follow our [standard upgrade procedure](/docs/ver/16.x/management/admin) to upgrade your cluster.
...
You can learn more in the [Application Access introduction](/docs/ver/16.x/application-access/introduction).
...
Learn more about [Teleport's RBAC Resources](/docs/ver/16.x/access-controls/introduction)

##### Cluster Labels

Teleport 5.0 also adds the ability to set labels on Trusted Clusters. The labels are set when creating a trusted cluster invite token. This lets teams use the same RBAC controls used on nodes to approve or deny access to clusters. This can be especially useful for MSPs that connect hundreds of customers' clusters - when combined with Access Workflows, cluster access can easily be delegated. Learn more by reviewing our [Truster Cluster Setup & RBAC Docs](/docs/ver/16.x/management/admin/trustedclusters)
...
- We've added a Waiting Room for customers using Access Workflows. [Docs](/docs/ver/16.x/access-controls/access-request-plugins/index)
...
We've added an [API Guide](/docs/ver/16.x/api/introduction) to simply developing applications against Teleport.

#### Upgrade Notes

Please follow our [standard upgrade procedure](/docs/ver/16.x/upgrading).
...
procedure](/docs/ver/16.x/upgrading).
...
Teleport 4.3 introduces four new plugins that work out of the box with [Approval Workflow](/docs/ver/16.x/access-controls/access-request-plugins/index). These plugins allow you to automatically support role escalation with commonly used third party services. The built-in plugins are listed below.

- [PagerDuty](/docs/ver/16.x/access-controls/access-request-plugins/ssh-approval-pagerduty)
- [Jira](/docs/ver/16.x/access-controls/access-request-plugins/ssh-approval-jira)
- [Slack](/docs/ver/16.x/access-controls/access-request-plugins/ssh-approval-slack)
- [Mattermost](/docs/ver/16.x/access-controls/access-request-plugins/ssh-approval-mattermost)
...
procedure](/docs/ver/16.x/upgrading) to upgrade to this version.
...
docs](/docs/ver/16.x/management/operations/ca-rotation).
...
permissions](/docs/ver/16.x/kubernetes-access/manage-access/rbac).

##### Path prefix for etcd

The [etcd backend](/docs/ver/16.x/reference/backends#etcd) now correctly uses
...
[upgrade guidance](/docs/ver/16.x/upgrading).

**Note: If you use an etcd backend with a non-default prefix and need to downgrade from 4.3 to 4.2, you should [backup Teleport data and restore it](/docs/ver/16.x/management/operations/backup-restore) into the downgraded cluster.**
...
- Alpha: Workflows API lets admins escalate RBAC roles in response to user requests. [Read the docs](/docs/ver/16.x/access-controls/access-requests). [#3006](https://github.com/gravitational/teleport/issues/3006)
- Beta: Teleport provides HA Support using Firestore and Google Cloud Storage using Google Cloud Platform. [Read the docs](/docs/ver/16.x/deploy-a-cluster/deployments/gcp). [#2821](https://github.com/gravitational/teleport/pull/2821)
- Remote tctl execution is now possible. [Read the docs](/docs/ver/16.x/reference/cli/tctl). [#1525](https://github.com/gravitational/teleport/issues/1525) [#2991](https://github.com/gravitational/teleport/issues/2991)
...
- Adopting root/leaf terminology for trusted clusters. [Trusted cluster documentation](/docs/ver/16.x/management/admin/trustedclusters).
- Documented Teleport FedRAMP & FIPS Support. [FedRAMP & FIPS documentation](/docs/ver/16.x/access-controls/compliance-frameworks/fedramp).
...
- Teleport now support 10,000 remote connections to a single Teleport cluster. [Using our recommend hardware setup.](/docs/ver/16.x/management/operations/scaling#hardware-recommendations)
...
Teleport 4.0 is backwards compatible with Teleport 3.2 and later. [Follow the recommended upgrade procedure to upgrade to this version.](/docs/ver/16.x/upgrading)
...
procedure](/docs/ver/16.x/upgrading) to upgrade to this
version.
...
- Role templates (depreciated in Teleport 2.3) were fully removed. We recommend
  migrating to role variables which are documented [here](/docs/ver/16.x/access-controls/guides/role-templates)
