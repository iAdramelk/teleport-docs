...
the cluster. Follow the updated agentless OpenSSH integration [guide](/docs/ver/16.x/server-access/guides/openssh)
...
guide](/docs/ver/16.x/server-access/guides/openssh).
