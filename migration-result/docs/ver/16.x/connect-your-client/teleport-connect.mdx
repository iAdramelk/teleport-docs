...
![resources tab in Teleport Connect](/assets/connect-cluster@2x-7418ac75d8.png)
...
<Tabs>
  ...
  <Tab title="Linux">
    ...
    ```code
    $ tar -xf  teleport-connect-15.0.0-dev-linux-*.tar.gz
    ```
  </Tab>
  ...
  <Tab title="Windows">
    ...
    ```code
    $ "Teleport Connect Setup-15.0.0-dev.exe" /S
    ```
  </Tab>
</Tabs>
...
![user interface of Teleport Connect](/assets/connect-ui-overview@2x-2e682a1226.png)
...
![Connect My Computer in the top bar](/assets/connect-my-computer-top-bar@2x-5694a1276d.png)
...
![Connect My Computer setup](/assets/connect-my-computer-setup@2x-15f37c908f.png)
...
![Connect My Computer status](/assets/connect-my-computer-status@2x-c158e1b98f.png)
