...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [`teleport join openssh`](/docs/ver/16.x/server-access/openssh/openssh)), you must specify the `sshd` port
...
For more information about Teleport authentication, see [Authentication options](/docs/ver/16.x/reference/authentication).
...
- [CLI Reference](/docs/ver/16.x/reference/cli/tsh#tsh-puttyconfig).
