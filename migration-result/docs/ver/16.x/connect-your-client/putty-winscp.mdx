...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [`teleport join openssh`](/docs/ver/16.x/server-access/guides/openssh/openssh)), you must specify the `sshd` port
...
![Main PuTTY window](../../../../../assets/putty-window-1edb46b857.png)

2. Double-click a session to connect to the host through Teleport.

![PuTTY console](../../../../../assets/putty-console-753182d312.png)
...
![WinSCP Site Manager window](../../../../../assets/winscp-1-ab50b3a746.png)

2. Click the **Tools** button at the bottom left, and choose **Import Sites**.

![Click 'Tools', then choose 'Import Sites...'](../../../../../assets/winscp-2-4106a33512.png)
...
![Choose PuTTY sessions to import and click OK](../../../../../assets/winscp-3-dda4ab049b.png)
...
![Click 'Tools', then choose 'Preferences...'](../../../../../assets/winscp-4-db81dd5c1a.png)
...
![Click 'Security', Check 'Load authorities from PuTTY' then click OK](../../../../../assets/winscp-5-e7dafcd7cb.png)
...
![Choose the host from the list and click Login](../../../../../assets/winscp-6-707baef6c7.png)
