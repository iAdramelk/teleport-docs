...
<Tabs>
  <Tab title="Mac">
    ...
    ```code
    $ curl -O https://cdn.teleport.dev/tsh-15.0.0-dev.pkg
    ```
  </Tab>
  ...
  <Tab title="Windows - Powershell">
    ```code
    $ curl.exe -O https://cdn.teleport.dev/teleport-v15.0.0-dev-windows-amd64-bin.zip
  ...
  <Tab title="Linux">
    ...
    ```code
    $ curl -O https://cdn.teleport.dev/teleport-v15.0.0-dev-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-v15.0.0-dev-linux-amd64-bin.tar.gz
    $ cd teleport
    $ sudo ./install
