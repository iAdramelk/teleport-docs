...
4. Browse and connect to all the resources your user is permitted to access:
   ...
   <img src="/assets/connect-ui-overview@2x-cf1e1d01db.png" alt="An example of Teleport Connect, populated with instances" width="1280" height="720" />
...
- `tsh` is the CLI tool for accessing resources through Teleport. With it,
  ...
  Learn more about it from [Using the tsh Command Line Tool](/docs/ver/16.x/connect-your-client/tsh).
...
- Teleport Connect is a graphic utility for connecting to resources through
  ...
  clusters. See [Using Teleport Connect](/docs/ver/16.x/connect-your-client/teleport-connect).

{/*lint ignore messaging for page title*/}

- [Database Access GUI Clients](/docs/ver/16.x/connect-your-client/gui-clients) details
