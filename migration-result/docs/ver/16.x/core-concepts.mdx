...
Read our guides to how [authorization](/docs/ver/16.x/architecture/authorization) and
[authentication](/docs/ver/16.x/architecture/authentication) work in Teleport.
...
works](/docs/ver/16.x/architecture/proxy).
...
in our [CLI Reference](/docs/ver/16.x/reference/cli/teleport).
...
Service](/docs/ver/16.x/application-access/introduction).
...
Service](/docs/ver/16.x/database-access/introduction).
...
Service](/docs/ver/16.x/desktop-access/introduction).
...
Service](/docs/ver/16.x/kubernetes-access/introduction)
...
Read more about the [Teleport SSH Service](/docs/ver/16.x/server-access/introduction).
...
Read more in our [Machine ID guide](/docs/ver/16.x/machine-id/introduction).
...
edition in [Choose an edition](/docs/ver/16.x/choose-an-edition/introduction).
...
guide](/docs/ver/16.x/choose-an-edition/teleport-cloud/introduction).
...
guide](/docs/ver/16.x/choose-an-edition/teleport-enterprise/introduction).
...
Read more in our [resource reference](/docs/ver/16.x/reference/resources).
...
Read our [guide to Teleport roles](/docs/ver/16.x/access-controls/guides/role-templates).
...
Read more about [local users](/docs/ver/16.x/reference/authentication) and how [SSO
authentication works in Teleport](/docs/ver/16.x/access-controls/sso).
...
See our guide to [Authentication Options](/docs/ver/16.x/reference/authentication).
...
see [Configure Trusted Clusters](/docs/ver/16.x/management/admin/trustedclusters).
For an overview of the architecture used in a trusted cluster relationship, see
[Trusted Cluster Architecture](/docs/ver/16.x/architecture/trustedclusters).
