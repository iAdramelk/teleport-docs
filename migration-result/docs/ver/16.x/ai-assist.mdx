...
<img src="/assets/architecture-diagram-9043780567.png" alt="Teleport Assist Architecture" width="1099" height="632" />

### The main screen

<img src="/assets/assist-example-e5bce5c4f1.png" alt="Teleport Assist Example" width="1841" height="1333" />
...
- A running Teleport Community Edition cluster, v12.4 or higher. For details on
  how to set this up, see our [Getting Started](/docs/ver/16.x/index) guide.
...
1. Open Teleport's Web UI in your browser (e.g., [https://teleport.example.com](https://teleport.example.com)).
2. Log in to the Web UI using your Teleport credentials.
3. Click on the "Assist" button in the top left dropdown menu.
   <img src="/assets/main-screen-388a38717b.png" alt="Teleport Assist Menu" width="1518" height="1119" />
4. Click "New Conversation" to start a new conversation with Teleport Assist.
   <img src="/assets/assist-screen-cd0426d9ee.png" alt="Teleport Assist New Chat" width="1518" height="1119" />
...
- [Access controls](/docs/ver/16.x/access-controls/getting-started)
- [Resource filtering](/docs/ver/16.x/reference/predicate-language)
- [Access request plugins](/docs/ver/16.x/access-controls/access-request-plugins/index)
