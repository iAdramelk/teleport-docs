...
![Teleport Assist Architecture](/assets/architecture-diagram-9043780567.png)

### The main screen

![Teleport Assist Example](/assets/assist-example-e5bce5c4f1.png)
...
3. Click on the "Assist" button in the top left dropdown menu.
   ![Teleport Assist Menu](/assets/main-screen-388a38717b.png)
4. Click "New Conversation" to start a new conversation with Teleport Assist.
   ![Teleport Assist New Chat](/assets/assist-screen-cd0426d9ee.png)
