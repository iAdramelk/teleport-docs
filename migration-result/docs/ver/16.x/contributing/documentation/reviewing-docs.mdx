...
![The structure of the gravitational/docs repo](/assets/doc-submodules-37302c7e4f.png)
...
- While reviewing documentation changes, you will often run into partials,
  ...
  Read about these in the [UI Reference](/docs/ver/16.x/contributing/documentation/reference).
- To make sure that docs pages make consistent use of language and structure,
  ...
  guide](/docs/ver/16.x/contributing/documentation/style-guide).
