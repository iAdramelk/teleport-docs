...
![TLS routing](/assets/tls-routing-c9e843e2c8.png)
...
![Layer 7 load balancer setup](/assets/tls-routing-alb-a519a7c03e.svg)
...
![Connection upgrade](/assets/tls-routing-connection-upgrade-38d470044d.svg)
