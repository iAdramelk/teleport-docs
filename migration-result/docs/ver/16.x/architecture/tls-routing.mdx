...
In TLS routing mode [Teleport proxy](/docs/ver/16.x/architecture/proxy) multiplexes all client
...
<img src="/assets/tls-routing-c9e843e2c8.png" alt="TLS routing" width="1924" height="645" />
...
See the [OpenSSH client](/docs/ver/16.x/server-access/openssh/openssh) guide for details on
how it's configured.
...
See [GUI clients](/docs/ver/16.x/connect-your-client/gui-clients) guide for a usage
example.
...
<img src="/assets/tls-routing-alb-a519a7c03e.svg" alt="Layer 7 load balancer setup" width="938" height="399" />
...
<img src="/assets/tls-routing-connection-upgrade-38d470044d.svg" alt="Connection upgrade" width="1076" height="631" />
...
- See [migration guide](/docs/ver/16.x/management/operations/tls-routing) to learn how to
