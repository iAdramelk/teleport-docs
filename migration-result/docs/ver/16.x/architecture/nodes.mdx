...
![Node joins a cluster](/assets/node-registration@1.2x-7ce1141229.svg)
...
![Host certificate](/assets/ssh-host-cert@1.2x-f6ebec7a8a.svg)
...
![Standard Mode](/assets/ssh-direct-mode@1.2x-364a316e16.svg)
...
![Tunnel Mode](/assets/ssh-tunnel-mode@1.2x-99704565ca.svg)
...
![session-recording-diagram](/assets/session-recording-9703d82171.svg)
...
![recording-proxy](/assets/recording-proxy-2f08329b20.svg)
