...
- See how Teleport uses [Certificates](/docs/ver/16.x/architecture/authentication) for authentication.
- Reduce your surface of attack using [TLS routing](/docs/ver/16.x/architecture/tls-routing).
- Follow our [guide](/docs/ver/16.x/management/admin/trustedclusters) to set up trusted clusters.
