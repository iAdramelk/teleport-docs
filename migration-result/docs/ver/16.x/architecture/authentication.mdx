...
![x.509 certs](/assets/x509-cert@2x-751a238fd5.svg)
...
![SSH certs](/assets/ssh-cert@2x-3a2857405f.svg)
...
![Short lived certs](/assets/ssh-cert-short-lived@1.5x-36df22c36d.svg)
...
![SSO exchange for short-lived certs](/assets/idp-sso-traits@1.5x-4e9be6e048.svg)
