...
Edition](/docs/ver/16.x/choose-an-edition/introduction).
...
guides](/docs/ver/16.x/deploy-a-cluster/introduction).
...
| -------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Single Sign-On (SSO)](/docs/ver/16.x/access-controls/sso)                                   | Allows Teleport to integrate with existing enterprise identity systems. Examples include Active Directory, GitHub, Google Apps and numerous identity middleware solutions like Auth0, Okta, and so on. Teleport supports SAML and OAuth/OpenID Connect protocols to interact with them. |
| [Access Requests](/docs/ver/16.x/access-controls/access-requests)                            | Request elevated access to roles or specific resources.                                                                                                                                                                                                                                 |
| [FedRAMP/FIPS](/docs/ver/16.x/access-controls/compliance-frameworks/fedramp)                 | Access controls to meet the requirements in a FedRAMP System Security Plan (SSP). This includes a FIPS 140-2 friendly build of Teleport Enterprise as well as a variety of improvements to aid in complying with security controls even in FedRAMP High environments.                   |
| [Hardware Security Module support](/docs/ver/16.x/choose-an-edition/teleport-enterprise/hsm) | The Teleport Auth Service can use your organization's HSM to generate TLS credentials, ensuring a highly reliable and secure public key infrastructure.                                                                                                                                 |
| [AWS KMS support](/docs/ver/16.x/choose-an-edition/teleport-enterprise/aws-kms)              | Teleport Enterprise allows you to configure the Teleport Auth Service to use AWS KMS-based private keys for establishing trust with users and Teleport services.                                                                                                                        |
| [Google Cloud KMS support](/docs/ver/16.x/choose-an-edition/teleport-enterprise/gcp-kms)     | Teleport Enterprise allows you to configure the Teleport Auth Service to use Google Cloud KMS-based private keys for establishing trust with users and Teleport services.                                                                                                               |
| [Moderated Sessions](/docs/ver/16.x/access-controls/guides/moderated-sessions)               | Allow or require moderators to be present in SSH or Kubernetes sessions.                                                                                                                                                                                                                |
...
License File](/docs/ver/16.x/choose-an-edition/teleport-enterprise/license) for how to manage the file in your Teleport
