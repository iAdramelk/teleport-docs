...
See our documentation on [data retention](/docs/ver/16.x/choose-an-edition/teleport-cloud/architecture#data-retention).
...
For any other questions, reach out to [https://goteleport.com/cloud/sales](https://goteleport.com/cloud/sales).
...
We believe mTLS with strong user and [device identity](/docs/ver/16.x/access-controls/device-trust/guide) provides the best available
...
Access Controls Reference](/docs/ver/16.x/access-controls/reference).
...
tunnels](/docs/ver/16.x/agents/join-services-to-your-cluster).
...
[dynamic tokens](/docs/ver/16.x/agents/join-services-to-your-cluster/join-token):
...
Find the appropriate download at [Teleport Enterprise Cloud Downloads](/docs/ver/16.x/choose-an-edition/teleport-cloud/downloads). Use the Enterprise version of `tctl`.
...
Yes. We recommend Teleport's [event handler plugin](/docs/ver/16.x/management/export-audit-events/fluentd) to export Teleport Enterprise Cloud audit events.

### Is it possible to store audit logs and session recordings in my own S3 bucket?

Yes, you can configure [External Audit Storage](/docs/ver/16.x/choose-an-edition/teleport-cloud/external-audit-storage).
...
described in [Teleport Upcoming Releases](/docs/ver/16.x/upcoming-releases).
...
the [Upgrading Overview](/docs/ver/16.x/upgrading/overview) for more information.
...
- [Upgrading Teleport Cloud Agents on
  Kubernetes](/docs/ver/16.x/upgrading/cloud-kubernetes)
- [Upgrading Teleport Cloud Agents on
  Linux Servers](/docs/ver/16.x/upgrading/cloud-linux)
...
-------- ------------------------------------ -------------- ------ ----------
server01 46d8cad0-8967-4815-a01a-77aae62c34fe                       16.0.0-dev
server02 c33b5513-a9eb-463b-8f1b-1f209afe5b4f                       16.0.0-dev
```
...
Read more in our [TLS Routing](/docs/ver/16.x/architecture/tls-routing) guide.
...
of regions all over the world, and allow customers to [select the region](/docs/ver/16.x/choose-an-edition/teleport-cloud/architecture#auth-service) where the data is stored.
...
Configuring [External Audit Storage](/docs/ver/16.x/choose-an-edition/teleport-cloud/external-audit-storage) will allow
...
We're currently researching whether this can be done, so please contact support at [support@goteleport.com](mailto:support@goteleport.com).
...
Teleport Enterprise Cloud commits to an SLA of 99.9% of monthly uptime,
a maximum of 44 minutes of downtime per month. While we routinely exceed this SLA,
