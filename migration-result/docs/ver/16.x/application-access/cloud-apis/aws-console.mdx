...
<img src="/assets/create-role-example-readonly-1-309932b26d.png" alt="Create Role Step 1" width="982" height="677" />
...
<img src="/assets/create-role-example-readonly-2-c531d9b5da.png" alt="Select Role Step 2" width="988" height="681" />
...
<img src="/assets/create-role-example-readonly-3-61a353eca8.png" alt="Create Role Step 3" width="985" height="636" />
...
<img src="/assets/aws-trusted-entities@2x-8f91d35971.png" alt="AWS trusted entities" width="298" height="257" />
...
<img src="/assets/attach-security-role-734008788a.png" alt="AWS Attach Security Role" width="824" height="397" />
...
<Accordion title="Configuring aws_role_arns">
  ...
  Reference](/docs/ver/16.x/access-controls/reference#template-expressions-for-access-to-infrastructure-resources)
  ...
  <Tab title="Local User">
    ...
    2. Edit your local user to add the new role:
       ...
       $ tctl users update $(tsh status -f json | jq -r '.active.username') \
         --set-roles "${ROLES?},aws-console-access"
       ```
...
<img src="/assets/iam-role-selector-0292fc870f.png" alt="IAM role selector" width="2228" height="298" />
...
<img src="/assets/federated-login@2x-f18a98c758.png" alt="Federated login" width="369" height="114" />
...
<img src="/assets/cloud-trail-d3fc186bff.png" alt="CloudTrail" width="1864" height="796" />
...
- Take a closer look at [role-based access controls](/docs/ver/16.x/application-access/controls).
- Explore other application access [guides](/docs/ver/16.x/application-access/guides).
