...
please see [helm chart documentation](/docs/ver/16.x/reference/helm-reference/teleport-kube-agent#kubernetesdiscovery).
...
For more information you can take a look at [`discovery_service`](/docs/ver/16.x/reference/config#discovery-service) and [`app_service`](/docs/ver/16.x/reference/config#application-service) configuration references.
...
contain full rewrite configuration in YAML format, same as one would use when configuring an app with dynamic registration syntax (see [documentation](/docs/ver/16.x/application-access/guides/connecting-apps#rewrite-redirect)).
