...
<Tabs>
  <Tab title="Docker">
    Select a Teleport edition, then follow the [Installation](/docs/ver/16.x/installation) instructions
...
- [Connecting applications](/docs/ver/16.x/application-access/guides/connecting-apps).
- Integrating with [JWT tokens](/docs/ver/16.x/application-access/jwt/introduction).
- Accessing applications with [RESTful APIs](/docs/ver/16.x/application-access/guides/api-access).
- Setting configuration options AND running CLI commands in the [Application Access reference](/docs/ver/16.x/application-access/reference).
