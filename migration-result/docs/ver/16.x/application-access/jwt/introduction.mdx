...
You can inject a JWT token into any header using [headers passthrough](/docs/ver/16.x/application-access/guides/connecting-apps#headers-passthrough)
...
[GitHub](https://github.com/gravitational/teleport/blob/v16.0.0-dev/examples/jwt/verify-jwt.go).
...
- [ElasticSearch](/docs/ver/16.x/application-access/jwt/elasticsearch)
