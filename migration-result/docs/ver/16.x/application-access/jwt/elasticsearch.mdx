...
- Running [Application Service](/docs/ver/16.x/application-access/guides/connecting-apps).
...
<Tip>
  You can also use [dynamic registration](/docs/ver/16.x/application-access/guides/dynamic-registration).
</Tip>
...
- Get more information about integrating with [Teleport JWT tokens](/docs/ver/16.x/application-access/jwt/introduction).
