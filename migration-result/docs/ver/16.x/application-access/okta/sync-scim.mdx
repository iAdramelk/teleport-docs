...
- the Okta integration [synchronization process](/docs/ver/16.x/application-access/okta/architecture)
...
<Note>
  ...
  The integration [enrolment process](/docs/ver/16.x/application-access/okta/hosted-guide) creates an Okta SAML
  Application to use as the identity provider for a new
  [SAML Authentication Connector](/docs/ver/16.x/access-controls/sso/okta). The enrolment
