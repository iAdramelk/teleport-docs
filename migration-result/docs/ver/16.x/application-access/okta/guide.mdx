...
<Warning>
  ...
  integration. See the [Okta hosted integration](/docs/ver/16.x/application-access/okta/hosted-guide) guide for more
  information.
</Warning>
...
to the application [Access Controls](/docs/ver/16.x/application-access/controls) and update your roles to match the
...
- Learn more about [accessing APIs](/docs/ver/16.x/application-access/guides/api-access) with the Teleport
  Application Service.
- Take a look at application-related [Access Controls](/docs/ver/16.x/application-access/controls).
