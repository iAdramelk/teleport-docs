...
guide](/docs/ver/16.x/application-access/getting-started).
...
- [AWS Console and CLI Applications](/docs/ver/16.x/application-access/cloud-apis/aws-console): How to access
  AWS Management Console, AWS CLI, and AWS SDKs with Teleport.
- [Google Cloud CLI Applications](/docs/ver/16.x/application-access/cloud-apis/google-cloud): How to access
  Google Cloud CLI applications and SDKs with Teleport.
- [Azure CLI Applications](/docs/ver/16.x/application-access/cloud-apis/azure): How to access Azure CLI
...
- [Web App Access](/docs/ver/16.x/application-access/guides/connecting-apps): How to access web apps with Teleport.
- [TCP App Access](/docs/ver/16.x/application-access/guides/tcp): How to access plain TCP apps with Teleport.
- [API Access](/docs/ver/16.x/application-access/guides/api-access): How to access REST APIs with Teleport.
- [Dynamic Registration](/docs/ver/16.x/application-access/guides/dynamic-registration): Register/unregister apps without restarting Teleport.
...
Teleport cluster automatically](/docs/ver/16.x/application-access/enroll-kubernetes-applications).
...
Learn more about the [Teleport Okta integration](/docs/ver/16.x/application-access/okta).
