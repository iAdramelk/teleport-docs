...
and follow the installation [instructions](/docs/ver/16.x/installation).
...
[role templates](/docs/ver/16.x/access-controls/guides/role-templates). In the
...
[Integrating with JWTs](/docs/ver/16.x/application-access/jwt/introduction) for more details.
