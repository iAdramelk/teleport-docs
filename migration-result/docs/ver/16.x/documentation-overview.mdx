...
up a demo cluster](/docs/ver/16.x) on a Linux server. After seeing how your demo
...
- [Installation](/docs/ver/16.x/installation): How to install Teleport binaries on your
  ...
  spinning up a [demo cluster](/docs/ver/16.x) or signing up for a [Teleport Team
