...
legacy infrastructure, using an [agentless architecture](/docs/ver/16.x/server-access/openssh/openssh).
Read the [Teleport OpenSSH guides](/docs/ver/16.x/server-access/openssh) to learn more.
