...
<Note>
  ...
  See the [OpenSSH guide](/docs/ver/16.x/server-access/guides/openssh) for more information.
...
[dedicated guide](/docs/ver/16.x/server-access/guides/openssh) for additional information.
