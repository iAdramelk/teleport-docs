...
<img src="/assets/teleport-with-updated-MOTD-eaecdfe684.png" alt="Teleport SSH with updated MOTD" width="1853" height="676" />

## Create local Unix users on login

<Warning>
  Using PAM to create local users on login is obsolete and will be removed in a future version. Refer to the
  [Host user creation](/docs/ver/16.x/server-access/guides/host-user-creation) guide to learn how to configure
...
authentication](/docs/ver/16.x/reference/authentication) (e.g. `tsh login`) is preferred.
