...
Teleport's default [SSH and Kubernetes session recording](/docs/ver/16.x/architecture/nodes#ssh-session-recording)
...
<Tip>
  ...
  [Teleport Nodes](/docs/ver/16.x/architecture/nodes#ssh-session-recording) for more
  details.
</Tip>
...
- Read more about
  [session recording](/docs/ver/16.x/architecture/nodes#ssh-session-recording).
- See all configuration options for Enhanced Session Recording in our
  [Configuration Reference](/docs/ver/16.x/reference/config).
