...
- `{{ .RepoChannel }}`: Optional package repository (apt/yum) channel name.
  Has format `<channel>/<version>` e.g. stable/v15. See [installation](/docs/ver/16.x/installation#linux) for more details.
...
- Read [Joining Services via GCP](/docs/ver/16.x/agents/join-services-to-your-cluster/gcp)
