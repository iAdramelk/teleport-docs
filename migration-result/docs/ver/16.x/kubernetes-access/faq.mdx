...
Check out the
[Kubernetes Service Standalone Guide](/docs/ver/16.x/kubernetes-access/register-clusters/static-kubeconfig).
...
Check out the [Teleport Kubernetes Access Controls Guide](/docs/ver/16.x/kubernetes-access/controls) for
...
Check out the [Kubernetes Service Discovery Guide](/docs/ver/16.x/kubernetes-access/discovery) for more
