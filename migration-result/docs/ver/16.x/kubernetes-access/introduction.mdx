...
Guides](/docs/ver/16.x/deploy-a-cluster/helm-deployments).
...
<img src="/assets/architecture-diagram-75347fc20e.png" alt="Kubernetes access architecture" width="3347" height="1669" />
...
Guide](/docs/ver/16.x/kubernetes-access/getting-started).
...
[Read our overview](/docs/ver/16.x/kubernetes-access/discovery) of how Teleport automatically discovers
Kubernetes clusters.

Read our guides to automatically registering Kubernetes clusters with Teleport
on your cloud:

- [AWS](/docs/ver/16.x/kubernetes-access/discovery/aws)
- [Google Cloud](/docs/ver/16.x/kubernetes-access/discovery/google-cloud)
- [Azure](/docs/ver/16.x/kubernetes-access/discovery/azure)
...
- [Deploy the Teleport Kubernetes
  Service with IAM Joining](/docs/ver/16.x/kubernetes-access/register-clusters/iam-joining) on your cluster of
  choice.
- Deploy the Teleport Kubernetes Service outside your Kubernetes cluster (e.g.,
  ...
  kubeconfig](/docs/ver/16.x/kubernetes-access/register-clusters/static-kubeconfig).
- Deploy the Teleport Kubernetes Service outside of Kubernetes  and [use dynamic
  configuration resources](/docs/ver/16.x/kubernetes-access/register-clusters/dynamic-registration) to
...
Read our [Kubernetes RBAC guide](/docs/ver/16.x/kubernetes-access/manage-access/rbac) for step-by-step
...
Reference](/docs/ver/16.x/kubernetes-access/controls).

See how to federate your Kubernetes access controls using [Teleport Trusted
Clusters](/docs/ver/16.x/kubernetes-access/manage-access/federation).
