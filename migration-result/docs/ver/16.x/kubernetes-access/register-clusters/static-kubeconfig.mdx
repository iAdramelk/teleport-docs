...
```code
$ curl -OL \
https://raw.githubusercontent.com/gravitational/teleport/v15.0.0-dev/examples/k8s-auth/get-kubeconfig.sh
```
...
<Accordion title="Connecting multiple Kubernetes clusters?">
  ...
  [merge-kubeconfigs.sh](https://github.com/gravitational/teleport/blob/branch/v15/examples/k8s-auth/merge-kubeconfigs.sh)
