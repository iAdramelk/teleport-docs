...
the Kubernetes [Access Controls Guide](/docs/ver/16.x/kubernetes-access/controls). You can leave your
...
Requests](/docs/ver/16.x/access-controls/access-requests/resource-requests)
for just-in-time access and [Access Request
plugins](/docs/ver/16.x/access-controls/access-request-plugins/index) so you can manage
