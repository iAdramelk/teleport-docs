...
- The Teleport Desktop Service with at least one remote desktop registered in
  ...
  Started with Desktop Access](/docs/ver/16.x/desktop-access/getting-started) before beginning this
  guide.
...
up [session recording for desktop access](/docs/ver/16.x/desktop-access/reference/sessions).
