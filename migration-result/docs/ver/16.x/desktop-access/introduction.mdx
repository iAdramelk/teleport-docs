...
<img src="/assets/windows-desktop-service-overview-8b46dedeba.png" alt="Manage access to Windows through Teleport" width="580" height="794" />
...
- [Configure access for local Windows users](/docs/ver/16.x/desktop-access/getting-started)
- [Configure access for Active Directory with scripts](/docs/ver/16.x/desktop-access/active-directory)
- [Configure access for Active Directory manually](/docs/ver/16.x/desktop-access/active-directory-manual)
...
- [Clipboard Sharing](/docs/ver/16.x/desktop-access/reference/clipboard)
- [Directory Sharing](/docs/ver/16.x/desktop-access/directory-sharing)
- [Session Recording and Playback](/docs/ver/16.x/desktop-access/reference/sessions)
- [Troubleshooting Desktop Access](/docs/ver/16.x/desktop-access/troubleshooting)
- [Desktop Access Audit Events Reference](/docs/ver/16.x/desktop-access/reference/audit)
- [Desktop Access Configuration Reference](/docs/ver/16.x/desktop-access/reference/configuration)
- [Desktop Access CLI Reference](/docs/ver/16.x/desktop-access/reference/cli)
