...
using a [join token](/docs/ver/16.x/agents/join-services-to-your-cluster/join-token), each
...
<Warning>
  ...
  reconfigured.
  Refer to [the Database CA Rotation Guide](/docs/ver/16.x/management/operations/db-ca-rotation).
</Warning>
