...
<Accordion title="How to make Teleport trust an external database CA?">
  ...
  [Database Access Configuration Reference](/docs/ver/16.x/database-access/reference/configuration).
</Accordion>
...
[CA Rotation Guide](/docs/ver/16.x/management/operations/ca-rotation).
...
[Database CA Rotation Guide](/docs/ver/16.x/management/operations/db-ca-rotation).

## Further reading

- How the [Teleport Certificate Authority](/docs/ver/16.x/architecture/authentication) works.
- How [Teleport Database Access](/docs/ver/16.x/database-access/architecture) works.
