...
- One Teleport agent running on an Amazon EC2 instance. See
  [our guides](/docs/ver/16.x/agents/join-services-to-your-cluster) for how to set up Teleport agents.
...
![Advanced Options](/assets/launch-instance-advanced-options-a8feeb2354.png)
...
![Instance Settings](/assets/instance-settings-1faf46d230.png)

![Allow Tags](/assets/allow-tags-41ac3f6088.png)
