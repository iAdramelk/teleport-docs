...
6. Verify that you have added the label by running the following command
   ...
   **Checking your user profile**
   ...
   For more information about managing logins for Teleport users, see [Local Users](/docs/ver/16.x/management/admin/users).
...
For more information, see [Resource filtering](/docs/ver/16.x/reference/predicate-language).
...
[Teleport Role Templates](/docs/ver/16.x/access-controls/guides/role-templates).
