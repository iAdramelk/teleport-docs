...
<img src="/assets/dynamic-resources-d3220cce21.png" alt="Architecture of dynamic resources" width="1800" height="948" />
...
- the ["Managing Users and Roles with IaC" guide](/docs/ver/16.x/management/dynamic-resources/user-and-role)
- the ["Creating Access Lists with IaC" guide](/docs/ver/16.x/management/dynamic-resources/access-list)
...
Controls Reference](/docs/ver/16.x/access-controls/reference).
...
reference](/docs/ver/16.x/reference/cli/tctl) for more information on `tctl`.
...
provider](/docs/ver/16.x/management/dynamic-resources/terraform-provider).
...
[Get started with the Kubernetes Operator](/docs/ver/16.x/management/dynamic-resources/teleport-operator).
...
- For a comprehensive reference of Teleport's static configuration options, read
  the [Configuration Reference](/docs/ver/16.x/reference/config).
- To see the dynamic configuration resources available to apply, read the
  [Configuration Resource Reference](/docs/ver/16.x/reference/resources). There are also
  dedicated configuration resource references for
  [applications](/docs/ver/16.x/application-access/reference#application-resource) and
  [databases](/docs/ver/16.x/database-access/reference/configuration#database-resource).
...
guides](/docs/ver/16.x/api/introduction).
