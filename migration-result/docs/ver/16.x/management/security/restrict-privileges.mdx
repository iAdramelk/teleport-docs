...
As you learned in [Add Labels to Resources](/docs/ver/16.x/management/admin/labels), labels enable you to group, filter, and control access to
...
[Storage backends](/docs/ver/16.x/reference/backends)
