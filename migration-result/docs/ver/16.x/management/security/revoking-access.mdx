...
See the [CA rotations guide](/docs/ver/16.x/management/operations/ca-rotation) for more details on
...
[Session and Identity Locking Guide](/docs/ver/16.x/access-controls/guides/locking).
