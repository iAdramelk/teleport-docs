...
```txt
Teleport event handler 16.0.0-dev
...
[audit event reference](/docs/ver/16.x/reference/audit#event-types) so you can plan
...
more reliable renewals. Read [our guide](/docs/ver/16.x/machine-id/getting-started)
