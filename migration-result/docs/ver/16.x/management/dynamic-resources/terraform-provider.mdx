...
and Machine ID](/docs/ver/16.x/machine-id/deployment/spacelift).
...
[(Machine ID)](/docs/ver/16.x/machine-id/introduction) to generate credentials.
...
using Machine ID, see the [Machine ID Getting Started Guide](/docs/ver/16.x/machine-id/getting-started).
...
- Follow [the user and role IaC guide](/docs/ver/16.x/management/dynamic-resources/user-and-role) to use the Terraform
  Provider to create Teleport users and grant them roles.
- Explore the full list of supported [Terraform provider resources](/docs/ver/16.x/reference/terraform-provider).
- Read more about [impersonation](/docs/ver/16.x/access-controls/guides/impersonation).
