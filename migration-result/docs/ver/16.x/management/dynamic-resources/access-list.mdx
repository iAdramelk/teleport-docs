...
on [the IaC users and roles guide](/docs/ver/16.x/management/dynamic-resources/user-and-role) by allowing users with
...
first [the basic users and roles IaC guide](/docs/ver/16.x/management/dynamic-resources/user-and-role). We will reuse
...
<Tabs>
  <Tab title="Web UI">
    ...
    members" and add `bob`.
        ...
        <img src="/assets/access-list-web-ui-6e85298ef7.png" alt="Screenshot of the web UI showing the Access List and the &#x22;Enroll Member&#x22; button" width="1683" height="859" />
  </Tab>
...
[in the Access List reference](/docs/ver/16.x/access-controls/access-lists/reference).
