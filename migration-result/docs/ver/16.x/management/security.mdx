...
- [Restrict Access for Privileged Accounts](/docs/ver/16.x/management/security/restrict-privileges). Learn about potential
  risks of allowing privileged access and how to mitigate them.
- [Reducing the Blast Radius of Attacks](/docs/ver/16.x/management/security/reduce-blast-radius).
  Prevent attackers from accessing your infrastructure even if they manage to
  obtain passwords or certificates.
- [Revoking Access](/docs/ver/16.x/management/security/revoking-access). Revoke access in the event
  of a compromise.
