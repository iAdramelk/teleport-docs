...
With Teleport [Access Requests](/docs/ver/16.x/access-controls/access-requests), you can
...
plugins](/docs/ver/16.x/access-controls/access-request-plugins/index).
...
- Go version 1.22+ installed on your workstation. See the [Go
...
stolen. View our [Machine ID documentation](/docs/ver/16.x/machine-id/introduction) to
learn more.
