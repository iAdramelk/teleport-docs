...
- Install [Go](https://golang.org/doc/install) 1.22+ and Go development environment.
...
<Tip>
  ...
  Read [API authorization](/docs/ver/16.x/api/architecture#authorization) to learn more about defining custom roles for your API client.
</Tip>
...
- Read about Teleport [API architecture](/docs/ver/16.x/api/architecture) for an in-depth overview of the API and API clients.
- Read [API authorization](/docs/ver/16.x/api/architecture#authorization) to learn more about defining custom roles for your API client.
...
- Familiarize yourself with the [admin manual](/docs/ver/16.x/management/admin) to make the best use of the API.
