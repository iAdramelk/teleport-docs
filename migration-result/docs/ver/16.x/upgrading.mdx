...
The [Upgrading Compatibility Overview](/docs/ver/16.x/upgrading/overview) explains how to
...
- [Linux Servers](/docs/ver/16.x/upgrading/self-hosted-linux)
- [Kubernetes](/docs/ver/16.x/upgrading/self-hosted-kubernetes)
...
Updates](/docs/ver/16.x/upgrading/self-hosted-automatic-agent-updates) guide to set up
