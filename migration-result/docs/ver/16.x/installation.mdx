...
See our [Upgrading](/docs/ver/16.x/upgrading) guide for more information.
...
[Using Teleport Connect](/docs/ver/16.x/connect-your-client/teleport-connect) for usage and installation*.
...
| --------------------------------------------------------------------------------------- | ------------- | ------------------------ | -------- | ----------- | ---------------------- | -------------- |
| [Enhanced Session Recording](/docs/ver/16.x/server-access/guides/bpf-session-recording) | Kernel  v5.8+ | 11, or 10 with backports | 20.04.2+ | 9+          | 2 (post 11/2021), 2023 | 12 SP5, 15 SP5 |
...
<Tabs>
  ...
  <Tab title="Teleport Enterprise Cloud">
    Check the [Cloud Downloads](/docs/ver/16.x/choose-an-edition/teleport-cloud/downloads) page for the most up-to-date
...
<Tabs>
  <Tab title="Teleport Community Edition">
    ...
    Teleport, which is currently `public.ecr.aws/gravitational/teleport-distroless:13.3.7`.
  </Tab>
  ...
  <Tab title="Teleport Enterprise">
    ...
    | Image name                                                                   | Includes troubleshooting tools | Image base                                                                 |
    | ---------------------------------------------------------------------------- | ------------------------------ | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-ent-fips-distroless:16.0.0-dev`       | No                             | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-ent-fips-distroless-debug:16.0.0-dev` | Yes                            | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |

    For testing, we always recommend that you use the latest release version of
    Teleport Enterprise, which is currently `public.ecr.aws/gravitational/teleport-ent-distroless:13.3.7`.
  </Tab>
...
```code
$ docker run -it --entrypoint="" public.ecr.aws/gravitational/teleport-distroless -debug:public.ecr.aws/gravitational/teleport-distroless:13.3.7 busybox sh
```
...
See the Teleport [Configuration Reference](/docs/ver/16.x/reference/config) for whether a
...
Reference](/docs/ver/16.x/reference/networking#ports) for the ports on your Teleport
container to expose.
...
method](/docs/ver/16.x/agents/join-services-to-your-cluster/join-token).
...
[reference Terraform code](https://github.com/gravitational/teleport/tree/branch/v16/examples/aws/terraform).

See the [AWS Single-Instance Deployment](/docs/ver/16.x/deploy-a-cluster/deployments/aws-starter-cluster-terraform)
and the [Running Teleport Enterprise in High Availability mode on AWS using Terraform](/docs/ver/16.x/deploy-a-cluster/deployments/aws-ha-autoscale-cluster-terraform)
...
`/etc/teleport.d/conf` file on the EC2 instance. See the [Starter Cluster Configuration Template](https://github.com/gravitational/teleport/tree/branch/v16/examples/aws/terraform/starter-cluster/data.tpl)
...
| ------------------------------------------------ | ---------- | ------------ | ------------ | ----------------------------------------------------------------------------------- |
| `teleport-oss-16.0.0-dev-x86_64-$TIMESTAMP`      | OSS        | amd64        | No           | `TeleportVersion: 16.0.0-dev`, `TeleportEdition: oss`, `TeleportFipsEnabled: false` |
| `teleport-oss-16.0.0-dev-arm64-$TIMESTAMP`       | OSS        | arm64        | No           | `TeleportVersion: 16.0.0-dev`, `TeleportEdition: oss`, `TeleportFipsEnabled: false` |
| `teleport-ent-16.0.0-dev-x86_64-$TIMESTAMP`      | Enterprise | amd64        | No           | `TeleportVersion: 16.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: false` |
| `teleport-ent-16.0.0-dev-arm64-$TIMESTAMP`       | Enterprise | arm64        | No           | `TeleportVersion: 16.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: false` |
| `teleport-ent-16.0.0-dev-x86_64-fips-$TIMESTAMP` | Enterprise | amd64        | Yes          | `TeleportVersion: 16.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: true`  |
| `teleport-ent-16.0.0-dev-arm64-fips-$TIMESTAMP`  | Enterprise | arm64        | Yes          | `TeleportVersion: 16.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: true`  |
...
| --------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `teleport-cluster`    | Auth Service<br />Proxy Service<br />Other Teleport services if using a custom configuration | [Reference](/docs/ver/16.x/reference/helm-reference/teleport-cluster)    |
| `teleport-kube-agent` | Kubernetes Service<br />Application Service<br />Database Service                            | [Reference](/docs/ver/16.x/reference/helm-reference/teleport-kube-agent) |
...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  <Tab title="Community/Team">
    <Tabs>
      <Tab title="Teleport package">
        ...
        | Link                                                                          | Binaries                                      |
        | ----------------------------------------------------------------------------- | --------------------------------------------- |
        | [`teleport-16.0.0-dev.pkg`](https://cdn.teleport.dev/teleport-16.0.0-dev.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
        | [`tsh-16.0.0-dev.pkg`](https://cdn.teleport.dev/tsh-16.0.0-dev.pkg)           | `tsh`                                         |

        You can also fetch an installer via the command line:

        ```code
        $ curl -O https://cdn.teleport.dev/teleport-16.0.0-dev.pkg
        # Installs on Macintosh HD
        $ sudo installer -pkg teleport-16.0.0-dev.pkg -target /
        # Password:
        # installer: Package name is teleport-16.0.0-dev
      ...
      <Tab title="Homebrew">
        ...
        [compatibility policy](/docs/ver/16.x/upgrading) for details.
  ...
  <Tab title="Enterprise">
    ...
    | Link                                                                                  | Binaries                                      |
    | ------------------------------------------------------------------------------------- | --------------------------------------------- |
    | [`teleport-ent-16.0.0-dev.pkg`](https://cdn.teleport.dev/teleport-ent-16.0.0-dev.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
    | [`tsh-16.0.0-dev.pkg`](https://cdn.teleport.dev/tsh-16.0.0-dev.pkg)                   | `tsh`                                         |

    You can also fetch an installer from the command line:

    ```code
    $ curl -O https://cdn.teleport.dev/teleport-ent-16.0.0-dev.pkg
    # Install on Macintosh HD
    $ sudo installer -pkg teleport-ent-16.0.0-dev.pkg -target / 
    Password:
    installer: Package name is teleport-ent-16.0.0-dev
    installer: Upgrading at base path /
    installer: The upgrade was successful.
    $ which teleport
    /usr/local/bin/teleport
...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  <Tab title="Teleport Community Edition">
    ...
    $ $Resp = Invoke-WebRequest https://cdn.teleport.dev/teleport-v16.0.0-dev-windows-amd64-bin.zip.sha256
    ...
    # <checksum> <filename>
    $ Invoke-WebRequest -OutFile teleport-v16.0.0-dev-windows-amd64-bin.zip -Uri https://cdn.teleport.dev/teleport-v16.0.0-dev-windows-amd64-bin.zip
    $ certUtil -hashfile teleport-v16.0.0-dev-windows-amd64-bin.zip SHA256
    # SHA256 hash of teleport-v16.0.0-dev-windows-amd64-bin.zip:
    # <checksum>
    ...
    `teleport-v16.0.0-dev-windows-amd64-bin\tsh.exe`.

    ```code
    $ Expand-Archive teleport-v16.0.0-dev-windows-amd64-bin.zip
    $ cd teleport-v16.0.0-dev-windows-amd64-bin
    $ .\tsh.exe version
    Teleport v16.0.0-dev git:v16.0.0-dev go1.22
    ```
  ...
  <Tab title="Teleport Enterprise Cloud">
    ...
    $ .\tsh.exe version
    Teleport v14.3.6 git:v14.3.6 go1.22
    ```
...
Teleport is written in Go, and currently requires **go v1.22** or
...
If you wish to uninstall Teleport at any time, see our documentation on [Uninstalling Teleport](/docs/ver/16.x/management/admin/uninstall-teleport).
...
- [Server Access](/docs/ver/16.x/server-access/introduction)
- [Kubernetes Access](/docs/ver/16.x/kubernetes-access/introduction)
- [Database Access](/docs/ver/16.x/database-access/introduction)
- [Application Access](/docs/ver/16.x/application-access/introduction)
- [Desktop Access](/docs/ver/16.x/desktop-access/introduction)
- [Machine ID](/docs/ver/16.x/machine-id/introduction)
