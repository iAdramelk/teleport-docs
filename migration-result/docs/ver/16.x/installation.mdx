...
`public.ecr.aws/gravitational/teleport:15.0.0-dev-arm64`.
...
- The major, minor, and patch version (e.g., `15.0.0-dev` for the
...
<Tabs>
  ...
  <Tab title="Teleport Enterprise Cloud/Enterprise">
    ...
    | Image name                                                                   | Includes troubleshooting tools | Image base                                                                 |
    | ---------------------------------------------------------------------------- | ------------------------------ | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-ent-fips-distroless:15.0.0-dev`       | No                             | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-ent-fips-distroless-debug:15.0.0-dev` | Yes                            | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
...
| ------------------------------------------------ | ---------- | ------------ | ------------ | ----------------------------------------------------------------------------------- |
| `teleport-oss-15.0.0-dev-x86_64-$TIMESTAMP`      | OSS        | amd64        | No           | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: oss`, `TeleportFipsEnabled: false` |
| `teleport-oss-15.0.0-dev-arm64-$TIMESTAMP`       | OSS        | arm64        | No           | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: oss`, `TeleportFipsEnabled: false` |
| `teleport-ent-15.0.0-dev-x86_64-$TIMESTAMP`      | Enterprise | amd64        | No           | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: false` |
| `teleport-ent-15.0.0-dev-arm64-$TIMESTAMP`       | Enterprise | arm64        | No           | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: false` |
| `teleport-ent-15.0.0-dev-x86_64-fips-$TIMESTAMP` | Enterprise | amd64        | Yes          | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: true`  |
| `teleport-ent-15.0.0-dev-arm64-fips-$TIMESTAMP`  | Enterprise | arm64        | Yes          | `TeleportVersion: 15.0.0-dev`, `TeleportEdition: ent`, `TeleportFipsEnabled: true`  |
...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  <Tab title="Community/Team">
    <Tabs>
      <Tab title="Teleport package">
        ...
        | Link                                                                          | Binaries                                      |
        | ----------------------------------------------------------------------------- | --------------------------------------------- |
        | [`teleport-15.0.0-dev.pkg`](https://cdn.teleport.dev/teleport-15.0.0-dev.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
        | [`tsh-15.0.0-dev.pkg`](https://cdn.teleport.dev/tsh-15.0.0-dev.pkg)           | `tsh`                                         |

        You can also fetch an installer via the command line:

        ```code
        $ curl -O https://cdn.teleport.dev/teleport-15.0.0-dev.pkg
        # Installs on Macintosh HD
        $ sudo installer -pkg teleport-15.0.0-dev.pkg -target /
        # Password:
        # installer: Package name is teleport-15.0.0-dev
  ...
  <Tab title="Enterprise">
    ...
    | Link                                                                                  | Binaries                                      |
    | ------------------------------------------------------------------------------------- | --------------------------------------------- |
    | [`teleport-ent-15.0.0-dev.pkg`](https://cdn.teleport.dev/teleport-ent-15.0.0-dev.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
    | [`tsh-15.0.0-dev.pkg`](https://cdn.teleport.dev/tsh-15.0.0-dev.pkg)                   | `tsh`                                         |

    You can also fetch an installer from the command line:

    ```code
    $ curl -O https://cdn.teleport.dev/teleport-ent-15.0.0-dev.pkg
    # Install on Macintosh HD
    $ sudo installer -pkg teleport-ent-15.0.0-dev.pkg -target / 
    Password:
    installer: Package name is teleport-ent-15.0.0-dev
    installer: Upgrading at base path /
    installer: The upgrade was successful.
    $ which teleport
    /usr/local/bin/teleport
  ...
  <Tab title="Enterprise Cloud">
    ...
    | Link                                                                          | Binaries                                      |
    | ----------------------------------------------------------------------------- | --------------------------------------------- |
    | [`teleport-ent-14.3.3.pkg`](https://cdn.teleport.dev/teleport-ent-14.3.3.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
    | [`tsh-14.3.3.pkg`](https://cdn.teleport.dev/tsh-14.3.3.pkg)                   | `tsh`                                         |

    You can also fetch an installer from the command line:

    ```code
    $ curl -O https://cdn.teleport.dev/teleport-ent-14.3.3.pkg
    # Install on Macintosh HD
    $ sudo installer -pkg teleport-ent-14.3.3.pkg -target / 
    Password:
    installer: Package name is teleport-ent-14.3.3
    installer: Upgrading at base path /
    installer: The upgrade was successful.
    $ which teleport
    /usr/local/bin/teleport
...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  <Tab title="Teleport Community Edition">
    ...
    $ $Resp = Invoke-WebRequest https://get.gravitational.com/teleport-v15.0.0-dev-windows-amd64-bin.zip.sha256
    ...
    # <checksum> <filename>
    $ Invoke-WebRequest -OutFile teleport-v15.0.0-dev-windows-amd64-bin.zip -Uri https://cdn.teleport.dev/teleport-v15.0.0-dev-windows-amd64-bin.zip
    $ certUtil -hashfile teleport-v15.0.0-dev-windows-amd64-bin.zip SHA256
    # SHA256 hash of teleport-v15.0.0-dev-windows-amd64-bin.zip:
    # <checksum>
    ...
    `teleport-v15.0.0-dev-windows-amd64-bin\tsh.exe`.

    ```code
    $ Expand-Archive teleport-v15.0.0-dev-windows-amd64-bin.zip
    $ cd teleport-v15.0.0-dev-windows-amd64-bin
    $ .\tsh.exe version
    Teleport v15.0.0-dev git:v15.0.0-dev go1.21
    ```
  ...
  <Tab title="Teleport Enterprise Cloud">
    ...
    $ [Net.ServicePointManager]::SecurityProtocol = [Net.SecurityProtocolType]::Tls12
    # Get the expected checksum for the Windows tsh package
    $ $Resp = Invoke-WebRequest https://get.gravitational.com/teleport-v14.3.3-windows-amd64-bin.zip.sha256
    # PowerShell will return the binary representation of the response content
    # by default, so you need to convert it to a string
    $ [System.Text.Encoding]::UTF8.getstring($Resp.Content)
    # <checksum> <filename>
    $ Invoke-WebRequest -OutFile teleport-v14.3.3-windows-amd64-bin.zip -Uri https://cdn.teleport.dev/teleport-v14.3.3-windows-amd64-bin.zip
    $ certUtil -hashfile teleport-v14.3.3-windows-amd64-bin.zip SHA256
    # SHA256 hash of teleport-v14.3.3-windows-amd64-bin.zip:
    # <checksum>
    # CertUtil: -hashfile command completed successfully.
    ```
    ...
    After you have verified that the checksums match, you can extract the archive.
    The executable will be available at
    `teleport-v14.3.3-windows-amd64-bin\tsh.exe`.

    ```code
    $ Expand-Archive teleport-v14.3.3-windows-amd64-bin.zip
    $ cd teleport-v14.3.3-windows-amd64-bin
    $ .\tsh.exe version
    Teleport v14.3.3 git:v14.3.3 go1.21
    ```
