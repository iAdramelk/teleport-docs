...
<Accordion title="Using another join method">
  ...
  - Google Kubernetes Engine: Where
    ...
    See the [GCP Platform Guide](/docs/ver/16.x/machine-id/deployment/gcp) for further information.
  - AWS Elastic Kubernetes Service: Where
    ...
    See the [AWS Platform Guide](/docs/ver/16.x/machine-id/deployment/aws) for further information.
</Accordion>
