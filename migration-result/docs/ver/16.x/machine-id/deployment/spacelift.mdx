...
Reference](/docs/ver/16.x/access-controls/reference#rbac-for-dynamic-teleport-resources)
...
version: "1"
stack_defaults:
  runner_image: public.ecr.aws/gravitational/teleport-spacelift-runner:16.0.0-dev
  before_init:
  - |-
    tbot start --oneshot \
      --data-dir=memory:// \
...
<img src="/assets/pr-run-2f2dbad292.png" alt="Terraform plan" width="2560" height="1440" />
...
<img src="/assets/apply-success-f1e6a20e99.png" alt="Successful apply" width="2560" height="1440" />
...
- Now that you know how to manage Teleport configuration resources with
  ...
  reference](/docs/ver/16.x/reference/terraform-provider) so you can flesh out your
  configuration.
...
- Learn how you can help achieve secure access for service accounts by sending
  [anonymous Machine ID telemetry](/docs/ver/16.x/machine-id/reference/telemetry).
