...
- If you have not already connected your server to Teleport, follow
  the [Server Access Getting Started Guide](/docs/ver/16.x/application-access/getting-started).
...
[Ansible-specific guide](/docs/ver/16.x/machine-id/access-guides/ansible).
