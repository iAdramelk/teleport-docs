...
will enable [TLS Routing](/docs/ver/16.x/management/operations/tls-routing) in your
Teleport cluster.
...
<Tip>
  ...
  Helm chart, read our [Helm Deployments](/docs/ver/16.x/deploy-a-cluster/helm-deployments) documentation.
</Tip>
...
to follow a more specific [deployment guide](/docs/ver/16.x/deploy-a-cluster/introduction) for your
environment.
...
Consult our [Backends Reference](/docs/ver/16.x/reference/backends) for the configuration
...
- [High-availability Teleport Deployments on Kubernetes with
  Helm](/docs/ver/16.x/deploy-a-cluster/helm-deployments)
- [Reference Deployments](/docs/ver/16.x/deploy-a-cluster/deployments) for running Teleport on a cluster of
  virtual machines
...
- [Scaling a Teleport cluster](/docs/ver/16.x/management/operations/scaling)
- [Monitoring a Teleport cluster](/docs/ver/16.x/management/diagnostics)
...
- [Applications](/docs/ver/16.x/application-access/getting-started)
- [Servers](/docs/ver/16.x/server-access/getting-started)
- [Kubernetes clusters](/docs/ver/16.x/kubernetes-access/getting-started)
- [Databases](/docs/ver/16.x/database-access/getting-started)
- [Windows desktops](/docs/ver/16.x/desktop-access/introduction)
- [Bot users](/docs/ver/16.x/machine-id/getting-started)
