...
This guide is designed to accompany our [reference starter-cluster Terraform code](https://github.com/gravitational/teleport/tree/branch/v15/examples/aws/terraform/starter-cluster#teleport-terraform-aws-ami-simple-example)
...
`examples/aws/terraform/starter-cluster` section of the Teleport repo](https://github.com/gravitational/teleport/blob/branch/v15/examples/aws/terraform/starter-cluster/README.md)
...
The AWS region to run in. You should pick from the supported list as detailed in the [README](https://github.com/gravitational/teleport/blob/branch/v15/examples/aws/terraform/starter-cluster/README.md).
