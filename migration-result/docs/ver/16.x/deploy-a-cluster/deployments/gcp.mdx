...
<img src="/assets/gcp-teleport-5c6de37b3a.svg" alt="GCP Intro Image" width="1628" height="806" />
...
see  [Admin Guide: Troubleshooting](/docs/ver/16.x/management/admin/troubleshooting) for more information.
...
<img src="/assets/gcp-service-key-ee049852b7.png" alt="GCP Service Key" width="1177" height="768" />
...
Follow install instructions from our [installation page](/docs/ver/16.x/installation#linux).
...
<Tabs>
  <Tab title="Open Source">
    **1. Configure Teleport Auth Server** using the below example `teleport.yaml`,and start it
    using [systemd](/docs/ver/16.x/management/admin/daemon). The DEB/RPM installations will
...
Follow our [Local Users](/docs/ver/16.x/management/admin/users) guide or integrate
with [Google Workspace](/docs/ver/16.x/access-controls/sso/google-workspace) to
provide SSO access.
