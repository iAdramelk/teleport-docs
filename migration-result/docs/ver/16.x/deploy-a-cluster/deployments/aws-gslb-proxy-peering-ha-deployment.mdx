...
- Teleport's [Proxy Peering](/docs/ver/16.x/architecture/proxy-peering) is used to reduce the total number of tunnel connections in the Teleport cluster.
...
- [GSLB](https://www.cloudflare.com/learning/cdn/glossary/global-server-load-balancing-gslb/)
- [Teleport TLS Routing](/docs/ver/16.x/architecture/tls-routing) to reduce the number of ports needed to use Teleport
- [Teleport Proxy Peering](/docs/ver/16.x/architecture/proxy-peering) for reducing the number of resource connections
...
<img
  src="/assets/aws-gslb-proxy-peering-ha-deployment-4a02a0cf1a.png"
  alt="Diagram showing this Teleport
architecture"
  width="1854"
  height="1856"
/>
...
Review the [configuration reference](/docs/ver/16.x/reference/config) page for
additional settings.

## Configure Proxy Peering

In this deployment architecture, [Proxy Peering](/docs/ver/16.x/architecture/proxy-peering) is used to restrict the number of connections made from
...
Reference the [Auth Server configuration](/docs/ver/16.x/reference/config#auth-service) reference page
...
<Tabs>
  <Tab title="Public Proxy Peering ports">
    | Port   | Description                                                                                                               |
    | ------ | ------------------------------------------------------------------------------------------------------------------------- |
    | `443`  | ALPN port for TLS Routing, HTTPS connections to authenticate `tsh` users into the cluster, and to serve Teleport's Web UI |
  ...
  <Tab title="VPC peering Proxy Peering ports">
    | Port  | Description                                                                                                               |
    | ----- | ------------------------------------------------------------------------------------------------------------------------- |
    | `443` | ALPN port for TLS Routing, HTTPS connections to authenticate `tsh` users into the cluster, and to serve Teleport's Web UI |
  </Tab>
...
Reference the [Proxy Service configuration](/docs/ver/16.x/reference/config#proxy-service) reference page
for additional settings.
