...
- The reason for both of these requirements is that Teleport uses X509 certificates for authentication, which requires
  ...
  [using ALPN connection upgrades](/docs/ver/16.x/architecture/tls-routing#working-with-layer-7-load-balancers-or-reverse-proxies).
    ...
    <Tabs>
      <Tab title="cert-manager">
        ...
        <Note>
          ...
          [ensure you set](/docs/ver/16.x/reference/helm-reference/teleport-cluster#highavailabilitycertmanageraddcommonname)
          ...
          [reference the secret](/docs/ver/16.x/reference/helm-reference/teleport-cluster#tlsexistingcasecretname)
...
[the DynamoDB autoscaling section](/docs/ver/16.x/reference/backends#dynamodb-autoscaling).
