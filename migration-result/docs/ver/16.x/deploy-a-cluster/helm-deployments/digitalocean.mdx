...
- Your workstation configured with [kubectl](https://kubernetes.io/docs/tasks/tools/), [Helm](https://helm.sh/docs/intro/install/), [doctl](https://docs.digitalocean.com/reference/doctl/how-to/install/), and the Teleport [tsh](/docs/ver/16.x/installation) client.
...
guide](/docs/ver/16.x/reference/helm-reference/teleport-cluster).

Read our guides to additional ways you can protect a Kubernetes cluster with
Teleport:

- Connect another Kubernetes cluster to Teleport by [deploying the Teleport Kubernetes Service](/docs/ver/16.x/kubernetes-access/getting-started)
- [Set up Machine ID with Kubernetes](/docs/ver/16.x/machine-id/access-guides/kubernetes)
- [Federated Access using Trusted Clusters](/docs/ver/16.x/kubernetes-access/manage-access/federation)
- [Single-Sign On and Kubernetes Access Control](/docs/ver/16.x/kubernetes-access/controls)
