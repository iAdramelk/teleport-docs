...
](/docs/ver/16.x/access-controls/compliance-frameworks/fedramp).
...
the cluster as Teleport services using [a join method](/docs/ver/16.x/reference/join-methods). They
can still join even if local auth is disabled.

See the [Machine ID introduction](/docs/ver/16.x/machine-id/introduction) for more information.
...
See the [SSO setup guides](/docs/ver/16.x/access-controls/sso) to learn how to setup an
