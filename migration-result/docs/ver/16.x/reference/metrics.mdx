...
- [Audit Events and Records](/docs/ver/16.x/reference/audit)
- [Forwarding events with Fluentd](/docs/ver/16.x/management/export-audit-events/fluentd)
- [Monitor Teleport Audit Events with the Elastic Stack](/docs/ver/16.x/management/export-audit-events/elastic-stack)
