...
See the [Kubernetes Operator for remote Teleport clusters guide](/docs/ver/16.x/management/dynamic-resources/teleport-operator-standalone)
for more details.

You can
[browse the source on GitHub](https://github.com/gravitational/teleport/tree/branch/v16/examples/chart/teleport-cluster/charts/teleport-operator).
...
[Kubernetes JWKS](/docs/ver/16.x/reference/join-methods#kubernetes-jwks) join method.
