...
You can [browse the source on GitHub](https://github.com/gravitational/teleport-plugins/tree/v16.0.0-dev/charts/access/mattermost).
...
Check out the [Access Requests with Mattermost](/docs/ver/16.x/access-controls/access-request-plugins/ssh-approval-mattermost) guide
