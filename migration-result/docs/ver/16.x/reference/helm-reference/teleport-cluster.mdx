...
You can
[browse the source on GitHub](https://github.com/gravitational/teleport/tree/branch/v15/examples/chart/teleport-cluster).
...
By default, Teleport charts used to install a [`podSecurityPolicy`](https://github.com/gravitational/teleport/blob/branch/v15/examples/chart/teleport-cluster/templates/psp.yaml).
