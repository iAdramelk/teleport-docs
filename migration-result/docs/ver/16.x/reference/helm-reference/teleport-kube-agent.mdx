...
GitHub](https://github.com/gravitational/teleport/tree/branch/v16/examples/chart/teleport-kube-agent).
...
By default, Teleport charts used to install a [`podSecurityPolicy`](https://github.com/gravitational/teleport/blob/branch/16/examples/chart/teleport-cluster/templates/psp.yaml).
