...
GitHub](https://github.com/gravitational/teleport-plugins/tree/v15.0.0-dev/charts/access/jira).
...
documentation](/docs/ver/16.x/access-controls/access-request-plugins/ssh-approval-jira)
