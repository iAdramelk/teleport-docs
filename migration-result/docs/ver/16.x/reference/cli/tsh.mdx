...
| `--auth`               | `local`          | Any defined [authentication connector](/docs/ver/16.x/reference/authentication), including `passwordless` and `local` (i.e., no authentication connector) | Specify the type of authentication connector to use.                                                                                                                                      |
...
- `<cluster>` - the name of the cluster,  see [Trusted Cluster](/docs/ver/16.x/management/admin/trustedclusters) for more information.
...
Access](/docs/ver/16.x/application-access/cloud-apis/azure).
...
through Teleport.  See the [OpenSSH Guide](/docs/ver/16.x/server-access/openssh/openssh) guide
...
See [full docs on `tsh puttyconfig` here](/docs/ver/16.x/connect-your-client/putty-winscp).
...
<Tip>
  ...
  in their [storage backend](/docs/ver/16.x/reference/backends).
...
| `--query`  | none             | String                                                       | Query by [predicate language](/docs/ver/16.x/reference/predicate-language#resource-filtering) enclosed in single quotes |
...
```code
$ tsh version
Teleport v16.0.0-dev git: go1.22
