...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    <Note>
      ...
      [Access Controls](/docs/ver/16.x/access-controls/introduction) and ensure that
...
<Tip>
  ...
  [Machine ID](/docs/ver/16.x/machine-id/introduction) is a more secure alternative that
...
See the [Resources Reference](/docs/ver/16.x/reference/resources) for complete docs on how to build these yaml files.
...
| `--google-legacy`  | Flag to select groups with direct membership filtered by domain (legacy behavior). <br />Disabled by default. [More info](/docs/ver/16.x/access-controls/sso/google-workspace#how-teleport-uses-google-workspace-apis) |
