...
Team](/docs/ver/16.x/choose-an-edition/teleport-team).
...
<Tip>
  ...
  use [host user creation](/docs/ver/16.x/server-access/guides/host-user-creation).
...
<img src="/assets/add-resources-98a7153460.png" alt="Adding resources" width="2560" height="1440" />
...
Terraform](/docs/ver/16.x/agents/deploy-agents-terraform) to get started.
