...
v14, or want a preview of the next version's
...
up a demo cluster](/docs/ver/14.x/index) on a Linux server. After seeing how your demo
...
guide](/docs/ver/14.x/core-concepts), which introduces the components of a Teleport
...
- [Installation](/docs/ver/14.x/installation): How to install Teleport binaries on your
  environment. If you are just getting started with Teleport, we recommend
  spinning up a [demo cluster](/docs/ver/14.x/index) or signing up for a [Teleport Team
  trial](https://goteleport.com/signup).
- [Frequently Asked Questions](/docs/ver/14.x/faq): If this page does not answer your
  question, try our AI-assisted search box on the left sidebar.
- [Usage Reporting and Billing](/docs/ver/14.x/usage-billing): How Teleport calculates
  usage metrics to determine customer billing.
- [Upcoming Releases](/docs/ver/14.x/upcoming-releases): Features to be introduced in
  future versions of Teleport.
- [Changelog](/docs/ver/14.x/changelog): A comprehensive collection of release notes.
- [Teleport Assist](/docs/ver/14.x/ai-assist): How to use the AI-guided Teleport client.
...
Edition](/docs/ver/14.x/choose-an-edition/introduction) section.

## Deploy a cluster

Once you know which edition you would like to deploy, read our [Deploy a
Cluster](/docs/ver/14.x/deploy-a-cluster/introduction) documentation for how to launch a
...
Access](/docs/ver/14.x/access-controls/introduction) to get started.
...
Cluster](/docs/ver/14.x/management/introduction) for more information.
...
- [Servers](/docs/ver/14.x/server-access/getting-started), including OpenSSH servers that
  [do not have Teleport installed](/docs/ver/14.x/server-access/guides/openssh)
- [Kubernetes clusters](/docs/ver/14.x/kubernetes-access/introduction)
- [Databases](/docs/ver/14.x/database-access/introduction)
- [Applications](/docs/ver/14.x/application-access/introduction)
- [Remote desktops](/docs/ver/14.x/desktop-access/introduction)

You can also set up [Machine ID](/docs/ver/14.x/machine-id/introduction) to enable
...
our [API guides](/docs/ver/14.x/api/introduction).
...
[Upcoming Releases](/docs/ver/14.x/upcoming-releases) section for a glimpse of features we
will release in the next Teleport version. Consult our
[Reference](/docs/ver/14.x/reference/introduction) guides for comprehensive lists of
configuration options, CLI flags, and more. For detailed explanations of how
Teleport works, see the [Architecture](/docs/ver/14.x/architecture/introduction) section.

Finally, if you're interested in adding to Teleport's documentation, view
our [contribution guide](/docs/ver/14.x/contributing/documentation).
