...
Teleport Kubernetes Service [on that cluster](/docs/ver/14.x/kubernetes-access/getting-started), you can
...
```bash
$ curl -OL \
https://raw.githubusercontent.com/gravitational/teleport/v14.3.6/examples/k8s-auth/get-kubeconfig.sh
```
...
<Accordion title="Connecting multiple Kubernetes clusters?">
  ...
  [merge-kubeconfigs.sh](https://github.com/gravitational/teleport/blob/branch/v14/examples/k8s-auth/merge-kubeconfigs.sh)
