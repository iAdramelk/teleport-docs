...
guide](/docs/ver/14.x/kubernetes-access/manage-access/rbac).
...
<img src="/assets/auth-7578f2f99e.svg" alt="Impersonation" width="757" height="376" />
...
<Tip>
  ...
  methods](/docs/ver/14.x/kubernetes-access/register-clusters) and [automatic methods](/docs/ver/14.x/kubernetes-access/discovery) for
