...
<Tip>
  ...
  Standalone Teleport Cluster](/docs/ver/14.x/kubernetes-access/register-clusters/static-kubeconfig).
</Tip>
...
<Tip>
  ...
  or up to one major version back. You can set the version override with the override variable, ex: `--set teleportVersionOverride=14.0.0-dev`.
</Tip>
...
- Take a look at a [kube-agent helm chart reference](/docs/ver/14.x/reference/helm-reference/teleport-kube-agent) for a full list of parameters.
