...
<img src="/assets/enroll-kubernetes-8ab2224673.png" alt="Enroll a Kubernetes cluster" width="1289" height="586" />
...
Teleport Cluster](/docs/ver/14.x/kubernetes-access/register-clusters/static-kubeconfig).
...
- Access to a running Teleport cluster, `tctl` admin tool, and `tsh` client tool,
  ...
  instructions](/docs/ver/14.x/installation#installation-instructions) for your environment.
...
[Registering Kubernetes Clusters with Teleport](/docs/ver/14.x/kubernetes-access/register-clusters).
...
2. (Optional) Specify the namespace, a Kubernetes group from the previous step, and
   ...
   <img src="/assets/test-k8s-connection-b0461a403b.png" alt="Connect to the Kubernetes cluster" width="1622" height="1624" />
...
- For information about discovering Kubernetes clusters hosted on cloud providers, see
  [Kubernetes Cluster Discovery](/docs/ver/14.x/kubernetes-access/discovery).
...
- For a complete list of the parameters you can configure in the `teleport-kube-agent`
  helm chart, see the [Chart Reference](/docs/ver/14.x/reference/helm-reference/teleport-kube-agent).
