...
- [AWS](/docs/ver/14.x/kubernetes-access/discovery/aws): Discovery for AWS EKS clusters.
- [Azure](/docs/ver/14.x/kubernetes-access/discovery/azure): Discovery for Azure AKS clusters.
- [Google Cloud](/docs/ver/14.x/kubernetes-access/discovery/google-cloud): Discovery for
