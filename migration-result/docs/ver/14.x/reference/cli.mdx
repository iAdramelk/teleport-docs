...
- [teleport](/docs/ver/14.x/reference/cli/teleport): Supports the Teleport Access Platform by starting and configuring various Teleport services.
- [tsh](/docs/ver/14.x/reference/cli/tsh): Allows end users to authenticate to Teleport and access resources in a cluster.
- [tctl](/docs/ver/14.x/reference/cli/tctl): Used to configure the Teleport Auth Service.
- [tbot](/docs/ver/14.x/reference/cli/tbot): Supports Machine ID, which provides short lived credentials to service accounts (e.g, a CI/CD server).
