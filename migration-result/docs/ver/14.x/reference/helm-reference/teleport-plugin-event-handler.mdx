...
You can [browse the source on GitHub](https://github.com/gravitational/teleport-plugins/tree/v14.3.6/charts/event-handler).
...
Check out the [Event Handler Helm Chart documentation](https://github.com/gravitational/teleport-plugins/tree/v14.3.6/charts/event-handler/#prerequisites) for more information about how to acquire these credentials.
