...
You can [browse the source on GitHub](https://github.com/gravitational/teleport-plugins/tree/v14.0.0-dev/charts/access/slack).
...
Slack](/docs/ver/14.x/access-controls/access-request-plugins/ssh-approval-slack) guide
