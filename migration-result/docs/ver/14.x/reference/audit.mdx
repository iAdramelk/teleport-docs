...
<Tip>
  You can use
  [Enhanced Session Recording with BPF](/docs/ver/14.x/server-access/guides/bpf-session-recording)
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [DynamoDB](/docs/ver/14.x/reference/backends#dynamodb) or [Firestore](/docs/ver/14.x/reference/backends#firestore)
    ...
    [Teleport Configuration Reference](/docs/ver/14.x/reference/config).
...
<Tip>
  ...
  read [Exporting Teleport Audit Events](/docs/ver/14.x/management/export-audit-events).
</Tip>
...
| join\_token.created      | A new join token has been created. Adds the following fields: `{"roles": ["Node", "Db"], "join_method": "token"}`                                                   |
...
<Tabs>
  <Tab title="Self-Hosted">
    Teleport can store the recorded sessions in an [AWS S3 bucket](/docs/ver/14.x/reference/backends#s3)
    ...
    You can replay recorded sessions using the [`tsh play`](/docs/ver/14.x/reference/cli#tsh-play)
  ...
  <Tab title="Cloud-Hosted">
    ...
    You can replay recorded sessions using the [`tsh play`](/docs/ver/14.x/reference/cli#tsh-play) command or the Web
    UI.
