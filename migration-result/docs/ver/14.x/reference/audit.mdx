...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [Athena](/docs/ver/14.x/reference/backends#athena), [DynamoDB](/docs/ver/14.x/reference/backends#dynamodb) or
    [Firestore](/docs/ver/14.x/reference/backends#firestore) chapters for information on how to
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    You can replay recorded sessions using the [`tsh play`](/docs/ver/14.x/reference/cli/tsh#tsh-play)
