...
<Note>
  ...
  You must be familiar with the [Teleport Core concepts](/docs/ver/14.x/core-concepts)
...
<Note>
  ...
  - How to [Join Services with a Secure Token](/docs/ver/14.x/agents/join-services-to-your-cluster/join-token).
  - [Deploying Machine ID on Linux](/docs/ver/14.x/machine-id/deployment/linux)
</Note>
...
<Note>
  ...
  - [Joining Services via AWS IAM Role](/docs/ver/14.x/agents/join-services-to-your-cluster/aws-iam).
  - [Deploying Machine ID on AWS](/docs/ver/14.x/machine-id/deployment/aws)
</Note>
...
<Note>
  ...
  [Joining Services via AWS EC2 Identity Document](/docs/ver/14.x/agents/join-services-to-your-cluster/aws-ec2).
</Note>
...
<Note>
  ...
  - [Joining Services via Azure Managed Identity](/docs/ver/14.x/agents/join-services-to-your-cluster/azure).
  - [Deploying Machine ID on Azure](/docs/ver/14.x/machine-id/deployment/azure)
</Note>
...
<Note>
  ...
  - How to [Join Services with GCP](/docs/ver/14.x/agents/join-services-to-your-cluster/gcp).
  - [Deploying Machine ID on GCP](/docs/ver/14.x/machine-id/deployment/gcp)
</Note>
...
typically used with [Machine ID](/docs/ver/14.x/machine-id/introduction) to access
...
<Note>
  ...
  - [Deploying Machine ID on GitHub Actions](/docs/ver/14.x/machine-id/deployment/github-actions)
</Note>

### CircleCI: `circleci`

This join method is typically used with [Machine ID](/docs/ver/14.x/machine-id/introduction)
...
<Note>
  ...
  - [Deploying Machine ID on Circle CI](/docs/ver/14.x/machine-id/deployment/circleci)
</Note>
...
This join method is typically used with [MachineID](/docs/ver/14.x/machine-id/introduction)
...
<Note>
  ...
  - [Deploying Machine ID on GitLab CI](/docs/ver/14.x/machine-id/deployment/gitlab)
</Note>
...
<Note>
  ...
  - [Joining Services via Kubernetes ServiceAccount Token](/docs/ver/14.x/agents/join-services-to-your-cluster/kubernetes)
</Note>
...
<Note>
  ...
  - [Deploying Machine ID on Kubernetes](/docs/ver/14.x/machine-id/deployment/kubernetes)
</Note>
