...
configure` in the [Teleport CLI Reference](/docs/ver/14.x/reference/cli/teleport).
...
windows_desktop_service:
  ...
  # (optional, available from 14.3) static_hosts is a list of hosts to register as WindowsDesktop
  ...
  #
  # The rules for matching static hosts (static_hosts, hosts and non_ad_hosts) and discovered hosts
