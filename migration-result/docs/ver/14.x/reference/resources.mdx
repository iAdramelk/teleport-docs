...
| login\_rule               | A Login Rule, see the [Login Rules guide](/docs/ver/14.x/access-controls/login-rules) for more info.                             |
| device                    | A Teleport Trusted Device, see the [Device Trust guide](/docs/ver/14.x/access-controls/device-trust/guide) for more info.        |
| [ui\_config](#ui-config)  | Configuration for the Web UI served by the Proxy Service                                                                         |
| cluster\_auth\_preference | Configuration for the cluster's auth preferences.                                                                                |
