...
Resources](/docs/ver/14.x/management/dynamic-resources).
...
Here's the list of resources currently exposed via [`tctl`](/docs/ver/14.x/reference/cli/tctl):
...
| connector                                              | Authentication connectors for [Single Sign-On](/docs/ver/14.x/access-controls/sso) (SSO) for SAML, OIDC and GitHub.              |
| node                                                   | A registered SSH node. The same record is displayed via `tctl nodes ls`                                                          |
| windows\_desktop                                       | A registered Windows desktop.                                                                                                    |
| cluster                                                | A trusted cluster. See [here](/docs/ver/14.x/management/admin/trustedclusters) for more details on connecting clusters together. |
| [login\_rule](#login-rules)                            | A Login Rule, see the [Login Rules guide](/docs/ver/14.x/access-controls/login-rules) for more info.                             |
| [device](#device)                                      | A Teleport Trusted Device, see the [Device Trust guide](/docs/ver/14.x/access-controls/device-trust/guide) for more info.        |
...
Roles not [granting Kubernetes access](/docs/ver/14.x/kubernetes-access/introduction) are
...
see [the `kubernetes_resource` documentation](/docs/ver/14.x/kubernetes-access/controls#kubernetes_resources)
for a complete list).
