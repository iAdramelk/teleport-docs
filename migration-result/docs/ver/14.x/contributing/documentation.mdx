...
- [How to Contribute to the Teleport Documentation](/docs/ver/14.x/contributing/documentation/how-to-contribute) describes
  how to set up a local environment and contribute changes to the Teleport documentation.
- [How to Review Documentation Changes](/docs/ver/14.x/contributing/documentation/reviewing-docs) explains how to
  set up a development server to preview documentation changes so you can review pull
  requests.
- [Documentation UI Components](/docs/ver/14.x/contributing/documentation/reference) provides reference
  information for how to include user interface components in Teleport documentation.
- [Style Guide](/docs/ver/14.x/contributing/documentation/style-guide) describes the documentation principles and
  conventions to follow to ensure contributions are consistent and effective.
- [Creating Documentation Issues](/docs/ver/14.x/contributing/documentation/issues) offers guidelines for
