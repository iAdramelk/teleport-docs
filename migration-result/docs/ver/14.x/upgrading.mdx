...
The [Upgrading Compatibility Overview](/docs/ver/14.x/upgrading/overview) explains how to
...
- [Linux Servers](/docs/ver/14.x/upgrading/self-hosted-linux)
- [Kubernetes](/docs/ver/14.x/upgrading/self-hosted-kubernetes)
...
Updates](/docs/ver/14.x/upgrading/self-hosted-automatic-agent-updates) guide to set up
