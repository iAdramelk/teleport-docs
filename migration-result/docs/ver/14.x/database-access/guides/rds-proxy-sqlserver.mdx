...
<Note>
  ...
  [PostgreSQL](/docs/ver/14.x/database-access/guides/rds-proxy-postgres),
  [MariaDB/MySQL](/docs/ver/14.x/database-access/guides/rds-proxy-postgres) or
  [Microsoft SQL Server](/docs/ver/14.x/database-access/guides/rds-proxy-sqlserver).
</Note>
...
<Accordion title="Method 1: Organize IAM roles with &#x22;assume_role_arn&#x22;">
  ...
  <Tabs>
    <Tab title="Auto-Discovery by Discovery Service">
      ...
      <Tip>
        ...
        labels](/docs/ver/14.x/database-access/reference/labels#auto-discovery)
  ...
  Access](/docs/ver/14.x/database-access/guides/aws-cross-account).
</Accordion>
...
<Accordion title="Method 3: Separate Database Services">
  ...
  configuration](/docs/ver/14.x/database-access/guides/ha) where databases can be
