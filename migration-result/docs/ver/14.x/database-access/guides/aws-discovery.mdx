...
- Learn about [Dynamic Registration](/docs/ver/14.x/database-access/guides/dynamic-registration) by the
  Teleport Database Service.
- Get started by [connecting](/docs/ver/14.x/database-access/guides) your database.
- Connect AWS databases in [external AWS accounts](/docs/ver/14.x/database-access/guides/aws-cross-account).
