...
Teleport can provide secure access to MySQL on Google Cloud SQL via the  [Teleport Database
...
1. Configure an MySQL on Google Cloud SQL with a service account.
2. Join the MySQL on Google Cloud SQL database to your Teleport cluster.
3. Connect to the MySQL on Google Cloud SQL database via the Teleport Database Service.
...
<img src="/assets/service-account-sql-admin-grant@2x-d886f6f255.png" alt="Grant Cloud SQL Admin to Service Account" width="519" height="501" />
...
<img src="/assets/instance-id-mysql@2x-3cbcc086ea.png" alt="Instance ID" width="186" height="85" />
