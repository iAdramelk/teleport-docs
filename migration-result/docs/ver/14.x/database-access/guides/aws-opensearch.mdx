...
Access](/docs/ver/14.x/database-access/introduction). This allows for
fine-grain access control through [Teleport's RBAC](/docs/ver/14.x/database-access/rbac).
...
<Accordion title="Alterative methods">
  ...
  - [Joining Nodes via AWS EC2 Identity Document](/docs/ver/14.x/agents/join-services-to-your-cluster/aws-ec2)
</Accordion>
...
<Tabs>
  ...
  <Tab title="Dynamic Config">
    ...
    resources, see: [Dynamic Registration](/docs/ver/14.x/database-access/guides/dynamic-registration).
  </Tab>
</Tabs>
