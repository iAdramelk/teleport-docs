...
See the available [guides](/docs/ver/14.x/database-access/guides) for all supported configurations.
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [Proxy Configuration](/docs/ver/14.x/database-access/reference/configuration#proxy-configuration) for
    more details.
...
[graphical clients](/docs/ver/14.x/connect-your-client/gui-clients).
...
[configuration file](/docs/ver/14.x/database-access/reference/configuration#database-service-configuration)
...
See [labels reference](/docs/ver/14.x/database-access/reference/labels) for a full list of Teleport
