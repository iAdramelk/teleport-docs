...
- Teleport cluster v13.1 or above with a configured [self-hosted
  PostgreSQL](/docs/ver/14.x/database-access/guides/postgres-self-hosted) or [RDS
  PostgreSQL](/docs/ver/14.x/database-access/guides/rds) database.
...
- Connect using your [GUI database
  client](/docs/ver/14.x/connect-your-client/gui-clients).
- Learn about [role
  templating](/docs/ver/14.x/access-controls/guides/role-templates#interpolation-rules).
