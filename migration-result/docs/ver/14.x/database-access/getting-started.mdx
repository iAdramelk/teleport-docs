...
See the [Automatic User Provisioning](/docs/ver/14.x/database-access/rbac/configuring-access) guide for how to configure Teleport to create accounts for your PostgreSQL users on demand.
