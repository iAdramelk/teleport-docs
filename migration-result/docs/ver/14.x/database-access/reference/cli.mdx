...
<Note>
  ...
  [impersonation guide](/docs/ver/14.x/access-controls/guides/impersonation)
...
Displays only the databases a user has access to (see [RBAC](/docs/ver/14.x/database-access/rbac)).
