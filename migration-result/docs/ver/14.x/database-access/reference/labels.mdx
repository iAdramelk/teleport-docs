...
| `dynamic`   | database resources created through [dynamic registration](/docs/ver/14.x/database-access/guides/dynamic-registration) like `tcl create` command. |
...
[Configuration](/docs/ver/14.x/database-access/reference/configuration) for reference.
...
Tags](/docs/ver/14.x/management/guides/ec2-tags) for more details.
