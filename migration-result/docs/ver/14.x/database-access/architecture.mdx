...
<img src="/assets/architecture-4d02926a75.svg" alt="Teleport Database Access Diagram" width="1752" height="991" />

In it, we have the following Teleport components:

<Tabs>
  <Tab title="Self-Hosted">
    - [Teleport Proxy Service](/docs/ver/14.x/architecture/proxy). A stateless service
  ...
  <Tab title="Teleport Enterprise Cloud">
    - [Teleport Proxy Service](/docs/ver/14.x/architecture/proxy). A stateless service that performs
...
4. The Proxy Service authenticates the connection and dispatches it to the
...
See respective [guides](/docs/ver/14.x/database-access/guides) for details on configuring client
...
See respective [guides](/docs/ver/14.x/database-access/guides) for details on configuring IAM/AD
authentication.
