...
page](/docs/ver/14.x/architecture/agent-update-management) describes how agent
updating works.
...
[enroll agents into automatic updates](/docs/ver/14.x/management/operations/enroll-agent-into-automatic-updates).
...
You can now [enroll agents into automatic updates](/docs/ver/14.x/management/operations/enroll-agent-into-automatic-updates).
