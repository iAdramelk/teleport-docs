...
Back up before upgrading. We have more instructions in [Backing up Teleport](/docs/ver/14.x/management/operations/backup-restore).
...
[Upgrade the Teleport Binary](/docs/ver/14.x/management/admin/upgrading-the-teleport-binary).
