...
<Accordion title="How to make Teleport trust an external database CA?">
  ...
  [Database Access Configuration Reference](/docs/ver/14.x/database-access/reference/configuration).
</Accordion>
...
[CA Rotation Guide](/docs/ver/14.x/management/operations/ca-rotation).
...
[Database CA Rotation Guide](/docs/ver/14.x/management/operations/db-ca-rotation).
