...
- [EC2 tags as Teleport Node labels](/docs/ver/14.x/management/guides/ec2-tags). How to set up
  Teleport Node labels based on EC2 tags.
- [Using Teleport's Certificate Authority with
  GitHub](/docs/ver/14.x/management/guides/ssh-key-extensions). Use Teleport's short-lived
