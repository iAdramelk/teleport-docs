...
- [Per-session MFA](/docs/ver/14.x/access-controls/guides/per-session-mfa)
- [Dual authorization](/docs/ver/14.x/access-controls/guides/dual-authz)
- [Role templates, allow/deny rules, and traits](/docs/ver/14.x/access-controls/guides/role-templates)
- [Access Requests](/docs/ver/14.x/access-controls/access-requests)

### Background reading

- [Authentication connectors](/docs/ver/14.x/reference/authentication)
- [Proxy Service](/docs/ver/14.x/architecture/proxy)
- [Auth Service](/docs/ver/14.x/architecture/authentication)
