...
<Tip>
  ...
  [Machine ID](/docs/ver/14.x/machine-id/introduction) is often a better option for
...
- Find the full list of [supported Terraform provider resources](/docs/ver/14.x/reference/terraform-provider).
