...
<Tip>
  ...
  - Replace the Teleport binaries, usually [`teleport`](/docs/ver/14.x/reference/cli#teleport)
    and [`tctl`](/docs/ver/14.x/reference/cli#tctl).
...
[Teleport CLI Reference](/docs/ver/14.x/reference/cli#teleport).
...
[upgrading a Teleport binary](/docs/ver/14.x/management/admin/upgrading-the-teleport-binary).
