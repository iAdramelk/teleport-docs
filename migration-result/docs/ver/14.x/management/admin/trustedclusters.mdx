...
![MSP Example](../../../../../../assets/trusted-clusters@1.5x-b3064bc46e.svg)
...
<Tip>
  ...
  databases behind a firewall. For more information, see how to [join a service to your cluster](/docs/ver/14.x/agents/join-services-to-your-cluster).
</Tip>
...
<Tabs>
  <Tab title="Teleport Team">
    ...
    - A second Teleport cluster, which will act as the leaf cluster. For details on
      how to set up this cluster, see our [Getting Started](/docs/ver/14.x/index)
      guide.

      As an alternative, you can set up a second Teleport Team account.

    - The `tctl` and `tsh` client tools version >= 13.2.0.

      You can download these from [Teleport Cloud Downloads](/docs/ver/14.x/choose-an-edition/teleport-cloud/downloads).
      ```code
      $ tctl version
    ...
    - A Teleport Node that is joined to one of your clusters. We will refer to this
      ...
      See [Join Services to your Cluster](/docs/ver/14.x/agents/join-services-to-your-cluster) for
  ...
  <Tab title="Open Source">
    - Two running Teleport clusters. For details on how to set up your clusters, see
      our [Getting Started](/docs/ver/14.x/index) guide.

    - The `tctl` and `tsh` client tools version >= 14.0.0-dev.
    ...
    - A Teleport agent that is joined to one of your clusters. We will refer to this
      ...
      Cluster](/docs/ver/14.x/agents/join-services-to-your-cluster) for how to launch a
  ...
  <Tab title="Enterprise">
    ...
    - The `tctl` and `tsh` client tools version >= 14.0.0-dev, which you
    ...
    - A Teleport Node that is joined to one of your clusters. We will refer to this
      ...
      See [Join Services to your Cluster](/docs/ver/14.x/agents/join-services-to-your-cluster) for how to launch a Teleport agent in
      your cluster.
  </Tab>
  ...
  <Tab title="Teleport Enterprise Cloud">
    ...
    - A Teleport Node that is joined to one of your clusters. We will refer to this
      ...
      See [Join Services to your Cluster](/docs/ver/14.x/agents/join-services-to-your-cluster) for how to launch a
      Teleport agent in your cluster.
  </Tab>
</Tabs>
...
<Accordion title="Optional: Add labels">
...
<Accordion title="Revoking join tokens">
...
<Accordion title="Role mapping syntax">
  ### Wildcard characters
...
<Accordion title="Sharing user traits between Trusted Clusters">
...
<Accordion title="Creating Trusted Clusters via the Web UI">
  ...
  ![Tunnels](../../../../../../assets/setting-up-trust-35cbee3222.png)
</Accordion>

<Accordion title="Update role mappings">
...
Assign the `demo-cluster-access` role to your Teleport user by running the following
...
<Tabs>
  <Tab title="Local User">
    ...
    Edit `out.yaml`, adding `demo-cluster-access` to the list of existing roles:
  ...
  <Tab title="GitHub">
    ...
    Edit `github.yaml`, adding `demo-cluster-access` to the
  ...
  <Tab title="SAML">
    ...
    Edit `saml.yaml`, adding `demo-cluster-access` to the
  ...
  <Tab title="OIDC">
    ...
    Edit `oidc.yaml`, adding `demo-cluster-access` to the
...
<Accordion title="What if you're using a load balancer?">
...
- Read more about how Trusted Clusters fit into Teleport's overall architecture:
  [Architecture Introduction](/docs/ver/14.x/architecture/trustedclusters).
