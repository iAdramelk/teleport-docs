...
<Tabs>
  <Tab title="Open Source">
    - A running Teleport cluster. For details on how to set this up, see our
      [Getting Started](/docs/ver/14.x/index) guide (skip TLS certificate setup).
...
<Tabs>
  ...
  <Tab title="Helm chart">
    ...
    [extraArgs](/docs/ver/14.x/reference/helm-reference/teleport-cluster#extraargs)
    ...
    ](/docs/ver/14.x/reference/helm-reference/teleport-kube-agent#insecureskipproxytlsverify)
    flag to `true`:
...
flag](/docs/ver/14.x/connect-your-client/teleport-connect#skipping-tls-certificate-verification).

## Further reading

- [Configuring Teleport TLS Certs](/docs/ver/14.x/index#configure-teleport)
- [Run Teleport as a systemd Daemon](/docs/ver/14.x/management/admin/daemon)
- [Teleport Proxy Service](/docs/ver/14.x/architecture/proxy)
