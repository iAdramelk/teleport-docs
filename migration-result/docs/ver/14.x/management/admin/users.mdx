...
- [Add local users](/docs/ver/14.x/management/admin/users#adding-local-users)
- [Edit existing users](/docs/ver/14.x/management/admin/users#editing-users)
- [Delete users](/docs/ver/14.x/management/admin/users#deleting-users)
...
<Tabs>
  <Tab title="Teleport Enterprise/Enterprise Cloud">
    ...
    resources. See our [Teleport Resources Reference](/docs/ver/14.x/reference/resources).

    For all available `tctl` commands and flags, see our [CLI Reference](/docs/ver/14.x/reference/cli#tctl).

    You can also configure Teleport so that users can log in using an SSO provider.
    For more information, see:

    - [Single Sign-On](/docs/ver/14.x/access-controls/sso)
  </Tab>
  ...
  <Tab title="Teleport Team/Community Edition">
    ...
    [CLI Reference](/docs/ver/14.x/reference/cli#tctl).

    You can also configure Teleport so that users can log in using GitHub. For more
    information, see [GitHub SSO](/docs/ver/14.x/access-controls/sso/github-sso).
  </Tab>
</Tabs>
