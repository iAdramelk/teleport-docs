...
reference](/docs/ver/14.x/reference/cli/tctl) for more information on `tctl`.
...
provider](/docs/ver/14.x/management/dynamic-resources/terraform-provider).
...
[Get started with the Kubernetes Operator](/docs/ver/14.x/management/dynamic-resources/teleport-operator).
...
- For a comprehensive reference of Teleport's static configuration options, read
  the [Configuration Reference](/docs/ver/14.x/reference/config).
- To see the dynamic configuration resources available to apply, read the
  [Configuration Resource Reference](/docs/ver/14.x/reference/resources). There are also
  dedicated configuration resource references for
  [applications](/docs/ver/14.x/application-access/reference#application-resource) and
  [databases](/docs/ver/14.x/database-access/reference/configuration#database-resource).
...
guides](/docs/ver/14.x/api/introduction).
