...
See our [Upgrading](/docs/ver/14.x/management/operations/upgrading) guide for more information.
...
| --------------------------------------------------------------------------------------- | ------------- | ------------------------ | -------- | ----------- | ---------------------- |
| [Enhanced Session Recording](/docs/ver/14.x/server-access/guides/bpf-session-recording) | Kernel  v5.8+ | 11, or 10 with backports | 20.04.2+ | 9+          | 2 (post 11/2021), 2023 |
  ...
  <Tab title="Teleport Team/Community Edition">
    <Tabs>
      ...
      <Tab title="Homebrew">
        ...
        [compatibility policy](/docs/ver/14.x/management/operations/upgrading) for details.
