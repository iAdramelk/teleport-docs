...
See our [Upgrading](/docs/ver/14.x/upgrading) guide for more information.
...
[Using Teleport Connect](/docs/ver/14.x/connect-your-client/teleport-connect) for usage and installation*.
...
| --------------------------------------------------------------------------------------- | ------------- | ------------------------ | -------- | ----------- | ---------------------- | -------------- |
| [Enhanced Session Recording](/docs/ver/14.x/server-access/guides/bpf-session-recording) | Kernel  v5.8+ | 11, or 10 with backports | 20.04.2+ | 9+          | 2 (post 11/2021), 2023 | 12 SP5, 15 SP5 |
...
<Tabs>
  ...
  <Tab title="Teleport Enterprise Cloud">
    Check the [Cloud Downloads](/docs/ver/14.x/choose-an-edition/teleport-cloud/downloads) page for the most up-to-date
...
`public.ecr.aws/gravitational/teleport:14.3.6-arm64`.
...
- The major, minor, and patch version (e.g., `14.3.6` for the
...
<Tabs>
  <Tab title="Teleport Community Edition">
    ...
    | --------------------------------------------------------------- | ---------------------- | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-distroless:14.3.6`       | No                     | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-distroless-debug:14.3.6` | Yes                    | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |

    For testing, we always recommend that you use the latest release version of
    Teleport, which is currently `public.ecr.aws/gravitational/teleport-distroless:14.3.6`.
  ...
  <Tab title="Teleport Enterprise">
    ...
    | Image name                                                               | Includes troubleshooting tools | Image base                                                                 |
    | ------------------------------------------------------------------------ | ------------------------------ | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-ent-fips-distroless:14.3.6`       | No                             | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-ent-fips-distroless-debug:14.3.6` | Yes                            | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
...
See the Teleport [Configuration Reference](/docs/ver/14.x/reference/config) for whether a
...
Reference](/docs/ver/14.x/reference/networking#ports) for the ports on your Teleport
container to expose.
...
method](/docs/ver/14.x/agents/join-services-to-your-cluster/join-token).
...
$ docker run --hostname localhost --rm \
  ...
  public.ecr.aws/gravitational/teleport-distroless:14.3.6 configure --roles=proxy,auth > ~/teleport/config/teleport.yaml
```
...
$ docker run --hostname localhost --name teleport \
  ...
  public.ecr.aws/gravitational/teleport-distroless:14.3.6
```
...
[reference Terraform code](https://github.com/gravitational/teleport/tree/branch/v14/examples/aws/terraform).

See the [AWS Single-Instance Deployment](/docs/ver/14.x/deploy-a-cluster/deployments/aws-starter-cluster-terraform)
and the [Running Teleport Enterprise in High Availability mode on AWS using Terraform](/docs/ver/14.x/deploy-a-cluster/deployments/aws-ha-autoscale-cluster-terraform)
...
`/etc/teleport.d/conf` file on the EC2 instance. See the [Starter Cluster Configuration Template](https://github.com/gravitational/teleport/tree/branch/v14/examples/aws/terraform/starter-cluster/data.tpl)
...
| ------------------------------------- | ---------- | ------------ | ------------------------------------------------------------------------------- | ---------------- |
| `teleport-oss-14.3.6-$TIMESTAMP`      | OSS        | No           | `TeleportVersion: 14.3.6`, `TeleportEdition: oss`, `TeleportFipsEnabled: false` | 146628656107     |
| `teleport-ent-14.3.6-$TIMESTAMP`      | Enterprise | No           | `TeleportVersion: 14.3.6`, `TeleportEdition: ent`, `TeleportFipsEnabled: false` | 146628656107     |
| `teleport-ent-14.3.6-fips-$TIMESTAMP` | Enterprise | Yes          | `TeleportVersion: 14.3.6`, `TeleportEdition: ent`, `TeleportFipsEnabled: true`  | 146628656107     |
...
| --------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `teleport-cluster`    | Auth Service<br />Proxy Service<br />Other Teleport services if using a custom configuration | [Reference](/docs/ver/14.x/reference/helm-reference/teleport-cluster)    |
| `teleport-kube-agent` | Kubernetes Service<br />Application Service<br />Database Service                            | [Reference](/docs/ver/14.x/reference/helm-reference/teleport-kube-agent) |
  ...
  <Tab title="Community/Team">
    <Tabs>
      <Tab title="Teleport package">
        ...
        | Link                                                                  | Binaries                                      |
        | --------------------------------------------------------------------- | --------------------------------------------- |
        | [`teleport-14.3.6.pkg`](https://cdn.teleport.dev/teleport-14.3.6.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
        ...
        # Password:
        # installer: Package name is teleport-14.3.6
      ...
      <Tab title="Homebrew">
        ...
        [compatibility policy](/docs/ver/14.x/upgrading) for details.
...
If you wish to uninstall Teleport at any time, see our documentation on [Uninstalling Teleport](/docs/ver/14.x/management/admin/uninstall-teleport).
...
- [Server Access](/docs/ver/14.x/server-access/introduction)
- [Kubernetes Access](/docs/ver/14.x/kubernetes-access/introduction)
- [Database Access](/docs/ver/14.x/database-access/introduction)
- [Application Access](/docs/ver/14.x/application-access/introduction)
- [Desktop Access](/docs/ver/14.x/desktop-access/introduction)
