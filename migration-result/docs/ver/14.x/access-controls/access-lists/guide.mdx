...
<img src="/assets/debug-app-0d67166b21.png" alt="Debug app" width="950" height="371" />
...
<img src="/assets/create-test-user-7d7d15dd96.png" alt="Create Test User" width="1413" height="649" />
...
<img src="/assets/create-new-access-list-d602831f07.png" alt="Navigate to create new Access List" width="1679" height="438" />

Here, fill in a title, description, and grant the `access` role. Select a date in the future for the next
review date.

<img src="/assets/fill-out-access-list-fields-d944c54d91.png" alt="Fill out Access List Fields" width="599" height="938" />
...
<img src="/assets/select-owner-8fbf054bb6.png" alt="Select an owner" width="558" height="325" />
...
<img src="/assets/add-member-d538b0d5e3.png" alt="Add a member" width="567" height="342" />
...
- Familiarize yourself with the CLI tooling available for managing access lists in the [reference](/docs/ver/14.x/access-controls/access-lists/reference).
