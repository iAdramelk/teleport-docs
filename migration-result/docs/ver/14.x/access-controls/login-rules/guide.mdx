...
The [`tctl sso test`](/docs/ver/14.x/reference/cli#tctl-sso-test) command can be used to
...
checking the [reference page](/docs/ver/14.x/reference/cli#tctl-login_rule-test).
