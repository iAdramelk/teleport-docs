...
<Note>
  The [Terraform provider guide](/docs/ver/14.x/management/dynamic-resources/terraform-provider)
...
Assign the `loginrule-manager` role to your Teleport user by running the following
...
<Tabs>
  ...
  <Tab title="GitHub">
    ...
    Edit `github.yaml`, adding `loginrule-manager` to the
  ...
  <Tab title="SAML">
    ...
    Edit `saml.yaml`, adding `loginrule-manager` to the
  ...
  <Tab title="OIDC">
    ...
    Edit `oidc.yaml`, adding `loginrule-manager` to the
...
- Read the [Terraform Guide](/docs/ver/14.x/management/dynamic-resources/terraform-provider) to
  learn more about configuring the Terraform provider.
- Read the [Login Rules reference](/docs/ver/14.x/access-controls/login-rules/reference) to learn mode about the
