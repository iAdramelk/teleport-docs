...
<Tabs>
  <Tab title="Download">
    ...
    ```bash
    $ curl -L -O https://get.gravitational.com/teleport-access-email-v14.3.3-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-email-v14.3.3-linux-amd64-bin.tar.gz
    ...
    teleport-email v14.3.3 git:teleport-email-v14.3.3-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    ```bash
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-email:14.3.3
    ```

    Make sure the plugin is installed by running the following command:

    ```bash
    $ docker run public.ecr.aws/gravitational/teleport-plugin-email:14.3.3 version
    teleport-email v14.3.3 git:teleport-email-v14.3.3-api/14.0.0-gd1e081e 1.21
    ```
...
<Tabs>
  ...
  <Tab title="Docker">
    ...
    ```bash
    $ docker run -v <path-to-config>:/etc/teleport-email.toml public.ecr.aws/gravitational/teleport-plugin-email:14.3.6 start
    ```
  </Tab>
