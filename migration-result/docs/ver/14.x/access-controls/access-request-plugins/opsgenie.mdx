...
- The Enterprise `tctl` admin tool and `tsh` client tool version >= 14.3.6.
  ...
  instructions](/docs/ver/14.x/installation#installation-instructions) for your environment and Teleport edition.
...
<img src="/assets/add-requester-role-8d15f5e725.png" alt="Add user one" width="1919" height="966" />
...
<img src="/assets/add-user-one-beddcc13f8.png" alt="Add user one" width="1916" height="971" />

Then select 'Create New User' and create a user with the requester role.

<img src="/assets/add-user-two-125869c7e6.png" alt="Add user two" width="1918" height="969" />
...
<img src="/assets/opsgenie-api-key-21c48ba3d9.png" alt="Create API key" width="1108" height="517" />
...
<img src="/assets/opsgenie-integration-page-66bc69502e.png" alt="Integrations page" width="1917" height="954" />
