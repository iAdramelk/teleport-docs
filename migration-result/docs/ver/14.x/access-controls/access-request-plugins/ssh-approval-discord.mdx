...
<Tabs>
  <Tab title="Download">
    ...
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-discord-v14.3.3-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-discord-v14.3.3-linux-amd64-bin.tar.gz
    ...
    teleport-discord v14.3.3 git:teleport-discord-v14.3.3-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    ```code
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-discord:14.3.3
    ```

    Make sure the plugin is installed by running the following command:

    ```code
    $ docker run public.ecr.aws/gravitational/teleport-plugin-discord:14.3.3 version
    teleport-discord v14.3.3 git:teleport-discord-v14.3.3-api/14.0.0-gd1e081e 1.21
    ```
...
<Tabs>
  <Tab title="Executable">
    ...
    ```code
    $ teleport-discord start
    INFO   Starting Teleport Access Discord Plugin 14.3.6: discord/app.go:80
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker run -v <path-to-config>:/etc/teleport-discord.toml public.ecr.aws/gravitational/teleport-plugin-discord:14.3.6 start
    ```
  </Tab>
