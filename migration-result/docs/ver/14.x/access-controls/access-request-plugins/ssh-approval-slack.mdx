...
<img src="/assets/diagram-258db6d174.png" alt="The Slack Access Request plugin" width="1800" height="666" />
...
<Tabs>
  <Tab title="Download">
    ...
    ```bash
    $ curl -L -O https://get.gravitational.com/teleport-access-slack-v14.3.3-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-slack-v14.3.3-linux-amd64-bin.tar.gz
    ...
    teleport-slack v14.3.3 git:teleport-slack-v14.3.3-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    ```bash
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-slack:14.3.3
    ```

    Make sure the plugin is installed by running the following command:

    ```bash
    $ docker run public.ecr.aws/gravitational/teleport-plugin-slack:14.3.3 version
    teleport-slack v14.3.3 git:teleport-slack-v14.3.3-api/14.0.0-gd1e081e 1.21
    ```
...
<img src="/assets/Create-a-Slack-App-ee24822a33.png" alt="Create Slack App" width="2210" height="1224" />
...
<img src="/assets/api-scopes-49ae0afd3c.png" alt="API Scopes" width="664" height="478" />
...
<img src="/assets/OAuth-ab2b4b7547.png" alt="OAuth Tokens" width="922" height="543" />
...
<Tabs>
  ...
  <Tab title="Docker">
    ...
    ```bash
    $ docker run -v <path-to-config>:/etc/teleport-slack.toml public.ecr.aws/gravitational/teleport-plugin-slack:14.3.6 start
    ```
  </Tab>
...
- Read our guides to configuring [Resource Access
  Requests](/docs/ver/14.x/access-controls/access-requests/resource-requests) and [Role Access
  Requests](/docs/ver/14.x/access-controls/access-requests/role-requests) so you can get the most out
