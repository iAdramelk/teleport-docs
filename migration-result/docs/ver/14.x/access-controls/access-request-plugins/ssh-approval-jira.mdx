...
<Tabs>
  <Tab title="Download">
    ...
    ```bash
    $ curl -L -O https://get.gravitational.com/teleport-access-jira-v14.3.3-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-jira-v14.3.3-linux-amd64-bin.tar.gz
    ...
    teleport-jira v14.3.3 git:teleport-jira-v14.3.3-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    ```bash
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-jira:14.3.3
    ```

    Make sure the plugin is installed by running the following command:

    ```bash
    $ docker run public.ecr.aws/gravitational/teleport-plugin-jira:14.3.3 version
    teleport-jira v14.3.3 git:teleport-jira-v14.3.3-api/14.0.0-gd1e081e 1.21
    ```
...
<img src="/assets/board-setup-b1569ac1af.png" alt="Jira board setup" width="2560" height="1440" />
...
<img src="/assets/new-request-447ef83aa1.png" alt="New Access Request" width="2560" height="1440" />
