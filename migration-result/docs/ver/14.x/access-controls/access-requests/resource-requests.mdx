...
<Accordion title="List of supported Kubernetes resources">
...
[filtering reference](/docs/ver/14.x/reference/cli#resource-filtering) for more information.
...
- Learn more about [Access Lists](/docs/ver/14.x/access-controls/access-lists)
