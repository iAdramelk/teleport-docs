...
clusters, see [Configure Trusted Clusters](/docs/ver/14.x/management/admin/trustedclusters).
...
After the file transfer has been requested, all session participants are notified
