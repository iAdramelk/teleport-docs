...
[integrate with many other providers](/docs/ver/14.x/access-controls/access-requests).

<Warning>
  This guide requires a commercial edition of Teleport. The open source edition of
  Teleport only supports [GitHub](/docs/ver/14.x/access-controls/sso/github-sso) as an
  SSO provider.
</Warning>
