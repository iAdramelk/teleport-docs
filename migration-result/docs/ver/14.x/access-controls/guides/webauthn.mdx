...
<Tip>
  ...
  *registered* security key" step. This may be undesirable at times, so you may
  ...
  Reference](/docs/ver/14.x/reference/cli/tsh#tsh-global-flags) page.
</Tip>
...
<Note>
  WebAuthn for logging in to Teleport is only required for [local users](/docs/ver/14.x/reference/authentication#local-no-authentication-connector).
...
- [Passwordless](/docs/ver/14.x/access-controls/guides/passwordless)
- [Set up per-session MFA checks](/docs/ver/14.x/access-controls/guides/per-session-mfa)
