...
<Tip>
  ...
  For Google Workspace, see [Teleport Authentication with Google Workspace](/docs/ver/14.x/access-controls/sso/google-workspace)
</Tip>
...
commands](/docs/ver/14.x/reference/resources) or the Teleport Web UI.
...
oidc](/docs/ver/14.x/reference/cli/tctl#tctl-sso-configure-oidc) section of the Teleport CLI
Reference page.
