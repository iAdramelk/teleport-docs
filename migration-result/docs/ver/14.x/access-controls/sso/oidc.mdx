...
<Tip>
  For Google Workspace please follow our dedicated [Guide](/docs/ver/14.x/access-controls/sso/google-workspace)
</Tip>
...
via `tctl` [resource commands](/docs/ver/14.x/reference/resources). To create a new connector,
...
`tctl` [resource commands](/docs/ver/14.x/reference/resources) as we used for the auth
connector.
