...
1. Select **Azure AD -> Enterprise Applications**
   ...
   <img src="/assets/azuread-1-home-553b890d08.png" alt="Select Enterprise Applications From Manage" width="293" height="438" />

2. Select **New application**

   <img src="/assets/azuread-2-newapp-a801b4e3a8.png" alt="Select New Applications From Manage" width="903" height="372" />
...
3. Select **Create your own application**, enter the application name (for example,
   ...
   <img src="/assets/azuread-3-createnongalleryapp-baf3b0eb2c.png" alt="Select Non-gallery application" width="1377" height="883" />

4. Select **Properties** under **Manage** and set **Assignment required?** to **No**

   <img src="/assets/azuread-4-turnoffuserassign-0d6e9d6d9a.png" alt="Turn off user assignment" width="2044" height="1958" />
...
1. Select **Single sign-on** under **Manage** and choose **SAML**
   ...
   <img src="/assets/azuread-5-selectsaml-b0abf716d8.png" alt="Select SAML" width="990" height="497" />

2. Edit the **Basic SAML Configuration**

   <img src="/assets/azuread-6-editbasicsaml-2b8a335236.png" alt="Edit Basic SAML Configuration" width="1039" height="383" />
...
3. Enter the URL for your Teleport Proxy Service host in the **Entity ID** and **Reply URL**  fields:
   ...
   <img src="/assets/azuread-7-entityandreplyurl-ad0a19fce1.png" alt="Put in Entity ID and Reply URL" width="1710" height="1852" />
...
4. In **SAML Certificates** section, copy the **App Federation
   ...
   <img src="/assets/azuread-9-fedmeatadataxml-c206577e78.png" alt="Download Federation Metadata XML" width="1522" height="769" />
...
2. Change the "name identifier format" to **Default**. Make sure the source
   ...
   <img src="/assets/azuread-8a-nameidentifier-37bedec1e3.png" alt="Confirm Name Identifier" width="1516" height="1042" />

3. Add a group claim to make user security groups available to the connector:

   <img src="/assets/azuread-8b-groupclaim-800e91d5af.png" alt="Put in Security group claim" width="1748" height="1098" />
...
4. Add a claim that transforms the format of the Azure AD username to lower case, in order to pass it to
   ...
   - Set the Value to `ToLowercase()`.
     ...
     <img src="/assets/azuread-8c-usernameclaim-1e6b540cd4.png" alt="Add a transformed username" width="2686" height="1818" />
...
<img src="/assets/azuread-token-encryption-0-e41ff41594.png" alt="Navigate to token encryption" width="528" height="1430" />

- Import certificate

<img src="/assets/azuread-token-encryption-1-import-24f85c2b7a.png" alt="Import certificate" width="1650" height="472" />

- Activate it

<img src="/assets/azuread-token-encryption-2-activate-bdf006700e.png" alt="Activate certificate" width="2130" height="572" />
...
<img src="/assets/azuread-nameid-427a83d6df.png" alt="Change NameID format to use email" width="1740" height="1106" />

## Further reading

- [Teleport Configuration Resources Reference](/docs/ver/14.x/reference/resources)
