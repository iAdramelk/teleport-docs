...
- `Name ID` should be a mapping of the LDAP Attribute `E-Mail-Addresses` to
  ...
  <img src="/assets/adfs-1-7c6d9499db.png" alt="Name ID Configuration" width="959" height="552" />

- A group membership claim should be used to map users to roles (for example to
  separate normal users and admins).

  <img src="/assets/adfs-2-f7329334c4.png" alt="Group Configuration" width="960" height="556" />
...
- If you are using dynamic roles (see below), it may be useful to map the LDAP
  ...
  <img src="/assets/adfs-3-f5a2ad14ff.png" alt="WAN Configuration" width="962" height="554" />

- And create another mapping of `E-Mail-Addresses` to `UPN`:

  <img src="/assets/adfs-4-6582626b20.png" alt="UPN Configuration" width="957" height="551" />
...
- Create a Relaying Party Trust:
  <img src="/assets/adfs-add-provider-trust-c148a6faa2.png" alt="Add a Claims Provider Trust" width="1732" height="904" />
...
<img src="/assets/adfs-add-teleport-cert-d15eb9ac13.png" alt="adfs-add-teleport-cert.png" width="1770" height="1286" />
