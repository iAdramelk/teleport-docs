...
![creation of a Google Cloud Platform project](../../../../../../assets/new-project-d8ca8dea8e.png)
...
![configuration of the OAuth consent screen](../../../../../../assets/consent-screen-1-7baee1e702.png)
...
![select email and openid scopes](../../../../../../assets/consent-screen-2-52c6c1ba0d.png)
...
![Create an OAuth Client ID](../../../../../../assets/create-oauth-client-id-ed71ad10de.png)
...
<nobr>HTTPS://EXAMPLE.TELEPORT.SH`/v1/webapi/oidc/callback`</nobr>

![OAuth client ID creation](../../../../../../assets/clientid-creation-8f929cf713.png)

Copy the Client ID and Client Secret from the next screen or click **DOWNLOAD JSON**:

![OAuth client data](../../../../../../assets/clientid-data-fc1baa5ec5.png)
...
![Create a service account](../../../../../../assets/create-service-account-392158a4f4.png)
...
![service account creation](../../../../../../assets/serviceacct-creation-b84d30b68a.png)

Click the newly-created account to view its details, and copy the Unique ID for later.

![service account unique ID](../../../../../../assets/serviceacct-uniqueid-885db194c2.png)

Create a new key for the service account, select JSON as the key type, and save
the resulting JSON file.

![service account key creation](../../../../../../assets/serviceacct-key-797654f7d6.png)
...
![domain-wide delegation](../../../../../../assets/domainwidedelegation-bd7aca40c8.png)
...
<Accordion title="Upgrading from Teleport < 8.1.2?">
