...
<Tip>
  Teleport supports device synchronization with [Jamf Pro](/docs/ver/14.x/access-controls/device-trust/jamf-integration). Once configured, devices
...
- A device must be registered. Registration may be
  ...
  integration, like the [Jamf Pro integration](/docs/ver/14.x/access-controls/device-trust/jamf-integration).
...
- [Device Trust Enforcement](/docs/ver/14.x/access-controls/device-trust/enforcing-device-trust)
