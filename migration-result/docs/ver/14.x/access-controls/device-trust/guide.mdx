...
works similar to [`require_session_mfa`](/docs/ver/14.x/access-controls/guides/per-session-mfa).
...
Refer to the [auto-enrollment guide](/docs/ver/14.x/access-controls/device-trust/auto-enrollment).
...
[macOS tsh installer](/docs/ver/14.x/installation#macos).

A trusted device needs to be registered and enrolled before it is recognized by
Teleport as such. Follow the [registration](/docs/ver/14.x/access-controls/device-trust/guide#step-12-register-a-trusted-device) and
[enrollment](/docs/ver/14.x/access-controls/device-trust/guide#step-22-enroll-a-trusted-device) steps
