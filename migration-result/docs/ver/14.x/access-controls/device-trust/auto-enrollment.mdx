...
[manual](/docs/ver/14.x/access-controls/device-trust/guide#step-12-register-a-trusted-device) or performed using an
integration, like the [Jamf integration](/docs/ver/14.x/access-controls/device-trust/jamf-integration).
...
- [A previously-registered device](/docs/ver/14.x/access-controls/device-trust/guide#step-12-register-a-trusted-device) is necessary for
