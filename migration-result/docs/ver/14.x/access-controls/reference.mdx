...
command line using [tctl resource commands](/docs/ver/14.x/reference/resources).
...
Check out our [predicate language](/docs/ver/14.x/reference/predicate-language#scoping-allowdeny-rules-in-role-resources)
guide for a more in depth explanation of the language.
