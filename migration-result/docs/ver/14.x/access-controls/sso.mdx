...
- [Azure Active Directory (AD)](/docs/ver/14.x/access-controls/sso/azuread): Configure Azure Active Directory SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Active Directory (ADFS)](/docs/ver/14.x/access-controls/sso/adfs): Configure Windows Active Directory SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Google Workspace](/docs/ver/14.x/access-controls/sso/google-workspace): Configure Google Workspace SSO for SSH, Kubernetes, databases, desktops and web apps.
- [GitHub](/docs/ver/14.x/access-controls/sso/github-sso): Configure GitHub SSO for SSH,
  Kubernetes, databases, desktops, and web apps.
- [GitLab](/docs/ver/14.x/access-controls/sso/gitlab): Configure GitLab SSO for SSH, Kubernetes, databases, desktops and web apps.
- [OneLogin](/docs/ver/14.x/access-controls/sso/one-login): Configure OneLogin SSO for SSH, Kubernetes, databases, desktops and web apps.
- [OIDC](/docs/ver/14.x/access-controls/sso/oidc): Configure OIDC SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Okta](/docs/ver/14.x/access-controls/sso/okta): Configure Okta SSO for SSH, Kubernetes, databases, desktops and web apps.
...
- `adfs` (SAML): Required for compatibility with Active Directory (ADFS); refer
  to the full [ADFS guide](/docs/ver/14.x/access-controls/sso/adfs#step-23-create-teleport-roles) for details.
- `netiq` (OIDC): Used to enable NetIQ-specific ACR value processing; refer to
  the [OIDC guide](/docs/ver/14.x/access-controls/sso/oidc#optional-acr-values) for details.
...
as described in the [Resources Reference](/docs/ver/14.x/reference/resources).
...
- [SSH Authentication with Okta](/docs/ver/14.x/access-controls/sso/okta)
- [SSH Authentication with OneLogin](/docs/ver/14.x/access-controls/sso/one-login)
- [SSH Authentication with ADFS](/docs/ver/14.x/access-controls/sso/adfs)
- [SSH Authentication with OAuth2 / OpenID Connect](/docs/ver/14.x/access-controls/sso/oidc)
...
| --------- | -------------------- | ------------------------------------------------------------------------------------------- |
| GitHub    | `display: GitHub`    | <img src="/assets/github@2x-724ac54c76.png" alt="github" width="419" height="62.5" />       |
| Microsoft | `display: Microsoft` | <img src="/assets/microsoft@2x-6158acb10a.png" alt="microsoft" width="416" height="62.5" /> |
| Google    | `display: Google`    | <img src="/assets/google@2x-ef9a318526.png" alt="google" width="419" height="62.5" />       |
| BitBucket | `display: Bitbucket` | <img src="/assets/bitbucket@2x-18a1eedbbf.png" alt="bitbucket" width="419" height="62.5" /> |
| OpenID    | `display: Okta`      | <img src="/assets/openId@2x-dafbbc8b0b.png" alt="Okta" width="418" height="54.5" />         |
