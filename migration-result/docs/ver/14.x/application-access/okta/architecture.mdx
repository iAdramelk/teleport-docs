...
<img src="/assets/okta-diagram-5d2279cfb1.png" alt="Architecture of the Okta Service" width="1800" height="1044" />
...
A guide for setting up a simple Okta Service can be found [here](/docs/ver/14.x/application-access/okta/guide).
