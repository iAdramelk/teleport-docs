...
<Tip>
  If you have not yet deployed the Auth Service and Proxy Service, you should follow one of our [getting started guides](/docs/ver/14.x/application-access/getting-started) or try our Teleport application access [interactive learning track](https://play.instruqt.com/teleport/invite/rgvuva4gzkon).
</Tip>
...
<Tabs>
  <Tab title="Using AWS Console">
    ...
    ![Create Role Step 1](../../../../../../assets/dynamodb-create-role-1-6823d0ab8e.png)

    Press "Next". Find the AWS-managed policy `AmazonAthenaFullAccess` and then select the policy:

    ![Create Role Step 2](../../../../../../assets/aws-create-iam-role-2-461eb140c1.png)

    Press "Next". Enter role name `ExampleTeleportAthenaRole` and press "Create role":

    ![Create Role Step 3](../../../../../../assets/aws-create-iam-role-3-16e815ffa5.png)
  </Tab>
...
Assign the `aws-athena-access` role to your Teleport user by running the following
...
<Tabs>
  ...
  <Tab title="GitHub">
    ...
    Edit `github.yaml`, adding `aws-athena-access` to the
  ...
  <Tab title="SAML">
    ...
    Edit `saml.yaml`, adding `aws-athena-access` to the
  ...
  <Tab title="OIDC">
    ...
    Edit `oidc.yaml`, adding `aws-athena-access` to the
...
![IAM role selector](../../../../../../assets/aws-database-select-iam-role-9a931437f7.png)
...
<Tabs>
  ...
  <Tab title="Connect with DBeaver">
    ...
    ![DBeaver main](../../../../../../assets/athena-dbeaver-main-3587b65932.png)

    Then fill in the `ProxyHost` and `ProxyPort` settings in "Driver properties":
    ![DBeaver main](../../../../../../assets/athena-dbeaver-properties-93fb011859.png)
