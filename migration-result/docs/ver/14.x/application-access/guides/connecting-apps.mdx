...
and follow the installation [instructions](/docs/ver/14.x/installation).
...
[role templates](/docs/ver/14.x/access-controls/guides/role-templates). In the
...
[Integrating with JWTs](/docs/ver/14.x/application-access/jwt/introduction) for more details.
