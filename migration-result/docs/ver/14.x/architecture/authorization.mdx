...
<img src="/assets/role-mapping@1.5x-de18662e59.svg" alt="Role mapping" width="759.3333333333334" height="967.3333333333334" />
...
that this cluster trusts. In this case, Teleport activates [trusted cluster mapping logic](/docs/ver/14.x/architecture/trustedclusters#role-mapping).
...
[`tctl users add`](/docs/ver/14.x/reference/cli) or API call.
...
[trusted cluster mapping logic](/docs/ver/14.x/architecture/trustedclusters#role-mapping) to support this use case.
...
<Tip>
  You can use `where` fields in all resource rules. Check out [the full role reference](/docs/ver/14.x/access-controls/reference) contains full role spec for details.
</Tip>
...
- [Access Control Reference](/docs/ver/14.x/access-controls/reference).
- [Teleport Predicate Language](/docs/ver/14.x/reference/predicate-language).
- [Access Requests Guides](/docs/ver/14.x/access-controls/access-requests)
- [Architecture Overview](/docs/ver/14.x/core-concepts)
- [Teleport Auth](/docs/ver/14.x/architecture/authentication)
