...
- [OpenSSH: `ssh`](/docs/ver/14.x/server-access/guides/openssh)
- [Teleport CLI client: `tsh ssh`](/docs/ver/14.x/reference/cli/tsh#tsh-ssh)
- [Teleport Proxy UI](/docs/ver/14.x/architecture/proxy) accessed via a web browser.
...
See the [reference](/docs/ver/14.x/reference/audit#recorded-sessions) to learn how to turn
on the recording proxy mode. Note that the recording mode is configured on the
Auth Service.

## More concepts

- [Architecture Overview](/docs/ver/14.x/core-concepts)
- [Teleport Authentication](/docs/ver/14.x/architecture/authentication)
- [Teleport Authorization](/docs/ver/14.x/architecture/authorization)
- [Teleport Proxy](/docs/ver/14.x/architecture/proxy)
