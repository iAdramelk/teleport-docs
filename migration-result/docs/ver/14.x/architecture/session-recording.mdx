...
[trusted clusters](/docs/ver/14.x/management/admin/trustedclusters) with their own
...
specified by the `audit_sessions_uri` field in the `teleport.yaml` [configuration file](/docs/ver/14.x/reference/config).
...
the [`tsh play`](/docs/ver/14.x/reference/cli/tsh#tsh-play) command. Desktop session
...
- [SSH session recording](/docs/ver/14.x/architecture/nodes#ssh-session-recording)
- [SSH recording modes](/docs/ver/14.x/reference/audit#modes)
- [Desktop Access recording](/docs/ver/14.x/desktop-access/reference/sessions)
