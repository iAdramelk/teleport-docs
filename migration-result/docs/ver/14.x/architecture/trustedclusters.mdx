...
- See how Teleport uses [Certificates](/docs/ver/14.x/architecture/authentication) for authentication.
- Reduce your surface of attack using [TLS routing](/docs/ver/14.x/architecture/tls-routing).
- Follow our [guide](/docs/ver/14.x/management/admin/trustedclusters) to set up trusted clusters.
