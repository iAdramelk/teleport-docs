...
In TLS routing mode [Teleport proxy](/docs/ver/14.x/architecture/proxy) multiplexes all client
...
See the [OpenSSH client](/docs/ver/14.x/server-access/guides/openssh) guide for details on
how it's configured.
...
See [GUI clients](/docs/ver/14.x/connect-your-client/gui-clients) guide for a usage
example.
...
<img src="/assets/tls-routing-connection-upgrade-e5185d62f9.svg" alt="Connection upgrade" width="928" height="614" />
...
- See [migration guide](/docs/ver/14.x/management/operations/tls-routing) to learn how to
