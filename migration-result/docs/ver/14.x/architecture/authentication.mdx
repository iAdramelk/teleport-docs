...
<img src="/assets/x509-cert@2x-751a238fd5.svg" alt="x.509 certs" width="408.5" height="491" />
...
<img src="/assets/ssh-cert@2x-3a2857405f.svg" alt="SSH certs" width="408.5" height="670" />
...
<img src="/assets/ssh-cert-short-lived@1.5x-36df22c36d.svg" alt="Short lived certs" width="788.6666666666666" height="373.3333333333333" />
...
<Tip>
  ...
  For those cases, Teleport Proxy can terminate live connections using [session and identity locking](/docs/ver/14.x/access-controls/guides/locking).
</Tip>
...
<img src="/assets/idp-sso-traits@1.5x-4e9be6e048.svg" alt="SSO exchange for short-lived certs" width="651.3333333333334" height="436" />
...
<img src="/assets/certs-machine-id@1.8x-3906419d75.svg" alt="Certificates for services" width="693.3333333333334" height="498.3333333333333" />
...
[short-lived tokens or cloud identity services](/docs/ver/14.x/agents/join-services-to-your-cluster/join-token).
...
Take a look at the [Certificate Rotation Guide](/docs/ver/14.x/management/operations/ca-rotation) to
...
<Tip>
  ...
  cluster certificates, use node [session and identity locking](/docs/ver/14.x/access-controls/guides/locking).
</Tip>
