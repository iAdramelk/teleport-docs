...
Policy](/docs/ver/14.x/desktop-access/active-directory-manual#enable-the-smart-card-service).
...
Policy](/docs/ver/14.x/desktop-access/active-directory-manual#create-another-gpo-and-import-the-teleport-ca). Note that if the
...
port](/docs/ver/14.x/desktop-access/active-directory-manual#open-firewall-to-inbound-rdp-connections) and [allow
remote RDP connections in Group
Policy](/docs/ver/14.x/desktop-access/active-directory-manual#allow-remote-rdp-connections).
...
Make sure that you [configure a certificate for RDP connections](/docs/ver/14.x/desktop-access/active-directory-manual#step-47-configure-a-certificate-for-rdp-connections).
...
[Desktop Access Manual Setup](/docs/ver/14.x/desktop-access/active-directory-manual#allow-remote-rdp-connections).
