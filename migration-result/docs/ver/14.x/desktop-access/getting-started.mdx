...
<Note>
  ...
  for automatic discovery by reading [Desktop Access with Active Directory](/docs/ver/14.x/desktop-access/active-directory).
...
<Accordion title="Version warning">
  ...
  an [Active Directory domain](/docs/ver/14.x/desktop-access/active-directory).
</Accordion>
...
Setup](https://cdn.teleport.dev/teleport-windows-auth-setup-v14.0.0-dev-amd64.exe).
...
Teleport in your config file, or use Teleport's [API](/docs/ver/14.x/api/introduction)
...
- See the [RBAC page](/docs/ver/14.x/desktop-access/rbac) for more information about setting up
  Windows desktop access permissions.
- See the [Access Controls Getting Started](/docs/ver/14.x/access-controls/getting-started#step-13-add-local-users-with-preset-roles)
