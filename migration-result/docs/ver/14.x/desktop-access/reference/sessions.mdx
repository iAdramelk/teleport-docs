...
<img src="/assets/session-recording@2x-6786acd6a3.png" alt="Desktop Session Recording" width="1255.5" height="489" />
...
Refer to the `storage` section of the [Teleport Configuration Reference](/docs/ver/14.x/reference/config)
