...
- Your workstation configured with [kubectl](https://kubernetes.io/docs/tasks/tools/), [Helm](https://helm.sh/docs/intro/install/), [doctl](https://docs.digitalocean.com/reference/doctl/how-to/install/), and the Teleport [tsh](/docs/ver/14.x/installation) client.
...
<img src="/assets/create-k8s-d007776ea2.png" alt="Create DigitalOcean Kubernetes cluster" width="2462" height="1210" />

<br />

While the Kubernetes cluster is being provisioned, follow the "Getting Started" guide as shown below:

<img src="/assets/setup-k8s-91b0116d94.png" alt="Set up DigitalOcean Kubernetes client" width="990" height="643" />
...
<img src="/assets/fqdn-ac81fc3020.png" alt="Configure DNS" width="2010" height="392" />
...
<img src="/assets/setup-user-2de78912de.png" alt="Set up user" width="2380" height="1528" />
...
<img src="/assets/edit-user-62df22ab07.png" alt="Edit user" width="2458" height="1330" />

Second, update the **tadmin** user role to assign the **member** role:

<img src="/assets/update-role-0f878b32c7.png" alt="Update role" width="2452" height="1456" />
...
<img src="/assets/view-activity-e1e28d5e63.png" alt="View audit log" width="2446" height="1318" />

## Next steps

To see all of the options you can set in the values file for the
`teleport-cluster` Helm chart, consult our [reference
guide](/docs/ver/14.x/reference/helm-reference/teleport-cluster).

Read our guides to additional ways you can protect a Kubernetes cluster with
Teleport:

- Connect another Kubernetes cluster to Teleport by [deploying the Teleport Kubernetes Service](/docs/ver/14.x/kubernetes-access/getting-started)
- [Set up Machine ID with Kubernetes](/docs/ver/14.x/machine-id/access-guides/kubernetes)
- [Federated Access using Trusted Clusters](/docs/ver/14.x/kubernetes-access/manage-access/federation)
- [Single-Sign On and Kubernetes Access Control](/docs/ver/14.x/kubernetes-access/controls)
