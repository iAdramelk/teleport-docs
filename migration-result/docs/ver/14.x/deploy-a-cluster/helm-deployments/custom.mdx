...
with custom [`teleport.yaml`](/docs/ver/14.x/reference/config) config file elements
...
<Warning>
  ...
  [Information on supported Teleport storage backends](/docs/ver/14.x/reference/backends)
...
You can find all possible configuration fields in the [Teleport Config Reference](/docs/ver/14.x/reference/config).
...
1. The Teleport Auth Service reads a license file to authenticate your Teleport
   Enterprise account.
