...
guide](/docs/ver/14.x/kubernetes-access/getting-started) to connect your Kubernetes
cluster to Teleport.
...
<img src="/assets/1-roles@1.5x-5879bb9a31.png" alt="Roles section" width="633.3333333333334" height="440" />

2. Fill in the details of a "Storage Bucket Creator" role (we suggest using the name `storage-bucket-creator-role`)

<img src="/assets/2-createrole@1.5x-0b0a1b7330.png" alt="Create role" width="618" height="584.6666666666666" />

3. Click the "Add Permissions" button.

<img src="/assets/3-addpermissions@1.5x-6e2b3c8e7c.png" alt="Storage bucket creator role" width="374.6666666666667" height="432" />

4. Use the "Filter" box to enter `storage.buckets.create` and select it in the list.

<img src="/assets/4-storagebucketscreate@1.5x-7a13f9a203.png" alt="Filter the list" width="371.3333333333333" height="426.6666666666667" />

5. Check the `storage.buckets.create` permission in the list and click the "Add" button to add it to the role.

<img src="/assets/5-select@1.5x-4ec47d7838.png" alt="Select storage.buckets.create" width="368" height="246.66666666666666" />

6. Once all these settings are entered successfully, click the "Create" button.

<img src="/assets/6-createrole@1.5x-439972b9df.png" alt="Create role" width="575.3333333333334" height="611.3333333333334" />
...
<img src="/assets/13-dns-createrole@1.5x-b7c90ccc1a.png" alt="Create role" width="540.6666666666666" height="542" />

3. Click the "Add Permissions" button.

<img src="/assets/3-addpermissions@1.5x-6e2b3c8e7c.png" alt="DNS updater role" width="374.6666666666667" height="432" />
...
<img src="/assets/14-dns-permissions-create@1.5x-62e1fda728.png" alt="Add DNS permissions" width="370" height="632" />
...
<img src="/assets/7-serviceaccounts@1.5x-4cf6bc0a07.png" alt="Create service account" width="515.3333333333334" height="253.33333333333334" />

2. Enter details for the service account (we recommend using the name `teleport-helm`) and click the "Create" button.

<img src="/assets/8-createserviceaccount@1.5x-6d360d6021.png" alt="Enter service account details" width="556.6666666666666" height="446" />
...
<img src="/assets/9-addroles@1.5x-7eeaf0bf07.png" alt="Add roles" width="363.3333333333333" height="434.6666666666667" />
...
<img src="/assets/10-serviceaccountdetails@1.5x-cc39661e82.png" alt="Click on the service account" width="539.3333333333334" height="522" />

2. Click the "Keys" tab at the top and click "Add Key". Choose "JSON" and click "Create".

<img src="/assets/11-createkey-aeb904f897.png" alt="Create JSON key" width="1344" height="804" />
...
<img src="/assets/12-privatekey@1.5x-bbc25bff71.png" alt="Private key saved" width="494" height="170" />
...
If you want to use a different version of Teleport, set the [`teleportVersionOverride`](/docs/ver/14.x/reference/helm-reference/teleport-cluster#teleportversionoverride) value.
...
Access](/docs/ver/14.x/access-controls/introduction) section to get started enrolling
users and setting up RBAC.

See the [high availability section of our Helm chart reference](/docs/ver/14.x/reference/helm-reference/teleport-cluster#highavailability) for more details on high availability.
