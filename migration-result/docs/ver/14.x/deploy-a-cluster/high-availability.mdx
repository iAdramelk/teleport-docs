...
<img src="/assets/ha-diagram-1c1f3f2548.png" alt="Architecture of a high availability Teleport deployment" width="1800" height="1176" />
...
will enable [TLS Routing](/docs/ver/14.x/management/operations/tls-routing) in your
Teleport cluster.
...
<Tip>
  ...
  Helm chart, read our [Helm Deployments](/docs/ver/14.x/deploy-a-cluster/helm-deployments) documentation.
</Tip>
...
to follow a more specific [deployment guide](/docs/ver/14.x/deploy-a-cluster/introduction) for your
environment.
...
Consult our [Backends Reference](/docs/ver/14.x/reference/backends) for the configuration
...
- [High-availability Teleport Deployments on Kubernetes with
  Helm](/docs/ver/14.x/deploy-a-cluster/helm-deployments)
- [Reference Deployments](/docs/ver/14.x/deploy-a-cluster/deployments) for running Teleport on a cluster of
  virtual machines
...
- [Scaling a Teleport cluster](/docs/ver/14.x/management/operations/scaling)
- [Monitoring a Teleport cluster](/docs/ver/14.x/management/diagnostics)
...
- [Databases](/docs/ver/14.x/database-access/getting-started)
- [Windows desktops](/docs/ver/14.x/desktop-access/getting-started)
- [Bot users](/docs/ver/14.x/machine-id/getting-started)
