...
- One or more Teleport SSH Service instances. If you have not yet done this,
  read the [Server Access Getting Started Guide](/docs/ver/14.x/server-access/getting-started) to
  learn how.
...
<Note>
  ...
  See the [OpenSSH guide](/docs/ver/14.x/server-access/guides/openssh) for more information.
