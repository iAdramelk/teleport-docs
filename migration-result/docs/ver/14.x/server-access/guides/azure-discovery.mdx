...
- `{{ .AutomaticUpgrades }}`: indicates whether Automatic Upgrades are enabled or disabled.
  ...
  [self-hosted automatic agent updates](/docs/ver/14.x/management/operations/self-hosted-automatic-agent-updates)
...
echo Teleport-14.0.0-dev
echo Repository Channel: stable/v14.0.0-dev
```
