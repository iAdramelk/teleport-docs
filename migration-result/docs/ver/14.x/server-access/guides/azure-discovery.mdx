...
<Tabs>
  <Tab title="Manually create identity">
    ...
    **Access control (IAM)** panel, click **Add > Add custom role**.
    ...
    ![Create custom
    role](/assets/create-custom-role-80673cb59e.png)
    ...
    **Add**.
    ...
    permission](/assets/read-permission-8b77bd11e1.png)
    ...
    **Access control (IAM)** panel, click **Add > Add role assignment**.
    ...
    ![Add a role
    assignment](/assets/add-role-assignment-16bce33185.png)
...
- Read [Joining Nodes via Azure Managed Identity](/docs/ver/14.x/agents/join-services-to-your-cluster/azure)
