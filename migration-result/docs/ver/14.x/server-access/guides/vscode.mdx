...
- One or more Teleport agents running the Teleport SSH Service. If you have not yet
  ...
  [Server Access Getting Started Guide](/docs/ver/14.x/server-access/getting-started) to learn how.
...
[OpenSSH guide](/docs/ver/14.x/server-access/guides/openssh) to configure the remote host to authenticate via
...
[dedicated guide](/docs/ver/14.x/server-access/guides/openssh) for additional information.
