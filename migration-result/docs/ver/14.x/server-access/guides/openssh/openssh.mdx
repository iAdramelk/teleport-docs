...
- RBAC and resource filtering based on [dynamically updated labels](/docs/ver/14.x/management/admin/labels)
- [Session recording without SSH connection termination](/docs/ver/14.x/server-access/guides/recording-proxy-mode)
- [Session sharing](/docs/ver/14.x/connect-your-client/tsh)
- [Advanced session recording](/docs/ver/14.x/server-access/guides/bpf-session-recording)
- [Restricting outbound network connections in SSH sessions](/docs/ver/14.x/server-access/guides/restricted-session)
...
<Tip>
  ...
  an option, you can [register your node manually instead](/docs/ver/14.x/server-access/guides/openssh/openssh-manual-install).
</Tip>
