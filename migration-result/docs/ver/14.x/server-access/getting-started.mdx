...
<img src="/assets/getting-started-diagram-1adf5b562e.svg" alt="Teleport Bastion" width="984" height="552" />
...
<img src="/assets/teleport_ui-35f52ccbd4.png" alt="Both servers in the Web UI" width="1797" height="349" />
...
- Learn more about Teleport `tsh` through the [reference documentation](/docs/ver/14.x/reference/cli/tsh#tsh-ssh).
- Learn more about [Teleport servers](/docs/ver/14.x/architecture/nodes#connecting-to-nodes)
- For a complete list of ports used by Teleport, read the [Networking Guide](/docs/ver/14.x/reference/networking).
...
- [Labels](/docs/ver/14.x/management/admin/labels)
