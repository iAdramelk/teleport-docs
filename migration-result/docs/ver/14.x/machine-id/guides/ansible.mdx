...
- If you already have not done so, follow the
  [Machine ID Getting Started Guide](/docs/ver/14.x/machine-id/getting-started) to create a bot
...
guide](/docs/ver/14.x/machine-id/getting-started), this user will be `root`. Assign ROOT to the username.
