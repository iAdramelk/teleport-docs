...
- If you have not already connected your application to Teleport, follow
  the [Application Access Getting Started Guide](/docs/ver/14.x/application-access/getting-started).
- If you're not already familiar with Machine ID, follow the
  [Getting Started Guide](/docs/ver/14.x/machine-id/getting-started) to familiarize yourself with
...
- Ensure the `tbot` binary is installed on your Machine ID client system.
  ...
  [Installation guide](/docs/ver/14.x/installation) for instructions on installing
...
[JWT authentication](/docs/ver/14.x/application-access/jwt/introduction) for your
app.
...
<Note>
  ...
  refer to the [Configuration Reference](/docs/ver/14.x/machine-id/reference/configuration) for a
...
- Review the [Access Controls Reference](/docs/ver/14.x/access-controls/reference#roles)
  to learn about restricting which Applications and other Teleport resources
  your bot may access.
- Configure [JWTs](/docs/ver/14.x/application-access/jwt/introduction) for your
