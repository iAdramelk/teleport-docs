...
- The `tsh` binary must be installed on the machine that will access the
  ...
  installed. If it is not, see [Installation](/docs/ver/14.x/installation) for
  details.
...
[Database Access RBAC guide](/docs/ver/14.x/database-access/rbac/configuring-access)
