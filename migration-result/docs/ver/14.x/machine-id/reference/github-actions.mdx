...
- [Using Machine ID with GitHub Actions](/docs/ver/14.x/machine-id/guides/github-actions): How to
  use Machine ID to SSH into Teleport nodes from GitHub Actions.
- [Using Machine ID with GitHub Actions and Kubernetes](/docs/ver/14.x/machine-id/guides/github-actions-kubernetes):
