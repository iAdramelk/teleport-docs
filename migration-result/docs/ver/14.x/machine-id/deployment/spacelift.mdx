...
Reference](/docs/ver/14.x/access-controls/reference#rbac-for-dynamic-teleport-resources)
...
version: "1"
stack_defaults:
  runner_image: public.ecr.aws/gravitational/teleport-spacelift-runner:14.3.6
  before_init:
  - |-
    tbot start --oneshot \
      --data-dir=memory:// \
...
- Now that you know how to manage Teleport configuration resources with
  ...
  reference](/docs/ver/14.x/reference/terraform-provider) so you can flesh out your
  configuration.
...
- Learn how you can help achieve secure access for service accounts by sending
  [anonymous Machine ID telemetry](/docs/ver/14.x/machine-id/reference/telemetry).
