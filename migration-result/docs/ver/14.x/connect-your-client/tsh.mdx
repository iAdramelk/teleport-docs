...
to call [`tsh login`](/docs/ver/14.x/reference/cli#tsh-login) in the beginning.
...
<Tabs>
  <Tab title="Mac">
    ...
    ```code
    $ curl -O https://cdn.teleport.dev/tsh-14.0.0-dev.pkg
    ```
  </Tab>
  ...
  <Tab title="Mac - Homebrew">
    ...
    <Note>
      ...
      versions. See our [compatibility policy](/docs/ver/14.x/management/operations/upgrading#component-compatibility) for details.
    </Note>
  </Tab>

  <Tab title="Windows - Powershell">
    ```code
    $ curl.exe -O https://cdn.teleport.dev/teleport-v14.0.0-dev-windows-amd64-bin.zip
  ...
  <Tab title="Linux">
    ...
    $ tar -xzf teleport-v14.0.0-dev-linux-amd64-bin.tar.gz
    $ cd teleport
    $ sudo ./install
...
[CLI Docs - tsh ssh](/docs/ver/14.x/reference/cli#tsh-ssh)
...
[CLI Docs - tsh login](/docs/ver/14.x/reference/cli#tsh-login)
...
<Tip>
  It is recommended to always use [`tsh login`](/docs/ver/14.x/reference/cli#tsh-login) before using any other `tsh` commands. This allows users to omit `--proxy` flag in subsequent tsh commands. For example `tsh ssh user@host` will work.
</Tip>
...
[CLI Docs - tsh status](/docs/ver/14.x/reference/cli#tsh-status)
...
[`tsh login`](/docs/ver/14.x/reference/cli#tsh-login) can also save the user certificate into a
file:
...
[CLI Docs - tctl auth sign](/docs/ver/14.x/reference/cli#tctl-auth-sign)
...
[CLI Docs - tsh ls](/docs/ver/14.x/reference/cli#tsh-ls)
...
These features are called **Trusted Clusters**. Refer to [the Trusted Clusters guide](/docs/ver/14.x/management/admin/trustedclusters)
...
[CLI Docs - tsh clusters](/docs/ver/14.x/reference/cli#tsh-clusters)
