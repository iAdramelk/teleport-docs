...
<Tabs>
  ...
  <Tab title="Commercial">
    <Tabs>
      ...
      <Tab title="SAML / OIDC / GitHub user">
        ```bash
...
1. Click **CONNECT** to connect to the Teleport cluster:
   ...
   <img src="/assets/teleport-connect-init-d987311a14.png" alt="A new instance of Teleport Connect" width="755" height="518" />
...
4. Browse and connect to all the resources your user is permitted to access:
   ...
   <img src="/assets/connect-ui-overview@2x-2e682a1226.png" alt="An example of Teleport Connect, populated with instances" width="1280" height="720" />
...
<Tabs>
  ...
  <Tab title="Web UI">
    From the  **Servers** menu, the Teleport
...
<Tabs>
  ...
  <Tab title="Teleport Connect">
    ...
    see a list of Kubernetes clusters you can access.
        ...
        <img src="/assets/connect-kube-list-d92cc4b07e.png" alt="Clusters you can access" width="5120" height="2880" />
    ...
    `kubectl` commands to interact with the cluster.
        ...
        <img src="/assets/connect-kube-access-b1ff32a570.png" alt="Connect to a cluster" width="5120" height="2880" />
  </Tab>

  <Tab title="Web UI">
    In the Teleport Web UI, click the&#x20;
    **Kubernetes** tab. You will see a list of Kubernetes clusters your Teleport
    user is authorized to connect to.

        <img src="/assets/kubernetes-clusters-90f7c25bb7.png" alt="Available Kubernetes clusters" width="5120" height="2880" />
    ...
    via Teleport.
        ...
        <img
          src="/assets/kubernetes-login-f735072170.png"
          alt="Connect to a Kubernetes
    cluster"
          width="5120"
          height="2880"
        />
  ...
  <Tab title="Teleport Connect">
    ...
    **CONNECT**. Select or type in a username available to your Teleport user.
    ...
    initiate a CLI connection inside Teleport Connect:
        ...
        <img src="/assets/teleport-connect-mysql-5669e054b2.png" alt="Teleport Connect database connection" width="1124" height="578" />
  </Tab>

  <Tab title="Web UI">
    The Teleport Web UI cannot provide direct connections to databases, but it will
    list those that are accessible to your user under&#x20;
...
3. Next to the desktop you want to access, click **CONNECT**. Select
   or type in a username available to your Teleport user.
4. Teleport will open a new browser tab or window and begin the RDP session.
...
- `tsh` is the CLI tool for accessing resources through Teleport. With it,
  ...
  Learn more about it from [Using the tsh Command Line Tool](/docs/ver/14.x/connect-your-client/tsh).
...
- Teleport Connect is a graphic utility for connecting to resources through
  ...
  clusters. See [Using Teleport Connect](/docs/ver/14.x/connect-your-client/teleport-connect).

{/*lint ignore messaging for page title*/}

- [Database Access GUI Clients](/docs/ver/14.x/connect-your-client/gui-clients) details
