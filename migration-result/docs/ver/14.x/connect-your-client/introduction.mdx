...
1. Click **CONNECT** to connect to the Teleport cluster:
   ...
   ![A new instance of Teleport Connect](/assets/teleport-connect-init-d987311a14.png)
...
4. Browse and connect to all the resources your user is permitted to access:
   ...
   ![An example of Teleport Connect, populated with instances](/assets/connect-ui-overview@2x-2e682a1226.png)
...
<Tabs>
  ...
  <Tab title="Teleport Connect">
    ...
    ![Clusters you can access](/assets/connect-kube-list-d92cc4b07e.png)
    ...
    ![Connect to a cluster](/assets/connect-kube-access-b1ff32a570.png)
  </Tab>
  ...
  <Tab title="Web UI">
    ...
    **Kubernetes** tab. You will see a list of Kubernetes clusters your Teleport
    ...
    ![Available Kubernetes clusters](/assets/kubernetes-clusters-90f7c25bb7.png)
    ...
    cluster](/assets/kubernetes-login-f735072170.png)
  </Tab>
</Tabs>
...
<Tabs>
  ...
  <Tab title="Teleport Connect">
    ...
    **CONNECT**. Select or type in a username available to your Teleport user.
    ...
    ![Teleport Connect database connection](/assets/teleport-connect-mysql-5669e054b2.png)
  </Tab>
