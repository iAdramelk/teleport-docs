...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [`teleport join openssh`](/docs/ver/14.x/server-access/guides/openssh/openssh)), you must specify the `sshd` port
...
For more information about Teleport authentication, see [Authentication options](/docs/ver/14.x/reference/authentication).
...
- [CLI Reference](/docs/ver/14.x/reference/cli/tsh#tsh-puttyconfig).
