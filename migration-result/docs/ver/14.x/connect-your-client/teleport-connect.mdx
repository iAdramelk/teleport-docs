...
<Tabs>
  ...
  <Tab title="Linux">
    ...
    ```code
    $ tar -xf  teleport-connect-14.0.0-dev-linux-*.tar.gz
    ```
  </Tab>
  ...
  <Tab title="Windows">
    ...
    ```code
    $ "Teleport Connect Setup-14.0.0-dev.exe" /S
    ```
  </Tab>
</Tabs>
...
variable](/docs/ver/14.x/reference/cli#tsh-environment-variables). For example, logging in to a new cluster
