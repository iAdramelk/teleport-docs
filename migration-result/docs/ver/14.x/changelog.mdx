...
- We've added a Waiting Room for customers using Access Workflows. [Docs](/docs/ver/14.x/access-controls/access-request-plugins)
...
Teleport 4.3 introduces four new plugins that work out of the box with [Approval Workflow](/docs/ver/14.x/access-controls/access-request-plugins). These plugins allow you to automatically support role escalation with commonly used third party services. The built-in plugins are listed below.
