...
[documentation](/docs/ver/14.x/machine-id/guides/github-actions) for using
...
[documentation](/docs/ver/14.x/machine-id/guides/databases).
...
[documentation](/docs/ver/14.x/management/operations/upgrading).
...
procedure](/docs/ver/14.x/management/admin/upgrading-the-teleport-binary).
...
- [Documented Teleport Plugins](/docs/ver/14.x/access-controls/access-request-plugins/index)
