...
- A running Teleport cluster in Kubernetes. For details on how to set this up,
  see [Guides for running Teleport using Helm](/docs/ver/14.x/deploy-a-cluster/helm-deployments).
...
- The Auth Service ServiceAccount must be granted the `system:auth-delegator`
  ...
  chart](/docs/ver/14.x/reference/helm-reference/teleport-cluster) version 12 or
...
<Tabs>
  <Tab title="Using tctl locally as your current user">
  ...
  <Tab title="Using tctl on the Auth Service as an admin">
...
- The possible values for `teleport-kube-agent` chart are documented
  [in its reference](/docs/ver/14.x/reference/helm-reference/teleport-kube-agent).
- See [Application Access Guides](/docs/ver/14.x/application-access/guides)
- See [Database Access Guides](/docs/ver/14.x/database-access/guides)
