...
<Accordion title="Connecting directly to the Auth Service">
  ...
  <Warning>
    ...
    by executing [`tctl auth rotate`](/docs/ver/14.x/reference/cli/tctl#tctl-auth-rotate).
  </Warning>
...
------------- --------------------- -------------- ---------------------- -------
1f58429134c4  6805dda3-779e-493b...                hostname=1f58429134c4  14.3.6
```
...
- If you have workloads split across different networks or clouds, we recommend
  setting up trusted clusters. Read how to get started in [Configure Trusted Clusters](/docs/ver/14.x/management/admin/trustedclusters).
