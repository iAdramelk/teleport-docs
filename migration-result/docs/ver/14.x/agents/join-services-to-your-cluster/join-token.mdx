...
<Accordion title="Connecting directly to the Auth Service">
  ...
  <Warning>
    ...
    by executing [`tctl auth rotate`](/docs/ver/14.x/reference/cli#tctl-auth-rotate).
  </Warning>
...
------------- --------------------- -------------- ---------------------- -------
1f58429134c4  6805dda3-779e-493b...                hostname=1f58429134c4  14.0.0-dev
```
...
- If you have workloads split across different networks or clouds, we recommend
  ...
  guide](/docs/ver/14.x/management/admin/trustedclusters).
