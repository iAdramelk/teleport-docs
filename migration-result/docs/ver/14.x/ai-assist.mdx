...
- A running Teleport Community Edition cluster, v12.4 or higher. For details on
  how to set this up, see our [Getting Started](/docs/ver/14.x) guide.
...
- [Access controls](/docs/ver/14.x/access-controls/getting-started)
- [Resource filtering](/docs/ver/14.x/reference/predicate-language)
- [Access request plugins](/docs/ver/14.x/access-controls/access-request-plugins)
