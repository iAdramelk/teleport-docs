...
[Athena](/docs/ver/14.x/reference/backends#athena) backend for audit events and the
[S3](/docs/ver/14.x/reference/backends#s3) backend for session recordings. It is only
...
<img src="/assets/integration-046b475dd3.png" alt="Screenshot of External Audit Storage integration tile" width="1352" height="862" />
...
[Event Handler](/docs/ver/14.x/management/export-audit-events) plugin to export
