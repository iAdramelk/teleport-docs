...
Edition](/docs/ver/14.x/choose-an-edition/introduction).
...
guides](/docs/ver/14.x/deploy-a-cluster/introduction).
...
| [Google Cloud KMS support](/docs/ver/14.x/choose-an-edition/teleport-enterprise/gcp-kms)     | Teleport Enterprise allows you to configure the Teleport Auth Service to use Google Cloud KMS-based private keys for establishing trust with users and Teleport services.                                                                                                               |
...
License File](/docs/ver/14.x/choose-an-edition/teleport-enterprise/license) for how to manage the file in your Teleport
