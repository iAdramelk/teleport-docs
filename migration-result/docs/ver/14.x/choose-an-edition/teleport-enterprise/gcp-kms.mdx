...
3. Perform a full [CA rotation](/docs/ver/14.x/management/operations/ca-rotation).
...
2. Perform a full [CA rotation](/docs/ver/14.x/management/operations/ca-rotation).
