...
<Tip>
  ...
  compares to Teleport Team, see the [Choose an Edition](/docs/ver/14.x/choose-an-edition/introduction) guide.
</Tip>
...
- Docker installed on your workstation. We will use a Docker container to
  ...
  <Tip>
    ...
    configure access to them](/docs/ver/14.x/server-access/introduction).
  </Tip>

- The `tsh` client tool. Visit our [Installation Guide](/docs/ver/14.x/installation)
...
![Add your first
resource](../../../../../assets/add-my-first-resource@2x-239d908158.png)
...
![Select resource
type](../../../../../assets/choose-resource@2x-e0b1d4cb7e.png)
...
![Connected
successfully](../../../../../assets/successfully-connected@2x-56f5ff8ca4.png)
...
![Session
recordings](../../../../../assets/session-recordings@2x-cb38decb3f.png)
...
Terraform](/docs/ver/14.x/agents/deploy-agents-terraform).
