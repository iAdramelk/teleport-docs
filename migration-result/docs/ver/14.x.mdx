...
Team](/docs/ver/14.x/choose-an-edition/teleport-team).
...
<Tip>
  ...
  use [host user creation](/docs/ver/14.x/server-access/guides/host-user-creation).
...
Terraform](/docs/ver/14.x/agents/deploy-agents-terraform) to get started.
