...
Team](/docs/ver/13.x/choose-an-edition/teleport-team).

## Set up a demo cluster

<img
  src="/assets/linux-server-diagram-2ab2358d52.png"
  alt="Architecture of the setup you will complete in this
guide"
  width="1666"
  height="602"
/>
...
<img src="/assets/welcome-79f3654310.png" alt="Teleport Welcome Screen" width="2560" height="1440" />
...
<Tip>
  ...
  use [host user creation](/docs/ver/13.x/server-access/guides/host-user-creation).
...
<img src="/assets/add-resources-cf0b3256e6.png" alt="Adding resources" width="2650" height="1491" />
...
Terraform](/docs/ver/13.x/agents/deploy-agents-terraform) to get started.
