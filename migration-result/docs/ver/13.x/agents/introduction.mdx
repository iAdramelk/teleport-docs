...
Reference](/docs/ver/13.x/reference/config#enabling-teleport-services) for which
...
agents](/docs/ver/13.x/agents/deploy-agents-terraform).
...
Cluster](/docs/ver/13.x/agents/join-services-to-your-cluster) guides.
...
e.g., [using a Terraform module](/docs/ver/13.x/agents/deploy-agents-terraform). To modify the
...
- **Dynamic**: Apply a [configuration
  resource](/docs/ver/13.x/management/dynamic-resources) that configures a resource to
  proxy.
...
[Read our guide](/docs/ver/13.x/agents/deploy-agents-terraform) to deploying a pool of agents
