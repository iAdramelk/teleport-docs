...
guide](/docs/ver/13.x/kubernetes-access/manage-access/rbac).
...
<Tip>
  ...
  methods](/docs/ver/13.x/kubernetes-access/register-clusters) and [automatic methods](/docs/ver/13.x/kubernetes-access/discovery) for
