...
- [AWS](/docs/ver/13.x/kubernetes-access/discovery/aws): Kubernetes Auto-Discovery for AWS EKS clusters.
- [Azure](/docs/ver/13.x/kubernetes-access/discovery/azure): Kubernetes Auto-Discovery for Azure AKS clusters.
- [Google Cloud](/docs/ver/13.x/kubernetes-access/discovery/google-cloud): Kubernetes Auto-Discovery for
