...
Guides](/docs/ver/13.x/deploy-a-cluster/helm-deployments).
...
Guide](/docs/ver/13.x/kubernetes-access/getting-started).
...
[Read our overview](/docs/ver/13.x/kubernetes-access/discovery) of how Teleport automatically discovers
Kubernetes clusters.

Read our guides to automatically registering Kubernetes clusters with Teleport
on your cloud:

- [AWS](/docs/ver/13.x/kubernetes-access/discovery/aws)
- [Google Cloud](/docs/ver/13.x/kubernetes-access/discovery/google-cloud)
- [Azure](/docs/ver/13.x/kubernetes-access/discovery/azure)
...
Read our [Kubernetes RBAC guide](/docs/ver/13.x/kubernetes-access/manage-access/rbac) for step-by-step
...
Reference](/docs/ver/13.x/kubernetes-access/controls).

See how to federate your Kubernetes access controls using [Teleport Trusted
Clusters](/docs/ver/13.x/kubernetes-access/manage-access/federation).
