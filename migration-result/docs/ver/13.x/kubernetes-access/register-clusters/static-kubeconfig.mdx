...
Teleport Kubernetes Service [on that cluster](/docs/ver/13.x/kubernetes-access/getting-started), you can
...
<Accordion title="Connecting multiple Kubernetes clusters?">
  ...
  [merge-kubeconfigs.sh](https://github.com/gravitational/teleport/blob/branch/v13/examples/k8s-auth/merge-kubeconfigs.sh)
