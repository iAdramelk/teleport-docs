...
If you want to use a different version of Teleport, set the [`teleportVersionOverride`](/docs/ver/13.x/reference/helm-reference/teleport-cluster#teleportversionoverride) value.
...
See the [high availability section of our Helm chart reference](/docs/ver/13.x/reference/helm-reference/teleport-cluster#highavailability) for more details on high availability.
