...
- The reason for both of these requirements is that Teleport uses X509 certificates for authentication, which requires
  ...
  [using ALPN connection upgrades](/docs/ver/13.x/architecture/tls-routing#working-with-layer-7-load-balancers-or-reverse-proxies-preview).
    ...
    <Tabs>
      <Tab title="cert-manager">
        ...
        <Note>
          ...
          [ensure you set](/docs/ver/13.x/reference/helm-reference/teleport-cluster#highavailabilitycertmanageraddcommonname)
          ...
          [reference the secret](/docs/ver/13.x/reference/helm-reference/teleport-cluster#tlsexistingcasecretname)
