...
2. Teleport's [Proxy Peering](/docs/ver/13.x/architecture/proxy-peering) is used to reduce the total number of tunnel connections in the Teleport cluster.
...
architecture](/assets/aws-gslb-proxy-peering-ha-deployment-4a02a0cf1a.png)
