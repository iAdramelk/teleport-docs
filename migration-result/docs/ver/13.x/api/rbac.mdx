...
- Go version 1.20 or above installed on your workstation. See the
...
Assign the `sync-kubernetes-rbac-impersonator` role to your Teleport user by running the following
...
<Tabs>
  <Tab title="Local User">
    ...
    Edit `out.yaml`, adding `sync-kubernetes-rbac-impersonator` to the list of existing roles:
  ...
  <Tab title="GitHub">
    ...
    Edit `github.yaml`, adding `sync-kubernetes-rbac-impersonator` to the
  ...
  <Tab title="SAML">
    ...
    Edit `saml.yaml`, adding `sync-kubernetes-rbac-impersonator` to the
  ...
  <Tab title="OIDC">
    ...
    Edit `oidc.yaml`, adding `sync-kubernetes-rbac-impersonator` to the
...
Run the following command, ensuring that PROXY-ADDRESS includes
...
- [Servers](/docs/ver/13.x/server-access/rbac)
- [Databases](/docs/ver/13.x/database-access/rbac)
- [Kubernetes clusters](/docs/ver/13.x/kubernetes-access/manage-access/rbac)
- [Windows Desktops](/docs/ver/13.x/desktop-access/rbac)
- [Applications](/docs/ver/13.x/application-access/controls)

For general guidance, read our [Access Controls
Reference](/docs/ver/13.x/access-controls/reference).
...
- [AWS](/docs/ver/13.x/application-access/cloud-apis/aws-console)
- [Google Cloud](/docs/ver/13.x/application-access/cloud-apis/google-cloud)
- [Azure](/docs/ver/13.x/application-access/cloud-apis/azure)
...
documentation](/docs/ver/13.x/machine-id/introduction) to learn more.
