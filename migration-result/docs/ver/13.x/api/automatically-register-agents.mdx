...
clusters](/docs/ver/13.x/kubernetes-access/discovery) in AWS, Azure, and Google Cloud,
as well as [servers](/docs/ver/13.x/server-access/guides/ec2-discovery) on Amazon EC2.
...
const (
	...
	proxyAddr      string = ""
	teleportImage  string = "public.ecr.aws/gravitational/teleport-distroless:13.2.0"
...
```code
$ docker image pull public.ecr.aws/gravitational/teleport-distroless:13.2.0
```
