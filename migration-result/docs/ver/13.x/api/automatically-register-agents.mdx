...
Assign the `register-apps-impersonator` role to your Teleport user by running the appropriate
...
<Tabs>
  <Tab title="Local User">
    ...
    2. Edit `out.yaml`, adding `register-apps-impersonator` to the list of existing roles:
...
const (
	...
	proxyAddr      string = ""
	teleportImage  string = "public.ecr.aws/gravitational/teleport-distroless:13.4.16"
...
```code
$ docker image pull public.ecr.aws/gravitational/teleport-distroless:13.4.16
```
