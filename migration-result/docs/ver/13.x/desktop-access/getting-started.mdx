...
Teleport in your config file, or use Teleport's [API](/docs/ver/13.x/api/introduction)
...
- See the [RBAC page](/docs/ver/13.x/desktop-access/rbac) for more information about setting up
  Windows desktop access permissions.
- See the [Access Controls Getting Started](/docs/ver/13.x/access-controls/getting-started#step-13-add-local-users-with-preset-roles)
