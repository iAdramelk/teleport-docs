...
Policy](/docs/ver/13.x/desktop-access/active-directory-manual#enable-the-smart-card-service).
...
Policy](/docs/ver/13.x/desktop-access/active-directory-manual#create-another-gpo-and-import-the-teleport-ca). Note that if the
Teleport CA was rotated since the last import, you will have to fetch the
new CA using the following command, assigning PROXY to the address of your Teleport Proxy Service:
...
port](/docs/ver/13.x/desktop-access/active-directory-manual#open-firewall-to-inbound-rdp-connections) and [allow
remote RDP connections in Group
Policy](/docs/ver/13.x/desktop-access/active-directory-manual#allow-remote-rdp-connections).
...
Make sure that you [configure a certificate for RDP connections](/docs/ver/13.x/desktop-access/active-directory-manual#step-47-configure-a-certificate-for-rdp-connections).
...
[Desktop Access Manual Setup](/docs/ver/13.x/desktop-access/active-directory-manual#allow-remote-rdp-connections).
