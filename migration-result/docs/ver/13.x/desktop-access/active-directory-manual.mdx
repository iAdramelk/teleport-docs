...
<Tip>
  ...
  Directory](/docs/ver/13.x/desktop-access/active-directory) for more information.

  Teleport Enterprise users can configure Windows Access for local users by
  following [Getting Started with Windows Access](/docs/ver/13.x/desktop-access/getting-started).
...
<Warning>
  ...
  Started with Desktop Access](/docs/ver/13.x/desktop-access/getting-started).
</Warning>
...
Started](/docs/ver/13.x/index) guide to set up a demo cluster.
...
<Note>
  ...
  you must first perform a [CA rotation](/docs/ver/13.x/management/operations/ca-rotation) in
...
[configuration reference](/docs/ver/13.x/desktop-access/reference/configuration) page.
...
[Troubleshooting documentation](/docs/ver/13.x/desktop-access/troubleshooting) for common problems and
solutions.
