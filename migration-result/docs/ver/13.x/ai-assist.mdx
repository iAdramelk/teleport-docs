...
- A running Teleport Community Edition cluster. For details on how to set this
  up, see our [Getting Started](/docs/ver/13.x/index) guide.
...
- [Access controls](/docs/ver/13.x/access-controls/getting-started)
- [Resource filtering](/docs/ver/13.x/reference/predicate-language)
- [Access request plugins](/docs/ver/13.x/access-controls/access-request-plugins/index)
