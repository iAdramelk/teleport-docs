...
[scope](/docs/ver/13.x/contributing/documentation/reference#scopes). If the `scopeOnly` property is provided and the
...
`scope` is an optional property that specifies the component's [scope](/docs/ver/13.x/contributing/documentation/reference#scopes).
...
![Example](/assets/overview-142db944e1.png)
...
In the main menu, click on  **Desktops**
to view desktops available to your Teleport user.

<Accordion title="Available icons">
  | Name           | Example |
  | :------------- | :------ |
  | `arrow`        |         |
  | `bolt`         |         |
...
<Accordion title="Getting cluster information">
  Log in to your Teleport cluster using the following command:
...
<Accordion title="Page variables" />
...
[explanation](/docs/ver/13.x/contributing/documentation/reference#scopes) of how to use the `scope` property.
...
<Tabs>
  <Tab title="First label">
    First tab.
  </Tab>

  <Tab title="Second label">
    Second tab.
  </Tab>
</Tabs>
...
`scope` is an optional property that specifies the component's
[scope](/docs/ver/13.x/contributing/documentation/reference#scopes). Selecting a scope via the menu at the top of
...
<Tabs dropdownView dropdownCaption="Teleport Component">
  ...
  <Tab title="Desktop Service">
    More information about the Desktop Service.
  </Tab>

  <Tab title="SSH Service">
    More information about the SSH Service.
  </Tab>
