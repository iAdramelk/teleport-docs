...
- Consult our [style guide](/docs/ver/13.x/contributing/documentation/style-guide) to ensure your docs page is
  consistent with the rest of our docs.
- Use our [UI reference](/docs/ver/13.x/contributing/documentation/reference) to find the right UI components for your needs.
