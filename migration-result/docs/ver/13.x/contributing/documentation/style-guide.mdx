...
- **[How-to guides](/docs/ver/13.x/contributing/documentation/style-guide#how-to-guides)**: Tutorials for intermediate readers who want to set up Teleport for a specific scenario.
- **[Getting started articles](/docs/ver/13.x/contributing/documentation/style-guide#getting-started-articles)**: Designed to get the user up and running in the quickest way possible.
- **[Architecture guides](/docs/ver/13.x/contributing/documentation/style-guide#architecture-guides)**: Guides that explain how Teleport works to advanced readers, e.g., architects, DevSecOps engineers, and SREs.
- **[Conceptual guides](/docs/ver/13.x/contributing/documentation/style-guide#conceptual-guides)**: Explain concepts related to Teleport for users who want a deeper understanding of its functionality.
- **[Reference manuals](/docs/ver/13.x/contributing/documentation/style-guide#reference-manuals)**: Provide a comprehensive list of configuration options, API methods, metrics, and other ways of interacting with Teleport.
...
- Several great examples are available here: [https://gravitational.slab.com/posts/diagrams-ix9nzhpd](https://gravitational.slab.com/posts/diagrams-ix9nzhpd).
...
- Mac users should use Quicktime's `Cmd-Shift-5` to record a small part of the screen:
  ...
  <img src="/assets/quicktime-0824e26657.webp" alt="quicktime" width="2152" height="1286" />
