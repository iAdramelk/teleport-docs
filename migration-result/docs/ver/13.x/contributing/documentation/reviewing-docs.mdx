...
<img src="/assets/doc-submodules-37302c7e4f.png" alt="The structure of the gravitational/docs repo" width="1440" height="1256" />
...
- While reviewing documentation changes, you will often run into partials,
  ...
  Read about these in the [UI Reference](/docs/ver/13.x/contributing/documentation/reference).
- To make sure that docs pages make consistent use of language and structure,
  ...
  guide](/docs/ver/13.x/contributing/documentation/style-guide).
