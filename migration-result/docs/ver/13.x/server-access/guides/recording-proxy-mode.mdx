...
![Teleport OpenSSH Recording Proxy](/assets/openssh-proxy-384f8ddf6d.svg)
...
[Server Access Getting Started Guide](/docs/ver/13.x/server-access/getting-started) so you can start
