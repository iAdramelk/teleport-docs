...
Teleport's default [SSH and Kubernetes session recording](/docs/ver/13.x/architecture/nodes#ssh-session-recording)
...
<Tip>
  ...
  [Teleport Nodes](/docs/ver/13.x/architecture/nodes#ssh-session-recording) for more
  details.
</Tip>
...
- Read more about
  [session recording](/docs/ver/13.x/architecture/nodes#ssh-session-recording).
- See all configuration options for Enhanced Session Recording in our
  [Configuration Reference](/docs/ver/13.x/reference/config).
