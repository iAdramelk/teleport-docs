...
- A running instance of the Teleport SSH Service registered with your Teleport
  ...
  Guide](/docs/ver/13.x/server-access/introduction). The SSH node must include a user
...
on the
[GitLab CI reference page.](/docs/ver/13.x/machine-id/reference/gitlab#gitlab-join-token)
...
deploy-job:
  ...
  script:
    ...
    - tar -xvf teleport-v13.4.16-linux-amd64-bin.tar.gz
