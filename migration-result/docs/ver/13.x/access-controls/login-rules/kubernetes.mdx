...
- Follow Step 1 of the
  [Teleport operator guide](/docs/ver/13.x/management/dynamic-resources/teleport-operator#step-13-install-teleport-cluster-helm-chart-with-the-operator)
...
- Read the [Teleport Operator Guide](/docs/ver/13.x/management/dynamic-resources/teleport-operator) to
