...
The [`tctl sso test`](/docs/ver/13.x/reference/cli/tctl#tctl-sso-test) command can be used to
...
checking the [reference page](/docs/ver/13.x/reference/cli/tctl#tctl-login_rule-test).
