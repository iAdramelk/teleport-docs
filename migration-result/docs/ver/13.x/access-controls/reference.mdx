...
command line using [tctl resource commands](/docs/ver/13.x/reference/resources).
...
| `record_session`             | Defines the [Session recording mode](/docs/ver/13.x/reference/audit#modes).                                                                                                   | The strictest value takes precedence.                                                                                                                                                                                                      |
...
explicitly set. Additionally, roles `v5` or `v6` are required to use [Moderated Sessions](/docs/ver/13.x/access-controls/guides/moderated-sessions).
...
fine-grained control over Kubernetes resources. See [Kubernetes RBAC](/docs/ver/13.x/kubernetes-access/manage-access/rbac) for more details.
...
This works by [labeling resources](/docs/ver/13.x/management/admin/labels) and
...
Check out our
[predicate language](/docs/ver/13.x/reference/predicate-language#label-expressions)
...
[shared sessions](/docs/ver/13.x/connect-your-client/tsh#sharing-sessions) and
[session recordings](/docs/ver/13.x/architecture/nodes#ssh-session-recording).
The examples below illustrate how to restrict session access only for the user
who created the session.

<Accordion title="Version Warning: Before 8.1">
...
Refer to the [Second Factor - WebAuthn](/docs/ver/13.x/access-controls/guides/webauthn#u2f) guide if you
...
Check out our [predicate language](/docs/ver/13.x/reference/predicate-language#scoping-allowdeny-rules-in-role-resources)
guide for a more in depth explanation of the language.
