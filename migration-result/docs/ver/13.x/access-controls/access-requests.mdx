...
Edition, see [Teleport Community Access Requests](/docs/ver/13.x/access-controls/access-requests/oss-role-requests).
...
[Get started with Resource Access Requests](/docs/ver/13.x/access-controls/access-requests/resource-requests).
...
[Get started with Role Access Requests](/docs/ver/13.x/access-controls/access-requests/role-requests).
