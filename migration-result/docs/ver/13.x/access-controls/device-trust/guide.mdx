...
<Tip>
  ...
  clusters](/docs/ver/13.x/management/admin/trustedclusters) to limit the impact of
...
works similar to [`require_session_mfa`](/docs/ver/13.x/access-controls/guides/per-session-mfa).
...
Similar to [session and identity locking](/docs/ver/13.x/access-controls/guides/locking), a device can
...
Refer to the [auto-enrollment guide](/docs/ver/13.x/access-controls/device-trust/auto-enrollment).
...
[macOS tsh installer](/docs/ver/13.x/installation#macos).

A trusted device needs to be registered and enrolled before it is recognized by
Teleport as such. Follow the [registration](/docs/ver/13.x/access-controls/device-trust/guide#step-12-register-a-trusted-device) and
[enrollment](/docs/ver/13.x/access-controls/device-trust/guide#step-22-enroll-a-trusted-device) steps
