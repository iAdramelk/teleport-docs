...
- A v12.2+ Teleport cluster with WebAuthn configured.
  See the [Second Factor: WebAuthn](/docs/ver/13.x/access-controls/guides/webauthn) guide.
- WebAuthn hardware device, such as YubiKey.
- Machines for Headless WebAuthn activities have [Linux](/docs/ver/13.x/installation#linux), [macOS](/docs/ver/13.x/installation#macos) or [Windows](/docs/ver/13.x/installation#windows-tsh-client-only) `tsh` binary v12.2+ installed.
