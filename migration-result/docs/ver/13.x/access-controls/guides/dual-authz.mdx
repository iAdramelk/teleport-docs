...
edition of Teleport only supports [GitHub](/docs/ver/13.x/access-controls/sso/github-sso) as
an SSO provider.

<Tip>
  The steps below describe how to use Teleport with Mattermost. You can also [integrate with many other providers](/docs/ver/13.x/access-controls/access-requests).
</Tip>
