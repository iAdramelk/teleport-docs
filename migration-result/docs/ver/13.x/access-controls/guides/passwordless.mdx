...
- Teleport must be configured for WebAuthn. See the [Second Factor:
  WebAuthn](/docs/ver/13.x/access-controls/guides/webauthn) guide.
...
- A signed and notarized version of `tsh` is required for Touch ID. This precludes
  versions installed from Homebrew. [Download the macOS tsh installer](/docs/ver/13.x/installation#macos).
...
[installation page](/docs/ver/13.x/installation).
...
standalone version of `tsh`. [Download the macOS tsh installer](/docs/ver/13.x/installation#macos).
