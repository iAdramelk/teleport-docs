...
Moderated sessions use roles to allow fine grained control over who can join a session
...
- **Allow** policies define which sessions users can join and under what conditions
...
clusters, see [Configure Trusted Clusters](/docs/ver/13.x/management/admin/trustedclusters).
...
When Alice—a user assigned the `auditor` role—joins the waiting session
...
<img src="/assets/webui-active-session-0471242e8b.png" alt="Join Server Session from UI" width="1137" height="446" />
...
After the file transfer has been requested, all session participants approve notified
and prompted to approve or deny the file transfer request.

<img src="/assets/moderated-file-transfer-dialog-cde3615842.png" alt="Approve/Deny Prompt" width="1314" height="233" />
