...
<Tabs>
  <Tab title="Download">
    ...
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-msteams-v13.3.8-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-msteams-v13.3.8-linux-amd64-bin.tar.gz
    ...
    teleport-msteams v13.3.8 git:teleport-msteams-v13.3.8-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    ```code
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-msteams:13.3.8
    ```

    Make sure the plugin is installed by running the following command:

    ```code
    $ docker run public.ecr.aws/gravitational/teleport-plugin-msteams:13.3.8 version
    teleport-msteams v13.3.8 git:teleport-msteams-v13.3.8-fffffffff 1.21
    ```
...
```text
teleport-msteams v13.3.8 go1.21
...
<Tabs>
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker run -v <path-to-config>:/etc/teleport-msteams.toml public.ecr.aws/gravitational/teleport-plugin-msteams:13.4.16 start
    ```
  </Tab>
