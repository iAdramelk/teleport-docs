...
<Tabs>
  <Tab title="Download">
    ...
    ```code
    $ curl -L -O https://get.gravitational.com/teleport-access-discord-v13.3.8-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-discord-v13.3.8-linux-amd64-bin.tar.gz
    ...
    teleport-discord v13.3.8 git:teleport-discord-v13.3.8-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    ```code
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-discord:13.3.8
    ```

    Make sure the plugin is installed by running the following command:

    ```code
    $ docker run public.ecr.aws/gravitational/teleport-plugin-discord:13.3.8 version
    teleport-discord v13.3.8 git:teleport-discord-v13.3.8-fffffffff 1.21
    ```
...
<Tabs>
  <Tab title="Executable">
    ...
    ```code
    $ teleport-discord start
    INFO   Starting Teleport Access Discord Plugin 13.4.16: discord/app.go:80
  ...
  <Tab title="Docker">
    ...
    ```code
    $ docker run -v <path-to-config>:/etc/teleport-discord.toml public.ecr.aws/gravitational/teleport-plugin-discord:13.4.16 start
    ```
  </Tab>
