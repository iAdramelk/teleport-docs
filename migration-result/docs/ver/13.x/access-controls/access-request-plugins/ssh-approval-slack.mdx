...
<Tabs>
  <Tab title="Download">
    ...
    ```bash
    $ curl -L -O https://get.gravitational.com/teleport-access-slack-v13.3.8-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-slack-v13.3.8-linux-amd64-bin.tar.gz
    ...
    teleport-slack v13.3.8 git:teleport-slack-v13.3.8-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    ```bash
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-slack:13.3.8
    ```

    Make sure the plugin is installed by running the following command:

    ```bash
    $ docker run public.ecr.aws/gravitational/teleport-plugin-slack:13.3.8 version
    teleport-slack v13.3.8 git:teleport-slack-v13.3.8-fffffffff 1.21
    ```
...
<Tabs>
  ...
  <Tab title="Docker">
    ...
    ```bash
    $ docker run -v <path-to-config>:/etc/teleport-slack.toml public.ecr.aws/gravitational/teleport-plugin-slack:13.4.16 start
    ```
  </Tab>
