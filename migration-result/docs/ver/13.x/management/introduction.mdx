...
and Kubernetes Operator. Read [Using Dynamic Resources](/docs/ver/13.x/management/dynamic-resources)
for more information.

## Configure your cluster

Get to know the [tools you can use](/docs/ver/13.x/management/dynamic-resources) to apply
...
The [Admin Guides](/docs/ver/13.x/management/admin) section describes how to perform routine
...
The [Operations](/docs/ver/13.x/management/operations) section describes how to perform critical,
...
[Security](/docs/ver/13.x/management/security) section.

## Integrations

Teleport integrates with third-party software in order to enable secure access
to your infrastructure. The [Integrations](/docs/ver/13.x/management/guides) section describes
...
Learn more in the [Diagnostics](/docs/ver/13.x/management/diagnostics) section.
...
[Exporting Audit Events](/docs/ver/13.x/management/export-audit-events) guides.
