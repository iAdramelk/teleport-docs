...
[enroll agents into automatic updates](/docs/ver/13.x/management/operations/enroll-agent-into-automatic-updates).
...
Make the `current` release channel target the version 13.4.16:

```bash
$ echo -n "13.4.16" > current/version
```
...
You can now [enroll agents into automatic updates](/docs/ver/13.x/management/operations/enroll-agent-into-automatic-updates).
