...
<Tabs>
  <Tab title="Open Source">
    - A running Teleport cluster. For details on how to set this up, see our
      [Getting Started](/docs/ver/13.x/index) guide (skip TLS certificate setup).
    ...
    - The `tctl` and `tsh` client tools version >= 13.4.16.
...
<Tabs>
  ...
  <Tab title="Helm chart">
    ...
    [extraArgs](/docs/ver/13.x/reference/helm-reference/teleport-cluster#extraargs)
    ...
    ](/docs/ver/13.x/reference/helm-reference/teleport-kube-agent#insecureskipproxytlsverify)
    flag to `true`:
...
flag](/docs/ver/13.x/connect-your-client/teleport-connect#skipping-tls-certificate-verification).

## Further reading

- [Configuring Teleport TLS Certs](/docs/ver/13.x/index#configure-teleport)
- [Run Teleport as a systemd Daemon](/docs/ver/13.x/management/admin/daemon)
- [Teleport Proxy Service](/docs/ver/13.x/architecture/proxy)
