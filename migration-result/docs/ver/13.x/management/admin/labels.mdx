...
<Tip>
  ...
  | [Databases](/docs/ver/13.x/database-access/getting-started)             | Teleport can discover some AWS-hosted databases automatically. In this case, labels will also be automatically applied.                                               |
  | [Kubernetes clusters](/docs/ver/13.x/kubernetes-access/getting-started) |                                                                                                                                                                       |
  | [Servers](/docs/ver/13.x/server-access/getting-started)                 |                                                                                                                                                                       |
  | [Windows desktops](/docs/ver/13.x/desktop-access/getting-started)       | Dynamic labels are not supported for Windows desktops. See our [Desktop Access documentation](/docs/ver/13.x/desktop-access/rbac#labeling) for how to label desktops. |
</Tip>
...
[Resource filtering](/docs/ver/13.x/reference/predicate-language).
