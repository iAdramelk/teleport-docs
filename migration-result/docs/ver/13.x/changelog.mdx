...
- Ensure connect\_to\_node\_attempts\_total is always incremented when dialing hosts. [#36738](https://github.com/gravitational/teleport/pull/36738)
...
- Added cluster\_auth\_preferences to the shortcuts for cluster\_auth\_preference. [#35328](https://github.com/gravitational/teleport/pull/35328)
...
guide](/docs/ver/13.x/server-access/guides/openssh).
...
guide](/docs/ver/13.x/deploy-a-cluster/helm-deployments/migration-v12).
...
follow
the [migration guide](/docs/ver/13.x/deploy-a-cluster/helm-deployments/migration-v12).
...
[documentation](/docs/ver/13.x/machine-id/guides/github-actions) for using
...
[documentation](/docs/ver/13.x/access-controls/guides/hardware-key-support):
...
- [VS Code](/docs/ver/13.x/server-access/guides/vscode)
- [JetBrains](/docs/ver/13.x/server-access/guides/jetbrains-sftp)
...
guide](/docs/ver/13.x/database-access/guides/azure-postgres-mysql) for more
details.
...
images](/docs/ver/13.x/installation#docker).
...
[install Teleport](/docs/ver/13.x/installation#linux).
...
See the [documentation](/docs/ver/13.x/access-controls/guides/passwordless).
...
[documentation](/docs/ver/13.x/server-access/guides/host-user-creation).
...
Refer to [the guide](/docs/ver/13.x/database-access/guides/sql-server-ad) to set
...
[documentation](/docs/ver/13.x/database-access/guides/snowflake).
...
Learn more about it in the [documentation](/docs/ver/13.x/database-access/guides/redis-aws).
...
[documentation](/docs/ver/13.x/machine-id/guides/databases).
...
[documentation](/docs/ver/13.x/management/operations/upgrading).
...
Refer to the
[documentation](/docs/ver/13.x/reference/networking#http-connect-proxies)
for more details.
...
instructions](/docs/ver/13.x/server-access/getting-started#step-14-install-teleport-on-your-linux-host).
...
guide](/docs/ver/13.x/access-controls/guides/moderated-sessions) for more
details.
...
documentation](/docs/ver/13.x/reference/backends) for more information.
...
configuration](/docs/ver/13.x/desktop-access/getting-started) to force Windows
...
See the [documentation](/docs/ver/13.x/reference/backends) for more information.
...
[Machine ID getting started guide](/docs/ver/13.x/machine-id/getting-started)
...
[Self-hosted Redis guide](/docs/ver/13.x/database-access/guides/redis)
...
[SQL Server guide](/docs/ver/13.x/database-access/guides/sql-server-ad)
...
[Updated RDS guide](/docs/ver/13.x/database-access/guides/rds)
...
- [`teleport db configure
  create`](/docs/ver/13.x/database-access/reference/cli#teleport-db-configure-create)
- [`teleport db configure bootstrap`](/docs/ver/13.x/database-access/reference/cli#teleport-db-configure-bootstrap)
...
[Moderated Sessions guide](/docs/ver/13.x/access-controls/guides/moderated-sessions)
...
[Getting Started Guide](/docs/ver/13.x/desktop-access/getting-started).
...
[documentation](/docs/ver/13.x/application-access/cloud-apis/aws-console).
...
[apps](/docs/ver/13.x/application-access/guides/dynamic-registration)
and
[databases](/docs/ver/13.x/database-access/guides/dynamic-registration).
...
See updated
[RDS guide](/docs/ver/13.x/database-access/guides/rds) for
more information.
...
View the [database access with MongoDB](/docs/ver/13.x/database-access/guides/mongodb-self-hosted) for more details.
...
View the Cloud SQL MySQL [guide](/docs/ver/13.x/database-access/guides/mysql-cloudsql) for more details.
...
Teleport application access can now automatically sign users into the AWS Management Console using [Identity federation](https://aws.amazon.com/identity/federation). View AWS Management Console [guide](/docs/ver/13.x/application-access/cloud-apis/aws-console) for more details.
...
View the [database access with Redshift on AWS guide](/docs/ver/13.x/database-access/guides/postgres-redshift) for more details.
...
MFA](/docs/ver/13.x/access-controls/guides/per-session-mfa) documentation or
[RFD
...
We have implemented [database access](/docs/ver/13.x/database-access/introduction),
...
Configure database access following the [Getting Started](/docs/ver/13.x/database-access/introduction#getting-started) guide.

##### Guides

- [AWS RDS/Aurora PostgreSQL](/docs/ver/13.x/database-access/guides/rds)
- [AWS RDS/Aurora MySQL](/docs/ver/13.x/database-access/guides/rds)
- [Self-hosted PostgreSQL](/docs/ver/13.x/database-access/guides/postgres-self-hosted)
- [Self-hosted MySQL](/docs/ver/13.x/database-access/guides/mysql-self-hosted)
- [GUI clients](/docs/ver/13.x/connect-your-client/gui-clients)

##### Resources

To learn more about configuring role-based access control for database access, check out the [RBAC](/docs/ver/13.x/database-access/introduction) section.

[Architecture](/docs/ver/13.x/database-access/introduction) provides a more in-depth look at database access internals such as networking and security.

See [Reference](/docs/ver/13.x/database-access/reference) for an overview of database access related configuration and CLI commands.

Finally, check out [Frequently Asked Questions](/docs/ver/13.x/database-access/faq).
...
Please follow our [standard upgrade procedure](/docs/ver/13.x/management/admin) to upgrade your cluster.
...
You can learn more in the [Application Access introduction](/docs/ver/13.x/application-access/introduction).
...
Learn more about [Teleport's RBAC Resources](/docs/ver/13.x/access-controls/introduction)

##### Cluster Labels

Teleport 5.0 also adds the ability to set labels on Trusted Clusters. The labels are set when creating a trusted cluster invite token. This lets teams use the same RBAC controls used on nodes to approve or deny access to clusters. This can be especially useful for MSPs that connect hundreds of customers' clusters - when combined with Access Workflows, cluster access can easily be delegated. Learn more by reviewing our [Truster Cluster Setup & RBAC Docs](/docs/ver/13.x/management/admin/trustedclusters)
...
- We've added a Waiting Room for customers using Access Workflows. [Docs](/docs/ver/13.x/access-controls/access-request-plugins/index)
...
We've added an [API Guide](/docs/ver/13.x/api/introduction) to simply developing applications against Teleport.

#### Upgrade Notes

Please follow our [standard upgrade
procedure](/docs/ver/13.x/management/admin/upgrading-the-teleport-binary).
...
Please follow our [standard upgrade
procedure](/docs/ver/13.x/management/operations/upgrading).
...
Teleport 4.3 introduces four new plugins that work out of the box with [Approval Workflow](/docs/ver/13.x/access-controls/access-request-plugins/index). These plugins allow you to automatically support role escalation with commonly used third party services. The built-in plugins are listed below.

- [PagerDuty](/docs/ver/13.x/access-controls/access-request-plugins/ssh-approval-pagerduty)
- [Jira](/docs/ver/13.x/access-controls/access-request-plugins/ssh-approval-jira)
- [Slack](/docs/ver/13.x/access-controls/access-request-plugins/ssh-approval-slack)
- [Mattermost](/docs/ver/13.x/access-controls/access-request-plugins/ssh-approval-mattermost)
...
procedure](/docs/ver/13.x/management/operations/upgrading) to upgrade to this version.
...
docs](/docs/ver/13.x/management/operations/ca-rotation).
...
permissions](/docs/ver/13.x/kubernetes-access/manage-access/rbac).

##### Path prefix for etcd

The [etcd backend](/docs/ver/13.x/reference/backends#etcd) now correctly uses
...
[upgrade guidance](/docs/ver/13.x/management/operations/upgrading).

**Note: If you use an etcd backend with a non-default prefix and need to downgrade from 4.3 to 4.2, you should [backup Teleport data and restore it](/docs/ver/13.x/management/operations/backup-restore) into the downgraded cluster.**
...
- Alpha: Workflows API lets admins escalate RBAC roles in response to user requests. [Read the docs](/docs/ver/13.x/access-controls/access-requests). [#3006](https://github.com/gravitational/teleport/issues/3006)
- Beta: Teleport provides HA Support using Firestore and Google Cloud Storage using Google Cloud Platform. [Read the docs](/docs/ver/13.x/deploy-a-cluster/deployments/gcp). [#2821](https://github.com/gravitational/teleport/pull/2821)
- Remote tctl execution is now possible. [Read the docs](/docs/ver/13.x/reference/cli/tctl). [#1525](https://github.com/gravitational/teleport/issues/1525) [#2991](https://github.com/gravitational/teleport/issues/2991)
...
- Adopting root/leaf terminology for trusted clusters. [Trusted cluster documentation](/docs/ver/13.x/management/admin/trustedclusters).
- Documented Teleport FedRAMP & FIPS Support. [FedRAMP & FIPS documentation](/docs/ver/13.x/access-controls/compliance-frameworks/fedramp).
...
- Teleport now support 10,000 remote connections to a single Teleport cluster. [Using our recommend hardware setup.](/docs/ver/13.x/management/operations/scaling#hardware-recommendations)
...
Teleport 4.0 is backwards compatible with Teleport 3.2 and later. [Follow the recommended upgrade procedure to upgrade to this version.](/docs/ver/13.x/management/operations/upgrading)
...
procedure](/docs/ver/13.x/management/operations/upgrading) to upgrade to this
version.
...
- Role templates (depreciated in Teleport 2.3) were fully removed. We recommend
  migrating to role variables which are documented [here](/docs/ver/13.x/access-controls/guides/role-templates)
...
- The Teleport daemon now implements built-in connection draining which allows
  ...
  documentation](/docs/ver/13.x/management/admin/upgrading-the-teleport-binary).
