...
[`teleport join openssh`](/docs/ver/13.x/server-access/guides/openssh/openssh)), you must specify the `sshd` port
...
<img src="/assets/putty-window-1edb46b857.png" alt="Main PuTTY window" width="452" height="437" />

2. Double-click a session to connect to the host through Teleport.

<img src="/assets/putty-console-753182d312.png" alt="PuTTY console" width="661" height="418" />
...
<img src="/assets/winscp-1-ab50b3a746.png" alt="WinSCP Site Manager window" width="626" height="422" />

2. Click the **Tools** button at the bottom left, and choose **Import Sites**.

<img src="/assets/winscp-2-4106a33512.png" alt="Click 'Tools', then choose 'Import Sites...'" width="226" height="237" />
...
<img src="/assets/winscp-3-dda4ab049b.png" alt="Choose PuTTY sessions to import and click OK" width="374" height="301" />
...
<img src="/assets/winscp-4-db81dd5c1a.png" alt="Click 'Tools', then choose 'Preferences...'" width="226" height="245" />
...
<img src="/assets/winscp-5-e7dafcd7cb.png" alt="Click 'Security', Check 'Load authorities from PuTTY' then click OK" width="545" height="495" />
...
<img src="/assets/winscp-6-707baef6c7.png" alt="Choose the host from the list and click Login" width="625" height="422" />
...
For more information about Teleport authentication, see [Authentication options](/docs/ver/13.x/reference/authentication).
...
- [CLI Reference](/docs/ver/13.x/reference/cli/tsh#tsh-puttyconfig).
