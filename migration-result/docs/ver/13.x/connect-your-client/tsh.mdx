...
to call [`tsh login`](/docs/ver/13.x/reference/cli#tsh-login) in the beginning.
...
<Tabs>
  <Tab title="Mac">
    ...
    ```code
    $ curl -O https://cdn.teleport.dev/tsh-13.2.0.pkg
    ```
  </Tab>
  ...
  <Tab title="Windows - Powershell">
    ```code
    $ curl.exe -O https://cdn.teleport.dev/teleport-v13.2.0-windows-amd64-bin.zip
  ...
  <Tab title="Linux">
    ...
    ```code
    $ curl -O https://cdn.teleport.dev/teleport-v13.2.0-linux-amd64-bin.tar.gz
...
[CLI Docs - tsh ssh](/docs/ver/13.x/reference/cli#tsh-ssh)
...
[CLI Docs - tsh login](/docs/ver/13.x/reference/cli#tsh-login)
...
<Tip>
  It is recommended to always use [`tsh login`](/docs/ver/13.x/reference/cli#tsh-login) before using any other `tsh` commands. This allows users to omit `--proxy` flag in subsequent tsh commands. For example `tsh ssh user@host` will work.
</Tip>
...
[CLI Docs - tsh status](/docs/ver/13.x/reference/cli#tsh-status)
...
[`tsh login`](/docs/ver/13.x/reference/cli#tsh-login) can also save the user certificate into a
file:
...
[CLI Docs - tctl auth sign](/docs/ver/13.x/reference/cli#tctl-auth-sign)
...
[CLI Docs - tsh ls](/docs/ver/13.x/reference/cli#tsh-ls)
...
[CLI Docs - tsh clusters](/docs/ver/13.x/reference/cli#tsh-clusters)
