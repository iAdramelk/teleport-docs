...
<img src="/assets/connect-cluster-f528f473f3.png" alt="resources tab in Teleport Connect" width="2545" height="1564" />
...
<Tabs>
  ...
  <Tab title="Linux">
    ...
    ```code
    $ tar -xf  teleport-connect-13.4.16-linux-*.tar.gz
    ```
  </Tab>
  ...
  <Tab title="Windows">
    ...
    ```code
    $ "Teleport Connect Setup-13.4.16.exe" /S
    ```
  </Tab>
</Tabs>
...
<img src="/assets/connect-ui-overview-c5655c3b8e.png" alt="user interface of Teleport Connect" width="2541" height="1562" />
...
variable](/docs/ver/13.x/reference/cli/tsh#tsh-environment-variables). For example, logging in to a new cluster
