...
See our [Upgrading](/docs/ver/13.x/management/operations/upgrading) guide for more
information.
...
Teleport offers this feature for the [Enterprise versions of Teleport](/docs/ver/13.x/choose-an-edition/teleport-enterprise/introduction).
...
[CLI Reference](/docs/ver/13.x/reference/cli#tctl-alerts-list).
