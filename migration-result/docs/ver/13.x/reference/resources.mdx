...
| [login\_rule](#login-rules)                            | A Login Rule, see the [Login Rules guide](/docs/ver/13.x/access-controls/login-rules) for more info.                             |
| [device](#device)                                      | A Teleport Trusted Device, see the [Device Trust guide](/docs/ver/13.x/access-controls/device-trust/guide) for more info.        |
