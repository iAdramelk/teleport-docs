...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    You can replay recorded sessions using the [`tsh play`](/docs/ver/13.x/reference/cli#tsh-play)
  ...
  <Tab title="Teleport Cloud">
    ...
    You can replay recorded sessions using the [`tsh play`](/docs/ver/13.x/reference/cli#tsh-play) command or the Web
    UI.
