...
<Tip>
  You can use
  [Enhanced Session Recording with BPF](/docs/ver/13.x/server-access/guides/bpf-session-recording)
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [DynamoDB](/docs/ver/13.x/reference/backends#dynamodb) or [Firestore](/docs/ver/13.x/reference/backends#firestore)
    ...
    period is 1 year, but this can be overridden using the `retention_period`
    ...
    [Teleport Configuration Reference](/docs/ver/13.x/reference/config).
...
<Tip>
  ...
  read [Exporting Teleport Audit Events](/docs/ver/13.x/management/export-audit-events).
</Tip>
...
<Tabs>
  <Tab title="Self-Hosted">
    Teleport can store the recorded sessions in an [AWS S3 bucket](/docs/ver/13.x/reference/backends#s3)
    ...
    You can replay recorded sessions using the [`tsh play`](/docs/ver/13.x/reference/cli/tsh#tsh-play)
