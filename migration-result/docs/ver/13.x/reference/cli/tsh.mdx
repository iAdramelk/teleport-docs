...
See [full docs on `tsh puttyconfig` here](/docs/ver/13.x/connect-your-client/putty-winscp).
...
```code
$ tsh version
Teleport v13.4.16 git: go1.21
Proxy version: 13.4.16
