...
You can [browse the source on GitHub](https://github.com/gravitational/teleport-plugins/tree/v13.4.16/charts/access/slack).
...
Slack](/docs/ver/13.x/access-controls/access-request-plugins/ssh-approval-slack) guide
