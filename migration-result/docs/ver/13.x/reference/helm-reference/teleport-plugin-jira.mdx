...
GitHub](https://github.com/gravitational/teleport-plugins/tree/v13.4.16/charts/access/jira).
...
documentation](/docs/ver/13.x/access-controls/access-request-plugins/ssh-approval-jira)
