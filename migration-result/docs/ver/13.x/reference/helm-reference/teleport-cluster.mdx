...
[Disabling local auth is required for FedRAMP / FIPS](/docs/ver/13.x/access-controls/compliance-frameworks/fedramp#teleport-auth-server).
...
<Note>
  ...
  and the relevant sections of the [AWS](/docs/ver/13.x/deploy-a-cluster/helm-deployments/aws#step-36-configure-tls-certificates-for-teleport) and [GCP](/docs/ver/13.x/deploy-a-cluster/helm-deployments/gcp#step-36-install-and-configure-cert-manager) guides for more information.
</Note>
...
<Note>
  ...
  of the [AWS](/docs/ver/13.x/deploy-a-cluster/helm-deployments/aws#step-36-configure-tls-certificates-for-teleport) and [GCP](/docs/ver/13.x/deploy-a-cluster/helm-deployments/gcp#step-36-install-and-configure-cert-manager) guides for more information.
</Note>
