...
Read our guides to how [authorization](/docs/ver/13.x/architecture/authorization) and
[authentication](/docs/ver/13.x/architecture/authentication) work in Teleport.
...
works](/docs/ver/13.x/architecture/proxy).
...
in our [CLI Reference](/docs/ver/13.x/reference/cli/teleport).
...
Service](/docs/ver/13.x/application-access/introduction).
...
Service](/docs/ver/13.x/database-access/introduction).
...
Service](/docs/ver/13.x/desktop-access/introduction).
...
Service](/docs/ver/13.x/kubernetes-access/introduction)
...
Read more about the [Teleport SSH Service](/docs/ver/13.x/server-access/introduction).
...
Read more in our [Machine ID guide](/docs/ver/13.x/machine-id/introduction).
...
edition in [Choose an edition](/docs/ver/13.x/choose-an-edition/introduction).
...
guide](/docs/ver/13.x/choose-an-edition/teleport-cloud/introduction).
...
guide](/docs/ver/13.x/choose-an-edition/teleport-enterprise/introduction).
...
Read more in our [resource reference](/docs/ver/13.x/reference/resources).
...
Read our [guide to Teleport roles](/docs/ver/13.x/access-controls/guides/role-templates).
...
Read more about [local users](/docs/ver/13.x/reference/authentication) and how [SSO
authentication works in Teleport](/docs/ver/13.x/access-controls/sso).
...
See our guide to [Authentication Options](/docs/ver/13.x/reference/authentication).
...
guide](/docs/ver/13.x/architecture/trustedclusters) for how Trusted Clusters work and our
[how-to guide](/docs/ver/13.x/management/admin/trustedclusters) for how to configure
Trusted Clusters.
