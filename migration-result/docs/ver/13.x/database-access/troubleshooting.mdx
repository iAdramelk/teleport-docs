...
- [PostgreSQL](/docs/ver/13.x/database-access/guides/postgres-self-hosted#step-25-create-a-certificatekey-pair)
- [MySQL/MariaDB](/docs/ver/13.x/database-access/guides/mysql-self-hosted#step-24-create-a-certificatekey-pair)
- [MongoDB](/docs/ver/13.x/database-access/guides/mongodb-self-hosted#set-up-mutual-tls)
- [CockroachDB](/docs/ver/13.x/database-access/guides/cockroachdb-self-hosted#set-up-mutual-tls)
- [Redis](/docs/ver/13.x/database-access/guides/redis#step-45-set-up-mutual-tls)
- [Redis Cluster](/docs/ver/13.x/database-access/guides/redis-cluster#step-46-set-up-mutual-tls)
...
access see the [RBAC](/docs/ver/13.x/database-access/rbac) documentation.
...
feature](/docs/ver/13.x/management/operations/tls-routing), where the Teleport Proxy
...
command](/docs/ver/13.x/connect-your-client/gui-clients#get-connection-information),
