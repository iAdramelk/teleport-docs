...
For a more general description of Teleport roles and examples see [RBAC](/docs/ver/13.x/access-controls/introduction), as
...
The `{{external.xyz}}` variables are replaced with values from external [SSO](/docs/ver/13.x/access-controls/sso)
