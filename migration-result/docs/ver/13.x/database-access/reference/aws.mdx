...
bootstrap`](/docs/ver/13.x/database-access/reference/cli#teleport-db-configure-bootstrap)
...
manually using a [static configuration](/docs/ver/13.x/database-access/reference/configuration) or
[`tctl`](/docs/ver/13.x/database-access/guides/dynamic-registration) and manage IAM yourself, example
