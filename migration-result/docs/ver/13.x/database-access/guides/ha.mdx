...
Registration](/docs/ver/13.x/database-access/guides/dynamic-registration).
...
- Review the [architecture](/docs/ver/13.x/database-access/architecture) of the Teleport Database
  Service.
