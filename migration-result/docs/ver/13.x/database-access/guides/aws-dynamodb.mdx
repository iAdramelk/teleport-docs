...
You can also connect to this database from the AWS NoSQL Workbench, as documented in our [Database Access GUI Clients](/docs/ver/13.x/connect-your-client/gui-clients#nosql-workbench) guide.
...
- See [Dynamic Database Registration](/docs/ver/13.x/database-access/guides/dynamic-registration) to learn how
