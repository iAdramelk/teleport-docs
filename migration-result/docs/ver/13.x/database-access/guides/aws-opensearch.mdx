...
<Accordion title="Alterative methods">
  ...
  - [Joining Nodes via AWS EC2 Identity Document](/docs/ver/13.x/agents/join-services-to-your-cluster/aws-ec2)
</Accordion>
...
<Tabs>
  ...
  <Tab title="Dynamic Config">
    ...
    resources, see: [Dynamic Registration](/docs/ver/13.x/database-access/guides/dynamic-registration).
  </Tab>
</Tabs>
