...
Teleport can provide secure access to Elasticsearch via the  [Teleport Database
...
<Accordion title="Role Mapping with wildcards">
  In a scenario where Teleport is using [single sign-on](/docs/ver/13.x/access-controls/sso) you may want to define a mapping for all users to a role:
...
<img src="/assets/elasticvue-371afcb9e5.png" alt="ElasticVue" width="1996" height="753" />
