...
<Note>
  ...
  [how to connect your database](/docs/ver/13.x/database-access/guides#how-to-connect-your-database-to-teleport).
</Note>
...
- Get started by [connecting](/docs/ver/13.x/database-access/guides) your database.
