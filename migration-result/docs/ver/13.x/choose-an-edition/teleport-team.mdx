...
<Tip>
  ...
  compares to Teleport Team, see the [Choose an Edition](/docs/ver/13.x/choose-an-edition/introduction) guide.
</Tip>
...
- Docker installed on your workstation. We will use a Docker container to
  ...
  <Tip>
    ...
    configure access to them](/docs/ver/13.x/server-access/introduction).
  </Tip>

- The `tsh` client tool. Visit our [Installation Guide](/docs/ver/13.x/installation)
...
Terraform](/docs/ver/13.x/agents/deploy-agents-terraform).
