...
<Tip>
  ...
  [Choose an Edition](/docs/ver/13.x/choose-an-edition/introduction).
</Tip>
...
- The `tsh` client tool.
  ...
  For installation instructions, see [Installation Guide](/docs/ver/13.x/installation).
...
with Terraform](/docs/ver/13.x/agents/deploy-agents-terraform).
