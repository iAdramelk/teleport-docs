...
See our documentation on [data retention](/docs/ver/13.x/choose-an-edition/teleport-cloud/architecture#data-retention).
...
We believe mTLS with strong user and [device identity](/docs/ver/13.x/access-controls/device-trust/guide) provides the best available
...
Access Controls Reference](/docs/ver/13.x/access-controls/reference).
...
tunnels](/docs/ver/13.x/agents/join-services-to-your-cluster).
...
[dynamic tokens](/docs/ver/13.x/agents/join-services-to-your-cluster/join-token):
...
Find the appropriate download at [Teleport Enterprise Cloud Downloads](/docs/ver/13.x/choose-an-edition/teleport-cloud/downloads). Use the Enterprise version of `tctl`.
...
Yes. We recommend Teleport's [event handler plugin](/docs/ver/13.x/management/export-audit-events/fluentd) to export Teleport Enterprise Cloud audit events.
...
described in [Teleport Upcoming Releases](/docs/ver/13.x/upcoming-releases).
...
updates](/docs/ver/13.x/management/operations/enroll-agent-into-automatic-updates).
...
agent into automatic updates](/docs/ver/13.x/management/operations/enroll-agent-into-automatic-updates).
...
-------- ------------------------------------ -------------- ------ ----------
server01 46d8cad0-8967-4815-a01a-77aae62c34fe                       13.4.16
server02 c33b5513-a9eb-463b-8f1b-1f209afe5b4f                       13.4.16
```
...
Read more in our [TLS Routing](/docs/ver/13.x/architecture/tls-routing) guide.
...
of regions all over the world, and allow customers to [select the region](/docs/ver/13.x/choose-an-edition/teleport-cloud/architecture#auth-service) where the data is stored.
