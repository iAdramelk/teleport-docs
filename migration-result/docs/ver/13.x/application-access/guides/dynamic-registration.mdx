...
instances](/docs/ver/13.x/agents/deploy-agents-terraform).
...
See the full app resource spec [reference](/docs/ver/13.x/application-access/reference#application-resource).
