...
and follow the installation [instructions](/docs/ver/13.x/installation).
...
[role templates](/docs/ver/13.x/access-controls/guides/role-templates). In the
...
[Integrating with JWTs](/docs/ver/13.x/application-access/jwt/introduction) for more details.
