...
You can inject a JWT token into any header using [headers passthrough](/docs/ver/13.x/application-access/guides/connecting-apps#headers-passthrough)
...
[GitHub](https://github.com/gravitational/teleport/blob/v13.4.16/examples/jwt/verify-jwt.go).
...
- [ElasticSearch](/docs/ver/13.x/application-access/jwt/elasticsearch)
