...
See our [Azure
CLI](/docs/ver/13.x/application-access/cloud-apis/azure#step-34-enable-your-user-to-access-azure-clis) guide
for more information on enabling access to Azure managed identities.

## Next steps

- View access controls [Getting Started](/docs/ver/13.x/access-controls/getting-started)
  and other available [guides](/docs/ver/13.x/access-controls/guides).
- Learn about using [JWT tokens](/docs/ver/13.x/application-access/jwt/introduction) to implement access controls
  in your application.
- Integrate with your identity provider:
  - [OIDC](/docs/ver/13.x/access-controls/sso/oidc)
  - [ADFS](/docs/ver/13.x/access-controls/sso/adfs)
  - [Azure AD](/docs/ver/13.x/access-controls/sso/azuread)
  - [Google Workspace](/docs/ver/13.x/access-controls/sso/google-workspace)
  - [Onelogin](/docs/ver/13.x/access-controls/sso/one-login)
  - [Okta](/docs/ver/13.x/access-controls/sso/okta)
