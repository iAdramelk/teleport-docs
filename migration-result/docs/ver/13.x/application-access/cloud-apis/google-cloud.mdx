...
Assign the `google-cloud-cli-access` role to your Teleport user by running the following
...
<Tabs>
  ...
  <Tab title="GitHub">
    ...
    Edit `github.yaml`, adding `google-cloud-cli-access` to the
  ...
  <Tab title="SAML">
    ...
    Edit `saml.yaml`, adding `google-cloud-cli-access` to the
  ...
  <Tab title="OIDC">
    ...
    Edit `oidc.yaml`, adding `google-cloud-cli-access` to the
...
- Now that you know how to protect access to Google Cloud CLIs using Teleport,
  ...
  Requests](/docs/ver/13.x/access-controls/access-requests/role-requests) and [Access
  Request plugins](/docs/ver/13.x/access-controls/access-request-plugins/index).
