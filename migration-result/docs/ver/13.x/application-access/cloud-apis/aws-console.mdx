...
- A host running the `teleport` daemon with the Application Service enabled.
  Follow the [Getting Started](/docs/ver/13.x/application-access/getting-started) or [Connecting
  Apps](/docs/ver/13.x/application-access/guides/connecting-apps) guides to get it running.
...
Templates](/docs/ver/13.x/access-controls/guides/role-templates) for details.
