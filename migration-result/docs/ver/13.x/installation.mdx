...
| --------------------------------------------------------------------------------------- | ------------- | ------------------------ | -------- | ----------- | ---------------------- |
| [Enhanced Session Recording](/docs/ver/13.x/server-access/guides/bpf-session-recording) | Kernel  v5.8+ | 11, or 10 with backports | 20.04.2+ | 9+          | 2 (post 11/2021), 2023 |
...
`public.ecr.aws/gravitational/teleport:13.2.0-arm64`.
...
- The major, minor, and patch version (e.g., `13.2.0` for the
...
<Tabs>
  <Tab title="Open Source">
    ...
    | --------------------------------------------------------------- | ---------------------- | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-distroless:13.2.0`       | No                     | [Distroless Debian 11](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-distroless-debug:13.2.0` | Yes                    | [Distroless Debian 11](https://github.com/GoogleContainerTools/distroless) |

    For testing, we always recommend that you use the latest released version of
    Teleport, which is currently `public.ecr.aws/gravitational/teleport-distroless:13.2.0`.
  ...
  <Tab title="Enterprise">
    ...
    | ------------------------------------------------------------------- | ------------------------------ | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-ent-distroless:13.2.0`       | No                             | [Distroless Debian 11](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-ent-distroless-debug:13.2.0` | Yes                            | [Distroless Debian 11](https://github.com/GoogleContainerTools/distroless) |
    ...
    Teleport Enterprise, which is currently `public.ecr.aws/gravitational/teleport-ent-distroless:13.2.0`.
...
$ docker run --hostname localhost --rm \
  ...
  public.ecr.aws/gravitational/teleport-distroless:13.2.0 configure --roles=proxy,auth > ~/teleport/config/teleport.yaml
```
...
$ docker run --hostname localhost --name teleport \
  ...
  public.ecr.aws/gravitational/teleport-distroless:13.2.0
```
  ...
  <Tab title="Open Source">
    <Tabs>
      <Tab title="Teleport package">
        ...
        | Link                                                                  | Binaries                                      |
        | --------------------------------------------------------------------- | --------------------------------------------- |
        | [`teleport-13.2.0.pkg`](https://cdn.teleport.dev/teleport-13.2.0.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
        | [`tsh-13.2.0.pkg`](https://cdn.teleport.dev/tsh-13.2.0.pkg)           | `tsh`                                         |

        You can also fetch an installer via the command line:

        ```code
        $ curl -O https://cdn.teleport.dev/teleport-13.2.0.pkg
        # Installs on Macintosh HD
        $ sudo installer -pkg teleport-13.2.0.pkg -target /
        # Password:
        # installer: Package name is teleport-13.2.0
