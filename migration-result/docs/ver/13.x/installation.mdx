...
See our [Upgrading](/docs/ver/13.x/management/operations/upgrading) guide for more information.
...
[Using Teleport Connect](/docs/ver/13.x/connect-your-client/teleport-connect) for usage and installation*.
...
| --------------------------------------------------------------------------------------- | ------------- | ------------------------ | -------- | ----------- | ---------------------- | -------------- |
| [Enhanced Session Recording](/docs/ver/13.x/server-access/guides/bpf-session-recording) | Kernel  v5.8+ | 11, or 10 with backports | 20.04.2+ | 9+          | 2 (post 11/2021), 2023 | 12 SP5, 15 SP5 |
...
<Tabs>
  ...
  <Tab title="Teleport Enterprise Cloud">
    Check the [Cloud Downloads](/docs/ver/13.x/choose-an-edition/teleport-cloud/downloads) page for the most up-to-date
...
`public.ecr.aws/gravitational/teleport:13.4.16-arm64`.
...
<Tabs>
  <Tab title="Teleport Community Edition">
    ...
    | ---------------------------------------------------------------- | ---------------------- | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-distroless:13.4.16`       | No                     | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-distroless-debug:13.4.16` | Yes                    | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |

    For testing, we always recommend that you use the latest release version of
    Teleport, which is currently `public.ecr.aws/gravitational/teleport-distroless:13.4.16`.
  ...
  <Tab title="Teleport Enterprise">
    ...
    | -------------------------------------------------------------------- | ------------------------------ | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-ent-distroless:13.4.16`       | No                             | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-ent-distroless-debug:13.4.16` | Yes                            | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |

    We also provide the following images for FIPS builds of Teleport Enterprise:

    | Image name                                                                | Includes troubleshooting tools | Image base                                                                 |
    | ------------------------------------------------------------------------- | ------------------------------ | -------------------------------------------------------------------------- |
    | `public.ecr.aws/gravitational/teleport-ent-fips-distroless:13.4.16`       | No                             | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |
    | `public.ecr.aws/gravitational/teleport-ent-fips-distroless-debug:13.4.16` | Yes                            | [Distroless Debian 12](https://github.com/GoogleContainerTools/distroless) |

    For testing, we always recommend that you use the latest release version of
    Teleport Enterprise, which is currently `public.ecr.aws/gravitational/teleport-ent-distroless:13.4.16`.
...
See the Teleport [Configuration Reference](/docs/ver/13.x/reference/config) for whether a
...
Reference](/docs/ver/13.x/reference/networking#ports) for the ports on your Teleport
container to expose.
...
method](/docs/ver/13.x/agents/join-services-to-your-cluster/join-token).
...
$ docker run --hostname localhost --rm \
  ...
  public.ecr.aws/gravitational/teleport-distroless:13.4.16 configure --roles=proxy,auth > ~/teleport/config/teleport.yaml
```
...
$ docker run --hostname localhost --name teleport \
  ...
  public.ecr.aws/gravitational/teleport-distroless:13.4.16
```
...
| --------------------- | -------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| `teleport-cluster`    | Auth Service<br />Proxy Service<br />Other Teleport services if using a custom configuration | [Reference](/docs/ver/13.x/reference/helm-reference/teleport-cluster)    |
| `teleport-kube-agent` | Kubernetes Service<br />Application Service<br />Database Service                            | [Reference](/docs/ver/13.x/reference/helm-reference/teleport-kube-agent) |
...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  <Tab title="Community/Team">
    <Tabs>
      <Tab title="Teleport package">
        ...
        | Link                                                                    | Binaries                                      |
        | ----------------------------------------------------------------------- | --------------------------------------------- |
        | [`teleport-13.4.16.pkg`](https://cdn.teleport.dev/teleport-13.4.16.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
        | [`tsh-13.4.16.pkg`](https://cdn.teleport.dev/tsh-13.4.16.pkg)           | `tsh`                                         |

        You can also fetch an installer via the command line:

        ```code
        $ curl -O https://cdn.teleport.dev/teleport-13.4.16.pkg
        # Installs on Macintosh HD
        $ sudo installer -pkg teleport-13.4.16.pkg -target /
        # Password:
        # installer: Package name is teleport-13.4.16
      ...
      <Tab title="Homebrew">
        ...
        [compatibility policy](/docs/ver/13.x/management/operations/upgrading) for details.
  ...
  <Tab title="Enterprise">
    ...
    | Link                                                                            | Binaries                                      |
    | ------------------------------------------------------------------------------- | --------------------------------------------- |
    | [`teleport-ent-13.4.16.pkg`](https://cdn.teleport.dev/teleport-ent-13.4.16.pkg) | `teleport`<br />`tctl`<br />`tsh`<br />`tbot` |
    | [`tsh-13.4.16.pkg`](https://cdn.teleport.dev/tsh-13.4.16.pkg)                   | `tsh`                                         |

    You can also fetch an installer from the command line:

    ```code
    $ curl -O https://cdn.teleport.dev/teleport-ent-13.4.16.pkg
    # Install on Macintosh HD
    $ sudo installer -pkg teleport-ent-13.4.16.pkg -target / 
    Password:
    installer: Package name is teleport-ent-13.4.16
    installer: Upgrading at base path /
    installer: The upgrade was successful.
    $ which teleport
    /usr/local/bin/teleport
...
<Tabs dropdownView dropdownCaption="Teleport Edition">
  <Tab title="Teleport Community Edition">
    ...
    $ $Resp = Invoke-WebRequest https://cdn.teleport.dev/teleport-v13.4.16-windows-amd64-bin.zip.sha256
    ...
    # <checksum> <filename>
    $ Invoke-WebRequest -OutFile teleport-v13.4.16-windows-amd64-bin.zip -Uri https://cdn.teleport.dev/teleport-v13.4.16-windows-amd64-bin.zip
    $ certUtil -hashfile teleport-v13.4.16-windows-amd64-bin.zip SHA256
    # SHA256 hash of teleport-v13.4.16-windows-amd64-bin.zip:
    # <checksum>
    ...
    `teleport-v13.4.16-windows-amd64-bin\tsh.exe`.

    ```code
    $ Expand-Archive teleport-v13.4.16-windows-amd64-bin.zip
    $ cd teleport-v13.4.16-windows-amd64-bin
    $ .\tsh.exe version
    Teleport v13.4.16 git:v13.4.16 go1.21
    ```
...
If you wish to uninstall Teleport at any time, see our documentation on [Uninstalling Teleport](/docs/ver/13.x/management/admin/uninstall-teleport).
...
- [Server Access](/docs/ver/13.x/server-access/introduction)
- [Kubernetes Access](/docs/ver/13.x/kubernetes-access/introduction)
- [Database Access](/docs/ver/13.x/database-access/introduction)
- [Application Access](/docs/ver/13.x/application-access/introduction)
- [Desktop Access](/docs/ver/13.x/desktop-access/introduction)
- [Machine ID](/docs/ver/13.x/machine-id/introduction)
