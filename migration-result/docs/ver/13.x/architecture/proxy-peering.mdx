...
<img src="/assets/proxy-peering@1.2x-3d3fb42551.svg" alt="Teleport Proxy Peering" width="606.6666666666667" height="370" />

## Next Steps

- See the [migration guide](/docs/ver/13.x/management/operations/proxy-peering) to learn how to upgrade an existing cluster to use
  Proxy Peering
