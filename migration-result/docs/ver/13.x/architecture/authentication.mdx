...
<Tip>
  ...
  For those cases, Teleport Proxy can terminate live connections using [session and identity locking](/docs/ver/13.x/access-controls/guides/locking).
</Tip>
...
[short-lived tokens or cloud identity services](/docs/ver/13.x/agents/join-services-to-your-cluster/join-token).
...
Take a look at the [Certificate Rotation Guide](/docs/ver/13.x/management/operations/ca-rotation) to
...
<Tip>
  ...
  cluster certificates, use node [session and identity locking](/docs/ver/13.x/access-controls/guides/locking).
</Tip>
