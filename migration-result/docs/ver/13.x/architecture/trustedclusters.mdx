...
<img src="/assets/trusted-clusters@1.5x-9574d8ae7a.svg" alt="Trusted clusters" width="1114" height="1057.3333333333333" />
...
<img src="/assets/tc-role-mapping-6a0dd7d07c.svg" alt="Role mapping" width="2043" height="1847" />
...
- See how Teleport uses [Certificates](/docs/ver/13.x/architecture/authentication) for authentication.
- Reduce your surface of attack using [TLS routing](/docs/ver/13.x/architecture/tls-routing).
- Follow our [guide](/docs/ver/13.x/management/admin/trustedclusters) to set up trusted clusters.
