...
Reference](/docs/reference/config#enabling-teleport-services) for which
...
<img src="/assets/agent-pool-diagram-516d201f48.png" alt="Diagram showing the architecture of an agent pool" width="2841" height="1973" />

Read our guide for how to use Terraform to [deploy a pool of
agents](/docs/agents/deploy-agents-terraform).
...
Cluster](/docs/agents/join-services-to-your-cluster) guides.
...
e.g., [using a Terraform module](/docs/agents/deploy-agents-terraform). To modify the
...
- **Dynamic**: Apply a [configuration
  resource](/docs/management/dynamic-resources) that configures a resource to
  proxy.
...
[Read our guide](/docs/agents/deploy-agents-terraform) to deploying a pool of agents
...
- [SSH Service](/docs/server-access/introduction)
- [Database Service](/docs/database-access/introduction)
- [Kubernetes Service](/docs/kubernetes-access/introduction)
- [Windows Desktop Service](/docs/desktop-access/introduction)
- [Application Service](/docs/application-access/introduction)
