...
- A running Teleport Community Edition cluster, v12.4 or higher. For details on
  how to set this up, see our [Getting Started](/docs/index) guide.
...
- [Access controls](/docs/access-controls/getting-started)
- [Resource filtering](/docs/reference/predicate-language)
- [Access request plugins](/docs/access-controls/access-request-plugins/index)
