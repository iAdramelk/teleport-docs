...
<Accordion title="Automated SSO connection with Okta integration">
  In Teleport Team, Teleport Enterprise Cloud and Self-Hosted Teleport Enterprise,
  Teleport can automatically configure an SSO connector for you when as part of
  [enrolling the hosted Okta integration](/docs).
...
<Tabs>
  <Tab title="Teleport Enterprise (Self-Hosted)">
    - The `tctl` and `tsh` client tools version >= 15.0.2, which you
  ...
  <Tab title="Teleport Cloud">
    - The `tctl` and `tsh` client tools version >= 14.3.6.
      ...
      You can download these from [Teleport Cloud Downloads](/docs/choose-an-edition/teleport-cloud/downloads).
      ```bash
      $ tctl version
...
<img src="/assets/okta-saml-2.1@2x-597fa51ce9.png" alt="Create Group Devs" width="1074" height="746" />

Repeat for the admin group:

<img src="/assets/okta-saml-2.2-73f81682ee.png" alt="Create Group Devs" width="2168" height="1494" />
...
<img src="/assets/okta-saml-1-b363e8566c.png" alt="Create APP" width="2446" height="1364" />
...
<img src="/assets/setup-redirection-f337618bde.png" alt="Configure APP" width="902" height="1055" />
...
<img src="/assets/okta-saml-3.1-cb316199a9.png" alt="Configure APP" width="2090" height="1468" />
...
<img src="/assets/okta-copy-metadata-09972a2dac.png" alt="View Okta IdP Metadata" width="1027" height="414" />
...
saml](/docs/reference/cli/tctl#tctl-sso-configure-saml) for a full reference of
