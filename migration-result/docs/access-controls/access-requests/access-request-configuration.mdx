...
- [Role requests in commercial Teleport editions](/docs/access-controls/access-requests/role-requests)
- [Resource requests in commercial Teleport editions](/docs/access-controls/access-requests/resource-requests)
- [Role requests in Teleport Community Edition](/docs/access-controls/access-requests/oss-role-requests)
...
Templates](/docs/access-controls/guides/role-templates#templating-in-access-requests) for more
...
1. Calculate the maximum duration of elevated privileges if the Access Request
   ...
   - The `--max-duration` flag of the [`tsh request
     create`](/docs/reference/cli/tsh#tsh-request-create) command (if the
...
2. Calculate the session TTL of the certificate the user would receive if
   ...
   - The requested session expiration time, which is the value of the
     ...
     create`](/docs/reference/cli/tsh#tsh-request-create).
...
[`tsh request create`](/docs/reference/cli/tsh#tsh-request-create) and [`tsh request
review`](/docs/reference/cli/tsh#tsh-request-review) commands. The format accepted
...
1. Begin with with the base expiration of the Access Request, which a user can
   ...
   create`](/docs/reference/cli/tsh#tsh-request-create) command. If this is
...
language](/docs/reference/predicate-language).
...
If you [write your own Access Request plugin](/docs/api/access-plugin), the
