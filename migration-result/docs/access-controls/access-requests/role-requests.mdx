...
[Resource Access Requests Guide](/docs/access-controls/access-requests/resource-requests).
...
See the [Access Request Configuration](/docs/access-controls/access-requests/access-request-configuration) guide
...
[documentation](/docs/access-controls/access-lists).
