...
See the [Device Trust guide](/docs/access-controls/device-trust) for fundamental Device Trust concepts
and behavior.
...
- To enroll a macOS device, you need:
  - A signed and notarized `tsh` binary, v12.0.0 or newer.
    [Download the macOS tsh installer](/docs/installation#macos).
- To enroll a Windows device, you need:
  ...
  - `tsh` v13.1.2 or newer. [Download the Windows tsh installer](/docs/installation#windows-tsh-client-only).
- To enroll a Linux device, you need:
  ...
  - `tsh` v15.0.0 or newer. [Install tsh for Linux](/docs/installation#linux).
...
[auto-enrollment](/docs/access-controls/device-trust/device-management#auto-enrollment).
