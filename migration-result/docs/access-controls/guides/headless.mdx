...
- A v12.2+ Teleport cluster with WebAuthn configured.
  See the [Second Factor: WebAuthn](/docs/access-controls/guides/webauthn) guide.
- WebAuthn hardware device, such as YubiKey.
- Machines for Headless WebAuthn activities have [Linux](/docs/installation#linux), [macOS](/docs/installation#macos) or [Windows](/docs/installation#windows-tsh-client-only) `tsh` binary v12.2+ installed.
