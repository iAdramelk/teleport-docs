...
<Note>
  The [Terraform provider guide](/docs/management/dynamic-resources/terraform-provider)
...
- Read the [Terraform Guide](/docs/management/dynamic-resources/terraform-provider) to
