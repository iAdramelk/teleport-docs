...
- Follow Step 1 of the
  [Teleport operator guide](/docs/management/dynamic-resources/teleport-operator#step-13-install-teleport-cluster-helm-chart-with-the-operator)
...
- Read the [Teleport Operator Guide](/docs/management/dynamic-resources/teleport-operator) to
  learn more about the Teleport Operator.
- Read the [Login Rules reference](/docs/access-controls/login-rules/reference) to learn mode about the
