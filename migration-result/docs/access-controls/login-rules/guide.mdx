...
Check the [Single Sign-On](/docs/access-controls/sso) docs to learn how to set this up.
...
The [`tctl sso test`](/docs/reference/cli/tctl#tctl-sso-test) command can be used to
...
[Login Rule Reference](/docs/access-controls/login-rules/reference) page.

Learn about the `tctl login_rule test` command by running the help command or
checking the [reference page](/docs/reference/cli/tctl#tctl-login_rule-test).
