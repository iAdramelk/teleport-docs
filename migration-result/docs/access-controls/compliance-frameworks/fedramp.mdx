...
You also can follow the [Installation instructions](/docs/installation#installation-instructions) for
...
```code
$ curl https://cdn.teleport.dev/teleport-ent-15.0.2-linux-$SYSTEM_ARCH-fips-bin.tar.gz.sha256
<checksum> <filename>
$ curl -O https://cdn.teleport.dev/teleport-ent-15.0.2-linux-$SYSTEM_ARCH-fips-bin.tar.gz

# Verify that the checksums match
$ shasum -a 256 teleport-ent-15.0.2-linux-$SYSTEM_ARCH-fips-bin.tar.gz

$ tar -xvf teleport-ent-15.0.2-linux-$SYSTEM_ARCH-fips-bin.tar.gz
$ cd teleport-ent
$ sudo ./install
```
...
```code
$ teleport version
Teleport Enterprise 15.0.2 api/14.0.0-gd1e081e 1.21 X:boringcrypto
```
