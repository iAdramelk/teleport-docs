...
- `value`: Value defined using a [predicate expression](/docs/reference/predicate-language), which can reference
...
- If you're new to SAML, consider reviewing our [SAML Identity Provider
  Reference](/docs/access-controls/idps/saml-reference) before proceeding.
