...
<Tabs>
  <Tab title="Download">
    ...
    teleport-jira v13.3.7 git:teleport-jira-v13.3.7-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    teleport-jira v13.3.7 git:teleport-jira-v13.3.7-api/14.0.0-gd1e081e 1.21
    ```
...
guide](/docs/reference/helm-reference/teleport-plugin-jira).
