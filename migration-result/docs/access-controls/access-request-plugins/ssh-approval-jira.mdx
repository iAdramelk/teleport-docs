...
<Tabs>
  <Tab title="Download">
    ...
    ```bash
    $ curl -L -O https://get.gravitational.com/teleport-access-jira-v15.0.2-linux-amd64-bin.tar.gz
    $ tar -xzf teleport-access-jira-v15.0.2-linux-amd64-bin.tar.gz
    ...
    teleport-jira v15.0.2 git:teleport-jira-v15.0.2-fffffffff go1.21
    ```
  </Tab>
  ...
  <Tab title="Docker Image">
    ...
    ```bash
    $ docker pull public.ecr.aws/gravitational/teleport-plugin-jira:15.0.2
    ```

    Make sure the plugin is installed by running the following command:

    ```bash
    $ docker run public.ecr.aws/gravitational/teleport-plugin-jira:15.0.2 version
    teleport-jira v15.0.2 git:teleport-jira-v15.0.2-api/14.0.0-gd1e081e 1.21
    ```
