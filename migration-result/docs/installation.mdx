...
See our [Upgrading](/docs/management/operations/upgrading) guide for more information.
  ...
  <Tab title="Community/Team">
    <Tabs>
      ...
      <Tab title="Homebrew">
        ...
        [compatibility policy](/docs/management/operations/upgrading) for details.
