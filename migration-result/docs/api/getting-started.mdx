...
<Tip>
  ...
  Read [API authorization](/docs/api/architecture#authorization) to learn more about defining custom roles for your API client.
</Tip>
...
- Read about Teleport [API architecture](/docs/api/architecture) for an in-depth overview of the API and API clients.
- Read [API authorization](/docs/api/architecture#authorization) to learn more about defining custom roles for your API client.
...
- Familiarize yourself with the [admin manual](/docs/management/admin) to make the best use of the API.
