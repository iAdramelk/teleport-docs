...
clusters](/docs/kubernetes-access/discovery) in AWS, Azure, and Google Cloud,
as well as [servers](/docs/server-access/guides/ec2-discovery) on Amazon EC2.
...
const (
	...
	proxyAddr      string = ""
	teleportImage  string = "public.ecr.aws/gravitational/teleport-distroless:15.0.2"
...
```code
$ docker image pull public.ecr.aws/gravitational/teleport-distroless:15.0.2
```
