...
The [Upgrading Compatibility Overview](/docs/upgrading/overview) explains how to
...
- [Linux Servers](/docs/upgrading/self-hosted-linux)
- [Kubernetes](/docs/upgrading/self-hosted-kubernetes)
...
Updates](/docs/upgrading/self-hosted-automatic-agent-updates) guide to set up
