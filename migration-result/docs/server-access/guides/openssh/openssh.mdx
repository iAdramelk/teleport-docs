...
- RBAC and resource filtering based on [dynamically updated labels](/docs/management/admin/labels)
- [Session recording without SSH connection termination](/docs/server-access/guides/recording-proxy-mode)
- [Session sharing](/docs/connect-your-client/tsh)
- [Advanced session recording](/docs/server-access/guides/bpf-session-recording)
- [Restricting outbound network connections in SSH sessions](/docs/server-access/guides/restricted-session)
...
<Tip>
  ...
  an option, you can [register your node manually instead](/docs/server-access/guides/openssh/openssh-manual-install).
</Tip>
