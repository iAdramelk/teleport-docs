...
[OpenSSH guide](/docs/server-access/openssh) to configure the remote host to authenticate via
...
[dedicated guide](/docs/server-access/openssh) for additional information.
