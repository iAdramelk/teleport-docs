...
<Warning>
  ...
  [Host user creation](/docs/server-access/guides/host-user-creation) guide to learn how to configure
...
authentication](/docs/reference/authentication) (e.g. `tsh login`) is preferred.
