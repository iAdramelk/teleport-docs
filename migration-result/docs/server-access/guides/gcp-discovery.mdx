...
- `{{ .AutomaticUpgrades }}`: indicates whether Automatic Upgrades are enabled or disabled.
  ...
  [self-hosted automatic agent updates](/docs/management/operations/self-hosted-automatic-agent-updates)
...
- Read [Joining Services via GCP](/docs/agents/join-services-to-your-cluster/gcp)
