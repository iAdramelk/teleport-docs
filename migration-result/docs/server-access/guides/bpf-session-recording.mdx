...
Teleport's default [SSH and Kubernetes session recording](/docs/architecture/nodes#ssh-session-recording)
...
<Tip>
  ...
  [Teleport Nodes](/docs/architecture/nodes#ssh-session-recording) for more
  details.
</Tip>
...
- Read more about
  [session recording](/docs/architecture/nodes#ssh-session-recording).
