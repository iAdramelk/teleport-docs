...
- A running Teleport Node. See the [Server Access Getting Started Guide](/docs/server-access/getting-started) for  how to add a Node to your Teleport cluster.
...
- Configure automatic user provisioning for [Database Access](/docs/database-access/auto-user-provisioning).
- Configure automatic user provisioning for [Desktop Access](/docs/desktop-access/rbac#automatic-user-creation).
