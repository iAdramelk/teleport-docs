...
the Kubernetes [Access Controls Guide](/docs/kubernetes-access/controls). You can leave your
...
Requests](/docs/access-controls/access-requests/resource-requests)
for just-in-time access and [Access Request
plugins](/docs/access-controls/access-request-plugins/index) so you can manage
