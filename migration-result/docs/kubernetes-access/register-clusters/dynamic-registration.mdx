...
- [Connect a Kubernetes Cluster to Teleport](/docs/kubernetes-access/getting-started): How to use
  the `teleport-kube-agent` Helm chart to register a Kubernetes cluster with
  Teleport.
- [Kubernetes Access from a Standalone Teleport
  Cluster](/docs/kubernetes-access/register-clusters/static-kubeconfig): How to use the Teleport Kubernetes
