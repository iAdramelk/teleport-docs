...
- [AWS](/docs/kubernetes-access/discovery/aws): Discovery for AWS EKS clusters.
- [Azure](/docs/kubernetes-access/discovery/azure): Discovery for Azure AKS clusters.
- [Google Cloud](/docs/kubernetes-access/discovery/google-cloud): Discovery for
