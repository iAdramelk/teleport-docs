...
guide](/docs/kubernetes-access/manage-access/rbac).
...
<Tip>
  ...
  methods](/docs/kubernetes-access/register-clusters) and [automatic methods](/docs/kubernetes-access/discovery) for
