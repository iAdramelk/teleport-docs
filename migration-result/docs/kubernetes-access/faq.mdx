...
Check out the
[Kubernetes Service Standalone Guide](/docs/kubernetes-access/register-clusters/static-kubeconfig).
...
Check out the [Teleport Kubernetes Access Controls Guide](/docs/kubernetes-access/controls) for
...
Check out the [Kubernetes Service Discovery Guide](/docs/kubernetes-access/discovery) for more
