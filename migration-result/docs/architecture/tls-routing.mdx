...
In TLS routing mode [Teleport proxy](/docs/architecture/proxy) multiplexes all client
...
See the [OpenSSH client](/docs/server-access/openssh/openssh) guide for details on
how it's configured.
...
See [GUI clients](/docs/connect-your-client/gui-clients) guide for a usage
example.
...
- See [migration guide](/docs/management/operations/tls-routing) to learn how to
