...
- See how Teleport uses [Certificates](/docs/architecture/authentication) for authentication.
- Reduce your surface of attack using [TLS routing](/docs/architecture/tls-routing).
- Follow our [guide](/docs/management/admin/trustedclusters) to set up trusted clusters.
