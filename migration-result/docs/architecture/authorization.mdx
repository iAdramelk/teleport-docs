...
that this cluster trusts. In this case, Teleport activates [trusted cluster mapping logic](/docs/architecture/trustedclusters#role-mapping).
...
[`tctl users add`](/docs/reference/cli) or API call.
...
[trusted cluster mapping logic](/docs/architecture/trustedclusters#role-mapping) to support this use case.
...
<Tip>
  You can use `where` fields in all resource rules. Check out [the full role reference](/docs/access-controls/reference) contains full role spec for details.
</Tip>
...
- [Access Control Reference](/docs/access-controls/reference).
- [Teleport Predicate Language](/docs/reference/predicate-language).
- [Access Requests Guides](/docs/access-controls/access-requests)
- [Architecture Overview](/docs/core-concepts)
- [Teleport Auth](/docs/architecture/authentication)
