...
specified by the `audit_sessions_uri` field in the `teleport.yaml` [configuration file](/docs/reference/config).
...
the [`tsh play`](/docs/reference/cli/tsh#tsh-play) command. Desktop session
...
- [SSH session recording](/docs/architecture/nodes#ssh-session-recording)
- [SSH recording modes](/docs/reference/audit#modes)
- [Desktop Access recording](/docs/desktop-access/reference/sessions)
