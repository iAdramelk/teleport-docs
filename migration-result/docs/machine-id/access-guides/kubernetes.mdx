...
- If you have not already connected your Kubernetes cluster to Teleport, follow
  the [Kubernetes Access Getting Started Guide](/docs/kubernetes-access/getting-started).
...
- Read the [Kubernetes Access RBAC guide](/docs/kubernetes-access/controls)
