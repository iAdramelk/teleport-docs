...
- If you have not already connected your application to Teleport, follow
  the [Application Access Getting Started Guide](/docs/application-access/getting-started).
...
- Review the [Access Controls Reference](/docs/access-controls/reference)
  to learn about restricting which Applications and other Teleport resources
  your bot may access.
- Configure [JWTs](/docs/application-access/jwt/introduction) for your
