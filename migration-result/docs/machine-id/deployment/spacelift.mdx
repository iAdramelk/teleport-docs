...
Reference](/docs/access-controls/reference#rbac-for-dynamic-teleport-resources)
...
version: "1"
stack_defaults:
  runner_image: public.ecr.aws/gravitational/teleport-spacelift-runner:15.0.2
  before_init:
  - |-
    tbot start --oneshot \
      --data-dir=memory:// \
...
- Now that you know how to manage Teleport configuration resources with
  ...
  reference](/docs/reference/terraform-provider) so you can flesh out your
  configuration.
...
- Learn how you can help achieve secure access for service accounts by sending
  [anonymous Machine ID telemetry](/docs/machine-id/reference/telemetry).
