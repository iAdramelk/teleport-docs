...
guide](/docs/machine-id/deployment/linux) is compatible with most platforms. For
custom approaches, you can also read the [Machine ID Reference](/docs/machine-id/reference)
and [Architecture](/docs/machine-id/architecture) to plan your deployment.
...
| ---------------------------------------------------- | ----------------------------------------------- | --------------------------------------------------- |
| [Linux](/docs/machine-id/deployment/linux)           | Package manager or TAR archive                  | Static join token                                   |
| [GCP](/docs/machine-id/deployment/gcp)               | Package manager, TAR archive, or Kubernetes pod | Identity document signed by GCP                     |
| [AWS](/docs/machine-id/deployment/aws)               | Package manager, TAR archive, or Kubernetes pod | Identity document signed by AWS                     |
| [Azure](/docs/machine-id/deployment/azure)           | Package manager or TAR archive                  | Identity document signed by Azure                   |
| [Kubernetes](/docs/machine-id/deployment/kubernetes) | Kubernetes pod                                  | Identity document signed by your Kubernetes cluster |
...
| Platform                                                     | Installation method                                           | Join method                        |
| ------------------------------------------------------------ | ------------------------------------------------------------- | ---------------------------------- |
| [CircleCI](/docs/machine-id/deployment/circleci)             | TAR archive                                                   | CircleCI-signed identity document  |
| [GitLab](/docs/machine-id/deployment/gitlab)                 | TAR archive                                                   | GitLab-signed identity document    |
| [GitHub Actions](/docs/machine-id/deployment/github-actions) | Teleport job available through the GitHub Actions marketplace | GitHub-signed identity document.   |
| [Jenkins](/docs/machine-id/deployment/jenkins)               | Package manager or TAR archive                                | Static join token                  |
| [Spacelift](/docs/machine-id/deployment/spacelift)           | Docker Image                                                  | Spacelift-signed identity document |
