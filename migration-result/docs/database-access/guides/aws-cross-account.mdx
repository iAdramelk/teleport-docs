...
<Note>
  ...
  [how to connect your database](/docs/database-access/guides#how-to-connect-your-database-to-teleport).
</Note>
...
<Tabs>
  ...
  <Tab title="Dynamic Config">
    ...
    resources, see: [Dynamic Registration](/docs/database-access/guides/dynamic-registration).
  </Tab>
</Tabs>
...
- Get started by [connecting](/docs/database-access/guides) your database.
