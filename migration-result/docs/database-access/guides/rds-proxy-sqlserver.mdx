...
<Note>
  ...
  [PostgreSQL](/docs/database-access/guides/rds-proxy-postgres),
  [MariaDB/MySQL](/docs/database-access/guides/rds-proxy-postgres) or
  [Microsoft SQL Server](/docs/database-access/guides/rds-proxy-sqlserver).
</Note>
