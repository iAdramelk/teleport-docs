...
- [PostgreSQL](/docs/database-access/guides/postgres-self-hosted#step-25-create-a-certificatekey-pair)
- [MySQL/MariaDB](/docs/database-access/guides/mysql-self-hosted#step-24-create-a-certificatekey-pair)
- [MongoDB](/docs/database-access/guides/mongodb-self-hosted#set-up-mutual-tls)
- [CockroachDB](/docs/database-access/guides/cockroachdb-self-hosted#set-up-mutual-tls)
- [Redis](/docs/database-access/guides/redis#step-45-set-up-mutual-tls)
- [Redis Cluster](/docs/database-access/guides/redis-cluster#step-46-set-up-mutual-tls)
...
access see the [RBAC](/docs/database-access/rbac) documentation.
...
feature](/docs/management/operations/tls-routing), where the Teleport Proxy
...
command](/docs/connect-your-client/gui-clients#get-connection-information),
