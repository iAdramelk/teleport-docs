...
bootstrap`](/docs/database-access/reference/cli#teleport-db-configure-bootstrap)
...
manually using a [static configuration](/docs/database-access/reference/configuration) or
[`tctl`](/docs/database-access/guides/dynamic-registration) and manage IAM yourself, example
