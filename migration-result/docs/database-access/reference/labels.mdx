...
| `dynamic`   | database resources created through [dynamic registration](/docs/database-access/guides/dynamic-registration) like `tcl create` command. |
...
[Configuration](/docs/database-access/reference/configuration) for reference.
...
Tags](/docs/management/guides/ec2-tags) for more details.
