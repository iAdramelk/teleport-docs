...
See the available [guides](/docs/database-access/guides) for all supported configurations.
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [Proxy Configuration](/docs/database-access/reference/configuration#proxy-configuration) for
    more details.
...
[graphical clients](/docs/connect-your-client/gui-clients).
...
[configuration file](/docs/database-access/reference/configuration#database-service-configuration)
...
See [labels reference](/docs/database-access/reference/labels) for a full list of Teleport
