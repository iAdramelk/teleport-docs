...
- Teleport cluster with a configured [self-hosted MySQL](/docs/database-access/guides/mysql-self-hosted)
  or [RDS MySQL](/docs/database-access/guides/rds) database.
