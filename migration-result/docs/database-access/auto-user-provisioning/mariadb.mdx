...
- Teleport cluster with a configured [self-hosted MariaDB](/docs/database-access/guides/mysql-self-hosted)
  or [RDS MariaDB](/docs/database-access/guides/rds) database.
