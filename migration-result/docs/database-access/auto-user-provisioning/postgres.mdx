...
- Teleport cluster with a configured [self-hosted PostgreSQL](/docs/database-access/guides/postgres-self-hosted)
  or [RDS PostgreSQL](/docs/database-access/guides/rds) database.
