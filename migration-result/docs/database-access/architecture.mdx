...
<Tabs>
  <Tab title="Self-Hosted">
    - [Teleport Proxy Service](/docs/architecture/proxy). A stateless service
  ...
  <Tab title="Teleport Enterprise Cloud">
    - [Teleport Proxy Service](/docs/architecture/proxy). A stateless service that performs
...
- [Teleport Auth Service](/docs/architecture/authentication). Serves as
...
1. A user logs into the cluster with `tsh login` command and retrieves
   a client certificate. See [Issuing User Certificates](/docs/architecture/authentication)
...
of the secrets. See [GUI Clients](/docs/connect-your-client/gui-clients) for details.
...
See respective [guides](/docs/database-access/guides) for details on configuring client
...
See respective [guides](/docs/database-access/guides) for details on configuring IAM/AD
authentication.
...
See [Core Concepts](/docs/core-concepts) for general Teleport
