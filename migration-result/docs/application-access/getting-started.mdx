...
<Tabs>
  <Tab title="Docker">
    Select a Teleport edition, then follow the [Installation](/docs/installation) instructions
...
- Integrating with [JWT tokens](/docs/application-access/jwt/introduction).
- Accessing applications with [RESTful APIs](/docs/application-access/guides/api-access).
- Setting configuration options AND running CLI commands in the [Application Access reference](/docs/application-access/reference).
