...
You can inject a JWT token into any header using [headers passthrough](/docs/application-access/guides/connecting-apps#headers-passthrough)
...
- [ElasticSearch](/docs/application-access/jwt/elasticsearch)
