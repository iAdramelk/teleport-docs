...
See our [Azure
CLI](/docs/application-access/cloud-apis/azure#step-34-enable-your-user-to-access-azure-clis) guide
for more information on enabling access to Azure managed identities.

## Next steps

- View access controls [Getting Started](/docs/access-controls/getting-started)
  and other available [guides](/docs/access-controls/guides).
...
- View access controls [Getting Started](/docs/access-controls/getting-started)
  and other available [guides](/docs/access-controls/guides).
- Learn about using [JWT tokens](/docs/application-access/jwt/introduction) to implement access
  controls in your application.
- Integrate with your identity provider:
  - [OIDC](/docs/access-controls/sso/oidc)
  - [ADFS](/docs/access-controls/sso/adfs)
  - [Azure AD](/docs/access-controls/sso/azuread)
  - [Google Workspace](/docs/access-controls/sso/google-workspace)
  - [Onelogin](/docs/access-controls/sso/one-login)
  - [Okta](/docs/access-controls/sso/okta)
