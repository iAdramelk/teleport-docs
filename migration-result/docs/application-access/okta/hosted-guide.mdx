...
For more information, see the [Okta Synchronization and SCIM](/docs/application-access/okta/sync-scim) guide.
...
<img src="/assets/scim-enable-76bd0367c3.png" alt="Enable SCIM" width="1000" height="1106" />
...
<img src="/assets/scim-configure-c34e4ba7b9.png" alt="Configure SCIM Client" width="1200" height="1148" />
...
<img src="/assets/scim-provisioning-ec9c9573d4.png" alt="Configure SCIM Provisioning" width="1200" height="1184" />

For more information about how the Okta integration manages Teleport resources,
see the Okta [Architecture](/docs/application-access/okta/architecture) and [Synchronization with Okta and SCIM](/docs/application-access/okta/sync-scim)
guides.
...
information, see the Teleport [Local Users](/docs/management/admin/users#deleting-users)
guide.
