...
- We've added a Waiting Room for customers using Access Workflows. [Docs](/docs/access-controls/access-request-plugins)
...
Teleport 4.3 introduces four new plugins that work out of the box with [Approval Workflow](/docs/access-controls/access-request-plugins). These plugins allow you to automatically support role escalation with commonly used third party services. The built-in plugins are listed below.
