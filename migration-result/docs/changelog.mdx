...
guide](/docs/management/dynamic-resources/teleport-operator-standalone)
...
1. Remote Session Environment > RemoteFX for Windows Server 2008 R2 > Configure
   RemoteFX
2. Remote Session Environment > Enable RemoteFX encoding for RemoteFX clients
...
guide](/docs/desktop-access/active-directory-manual#enable-remotefx). A
...
See the documentation [here](/docs/reference/backends#athena).
...
You can find existing access lists documentation [here](/docs/access-controls/access-lists/guide).
...
See documentation [here](/docs/application-access/enroll-kubernetes-applications).
...
resources](/docs/kubernetes-access/controls#kubernetes_resources).
...
See how to connect ClickHouse to Teleport [here](/docs/database-access/guides/clickhouse-self-hosted).
...
See documentation on how to configure it in the [Oracle guide](/docs/database-access/guides/oracle-self-hosted).
...
For more information on using Teleport with local Windows users, see [docs](/docs/desktop-access/getting-started).
...
For more information, see [docs](/docs/connect-your-client/putty-winscp).
...
For more information, see [docs](/docs/machine-id/reference/configuration#kubernetes_secret).
...
the cluster. Follow the updated agentless OpenSSH integration [guide](/docs/server-access/openssh/openssh)
...
See more details in our [documentation](/docs/management/security/proxy-protocol).
...
using [header rewriting](/docs/application-access/jwt/introduction#inject-jwt).
...
You can review role versions in the [documentation](/docs/access-controls/reference#role-versions).
...
For more details and guidance on how to upgrade to v2, see [docs](/docs/machine-id/reference/v14-upgrade-guide).
...
guide](/docs/server-access/openssh/openssh).
...
guide](/docs/deploy-a-cluster/helm-deployments/migration-v12).
...
follow
the [migration guide](/docs/deploy-a-cluster/helm-deployments/migration-v12).
...
[documentation](/docs/machine-id/deployment/github-actions) for using
...
[documentation](/docs/access-controls/guides/hardware-key-support):
...
- [VS Code](/docs/server-access/guides/vscode)
- [JetBrains](/docs/server-access/guides/jetbrains-sftp)
...
guide](/docs/database-access/guides/azure-postgres-mysql) for more
details.
...
images](/docs/installation#docker).
...
[install Teleport](/docs/installation#linux).
...
See the [documentation](/docs/access-controls/guides/passwordless).
...
[documentation](/docs/server-access/guides/host-user-creation).
...
Refer to [the guide](/docs/database-access/guides/sql-server-ad) to set
...
[documentation](/docs/database-access/guides/snowflake).
...
Learn more about it in the [documentation](/docs/database-access/guides/redis-aws).
...
[documentation](/docs/machine-id/access-guides/databases).
...
Refer to the
[documentation](/docs/reference/networking#http-connect-proxies)
for more details.
...
instructions](/docs/server-access/getting-started#step-14-install-teleport-on-your-linux-host).
...
guide](/docs/access-controls/guides/moderated-sessions) for more
details.
...
documentation](/docs/reference/backends) for more information.
...
configuration](/docs/desktop-access/getting-started) to force Windows
...
See the [documentation](/docs/reference/backends) for more information.
...
[Machine ID getting started guide](/docs/machine-id/getting-started)
...
[Self-hosted Redis guide](/docs/database-access/guides/redis)
...
[SQL Server guide](/docs/database-access/guides/sql-server-ad)
...
[Updated RDS guide](/docs/database-access/guides/rds)
...
- [`teleport db configure
  create`](/docs/database-access/reference/cli#teleport-db-configure-create)
- [`teleport db configure bootstrap`](/docs/database-access/reference/cli#teleport-db-configure-bootstrap)
...
[Moderated Sessions guide](/docs/access-controls/guides/moderated-sessions)
...
[Getting Started Guide](/docs/desktop-access/getting-started).
...
[documentation](/docs/application-access/cloud-apis/aws-console).
...
[apps](/docs/application-access/guides/dynamic-registration)
and
[databases](/docs/database-access/guides/dynamic-registration).
...
See updated
[RDS guide](/docs/database-access/guides/rds) for
more information.
...
View the [database access with MongoDB](/docs/database-access/guides/mongodb-self-hosted) for more details.
...
View the Cloud SQL MySQL [guide](/docs/database-access/guides/mysql-cloudsql) for more details.
...
Teleport application access can now automatically sign users into the AWS Management Console using [Identity federation](https://aws.amazon.com/identity/federation). View AWS Management Console [guide](/docs/application-access/cloud-apis/aws-console) for more details.
...
View the [database access with Redshift on AWS guide](/docs/database-access/guides/postgres-redshift) for more details.
...
MFA](/docs/access-controls/guides/per-session-mfa) documentation or
[RFD
...
We have implemented [database access](/docs/database-access/introduction),
...
Configure database access following the [Getting Started](/docs/database-access/introduction#getting-started) guide.

##### Guides

- [AWS RDS/Aurora PostgreSQL](/docs/database-access/guides/rds)
- [AWS RDS/Aurora MySQL](/docs/database-access/guides/rds)
- [Self-hosted PostgreSQL](/docs/database-access/guides/postgres-self-hosted)
- [Self-hosted MySQL](/docs/database-access/guides/mysql-self-hosted)
- [GUI clients](/docs/connect-your-client/gui-clients)

##### Resources

To learn more about configuring role-based access control for database access, check out the [RBAC](/docs/database-access/introduction) section.

[Architecture](/docs/database-access/introduction) provides a more in-depth look at database access internals such as networking and security.

See [Reference](/docs/database-access/reference) for an overview of database access related configuration and CLI commands.
...
Please follow our [standard upgrade procedure](/docs/management/admin) to upgrade your cluster.
...
You can learn more in the [Application Access introduction](/docs/application-access/introduction).
...
Learn more about [Teleport's RBAC Resources](/docs/access-controls/introduction)

##### Cluster Labels

Teleport 5.0 also adds the ability to set labels on Trusted Clusters. The labels are set when creating a trusted cluster invite token. This lets teams use the same RBAC controls used on nodes to approve or deny access to clusters. This can be especially useful for MSPs that connect hundreds of customers' clusters - when combined with Access Workflows, cluster access can easily be delegated. Learn more by reviewing our [Truster Cluster Setup & RBAC Docs](/docs/management/admin/trustedclusters)
...
- We've added a Waiting Room for customers using Access Workflows. [Docs](/docs/access-controls/access-request-plugins/index)
...
We've added an [API Guide](/docs/api/introduction) to simply developing applications against Teleport.

#### Upgrade Notes

Please follow our [standard upgrade procedure](/docs/upgrading).
...
Teleport 4.3 introduces four new plugins that work out of the box with [Approval Workflow](/docs/access-controls/access-request-plugins/index). These plugins allow you to automatically support role escalation with commonly used third party services. The built-in plugins are listed below.

- [PagerDuty](/docs/access-controls/access-request-plugins/ssh-approval-pagerduty)
- [Jira](/docs/access-controls/access-request-plugins/ssh-approval-jira)
- [Slack](/docs/access-controls/access-request-plugins/ssh-approval-slack)
- [Mattermost](/docs/access-controls/access-request-plugins/ssh-approval-mattermost)
...
procedure](/docs/upgrading) to upgrade to this version.
...
docs](/docs/management/operations/ca-rotation).
...
permissions](/docs/kubernetes-access/manage-access/rbac).

##### Path prefix for etcd

The [etcd backend](/docs/reference/backends#etcd) now correctly uses
...
[upgrade guidance](/docs/upgrading).

**Note: If you use an etcd backend with a non-default prefix and need to downgrade from 4.3 to 4.2, you should [backup Teleport data and restore it](/docs/management/operations/backup-restore) into the downgraded cluster.**
...
- Alpha: Workflows API lets admins escalate RBAC roles in response to user requests. [Read the docs](/docs/access-controls/access-requests). [#3006](https://github.com/gravitational/teleport/issues/3006)
- Beta: Teleport provides HA Support using Firestore and Google Cloud Storage using Google Cloud Platform. [Read the docs](/docs/deploy-a-cluster/deployments/gcp). [#2821](https://github.com/gravitational/teleport/pull/2821)
- Remote tctl execution is now possible. [Read the docs](/docs/reference/cli/tctl). [#1525](https://github.com/gravitational/teleport/issues/1525) [#2991](https://github.com/gravitational/teleport/issues/2991)
...
- Adopting root/leaf terminology for trusted clusters. [Trusted cluster documentation](/docs/management/admin/trustedclusters).
- Documented Teleport FedRAMP & FIPS Support. [FedRAMP & FIPS documentation](/docs/access-controls/compliance-frameworks/fedramp).
...
- Teleport now support 10,000 remote connections to a single Teleport cluster. [Using our recommend hardware setup.](/docs/management/operations/scaling#hardware-recommendations)
...
Teleport 4.0 is backwards compatible with Teleport 3.2 and later. [Follow the recommended upgrade procedure to upgrade to this version.](/docs/upgrading)
...
procedure](/docs/upgrading) to upgrade to this
version.
...
- Role templates (depreciated in Teleport 2.3) were fully removed. We recommend
  migrating to role variables which are documented [here](/docs/access-controls/guides/role-templates)
