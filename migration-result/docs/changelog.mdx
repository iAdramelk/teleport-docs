...
the cluster. Follow the updated agentless OpenSSH integration [guide](/docs/server-access/guides/openssh)
...
guide](/docs/server-access/guides/openssh).
...
[documentation](/docs/management/operations/upgrading).
...
procedure](/docs/management/admin/upgrading-the-teleport-binary).
...
Please follow our [standard upgrade
procedure](/docs/management/operations/upgrading).
...
procedure](/docs/management/operations/upgrading) to upgrade to this version.
...
[upgrade guidance](/docs/management/operations/upgrading).
...
Teleport 4.0 is backwards compatible with Teleport 3.2 and later. [Follow the recommended upgrade procedure to upgrade to this version.](/docs/management/operations/upgrading)
...
procedure](/docs/management/operations/upgrading) to upgrade to this
version.
...
- The Teleport daemon now implements built-in connection draining which allows
  ...
  documentation](/docs/management/admin/upgrading-the-teleport-binary).
