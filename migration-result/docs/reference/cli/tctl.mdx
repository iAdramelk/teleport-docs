...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    <Note>
      ...
      [Access Controls](/docs/access-controls/introduction) and ensure that
...
<Tip>
  ...
  [Machine ID](/docs/machine-id/introduction) is a more secure alternative that
...
See the [Resources Reference](/docs/reference/resources) for complete docs on how to build these yaml files.
...
| `--google-legacy`  | Flag to select groups with direct membership filtered by domain (legacy behavior). <br />Disabled by default. [More info](/docs/access-controls/sso/google-workspace#how-teleport-uses-google-workspace-apis) |
