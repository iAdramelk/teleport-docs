...
<Note>
  You must be familiar with the [Teleport Core concepts](/docs/core-concepts)
...
<Note>
  - How to [Join Services with a Secure Token](/docs/agents/join-services-to-your-cluster/join-token).
  - [Deploying Machine ID on Linux](/docs/machine-id/deployment/linux)
</Note>
...
<Note>
  - [Joining Services via AWS IAM Role](/docs/agents/join-services-to-your-cluster/aws-iam).
  - [Deploying Machine ID on AWS](/docs/machine-id/deployment/aws)
</Note>
...
<Note>
  [Joining Services via AWS EC2 Identity Document](/docs/agents/join-services-to-your-cluster/aws-ec2).
</Note>
...
<Note>
  - [Joining Services via Azure Managed Identity](/docs/agents/join-services-to-your-cluster/azure).
  - [Deploying Machine ID on Azure](/docs/machine-id/deployment/azure)
</Note>
...
<Note>
  - How to [Join Services with GCP](/docs/agents/join-services-to-your-cluster/gcp).
  - [Deploying Machine ID on GCP](/docs/machine-id/deployment/gcp)
</Note>
...
typically used with [Machine ID](/docs/machine-id/introduction) to access
...
<Note>
  - [Deploying Machine ID on GitHub Actions](/docs/machine-id/deployment/github-actions)
</Note>

### CircleCI: `circleci`

This join method is typically used with [Machine ID](/docs/machine-id/introduction)
...
<Note>
  - [Deploying Machine ID on Circle CI](/docs/machine-id/deployment/circleci)
</Note>
...
This join method is typically used with [MachineID](/docs/machine-id/introduction)
...
<Note>
  - [Deploying Machine ID on GitLab CI](/docs/machine-id/deployment/gitlab)
</Note>
...
<Note>
  - [Joining Services via Kubernetes ServiceAccount Token](/docs/agents/join-services-to-your-cluster/kubernetes)
</Note>
...
<Note>
  - [Deploying Machine ID on Kubernetes](/docs/machine-id/deployment/kubernetes)
</Note>
