...
See the [Kubernetes Operator for remote Teleport clusters guide](/docs/management/dynamic-resources/teleport-operator-standalone)
for more details.
...
[Kubernetes JWKS](/docs/reference/join-methods#kubernetes-jwks) join method.
