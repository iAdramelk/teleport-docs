...
| ------------------------------------------------------------ | -------------------------------------- | -------------------------------------------------------------------------------------------- |
| [`kubernetes_service`](/docs/kubernetes-access/introduction) | `kube`                                 | Uses Teleport to handle authentication<br /> with and proxy access to a Kubernetes cluster   |
| [`application_service`](/docs/application-access/guides)     | `app`                                  | Uses Teleport to handle authentication<br /> with and proxy access to web-based applications |
| [`database_service`](/docs/database-access/guides)           | `db`                                   | Uses Teleport to handle authentication<br /> with and proxy access to databases              |
| [`discovery_service`](/docs/kubernetes-access/discovery)     | `discovery`                            | Uses Teleport to discover new resources<br /> and dynamically add them to the cluster        |
...
See [the join method reference](/docs/reference/join-methods) for the list of possible
...
When `joinParams.method` is [a delegated join method](/docs/reference/join-methods#delegated-join-methods),
...
the agent. See [the Teleport Application access documentation](/docs/application-access/introduction)
for more details.
...
<Tip>
  ...
  Reference](/docs/application-access/reference#configuration).
</Tip>
...
Application access documentation](/docs/application-access/introduction)
for more details.
...
<Tip>
  ...
  `tsh` by following [the Dynamic App Registration guide](/docs/application-access/guides/dynamic-registration).
</Tip>
...
<Note>
  For AWS database auto-discovery to work, your Database Service pods will need to use a role which has appropriate IAM permissions as per the [database documentation](/docs/database-access/guides/rds#step-36-create-iam-policies-for-teleport).
...
<Note>
  For Azure database auto-discovery to work, your Database Service pods will need to have appropriate IAM permissions as per the [database documentation](/docs/database-access/guides/azure-postgres-mysql#step-46-configure-iam-permissions-for-teleport).
...
the agent. See [the Teleport Database access documentation](/docs/database-access/introduction)
for more details.
...
<Tip>
  You can see a list of all the supported [values which can be used in a Teleport database service configuration here](/docs/database-access/reference/configuration).
</Tip>
...
Database access documentation](/docs/database-access/introduction)
for more details.
...
<Tip>
  ...
  `tsh` by following [this guide](/docs/database-access/guides/dynamic-registration).
</Tip>
...
documentation](/docs/application-access/enroll-kubernetes-applications/architecture)
for more details.
...
<Warning>
  ...
  One option might be to use Teleport's built-in [ACME support](/docs/reference/helm-reference/teleport-cluster#acme) or enable [cert-manager support](/docs/reference/helm-reference/teleport-cluster#highavailabilitycertmanager).
</Warning>
...
<Note>
  ...
  For more information on how to set static/dynamic labels for Teleport services, see [labelling nodes and applications](/docs/management/admin/labels).
</Note>
...
See the [Teleport config file reference](/docs/reference/config) for
