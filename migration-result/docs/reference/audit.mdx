...
<Tip>
  You can use
  [Enhanced Session Recording with BPF](/docs/server-access/guides/bpf-session-recording)
...
<Tabs>
  <Tab title="Self-Hosted">
    ...
    [Athena](/docs/reference/backends#athena), [DynamoDB](/docs/reference/backends#dynamodb) or
    [Firestore](/docs/reference/backends#firestore) chapters for information on how to
    ...
    [Teleport Configuration Reference](/docs/reference/config).
...
<Tip>
  ...
  read [Exporting Teleport Audit Events](/docs/management/export-audit-events).
</Tip>
...
<Tabs>
  <Tab title="Self-Hosted">
    Teleport can store the recorded sessions in an [AWS S3 bucket](/docs/reference/backends#s3)
    ...
    You can replay recorded sessions using the [`tsh play`](/docs/reference/cli/tsh#tsh-play)
