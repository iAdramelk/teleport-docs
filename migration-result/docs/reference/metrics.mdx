...
- [Audit Events and Records](/docs/reference/audit)
- [Forwarding events with Fluentd](/docs/management/export-audit-events/fluentd)
- [Monitor Teleport Audit Events with the Elastic Stack](/docs/management/export-audit-events/elastic-stack)
