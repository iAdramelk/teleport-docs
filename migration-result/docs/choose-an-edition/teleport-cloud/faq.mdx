...
See our documentation on [data retention](/docs/choose-an-edition/teleport-cloud/architecture#data-retention).
...
We believe mTLS with strong user and [device identity](/docs/access-controls/device-trust/guide) provides the best available
...
tunnels](/docs/agents/join-services-to-your-cluster).
...
[dynamic tokens](/docs/agents/join-services-to-your-cluster/join-token):
...
Find the appropriate download at [Teleport Enterprise Cloud Downloads](/docs/choose-an-edition/teleport-cloud/downloads). Use the Enterprise version of `tctl`.
...
Yes. We recommend Teleport's [event handler plugin](/docs/management/export-audit-events/fluentd) to export Teleport Enterprise Cloud audit events.

### Is it possible to store audit logs and session recordings in my own S3 bucket?

Yes, you can configure [External Audit Storage](/docs/choose-an-edition/teleport-cloud/external-audit-storage).
...
described in [Teleport Upcoming Releases](/docs/upcoming-releases).
...
the [Upgrading Overview](/docs/upgrading/overview) for more information.
...
- [Upgrading Teleport Cloud Agents on
  Kubernetes](/docs/upgrading/cloud-kubernetes)
- [Upgrading Teleport Cloud Agents on
  Linux Servers](/docs/upgrading/cloud-linux)
...
-------- ------------------------------------ -------------- ------ ----------
server01 46d8cad0-8967-4815-a01a-77aae62c34fe                       15.0.2
server02 c33b5513-a9eb-463b-8f1b-1f209afe5b4f                       15.0.2
```
...
Read more in our [TLS Routing](/docs/architecture/tls-routing) guide.
...
of regions all over the world, and allow customers to [select the region](/docs/choose-an-edition/teleport-cloud/architecture#auth-service) where the data is stored.
...
Configuring [External Audit Storage](/docs/choose-an-edition/teleport-cloud/external-audit-storage) will allow
