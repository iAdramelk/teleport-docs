...
updates](/docs/management/operations/enroll-agent-into-automatic-updates).
...
agent into automatic updates](/docs/management/operations/enroll-agent-into-automatic-updates).
