...
[Athena](/docs/reference/backends#athena) backend for audit events and the
[S3](/docs/reference/backends#s3) backend for session recordings. It is only
...
[Event Handler](/docs/management/export-audit-events) plugin to export
