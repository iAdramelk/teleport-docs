...
- [Per-session MFA](/docs/access-controls/guides/per-session-mfa)
- [Dual authorization](/docs/access-controls/guides/dual-authz)
- [Role templates, allow/deny rules, and traits](/docs/access-controls/guides/role-templates)
- [Access Requests](/docs/access-controls/access-requests)

### Background reading

- [Authentication connectors](/docs/reference/authentication)
- [Proxy Service](/docs/architecture/proxy)
- [Auth Service](/docs/architecture/authentication)
