...
follow [the guide for Helm-deployed clusters](/docs/management/dynamic-resources/teleport-operator-helm).

If you are hosting Teleport out of Kubernetes (Teleport Cloud, Terraform, ...),
follow [the standalone operator guide](/docs/management/dynamic-resources/teleport-operator-standalone).
...
- Follow the ["Managing users and roles with IaC" guide](/docs/management/dynamic-resources/user-and-role).
- Check out [access controls documentation](/docs/access-controls/introduction).
