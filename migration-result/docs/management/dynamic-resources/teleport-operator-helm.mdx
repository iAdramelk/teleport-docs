...
<Warning>
  ...
  [the standalone operator guide](/docs/management/dynamic-resources/teleport-operator-standalone) instead.
</Warning>
...
Helm Chart parameters are documented in the [`teleport-cluster` Helm chart reference](/docs/reference/helm-reference/teleport-cluster).

See the [Helm Deployment guides](/docs/deploy-a-cluster/helm-deployments) detailing specific setups like running Teleport on AWS or GCP.
