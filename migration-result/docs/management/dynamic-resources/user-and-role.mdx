...
<Tabs>
  ...
  <Tab title="Kubernetes Operator">
    ...
    - [the guide to enable the operator in the `teleport-cluster` Helm chart](/docs/management/dynamic-resources/teleport-operator-helm).
    - [the guide to setup a standalone operator](/docs/management/dynamic-resources/teleport-operator-standalone).
  ...
  <Tab title="Terraform">
    A functional Teleport Terraform provider by following [the Terraform provider guide](/docs/management/dynamic-resources/terraform-provider).
  </Tab>
</Tabs>
...
<Note>
  ...
  See [the user type reference](/docs/reference/user-types) for more details.
</Note>
...
<Tabs>
  <Tab title="Via the UI">
    ...
    ![Screenshot of the web UI listing alice and bob users](/assets/check-users-web-ui-faec7c14af.png)
...
- Allow users with the `manager` role to grant access to production servers to
  ...
  See [the AccessList documentation](/docs/access-controls/access-lists) for
  a high-level explanation of the feature,
  and [the AccessList IaC guide](/docs/management/dynamic-resources/access-list) for a step by step IaC
  AccessList setup.
- Allow users with the `engineer` role to request temporary access to
  ...
  See [the Access Requests documentation](/docs/access-controls/access-requests)
- You can see all supported fields in the references
  of [the user resource](/docs/reference/resources#user)
  and [the role resource](/docs/reference/resources#role).
