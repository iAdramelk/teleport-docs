...
on [the IaC users and roles guide](/docs/management/dynamic-resources/user-and-role) by allowing users with
...
first [the basic users and roles IaC guide](/docs/management/dynamic-resources/user-and-role). We will reuse
...
[in the Access List reference](/docs/access-controls/access-lists/reference).
