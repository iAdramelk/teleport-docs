...
- the ["Creating Access Lists with IaC" guide](/docs/management/dynamic-resources/access-list)
...
reference](/docs/reference/cli/tctl) for more information on `tctl`.
...
provider](/docs/management/dynamic-resources/terraform-provider).
...
[Get started with the Kubernetes Operator](/docs/management/dynamic-resources/teleport-operator).
...
- To see the dynamic configuration resources available to apply, read the
  [Configuration Resource Reference](/docs/reference/resources). There are also
  dedicated configuration resource references for
  [applications](/docs/application-access/reference#application-resource) and
  [databases](/docs/database-access/reference/configuration#database-resource).
