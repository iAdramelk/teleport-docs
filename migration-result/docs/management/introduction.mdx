...
and Kubernetes Operator. Read [Using Dynamic Resources](/docs/management/dynamic-resources)
for more information.

## Configure your cluster

Get to know the [tools you can use](/docs/management/dynamic-resources) to apply
...
The [Admin Guides](/docs/management/admin) section describes how to perform routine
...
The [Operations](/docs/management/operations) section describes how to perform critical,
...
[Security](/docs/management/security) section.

## Integrations

Teleport integrates with third-party software in order to enable secure access
to your infrastructure. The [Integrations](/docs/management/guides) section describes
...
Learn more in the [Diagnostics](/docs/management/diagnostics) section.
...
[Exporting Audit Events](/docs/management/export-audit-events) guides.
