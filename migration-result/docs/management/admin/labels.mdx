...
6. Verify that you have added the label by running the following command
   ...
   **Checking your user profile**
   ...
   For more information about managing logins for Teleport users, see [Local Users](/docs/management/admin/users).
...
For more information, see [Resource filtering](/docs/reference/predicate-language).
...
[Teleport Role Templates](/docs/access-controls/guides/role-templates).
