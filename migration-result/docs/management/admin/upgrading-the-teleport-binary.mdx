...
<Accordion title="Using containers?">
  ...
  [How to Run Teleport Using Docker](/docs/installation#docker) for information on
...
For Teleport major version `15` the latest version is `15.0.0-dev`.
...
[Upgrading a Teleport Cluster](/docs/management/operations/upgrading).

See the full list of supported signals in the
[Teleport Signals Reference](/docs/reference/signals).
