...
<Tabs>
  <Tab title="Open Source">
    - A running Teleport cluster. For details on how to set this up, see our
      [Getting Started](/docs/index) guide (skip TLS certificate setup).
    ...
    - The `tctl` and `tsh` client tools version >= 15.0.2.
...
<Tabs>
  ...
  <Tab title="Helm chart">
    ...
    [extraArgs](/docs/reference/helm-reference/teleport-cluster#extraargs)
    ...
    [insecureSkipProxyTLSVerify](/docs/reference/helm-reference/teleport-kube-agent#insecureskipproxytlsverify)
    flag to `true`:
...
flag](/docs/connect-your-client/teleport-connect#skipping-tls-certificate-verification).

## Further reading

- [Configuring Teleport TLS Certs](/docs/index#configure-teleport)
- [Run Teleport as a systemd Daemon](/docs/management/admin/daemon)
- [Teleport Proxy Service](/docs/architecture/proxy)
