...
page](/docs/architecture/agent-update-management) describes how agent
updating works.
...
[enroll agents into automatic updates](/docs/management/operations/enroll-agent-into-automatic-updates).
...
Make the `current` release channel target the version 15.0.0-dev:
...
You can now [enroll agents into automatic updates](/docs/management/operations/enroll-agent-into-automatic-updates).
