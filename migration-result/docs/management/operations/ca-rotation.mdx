...
using a [join token](/docs/agents/join-services-to-your-cluster/join-token), each
...
<Warning>
  ...
  reconfigured.
  Refer to [the Database CA Rotation Guide](/docs/management/operations/db-ca-rotation).
</Warning>
