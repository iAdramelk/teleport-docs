...
Back up before upgrading. We have more instructions in [Backing up Teleport](/docs/management/operations/backup-restore).
...
[Upgrade the Teleport Binary](/docs/management/admin/upgrading-the-teleport-binary).
