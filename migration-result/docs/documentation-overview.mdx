...
v15, or want a preview of the next version's
...
up a demo cluster](/docs/index) on a Linux server. After seeing how your demo
...
guide](/docs/core-concepts), which introduces the components of a Teleport
...
- [Installation](/docs/installation): How to install Teleport binaries on your
  environment. If you are just getting started with Teleport, we recommend
  spinning up a [demo cluster](/docs/index) or signing up for a [Teleport Team
  trial](https://goteleport.com/signup).
- [Frequently Asked Questions](/docs/faq): If this page does not answer your
  question, try our AI-assisted search box on the left sidebar.
- [Usage Reporting and Billing](/docs/usage-billing): How Teleport calculates
  usage metrics to determine customer billing.
- [Upcoming Releases](/docs/upcoming-releases): Features to be introduced in
  future versions of Teleport.
- [Changelog](/docs/changelog): A comprehensive collection of release notes.
- [Teleport Assist](/docs/ai-assist): How to use the AI-guided Teleport client.
...
Edition](/docs/choose-an-edition/introduction) section.

## Deploy a cluster

Once you know which edition you would like to deploy, read our [Deploy a
Cluster](/docs/deploy-a-cluster/introduction) documentation for how to launch a
...
Access](/docs/access-controls/introduction) to get started.
...
Cluster](/docs/management/introduction) for more information.
...
- [Servers](/docs/server-access/getting-started), including OpenSSH servers that
  [do not have Teleport installed](/docs/server-access/openssh/openssh)
- [Kubernetes clusters](/docs/kubernetes-access/introduction)
- [Databases](/docs/database-access/introduction)
- [Applications](/docs/application-access/introduction)
- [Remote desktops](/docs/desktop-access/introduction)

You can also set up [Machine ID](/docs/machine-id/introduction) to enable
...
our [API guides](/docs/api/introduction).
...
[Upcoming Releases](/docs/upcoming-releases) section for a glimpse of features we
will release in the next Teleport version. Consult our
[Reference](/docs/reference/introduction) guides for comprehensive lists of
configuration options, CLI flags, and more. For detailed explanations of how
Teleport works, see the [Architecture](/docs/architecture/introduction) section.
