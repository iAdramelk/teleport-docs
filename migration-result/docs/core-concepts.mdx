...
Read our guides to how [authorization](/docs/architecture/authorization) and
[authentication](/docs/architecture/authentication) work in Teleport.
...
in our [CLI Reference](/docs/reference/cli/teleport).
...
Service](/docs/application-access/introduction).
...
Service](/docs/database-access/introduction).
...
Service](/docs/desktop-access/introduction).
...
Service](/docs/kubernetes-access/introduction)
...
Read more about the [Teleport SSH Service](/docs/server-access/introduction).
...
Read more in our [Machine ID guide](/docs/machine-id/introduction).
...
edition in [Choose an edition](/docs/choose-an-edition/introduction).
...
guide](/docs/choose-an-edition/teleport-cloud/introduction).
...
guide](/docs/choose-an-edition/teleport-enterprise/introduction).
...
Read more in our [resource reference](/docs/reference/resources).
...
Read our [guide to Teleport roles](/docs/access-controls/guides/role-templates).
...
Read more about [local users](/docs/reference/authentication) and how [SSO
authentication works in Teleport](/docs/access-controls/sso).
...
See our guide to [Authentication Options](/docs/reference/authentication).
...
see [Configure Trusted Clusters](/docs/management/admin/trustedclusters).
For an overview of the architecture used in a trusted cluster relationship, see
[Trusted Cluster Architecture](/docs/architecture/trustedclusters).
