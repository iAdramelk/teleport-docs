...
- Your workstation configured with [kubectl](https://kubernetes.io/docs/tasks/tools/), [Helm](https://helm.sh/docs/intro/install/), [doctl](https://docs.digitalocean.com/reference/doctl/how-to/install/), and the Teleport [tsh](/docs/installation) client.
...
guide](/docs/reference/helm-reference/teleport-cluster).

Read our guides to additional ways you can protect a Kubernetes cluster with
Teleport:

- Connect another Kubernetes cluster to Teleport by [deploying the Teleport Kubernetes Service](/docs/kubernetes-access/getting-started)
- [Set up Machine ID with Kubernetes](/docs/machine-id/access-guides/kubernetes)
- [Federated Access using Trusted Clusters](/docs/kubernetes-access/manage-access/federation)
- [Single-Sign On and Kubernetes Access Control](/docs/kubernetes-access/controls)
