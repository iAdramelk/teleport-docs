...
- The `tsh` client tool v15.0.0-dev+ installed on your workstation.
  You can download this from our [installation page](/docs/installation).
...
<Warning>
  ...
  guide](/docs/kubernetes-access/controls) before you begin.
</Warning>
...
- **Set up Single Sign-On:** In this guide, we showed you how to create a local
  ...
  Sign-On guides](/docs/access-controls/sso) for how to do this.
- **Configure your Teleport deployment:** To see all of the options you can set
  ...
  [reference guide](/docs/reference/helm-reference/teleport-cluster).
- **Register resources:** You can register all of the Kubernetes clusters in
  ...
  guides](/docs/kubernetes-access/discovery) to see how to automatically
...
- **Fine-tune your Kubernetes RBAC:** While the user you created in this guide
  ...
  Access Controls Guide](/docs/kubernetes-access/controls) for more
  information.
