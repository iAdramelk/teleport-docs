...
If you want to use a different version of Teleport, set the [`teleportVersionOverride`](/docs/reference/helm-reference/teleport-cluster#teleportversionoverride) value.
