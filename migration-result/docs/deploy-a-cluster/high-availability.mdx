...
will enable [TLS Routing](/docs/management/operations/tls-routing) in your
Teleport cluster.
...
<Tip>
  ...
  Helm chart, read our [Helm Deployments](/docs/deploy-a-cluster/helm-deployments) documentation.
</Tip>
...
to follow a more specific [deployment guide](/docs/deploy-a-cluster/introduction) for your
environment.
...
Consult our [Backends Reference](/docs/reference/backends) for the configuration
...
- [High-availability Teleport Deployments on Kubernetes with
  Helm](/docs/deploy-a-cluster/helm-deployments)
- [Reference Deployments](/docs/deploy-a-cluster/deployments) for running Teleport on a cluster of
  virtual machines
...
- [Scaling a Teleport cluster](/docs/management/operations/scaling)
- [Monitoring a Teleport cluster](/docs/management/diagnostics)
...
- [Applications](/docs/application-access/getting-started)
- [Servers](/docs/server-access/getting-started)
- [Kubernetes clusters](/docs/kubernetes-access/getting-started)
- [Databases](/docs/database-access/getting-started)
- [Windows desktops](/docs/desktop-access/introduction)
- [Bot users](/docs/machine-id/getting-started)
