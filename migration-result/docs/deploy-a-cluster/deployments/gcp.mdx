...
see  [Admin Guide: Troubleshooting](/docs/management/admin/troubleshooting) for more information.
...
Follow install instructions from our [installation page](/docs/installation#linux).
...
<Tabs>
  <Tab title="Open Source">
    **1. Configure Teleport Auth Server** using the below example `teleport.yaml`,and start it
    using [systemd](/docs/management/admin/daemon). The DEB/RPM installations will
...
Follow our [Local Users](/docs/management/admin/users) guide or integrate
with [Google Workspace](/docs/access-controls/sso/google-workspace) to
provide SSO access.
