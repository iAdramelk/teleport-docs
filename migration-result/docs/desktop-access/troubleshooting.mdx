...
Policy](/docs/desktop-access/active-directory-manual#enable-smart-card-authentication).
...
Policy](/docs/desktop-access/active-directory-manual#create-the-GPO-for-the-Teleport-certificate).
...
connections](/docs/desktop-access/active-directory-manual#allow-remote-desktop-connections)
...
connections](/docs/desktop-access/active-directory-manual#step-47-configure-a-certificate-for-rdp-connections).
...
desktop connections](/docs/desktop-access/active-directory-manual#allow-remote-desktop-connections)
in the group policy object you have configured for Teleport connections.
