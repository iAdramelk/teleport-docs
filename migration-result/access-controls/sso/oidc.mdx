...
<Tip>
  For Google Workspace, see [Teleport Authentication with Google Workspace](/access-controls/sso/google-workspace)
</Tip>
...
commands](/reference/resources) or the Teleport Web UI.
...
oidc](/reference/cli/tctl#tctl-sso-configure-oidc) section of the Teleport CLI
Reference page.
