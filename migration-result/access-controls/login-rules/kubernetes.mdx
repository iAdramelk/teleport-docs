...
- Follow Step 1 of the
  [Teleport operator guide](/management/dynamic-resources/teleport-operator#step-13-install-teleport-cluster-helm-chart-with-the-operator)
...
- Read the [Teleport Operator Guide](/management/dynamic-resources/teleport-operator) to
  learn more about the Teleport Operator.
- Read the [Login Rules reference](/access-controls/login-rules/reference) to learn mode about the
