...
<Note>
  The [Terraform provider guide](/management/dynamic-resources/terraform-provider)
...
- Read the [Terraform Guide](/management/dynamic-resources/terraform-provider) to
