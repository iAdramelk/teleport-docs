...
Check the [Single Sign-On](/access-controls/sso) docs to learn how to set this up.
...
The [`tctl sso test`](/reference/cli/tctl#tctl-sso-test) command can be used to
...
[Login Rule Reference](/access-controls/login-rules/reference) page.

Learn about the `tctl login_rule test` command by running the help command or
checking the [reference page](/reference/cli/tctl#tctl-login_rule-test).
