...
- [Azure Active Directory (AD)](/access-controls/sso/azuread): Configure Azure Active Directory SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Active Directory (ADFS)](/access-controls/sso/adfs): Configure Windows Active Directory SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Google Workspace](/access-controls/sso/google-workspace): Configure Google Workspace SSO for SSH, Kubernetes, databases, desktops and web apps.
- [GitHub](/access-controls/sso/github-sso): Configure GitHub SSO for SSH,
  Kubernetes, databases, desktops, and web apps.
- [GitLab](/access-controls/sso/gitlab): Configure GitLab SSO for SSH, Kubernetes, databases, desktops and web apps.
- [OneLogin](/access-controls/sso/one-login): Configure OneLogin SSO for SSH, Kubernetes, databases, desktops and web apps.
- [OIDC](/access-controls/sso/oidc): Configure OIDC SSO for SSH, Kubernetes, databases, desktops and web apps.
- [Okta](/access-controls/sso/okta): Configure Okta SSO for SSH, Kubernetes, databases, desktops and web apps.
...
- `adfs` (SAML): Required for compatibility with Active Directory (ADFS); refer
  to the full [ADFS guide](/access-controls/sso/adfs#step-23-create-teleport-roles) for details.
- `netiq` (OIDC): Used to enable NetIQ-specific ACR value processing; refer to
  the [OIDC guide](/access-controls/sso/oidc#optional-acr-values) for details.
...
as described in the [Resources Reference](/reference/resources).
...
- [SSH Authentication with Okta](/access-controls/sso/okta)
- [SSH Authentication with OneLogin](/access-controls/sso/one-login)
- [SSH Authentication with ADFS](/access-controls/sso/adfs)
- [SSH Authentication with OAuth2 / OpenID Connect](/access-controls/sso/oidc)
