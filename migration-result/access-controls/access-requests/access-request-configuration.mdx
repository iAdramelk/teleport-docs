...
- [Role requests in commercial Teleport editions](/access-controls/access-requests/role-requests)
- [Resource requests in commercial Teleport editions](/access-controls/access-requests/resource-requests)
- [Role requests in Teleport Community Edition](/access-controls/access-requests/oss-role-requests)
...
Templates](/access-controls/guides/role-templates#templating-in-access-requests) for more
...
1. Calculate the maximum duration of elevated privileges if the Access Request
   ...
   - The `--max-duration` flag of the [`tsh request
     create`](/reference/cli/tsh#tsh-request-create) command (if the
...
2. Calculate the session TTL of the certificate the user would receive if
   ...
   - The requested session expiration time, which is the value of the
     ...
     create`](/reference/cli/tsh#tsh-request-create).
...
1. Begin with with the base expiration of the Access Request, which a user can
   ...
   create`](/reference/cli/tsh#tsh-request-create) command. If this is
...
language](/reference/predicate-language).
...
If you [write your own Access Request plugin](/api/access-plugin), the
