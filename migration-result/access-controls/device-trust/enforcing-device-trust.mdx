...
works similarly to [`require_session_mfa`](/access-controls/guides/per-session-mfa).
...
<Tip>
  ...
  clusters](/management/admin/trustedclusters) to limit the impact of
...
Similar to [session and identity locking](/access-controls/guides/locking), a device can
