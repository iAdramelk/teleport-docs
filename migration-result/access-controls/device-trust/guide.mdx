...
<Tip>
  ...
  [device management guide](/access-controls/device-trust/device-management#register-a-trusted-device)
</Tip>
...
- [Device Management](/access-controls/device-trust/device-management)
- [Enforcing Device Trust](/access-controls/device-trust/enforcing-device-trust)
