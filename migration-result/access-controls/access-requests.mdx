...
consider [Access Lists](/access-controls/access-lists).
...
[Get started with Role Access Requests](/access-controls/access-requests/role-requests).
...
[Get started with Resource Access Requests](/access-controls/access-requests/resource-requests).
...
Configuration](/access-controls/access-requests/access-request-configuration) guide for an
...
Edition, see [Teleport Community Access Requests](/access-controls/access-requests/oss-role-requests).
