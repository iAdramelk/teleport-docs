...
- [Custom API clients](/api/rbac)

To read more about managing dynamic resources, see the [Dynamic
Resources](/management/dynamic-resources) guide.
...
| `record_session`             | Defines the [Session recording mode](/reference/audit#modes).                                                                                                                                                                                                                                                                            | The strictest value takes precedence.                                                                                                                                                                                                      |
...
explicitly set. Additionally, roles `v5` or `v6` are required to use [Moderated Sessions](/access-controls/guides/moderated-sessions).
...
fine-grained control over Kubernetes resources. See [Kubernetes RBAC](/kubernetes-access/manage-access/rbac) for more details.
...
This works by [labeling resources](/management/admin/labels) and
...
Check out our
[predicate language](/reference/predicate-language#label-expressions)
...
[shared sessions](/connect-your-client/tsh#sharing-sessions) and
[session recordings](/architecture/nodes#ssh-session-recording).
...
Read the [predicate
language](/reference/predicate-language#scoping-allowdeny-rules-in-role-resources)
guide for a more in depth explanation of the language.

## Second Factor - U2F

Refer to the [Second Factor - WebAuthn](/access-controls/guides/webauthn#u2f) guide if you
