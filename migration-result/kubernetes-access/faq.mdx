...
Check out the
[Kubernetes Service Standalone Guide](/kubernetes-access/register-clusters/static-kubeconfig).
...
Check out the [Teleport Kubernetes Access Controls Guide](/kubernetes-access/controls) for
...
Check out the [Kubernetes Service Discovery Guide](/kubernetes-access/discovery) for more
