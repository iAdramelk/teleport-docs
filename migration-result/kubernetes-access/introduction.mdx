...
Guide](/kubernetes-access/getting-started).
...
[Read our overview](/kubernetes-access/discovery) of how Teleport automatically discovers
Kubernetes clusters.

Read our guides to automatically registering Kubernetes clusters with Teleport
on your cloud:

- [AWS](/kubernetes-access/discovery/aws)
- [Google Cloud](/kubernetes-access/discovery/google-cloud)
- [Azure](/kubernetes-access/discovery/azure)
...
- [Deploy the Teleport Kubernetes
  Service with IAM Joining](/kubernetes-access/register-clusters/iam-joining) on your cluster of
  choice.
- Deploy the Teleport Kubernetes Service outside your Kubernetes cluster (e.g.,
  ...
  kubeconfig](/kubernetes-access/register-clusters/static-kubeconfig).
- Deploy the Teleport Kubernetes Service outside of Kubernetes  and [use dynamic
  configuration resources](/kubernetes-access/register-clusters/dynamic-registration) to
...
Read our [Kubernetes RBAC guide](/kubernetes-access/manage-access/rbac) for step-by-step
...
Reference](/kubernetes-access/controls).

See how to federate your Kubernetes access controls using [Teleport Trusted
Clusters](/kubernetes-access/manage-access/federation).
