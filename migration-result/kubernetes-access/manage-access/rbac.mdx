...
the Kubernetes [Access Controls Guide](/kubernetes-access/controls). You can leave your
...
Requests](/access-controls/access-requests/resource-requests)
for just-in-time access and [Access Request
plugins](/access-controls/access-request-plugins/index) so you can manage
