...
See our [Azure
CLI](/application-access/cloud-apis/azure#step-34-enable-your-user-to-access-azure-clis) guide
for more information on enabling access to Azure managed identities.

## Next steps

- View access controls [Getting Started](/access-controls/getting-started)
  and other available [guides](/access-controls/guides).
...
- View access controls [Getting Started](/access-controls/getting-started)
  and other available [guides](/access-controls/guides).
- Learn about using [JWT tokens](/application-access/jwt/introduction) to implement access
  controls in your application.
- Integrate with your identity provider:
  - [OIDC](/access-controls/sso/oidc)
  - [ADFS](/access-controls/sso/adfs)
  - [Azure AD](/access-controls/sso/azuread)
  - [Google Workspace](/access-controls/sso/google-workspace)
  - [Onelogin](/access-controls/sso/one-login)
  - [Okta](/access-controls/sso/okta)
