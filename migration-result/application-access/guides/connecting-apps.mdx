...
and follow the installation [instructions](/installation).
...
Rewritten header values support the same templating variables as [role templates](/access-controls/guides/role-templates).
...
[Integrating with JWTs](/application-access/jwt/introduction) for more details.
