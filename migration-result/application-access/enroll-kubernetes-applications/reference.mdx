...
please see [helm chart documentation](/reference/helm-reference/teleport-kube-agent#kubernetesdiscovery).
...
For more information you can take a look at [`discovery_service`](/reference/config#discovery-service) and [`app_service`](/reference/config#application-service) configuration references.
...
app (see [documentation](/application-access/guides/connecting-apps#rewrite-redirect)).
