...
- Running [Application Service](/application-access/guides/connecting-apps).
...
<Tip>
  You can also use [dynamic registration](/application-access/guides/dynamic-registration).
</Tip>
...
- Get more information about integrating with [Teleport JWT tokens](/application-access/jwt/introduction).
