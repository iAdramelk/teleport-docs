...
You can inject a JWT token into any header using [headers passthrough](/application-access/guides/connecting-apps#headers-passthrough)
...
- [ElasticSearch](/application-access/jwt/elasticsearch)
