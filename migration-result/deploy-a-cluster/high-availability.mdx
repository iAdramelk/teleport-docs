...
will enable [TLS Routing](/management/operations/tls-routing) in your
Teleport cluster.
...
<Tip>
  ...
  Helm chart, read our [Helm Deployments](/deploy-a-cluster/helm-deployments) documentation.
</Tip>
...
to follow a more specific [deployment guide](/deploy-a-cluster/introduction) for your
environment.
...
Consult our [Backends Reference](/reference/backends) for the configuration
...
- [High-availability Teleport Deployments on Kubernetes with
  Helm](/deploy-a-cluster/helm-deployments)
- [Reference Deployments](/deploy-a-cluster/deployments) for running Teleport on a cluster of
  virtual machines
...
- [Scaling a Teleport cluster](/management/operations/scaling)
- [Monitoring a Teleport cluster](/management/diagnostics)
...
- [Applications](/application-access/getting-started)
- [Servers](/server-access/getting-started)
- [Kubernetes clusters](/kubernetes-access/getting-started)
- [Databases](/database-access/getting-started)
- [Windows desktops](/desktop-access/introduction)
- [Bot users](/machine-id/getting-started)
