...
- Teleport's [Proxy Peering](/architecture/proxy-peering) is used to reduce the total number of tunnel connections in the Teleport cluster.
...
- [GSLB](https://www.cloudflare.com/learning/cdn/glossary/global-server-load-balancing-gslb/)
- [Teleport TLS Routing](/architecture/tls-routing) to reduce the number of ports needed to use Teleport
- [Teleport Proxy Peering](/architecture/proxy-peering) for reducing the number of resource connections
...
Review the [configuration reference](/reference/config) page for
additional settings.

## Configure Proxy Peering

In this deployment architecture, [Proxy Peering](/architecture/proxy-peering) is used to restrict the number of connections made from
...
Reference the [Auth Server configuration](/reference/config#auth-service) reference page
...
Reference the [Proxy Service configuration](/reference/config#proxy-service) reference page
for additional settings.
