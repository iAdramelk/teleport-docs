...
- The `tsh` client tool v15.0.0-dev+ installed on your workstation.
  You can download this from our [installation page](/installation).
...
<Warning>
  ...
  guide](/kubernetes-access/controls) before you begin.
</Warning>
...
- **Set up Single Sign-On:** In this guide, we showed you how to create a local
  ...
  Sign-On guides](/access-controls/sso) for how to do this.
- **Configure your Teleport deployment:** To see all of the options you can set
  ...
  [reference guide](/reference/helm-reference/teleport-cluster).
- **Register resources:** You can register all of the Kubernetes clusters in
  ...
  guides](/kubernetes-access/discovery) to see how to automatically
...
- **Fine-tune your Kubernetes RBAC:** While the user you created in this guide
  ...
  Access Controls Guide](/kubernetes-access/controls) for more
  information.
