...
- The reason for both of these requirements is that Teleport uses X509 certificates for authentication, which requires
  ...
  [using ALPN connection upgrades](/architecture/tls-routing#working-with-layer-7-load-balancers-or-reverse-proxies).
    ...
    <Tabs>
      <Tab title="cert-manager">
        ...
        <Note>
          ...
          [ensure you set](/reference/helm-reference/teleport-cluster#highavailabilitycertmanageraddcommonname)
          ...
          [reference the secret](/reference/helm-reference/teleport-cluster#tlsexistingcasecretname)
...
[the DynamoDB autoscaling section](/reference/backends#dynamodb-autoscaling).
